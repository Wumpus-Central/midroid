...
public object AppDatabase {
   ...
   public fun getGuildVersions(userId: String?, requiredCacheVersion: String?): DatabaseVersions {
      if (var1 == null) {
         ...
         var var4: Int;
         var var25: Array<NonGuildVersion>;
         var var26: Array<GuildVersion>;
         try {
            var1 = this.databaseName(var1);
            val var7: java.lang.String = DiscordMobileApi.getGuildVersions(var1, "guild_versions");
            val var6: java.lang.String = DiscordMobileApi.getGuildVersions(var1, "non_guild_versions");
            ...
            var14.a();
            var26 = var14.b(new i2(GuildVersion::class, GuildVersion.Companion.serializer()), var7) as Array<GuildVersion>;
            var14.a();
            var25 = var14.b(new i2(NonGuildVersion::class, NonGuildVersion.Companion.serializer()), var6) as Array<NonGuildVersion>;
            var14.a();
         ...
         for (int var3 = 0; var3 < var4; var3++) {
            try {
               if (var15[var3].getVersion() == var2) {
                  return new DatabaseVersions(var26, var25);
               }

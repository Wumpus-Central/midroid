...
public object AppDatabase {
   ...
   public fun getGuildVersions(userId: String?, requiredCacheVersion: String?): DatabaseVersions {
      if (var1 == null) {
         ...
         try {
            ...
            var23.a();
            var26 = var23.b(new K0(GuildVersion::class, GuildVersion.Companion.serializer()), var6) as Array<GuildVersion>;
            var23.a();
            var27 = var23.b(new K0(NonGuildVersion::class, NonGuildVersion.Companion.serializer()), var7) as Array<NonGuildVersion>;
            var23.a();
            var16 = var23.b(new K0(CacheVersion::class, CacheVersion.Companion.serializer()), var1) as Array<CacheVersion>;
            var4 = var16.length;
   ...
   public fun initializeAppDatabase(context: Context) {
      ...
      Ga.a.b(false, false, null, "AppDatabaseLoader", 0, new a(var1), 23, null);
   }
}

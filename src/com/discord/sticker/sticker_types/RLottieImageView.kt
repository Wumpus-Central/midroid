...
internal class RLottieImageView(context: Context) : com.discord.rlottie.RLottieImageView(var1) {
   ...
   init {
      ...
      this.rLottieStateManager = new AnimatedImageStateManager<>(
         new a(this),
         new b(this),
         null,
         new com.discord.sticker.sticker_types.c(this),
         new com.discord.sticker.sticker_types.d(this),
         new com.discord.sticker.sticker_types.e(this),
         4,
         null
      );
   }
         ...
         new Function2<CoroutineScope, Continuation<? super Unit>, Object>(this, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               val var12: Flow = FileDownloader.downloadFile$default(
                  var9, var7, var6, var5.toString(), new File(this.this$0.getContext().getCacheDir(), "stickers"), false, 16, null
               );
               val var10: FlowCollector = new FlowCollector(this.this$0, this.$config) {
                  ...
                  public final Object emit(DownloadState var1, Continuation<? super Unit> var2x) {
                     if (var1 is DownloadState.Completed) {
                        val var4x: Any = gu.g.g(
                           m0.c(), new Function2<CoroutineScope, Continuation<? super Unit>, Object>(this.this$0, var1, this.$config, null) {
                              final RLottieImageView.Config $config;
                              ...
                              public final Object invokeSuspend(Object var1) {
                                 ...
                                 if (this.label == 0) {
                                    ...
                                    var6.setAnimation(var7, var5, var3, var4x, var1);

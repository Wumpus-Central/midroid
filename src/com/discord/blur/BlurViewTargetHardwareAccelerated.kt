         ...
         if (!var6) {
            ...
            for (Entry var15 : this.blurRectRenderNodes.entrySet()) {
               ...
               if (var11 != null) {
                  ...
                  i.a(var17, 0, 0, var11.getWidth(), var11.getHeight());
                  u.a(var17, (float)(var11.getWindowX() - this.blurViewTargetWindowOffsetX));
                  j.a(var17, (float)(var11.getWindowY() - this.blurViewTargetWindowOffsetY));
                  val var16: RecordingCanvas = m.a(var17);
                  n.a(
                     var16,

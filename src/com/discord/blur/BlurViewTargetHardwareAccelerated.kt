      ...
      while (true) {
         ...
         if (!var6) {
            ...
            for (Entry var15 : this.blurRectRenderNodes.entrySet()) {
               ...
               val var16: RenderNode = k.a(var15.getValue());
               ...
               if (var17 != null) {
                  ...
                  a1.a(var16, l.a(Math.abs(var2), Math.abs(var2), TileMode.CLAMP));
                  x0.a(var16, 0, 0, var17.getWidth(), var17.getHeight());
                  X0.a(var16, (float)(var17.getWindowX() - this.blurViewTargetWindowOffsetX));
                  M0.a(var16, (float)(var17.getWindowY() - this.blurViewTargetWindowOffsetY));
                  val var11: RecordingCanvas = Y0.a(var16);
                  i.a(
                     var11,
                     -((float)(var17.getWindowX() - this.blurViewTargetWindowOffsetX)),
                     -((float)(var17.getWindowY() - this.blurViewTargetWindowOffsetY))
                  );
                  j.a(var11, this.blurContentRenderNode);
                  n0.a(var16);
                  z0.a(var1, var16);
               }
            }

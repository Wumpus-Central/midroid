         ...
         if (var8 == null) {
            ...
            if (var10 != null) {
               ...
               if (var2 != null) {
                  ...
                  val var3: JsonElement = hn.g.o(var14).get("$meta") as JsonElement;
                  if (var3 == null) {
                     return null;
                  }
                  ...
                  val var15: JsonObject = hn.g.o(var14);
   ...
   public fun validateBuildOverrideCookie(buildOverrideCookie: Cookie?, version: String): Boolean {
      ...
      if (var5 == null) {
         ...
         if (var6 == null) {
            ...
            val var7: java.lang.Iterable = var6;
            var var3: Boolean;
            if (var6 is java.util.Collection && (var6 as java.util.Collection).isEmpty()) {
               ...
               while (true) {
                  ...
                  if (q.c(var8.next() as java.lang.String, var2)) {
                     var3 = true;
                     break;
                  }
               }

...
public data class BuildOverrideCookieMeta(expiresAt: String? = null,
   ...
   fun {
      val var0: n2 = n2.a;
      $childSerializers = new KSerializer[]{null, null, new av.f(n2.a), new av.f(var0), null, new u0(var0, p0.a)};
   }
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         var1 = var1;
         if (!(this.expiresAt == var1.expiresAt)) {
            return false;
         } else if (!(this.releaseChannel == var1.releaseChannel)) {
            return false;
         } else if (!(this.validForUserIds == var1.validForUserIds)) {
            return false;
         } else if (!(this.allowedVersions == var1.allowedVersions)) {
            return false;
         } else if (!(this.allowLoggedOut == var1.allowLoggedOut)) {
            return false;
         } else {
            return this.experiments == var1.experiments;
         }
      }
   }
   ...
   public fun toNativeMap(): WritableNativeMap {
      val var4: Pair = v.a("expiresAt", this.expiresAt);
      val var3: Pair = v.a("releaseChannel", this.releaseChannel);
      ...
      val var7: Pair = v.a("allowedVersions", var9);
      val var6: Pair = v.a("allowLoggedOut", this.allowLoggedOut);
      var var12: WritableNativeMap = null;
      if (this.experiments != null) {
         var12 = NativeMapExtensionsKt.toNativeMap(this.experiments);
      }

      return NativeMapExtensionsKt.nativeMapOf(new Pair[]{var4, var3, var5, var7, var6, v.a("experiments", var12)});
   }
   ...
   public override fun toString(): String {
      ...
      val var7: java.util.List = this.allowedVersions;

...
public class ClipboardModule(reactContext: ReactApplicationContext) : NativeClipboardManagerSpec {
   ...
   public open fun setItem(item: String?, type: String?, text: String?) {
      val var4: ClipboardManager = a.i(this.getReactApplicationContext().getApplicationContext(), ClipboardManager.class);

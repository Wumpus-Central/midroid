...
public class PromiseWrapper(promise: Promise,
      ...
      rejectTransform: (com.discord.react.utilities.PromiseWrapper.Rejection) -> com.discord.react.utilities.PromiseWrapper.Rejection = new com.discord.react.utilities.c()
   ) :
   Promise {
   ...
   public override fun reject(code: String, throwable: Throwable?) {
      ...
      val var6: java.lang.String = var5.getCode();
      var3.reject(var6, var5.getThrowable());
   }

...
internal fun getSocFromProcCpuInfo(): String {
   ...
   // 32: aload 2
   // 33: invokestatic Ha/q.d (Ljava/io/BufferedReader;)Lkotlin/sequences/Sequence;
   ...
   // 95: aload 2
   // 96: aconst_null
   // 97: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 9a: goto a7
   // 9d: aload 3
   // 9e: athrow
   // 9f: astore 0
   // a0: aload 2
   // a1: aload 3
   // a2: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // a5: aload 0
   // a6: athrow
   // a7: aload 0
   // a8: areturn

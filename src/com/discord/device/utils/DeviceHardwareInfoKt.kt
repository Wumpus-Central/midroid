...
internal fun getSocFromProcCpuInfo(): String {
   ...
   // 0d: getstatic Q9/a.b Ljava/nio/charset/Charset;
   // 10: astore 3
   ...
   // 33: aload 2
   // 34: invokestatic u8/q.d (Ljava/io/BufferedReader;)Lkotlin/sequences/Sequence;
   ...
   // 96: aload 2
   // 97: aconst_null
   // 98: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 9b: goto a8
   // 9e: aload 0
   // 9f: athrow
   // a0: astore 3
   // a1: aload 2
   // a2: aload 0
   // a3: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // a6: aload 3
   // a7: athrow
   // a8: aload 0
   // a9: areturn
...
internal fun maxCpuFreq(): String {
   ...
   // 05a: lload 4
   // 05c: lstore 8
   // 05e: getstatic Q9/a.b Ljava/nio/charset/Charset;
   // 061: astore 15
   // 063: lload 4
   // 065: lstore 8
   ...
   // 0fd: aload 12
   // 0ff: aconst_null
   // 100: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 103: lload 6
   // 105: lstore 4
   // 107: goto 121
   // 10a: aload 14
   ...
   // 113: aload 12
   // 115: aload 14
   // 117: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 11a: lload 10
   // 11c: lstore 8
   // 11e: aload 13
   // 120: athrow

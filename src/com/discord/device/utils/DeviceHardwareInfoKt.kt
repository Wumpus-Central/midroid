...
internal fun getSocFromProcCpuInfo(): String {
   ...
   // 32: aload 2
   // 33: invokestatic Ma/q.d (Ljava/io/BufferedReader;)Lkotlin/sequences/Sequence;
   ...
   // 88: invokestatic kotlin/text/StringsKt.Z0 (Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
   ...
   // 95: aload 2
   // 96: aconst_null
   // 97: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 9a: goto a7
   // 9d: aload 0
   // 9e: athrow
   // 9f: astore 3
   // a0: aload 2
   // a1: aload 0
   // a2: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // a5: aload 3
   // a6: athrow
   // a7: aload 0
   // a8: areturn

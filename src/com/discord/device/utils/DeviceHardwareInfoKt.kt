...
internal fun getSocFromProcCpuInfo(): String {
   ...
   // 32: aload 2
   // 33: invokestatic K9/p.d (Ljava/io/BufferedReader;)Lkotlin/sequences/Sequence;
   ...
   // 95: aload 2
   // 96: aconst_null
   // 97: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 9a: goto a7
   // 9d: aload 0
   // 9e: athrow
   // 9f: astore 3
   // a0: aload 2
   // a1: aload 0
   // a2: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // a5: aload 3
   // a6: athrow
   // a7: aload 0
   // a8: areturn
...
internal fun maxCpuFreq(): String {
   ...
   // 0fd: aload 12
   // 0ff: aconst_null
   // 100: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
   // 103: lload 6
   // 105: lstore 4
   // 107: goto 121
   // 10a: aload 13

...
internal class OkHttpDNSSelector(mode: com.discord.networking.okhttp.OkHttpDNSSelector.IPvMode) : h {
   ...
   public open fun lookup(hostname: String): List<InetAddress> {
      val var3: java.util.List = h.b.lookup(var1);
      ...
      if (var2 != 1) {
         if (var2 != 2) {
            if (var2 != 3) {
               if (var2 != 4) {
                  ...
                  for (Object var11 : var10) {
                     if (Inet4Address.class.isInstance(var11 as InetAddress)) {
                        var7.add(var11);
                     }
                  }
               ...
               val var8: java.lang.Iterable = var3;
            ...
            return CollectionsKt.W0(var3, new Comparator() {
               @Override

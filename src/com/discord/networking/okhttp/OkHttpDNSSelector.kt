...
internal class OkHttpDNSSelector(mode: com.discord.networking.okhttp.OkHttpDNSSelector.IPvMode) : sv.h {
   ...
   public open fun lookup(hostname: String): List<InetAddress> {
      val var5: java.util.List = sv.h.b.lookup(var1);
         ...
         if (var2 != 2) {
            if (var2 != 3) {
               if (var2 != 4) {
                  ...
                  val var10: java.lang.Iterable = var5;
                  val var7: ArrayList = new ArrayList();

                  for (var10 : var10) {
                     if (Inet4Address.class.isInstance(var10 as InetAddress)) {
                        var7.add(var10);
                     }
                  }
               ...
               val var8: java.lang.Iterable = var5;
            ...
            return CollectionsKt.W0(var5, new Comparator() {
               @Override

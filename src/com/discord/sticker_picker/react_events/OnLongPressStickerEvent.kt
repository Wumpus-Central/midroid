...
internal data class OnLongPressStickerEvent(stickerId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: OnLongPressStickerEvent, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<OnLongPressStickerEvent> {
      ...
      public open fun serialize(encoder: Encoder, value: OnLongPressStickerEvent) {
         ...
         OnLongPressStickerEvent.write$Self(var2, var4, var3);
         var4.c(var3);
      }

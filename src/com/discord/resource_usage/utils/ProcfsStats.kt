...
internal data class ProcfsStats(totalTime: Long, rssPages: Long) {
   ...
   public companion object {
      ...
      private fun File.parsePidStats(): ProcfsStats? {
         ...
         // 091: aload 10
         // 093: aconst_null
         // 094: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
         // 097: aload 11
         // 099: astore 10
         // 09b: aload 1
         // 09c: ifnull 112
         ...
         // 0c9: lconst_0
         // 0ca: invokestatic Gc/c.T (Ljava/lang/String;J)J
         // 0cd: lstore 8
         // 0cf: aload 1
         // 0d0: bipush 14
         ...
         // 0da: lconst_0
         // 0db: invokestatic Gc/c.T (Ljava/lang/String;J)J
         // 0de: lstore 4
         // 0e0: aload 1
         // 0e1: bipush 23
         ...
         // 0eb: lconst_0
         // 0ec: invokestatic Gc/c.T (Ljava/lang/String;J)J
         // 0ef: lstore 6
         ...
         // 109: aload 10
         // 10b: aload 12
         // 10d: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
         // 110: aload 1
         // 111: athrow
         // 112: aload 10
         // 114: areturn

...
internal data class ProcfsStats(totalTime: Long, rssPages: Long) {
   ...
   public companion object {
      ...
      private fun File.parsePidStats(): ProcfsStats? {
         ...
         // 89: aload 4
         // 8b: aconst_null
         // 8c: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
         // 8f: aload 1
         // 90: ifnull e6
         // 93: aload 1
         ...
         // a7: bipush 6
         // a9: aconst_null
         // aa: invokestatic kotlin/text/StringsKt.J0 (Ljava/lang/CharSequence;[CZIILjava/lang/Object;)Ljava/util/List;
         // ad: astore 1
         ...
         // bd: lconst_0
         // be: invokestatic tv/e.X (Ljava/lang/String;J)J
         // c1: aload 1
         // c2: bipush 14
         // c4: invokeinterface java/util/List.get (I)Ljava/lang/Object; 2
         // c9: checkcast java/lang/String
         // cc: lconst_0
         // cd: invokestatic tv/e.X (Ljava/lang/String;J)J
         // d0: ladd
         // d1: aload 1
         // d2: bipush 23
         ...
         // dc: lconst_0
         // dd: invokestatic tv/e.X (Ljava/lang/String;J)J
         ...
         // ec: aload 4
         // ee: aload 1
         // ef: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
         // f2: aload 5
         // f4: athrow
         // f5: aconst_null
         // f6: areturn

...
internal class DeviceResourceUsageManager(context: Context) {
   ...
   public fun start() {
      ...
      // 10: aload 3
      // 11: aload 0
      // 12: invokespecial i3/a.<init> (Lcom/discord/resource_usage/DeviceResourceUsageManager;)V
      // 15: aload 0
      // 16: bipush 1
      // 17: bipush 1
      // 18: aconst_null
      ...
      // 1e: bipush 4
      // 1f: aconst_null
      // 20: invokestatic Na/a.b (ZZLjava/lang/ClassLoader;Ljava/lang/String;ILkotlin/jvm/functions/Function0;ILjava/lang/Object;)Ljava/lang/Thread;

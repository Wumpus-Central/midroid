...
internal class DeviceResourceUsageManager(timeSpanMillis: Long = 1000L) {
   ...
   public fun start() {
      ...
      // 10: aload 3
      // 11: aload 0
      // 12: invokespecial d2/a.<init> (Lcom/discord/resource_usage/DeviceResourceUsageManager;)V
      // 15: bipush 1
      // 16: bipush 1
      // 17: aconst_null
      ...
      // 1c: bipush 4
      // 1d: aconst_null
      // 1e: invokestatic F9/a.b (ZZLjava/lang/ClassLoader;Ljava/lang/String;ILkotlin/jvm/functions/Function0;ILjava/lang/Object;)Ljava/lang/Thread;
      // 21: astore 3
      // 22: aload 0
      // 23: aload 3

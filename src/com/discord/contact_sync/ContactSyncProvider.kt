...
public object ContactSyncProvider {
   private fun Uri.asBase64BitmapString(context: Context, quality: Int = 100): String? {
      ...
      // 46: aload 2
      // 47: aconst_null
      // 48: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 4b: goto 5a
      // 4e: aload 4
      // 50: athrow
      // 51: astore 1
      // 52: aload 2
      // 53: aload 4
      // 55: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 58: aload 1
      // 59: athrow
      // 5a: aload 1
      // 5b: areturn
   ...
   public fun getImageForContactId(context: Context, deviceContactId: String): String? {
      ...
      // 78: aload 3
      // 79: aconst_null
      // 7a: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 7d: aload 1
      // 7e: astore 2
      // 7f: goto 8c
      // 82: aload 1
      ...
      // 85: aload 3
      // 86: aload 1
      // 87: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8a: aload 2
      // 8b: athrow
      // 8c: aload 2
      // 8d: areturn

...
public object ContactSyncProvider {
   private fun Uri.asBase64BitmapString(context: Context, quality: Int = 100): String? {
      ...
      // 45: aload 2
      // 46: aconst_null
      // 47: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 4a: goto 59
      // 4d: aload 1
      // 4e: athrow
      // 4f: astore 4
      // 51: aload 2
      // 52: aload 1
      // 53: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 56: aload 4
      // 58: athrow
      // 59: aload 1
      // 5a: areturn
   ...
   public fun getImageForContactId(context: Context, deviceContactId: String): String? {
      ...
      // 7d: aload 3
      // 7e: aconst_null
      // 7f: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 82: aload 1
      // 83: astore 2
      // 84: goto 91
      // 87: aload 1
      ...
      // 8a: aload 3
      // 8b: aload 1
      // 8c: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8f: aload 2
      // 90: athrow
      // 91: aload 2
      // 92: areturn

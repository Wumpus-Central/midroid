...
public object ContactSyncProvider {
   private fun Uri.asBase64BitmapString(context: Context, quality: Int = 100): String? {
      ...
      // 48: aload 2
      // 49: aconst_null
      // 4a: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 4d: goto 5c
      // 50: aload 4
      // 52: athrow
      // 53: astore 1
      // 54: aload 2
      // 55: aload 4
      // 57: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 5a: aload 1
      // 5b: athrow
      // 5c: aload 1
      // 5d: areturn
   ...
   public fun getImageForContactId(context: Context, deviceContactId: String): String? {
      ...
      // 7d: aload 3
      // 7e: aconst_null
      // 7f: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 82: aload 1
      // 83: astore 2
      // 84: goto 91
      // 87: aload 1
      ...
      // 8a: aload 3
      // 8b: aload 1
      // 8c: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8f: aload 2
      // 90: athrow
      // 91: aload 2
      // 92: areturn

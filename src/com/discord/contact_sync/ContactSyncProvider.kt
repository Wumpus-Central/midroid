...
public object ContactSyncProvider {
   private fun Uri.asBase64BitmapString(context: Context, quality: Int = 100): String? {
      ...
      // 48: aload 2
      // 49: aconst_null
      // 4a: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 4d: goto 5c
      // 50: aload 4
      // 52: athrow
      // 53: astore 1
      // 54: aload 2
      // 55: aload 4
      // 57: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 5a: aload 1
      // 5b: athrow
      // 5c: aload 1
      // 5d: areturn
   ...
   public fun getImageForContactId(context: Context, deviceContactId: String): String? {
      ...
      // 78: aload 3
      // 79: aconst_null
      // 7a: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 7d: aload 1
      // 7e: astore 2
      // 7f: goto 8c
      // 82: aload 1

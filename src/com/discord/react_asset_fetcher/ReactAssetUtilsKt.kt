...
public fun Context.getReactImageUrl(assetUrl: String): String {
   q.h(var0, "<this>");
   q.h(var1, "assetUrl");
   val var2: java.lang.String = new ImageSource(var0, var1, 0.0, 0.0, false, 28, null).getUri().toString();
   q.g(var2, "toString(...)");
   return var2;
}
            ...
            var4 = new Function2(this.$this_setReactIcon, this.$assetUrl, null) {
               ...
               public final Object invokeSuspend(Object var1) {
                  ...
                  if (this.label == 0) {
                     ...
                     q.g(var1, "getContext(...)");
                     val var2x: ImageSource = new ImageSource(var1, this.$assetUrl, 0.0, 0.0, false, 28, null);
                     var1 = this.$this_setReactIcon;
                     if (var2x.isResource()) {

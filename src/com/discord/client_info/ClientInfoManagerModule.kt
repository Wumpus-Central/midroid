...
public class ClientInfoManagerModule(reactContext: ReactApplicationContext) : NativeClientInfoManagerSpec {
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var7: Pair = w.a("Version", var8.getVersionName());
      val var2: Pair = w.a("Build", var8.getVersionCode());
      val var5: Pair = w.a("Manifest", var8.getOtaManifestETag());
      val var6: Pair = w.a("OTABuild", var8.getOtaVersion());
      ...
      return r.m(
         new Pair[]{
            ...
            var5,
            var6,
            w.a("DeviceVendorID", var4.getDeviceVendorId(var3)),

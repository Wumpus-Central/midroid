...
public class ClientInfoManagerModule(reactContext: ReactApplicationContext) : NativeClientInfoManagerSpec {
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var3: Pair = w.a("Version", var1.getVersionName());
      val var8: Pair = w.a("Build", var1.getVersionCode());
      val var4: Pair = w.a("Manifest", var1.getOtaManifestETag());
      val var6: Pair = w.a("OTABuild", var1.getOtaVersion());

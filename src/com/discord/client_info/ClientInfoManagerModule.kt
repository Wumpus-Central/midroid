...
public class ClientInfoManagerModule(reactContext: ReactApplicationContext) : NativeClientInfoManagerSpec {
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var1: Pair = w.a("Version", var4.getVersionName());
      val var2: Pair = w.a("Build", var4.getVersionCode());
      val var3: Pair = w.a("Manifest", var4.getOtaManifestETag());
      val var5: Pair = w.a("OTABuild", var4.getOtaVersion());

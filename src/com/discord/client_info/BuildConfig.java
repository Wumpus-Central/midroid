...
public final class BuildConfig {
   ...
   public static final String PROGUARD_UUID = "55eabae1-d1f7-49a5-871a-d3d9a7fa6e44";
   ...
   public static final String SENTRY_RELEASE = "discord_android@299.6.0-2+299206";

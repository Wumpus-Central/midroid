...
public class ClientInfoModule(reactContext: ReactApplicationContext) : NativeClientInfoModuleSpec(var1) {
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var6: Pair = s.a("Version", var8.getVersionName());
      val var3: Pair = s.a("Build", var8.getVersionCode());
      val var4: Pair = s.a("Manifest", var8.getOtaManifestETag());
      val var5: Pair = s.a("OTABuild", var8.getOtaVersion());
      ...
      return L.m(
         new Pair[]{
            ...
            var4,
            var5,
            s.a("DeviceVendorID", var2.getDeviceVendorId(var7)),

...
public class ClientInfoModule(reactContext: ReactApplicationContext) : NativeClientInfoModuleSpec(var1) {
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var5: Pair = s.a("Version", var7.getVersionName());
      val var2: Pair = s.a("Build", var7.getVersionCode());
      val var1: Pair = s.a("Manifest", var7.getOtaManifestETag());
      val var3: Pair = s.a("OTABuild", var7.getOtaVersion());
      ...
      return L.m(
         new Pair[]{
            ...
            var1,
            var3,
            s.a("DeviceVendorID", var8.getDeviceVendorId(var6)),

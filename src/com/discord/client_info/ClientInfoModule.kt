...
public class ClientInfoModule(reactContext: ReactApplicationContext) : NativeClientInfoModuleSpec {
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var3: Pair = s.a("Build", var7.getVersionCode());
      val var5: Pair = s.a("Manifest", var7.getOtaManifestETag());
      val var8: Pair = s.a("OTABuild", var7.getOtaVersion());
      ...
      return q.m(
         new Pair[]{
            ...
            var5,
            var8,
            s.a("DeviceVendorID", var2.getDeviceVendorId(var6)),

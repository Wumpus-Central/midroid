...
public class ClientInfoModule(reactContext: ReactApplicationContext) : NativeClientInfoModuleSpec(var1) {
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var3: Pair = v.a("Identifier", ClientInfo.INSTANCE.getPackageName());
      val var7: Pair = v.a("Version", var8.getVersionName());
      val var4: Pair = v.a("Build", var8.getVersionCode());
      val var1: Pair = v.a("Manifest", var8.getOtaManifestETag());
      val var5: Pair = v.a("OTABuild", var8.getOtaVersion());
      ...
      return O.n(
         new Pair[]{
            ...
            var1,
            var5,
            v.a("DeviceVendorID", var6.getDeviceVendorId(var2)),

...
public class ClientInfoModule(reactContext: ReactApplicationContext) : NativeClientInfoModuleSpec(var1) {
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      val var5: Pair = s.a("Version", var1.getVersionName());
      val var6: Pair = s.a("Build", var1.getVersionCode());
      val var3: Pair = s.a("Manifest", var1.getOtaManifestETag());
      ...
      return L.m(
         new Pair[]{
            ...
            var3,
            var7,
            s.a("DeviceVendorID", var8.getDeviceVendorId(var2)),

...
public object JavaScript {
         ...
         public fun <RC, S> createFunctionRule(codeStyleProviders: CodeStyleProviders<RC>): Rule<RC, Node<RC>, S> {
            return new Rule<RC, Node<RC>, S>(this, var1, JavaScript.FunctionNode.access$getPATTERN_JAVASCRIPT_FUNC$cp()) {
               ...
               public ParseSpec<RC, S> parse(@NotNull Matcher var1, @NotNull Parser<RC, ? super Node<RC>, S> var2, S var3) {
                  ...
                  val var5: ParseSpec.Companion = ParseSpec.Companion;
                  return (ParseSpec<RC, S>)var5.createTerminal(new JavaScript.FunctionNode<>(var7, var4, var6, this.$codeStyleProviders), var3);
               }
            };
         }
      }
   ...
   public class ObjectPropertyNode<RC>(prefix: String, property: String, suffix: String, codeStyleProviders: CodeStyleProviders<Any>) : Node.Parent(

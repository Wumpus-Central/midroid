...
public object CodeRules {
   ...
   public fun <R, S> createCodeLanguageMap(codeStyleProviders: CodeStyleProviders<R>): Map<String, List<Rule<R, Node<R>, S>>> {
      ...
      val var17: java.util.List = this.createGenericCodeRules(
         var1,
         h.l(new Rule[]{var16, toMatchGroupRule$default(this, var20, 0, var1.getLiteralStyleProvider(), 1, null)}),
      ...
      r.g(var7, "Pattern.compile(\"\"\"^@(\\w+)\"\"\")");
      val var23: java.util.List = this.createGenericCodeRules(
         var1,
         h.l(new Rule[]{var22, var24, var28, toMatchGroupRule$default(this, var7, 0, var1.getGenericsStyleProvider(), 1, null)}),
      ...
      val var27: java.util.List = this.createGenericCodeRules(
         var1,
         h.l(new Rule[]{var26, var30, toMatchGroupRule$default(this, var7, 0, var1.getGenericsStyleProvider(), 1, null)}),
      ...
      var7 = PATTERN_TEXT;
      val var32: java.util.List = h.l(new Rule[]{var31, var10, var9, toMatchGroupRule$default(this, PATTERN_TEXT, 0, null, 3, null)});

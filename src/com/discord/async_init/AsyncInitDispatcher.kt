   ...
   private fun onInitFinish() {
      if (this.initStartMs != 0L) {
         ...
         if (var3 < this.longDispatchThresholdMs) {
            ...
            var8.append(var10);
            var8.append(": queued tasks  took ");
            var8.append(var3);
            var8.append(" ms");
            Log.i$default(var9, var10, var8.toString(), null, 4, null);
         } else {
            val var7: Log = Log.INSTANCE;
            val var6: java.lang.String = this.name;
            val var5: StringBuilder = new StringBuilder();
            var5.append(var6);
            var5.append(": running queued tasks on init took ");
            var5.append(var3);
            var5.append(" ms which exceeds threshold=");
            var5.append(var1);
            var5.append(" ms");
            Log.w$default(var7, var6, var5.toString(), null, 4, null);
         }
      }
   }

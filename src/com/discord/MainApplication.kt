...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         V8.a.b(false, false, null, "ReactNativeLoader", 10, new b(this), 7, null);
         ...
         ClientInfo.INSTANCE.init(this, "282.2", 282202, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@282.2.0-2+282202";
      }

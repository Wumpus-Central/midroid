...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         j8.a.b(false, false, null, "ReactNativeLoader", 10, new Function0(this) {
         ...
         ClientInfo.INSTANCE.init(this, "277.14", 277014, "google", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@277.14.0-0+277014";
      }

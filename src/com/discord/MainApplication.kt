...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public open fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "249.5", 249205, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@249.5.0-2+249205";
      }

...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public open fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "245.10", 245110, "beta", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@245.10.0-1+245110";
      }

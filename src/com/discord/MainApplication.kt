...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         r8.a.b(false, false, null, "ReactNativeLoader", 10, new Function0(this) {
         ...
         ClientInfo.INSTANCE.init(this, "280.3", 280203, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@280.3.0-2+280203";
      }

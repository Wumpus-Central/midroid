...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "293.5", 293205, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@293.5.0-2+293205";
      }

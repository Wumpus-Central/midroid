...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   fun `initialize$lambda$3`(var0: MainApplication): Unit {
      ...
      label11: {
         ...
         var4 = "discord_android@303.1.0-2+303201";
      }
   ...
   public override fun initialize() {
      ...
      ClientInfo.INSTANCE.init(this, "303.1", 303201, "canary", "release", var2.instance().getManifestETag(), var2.instance().getOtaVersion());

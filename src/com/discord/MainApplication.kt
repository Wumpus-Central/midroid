...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         q8.a.b(false, false, null, "ReactNativeLoader", 10, new Function0(this) {
         ...
         ClientInfo.INSTANCE.init(this, "280.1", 280201, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@280.1.0-2+280201";
      }

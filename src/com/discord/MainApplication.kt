...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   fun `initialize$lambda$3`(var0: MainApplication): Unit {
      ...
      label11: {
         ...
         var4 = "discord_android@301.7.0-1+301107";
      }
   ...
   public override fun initialize() {
      ...
      ClientInfo.INSTANCE.init(this, "301.7", 301107, "beta", "release", var2.instance().getManifestETag(), var2.instance().getOtaVersion());

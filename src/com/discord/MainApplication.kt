...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   fun `initialize$lambda$3`(var0: MainApplication): Unit {
      ...
      label11: {
         ...
         var4 = "discord_android@303.2.0-2+303202";
      }
   ...
   protected open fun attachBaseContext(base: Context) {
      ...
      Ha.a.b(false, false, null, "helperReactNativeLoader", 10, new c(var1, this), 7, null);
   }

   public open fun initialize() {
      Ha.a.b(false, false, null, "ReactNativeLoader", 10, new d(this), 7, null);
      ...
      ClientInfo.INSTANCE.init(this, "303.2", 303202, "canary", "release", var2.instance().getManifestETag(), var2.instance().getOtaVersion());
      ...
      Ha.a.b(false, false, null, null, 0, new e(this), 31, null);
   ...
   public open fun onCreate() {
      super.onCreate();
      Ha.a.b(false, false, null, null, 0, new b(this), 31, null);
   }
}

...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   fun `initialize$lambda$3`(var0: MainApplication): Unit {
      ...
      label11: {
         ...
         var4 = "discord_android@300.12.0-1+300112";
      }
   ...
   public override fun initialize() {
      ...
      ClientInfo.INSTANCE.init(this, "300.12", 300112, "beta", "release", var2.instance().getManifestETag(), var2.instance().getOtaVersion());

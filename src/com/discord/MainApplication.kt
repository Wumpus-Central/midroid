...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         G9.a.b(false, false, null, "ReactNativeLoader", 10, new b(this), 7, null);
         ...
         ClientInfo.INSTANCE.init(this, "293.1", 293201, "canary", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@293.1.0-2+293201";
      }

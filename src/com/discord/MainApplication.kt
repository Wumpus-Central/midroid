...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "279.8", 279108, "beta", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@279.8.0-1+279108";
      }

...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public override fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "297.12", 297112, "beta", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@297.12.0-1+297112";
      }

...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   public open fun initialize() {
      ...
      label11: {
         ...
         ClientInfo.INSTANCE.init(this, "246.13", 246113, "beta", "release", var1.instance().getManifestETag(), var1.instance().getOtaVersion());
         ...
         var5 = "discord_android@246.13.0-1+246113";
      }

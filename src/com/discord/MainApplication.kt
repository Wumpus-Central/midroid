...
public class MainApplication : TTILoggingApplication, ReactApplication {
   ...
   fun `initialize$lambda$3`(var0: MainApplication): Unit {
      ...
      label11: {
         ...
         var4 = "discord_android@301.3.0-2+301203";
      }
   ...
   public override fun initialize() {
      ...
      ClientInfo.INSTANCE.init(this, "301.3", 301203, "canary", "release", var2.instance().getManifestETag(), var2.instance().getOtaVersion());

   ...
   public companion object {
      private fun fromRootViewAsStableInsets(insets: WindowInsetsCompat, leftRight: Boolean = false): SafeAreaEdgeInsets {
         ...
         if (VERSION.SDK_INT > 29) {
            ...
            val var3: Float = SizeUtilsKt.getPxToDp(Math.max(var10.a, var15));
            if (var2) {
               var6 = var9.c;
            }

            var11 = new SafeAreaEdgeInsets(var4, SizeUtilsKt.getPxToDp(Math.max(var10.c, var6)), var5, var3);
         } else {
            val var14: Float = SizeUtilsKt.getPxToDp(Math.max(var10.b, var1.k()));
            val var12: Float = SizeUtilsKt.getPxToDp(Math.max(var10.d, var1.h()));
            val var17: Int;
            if (var2) {
               var17 = var1.i();
            } else {
            ...
            var11 = new SafeAreaEdgeInsets(var14, SizeUtilsKt.getPxToDp(Math.max(var10.c, var6)), var12, var13);
         }

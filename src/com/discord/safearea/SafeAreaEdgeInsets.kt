   ...
   public companion object {
      private fun fromRootViewAsStableInsets(insets: WindowInsetsCompat, leftRight: Boolean = false): SafeAreaEdgeInsets {
         ...
         if (VERSION.SDK_INT > 29) {
            ...
            val var14: Float = SizeUtilsKt.getPxToDp(Math.max(var9.b, var1.k()));
            val var12: Float = SizeUtilsKt.getPxToDp(Math.max(var9.d, var1.h()));
            val var17: Int;
            if (var2) {
               var17 = var1.i();
            } else {
            ...
            var11 = new SafeAreaEdgeInsets(var14, SizeUtilsKt.getPxToDp(Math.max(var9.c, var6)), var12, var13);
         }

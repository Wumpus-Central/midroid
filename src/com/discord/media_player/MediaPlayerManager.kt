...
public object MediaPlayerManager {
   ...
   fun {
      ...
      scope = kotlinx.coroutines.g.a(var1.L(T.b(var0)));
   }
      ...
      return Aa.f.d(
         ...
         new Function2(var2, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               label85: {
                  var var5: MutableStateFlow = (MutableStateFlow)Y8.b.e();
                  if (this.label != 0) {
                     if (this.label != 1) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                     }
                     ...
                     this.L$1 = var24;
                     this.label = 1;
                     if (Aa.f.g(var16, var7, this) === var5) {
                        return var5;
                     }
                  }
   ...
   public fun pauseActivePlayer(): Job {
      return Aa.f.d(scope, K.c(), null, new Function2(null) {
         int label;

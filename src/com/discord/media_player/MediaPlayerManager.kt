...
public object MediaPlayerManager {
   ...
   fun {
      ...
      scope = kotlinx.coroutines.g.a(var0.T(T.b(var1)));
   }
   ...
   public fun acquire(context: Context, key: Double, playerSettings: PlayerSettings): MediaPlayer {
      ...
      // 57: invokestatic kotlin/collections/i.i0 (Ljava/lang/Iterable;)Ljava/lang/Object;
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               label85: {
                  ...
                  if (this.label != 0) {
                     ...
                     if (r.c(this.$event, MediaPlayer.Event.Paused.INSTANCE)) {
                        if (!var3) {
                           return Unit.a;
                        }
                        ...
                        } while (!var19.a(var5, s.a(var1, kotlin.coroutines.jvm.internal.b.c(0.0))));

                        return Unit.a;
                     }

                     if (!r.c(var6, MediaPlayer.Event.StartedPlaying.INSTANCE)) {
                        if (r.c(var6, MediaPlayer.Event.PlaybackEnded.INSTANCE)) {
                           if (!var3) {
                              return Unit.a;
                           }
                        ...
                        } else if (!r.c(var6, MediaPlayer.Event.BufferEnd.INSTANCE)
                           && !r.c(var6, MediaPlayer.Event.BufferStart.INSTANCE)
                     ...
                     this.L$1 = var24;
                     this.label = 1;
                     if (jb.f.g(var7, var16, this) === var5) {
                        return var5;
                     }
                  }
               ...
               } while (!var9.a(var20, s.a(var15, kotlin.coroutines.jvm.internal.b.c(1.0))));
               ...
               if (var10 != null) {
                  v.f(var10, "New progress monitor override", null, 2, null);
               }
   ...
   public fun pauseActivePlayer(): Job {
      return jb.f.d(scope, K.c(), null, new Function2(null) {
         int label;

...
public data class MediaPlayFinishedAnalytics(playWallTimeMs: Long,
   ...
   public override fun hashCode(): Int {
      ...
      return (
               (
                        (
                                 (((((((var3 * 31 + var5) * 31 + var6) * 31 + var7) * 31 + var4) * 31 + var1) * 31 + var8) * 31 + var2) * 31
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): MediaPlayFinishedAnalytics {
            ...
            while (var34) {
               ...
               switch (var10) {
                  case -1:
                     ...
                     break;
                  case 0:
                     var35 = var29.h(var28, 0);
                     var33 |= 1;
                     break;
                  case 1:
                     var36 = var29.h(var28, 1);
                     var33 |= 2;
                     break;
                  case 2:
                     var8 = var29.k(var28, 2);
         ...
         var29.b(var28);
         return new MediaPlayFinishedAnalytics(var7, var19, var15, var8, var4, var23, var27, var2, var26, var5, var6, var17, var21, null);
      }

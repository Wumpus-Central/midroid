...
public data class MediaPlayFinishedAnalytics(playWallTimeMs: Long,
   ...
   public override fun hashCode(): Int {
      ...
      return (
               (
                        (
                                 (((((((var3 * 31 + var6) * 31 + var7) * 31 + var4) * 31 + var5) * 31 + var1) * 31 + var8) * 31 + var2) * 31
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): MediaPlayFinishedAnalytics {
         ...
         var var36: Int;
         if (var25) {
            var23 = var29.f(var28, 0);
            var15 = var29.f(var28, 1);
            var34 = var29.i(var28, 2);
            var36 = var29.i(var28, 3);
            val var11: Long = var29.f(var28, 4);
            val var30: b2 = b2.a;
            var27 = var29.n(var28, 5, b2.a, null) as java.lang.String;
            ...
            while (var37) {
               ...
               switch (var10) {
                  case -1:
                     ...
                     break;
                  case 0:
                     var38 = var29.f(var28, 0);
                     var33 |= 1;
                     break;
                  case 1:
                     var39 = var29.f(var28, 1);
                     var33 |= 2;
                     break;
                  case 2:
         ...
         var29.c(var28);
         return new MediaPlayFinishedAnalytics(var6, var23, var15, var8, var34, var19, var27, var2, var26, var5, var36, var21, var17, null);
      }

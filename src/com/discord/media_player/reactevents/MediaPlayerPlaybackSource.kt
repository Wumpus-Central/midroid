   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): MediaPlayerPlaybackSource {
         ...
         if (var12.y()) {
            ...
            val var5: java.lang.String = var12.v(var11, 2, (DeserializationStrategy)var16, null) as java.lang.String;
            ...
            var16 = var12.v(var11, 4, N.a, null) as Int;
            var2 = 31;
            var10 = var5;
            var25 = var15;
         } else {
               ...
               if (var4 != -1) {
                  if (var4 != 0) {
                     if (var4 != 1) {
                        ...
                        var18 = var12.v(var11, 1, C0.a, var18) as java.lang.String;
                        var2 |= 2;
                     }
                  } else {
         ...
         var12.b(var11);
         return new MediaPlayerPlaybackSource(var2, var8, var7, var10, var25, var16, null, null);
      }

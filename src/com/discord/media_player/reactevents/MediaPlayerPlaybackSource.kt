...
public data class MediaPlayerPlaybackSource(id: String?, assetUrl: String?, channelId: String?, messageId: MessageId?, attachmentIndex: Int?) : MediaPlayerPlaybackSource(
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): MediaPlayerPlaybackSource {
                     ...
                     if (var4 != 1) {
                        if (var4 != 2) {
                           if (var4 != 3) {
                              ...
                              var18 = var11.v(var10, 4, N.a, var18) as Int;
                              var2 |= 16;
                           } else {
                              val var21: MessageId;
                              if (var8 != null) {
                        ...
                        var5 = var11.v(var10, 1, C0.a, var5) as java.lang.String;
                        var2 |= 2;
                     }
                  } else {
         ...
         var11.b(var10);
         return new MediaPlayerPlaybackSource(var2, var8, var7, var5, var24, (Integer)var18, null, null);
      }

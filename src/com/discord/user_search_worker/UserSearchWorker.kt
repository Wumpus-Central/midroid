...
internal class UserSearchWorker(onResults: (List<UserSearchWorkerResult>, String, String) -> Unit) {
   ...
   private fun searchUsers(uuid: String, payload: UserSearchQuerySetPayload) {
      ...
      if (var14.length() == 0) {
         ...
         val var17: Regex = new Regex(var24, var34);
         ...
         val var33: Array<Array<Function1>> = new Function1[2];
         var33[var7] = var41;
         var33[1] = var38;
         this.onResults.invoke(CollectionsKt.a1(CollectionsKt.W0(var15, lt.a.b(var33)), var2.getLimit()), var14, var1);
      }
   }

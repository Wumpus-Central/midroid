...
internal class UserSearchWorker(onResults: (List<UserSearchWorkerResult>, String, String) -> Unit) {
   ...
   private fun mergeUsers(data: UserSearchUpdateUsersData) {
      ...
      while (var9.hasNext()) {
         ...
         if (var10 != null) {
            ...
            var14 = var10.copy(var13, var12, var15, var3, var21, var5, f9.q.p(var10.getNicknames(), var6.getNicknames()));
            if (var14 == null) {
               var14 = var6;
            }
         }
   ...
   private fun searchUsers(uuid: String, payload: UserSearchQuerySetPayload) {
      ...
      if (var13.length() == 0) {
         ...
         val var8: La.d = La.d.l;
         var var25: Regex = new Regex(var24, La.d.l);
         ...
         this.onResults.invoke(i.K0(i.I0(var11, i9.a.b(new Function1[]{new b(), new c()})), var2.getLimit()), var13, var1);
      }
   }

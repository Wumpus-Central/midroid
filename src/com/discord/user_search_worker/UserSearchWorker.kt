...
internal class UserSearchWorker(onResults: (List<UserSearchWorkerResult>, String, String) -> Unit) {
   ...
   private fun mergeUsers(data: UserSearchUpdateUsersData) {
      ...
      while (var9.hasNext()) {
         ...
         if (var10 != null) {
            ...
            var14 = var10.copy(var12, var13, var15, var3, var21, var5, B9.q.p(var10.getNicknames(), var6.getNicknames()));
            if (var14 == null) {
               var14 = var6;
            }
         }
   ...
   private fun searchUsers(uuid: String, payload: UserSearchQuerySetPayload) {
      ...
      if (var13.length() == 0) {
         ...
         val var8: hb.d = hb.d.l;
         var var25: Regex = new Regex(var24, hb.d.l);
            ...
            if (this.isValid(var15, var27, var2)) {
               ...
               if (q.c(var15, var13)) {
                  ...
                  if (var5) {
                     ...
                     val var10: java.lang.String = var27.getGlobalName();
                     ...
                     var30 = i.n(new java.lang.String[]{var32, var10, var12, (java.lang.String)var17.get(var29)});
                  } else {
                     if (var5) {
                        throw new n();
                     }
         ...
         this.onResults.invoke(i.M0(i.K0(var11, E9.a.b(new Function1[]{new b(), new c()})), var2.getLimit()), var13, var1);
      }
   }

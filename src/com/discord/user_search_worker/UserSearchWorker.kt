...
internal class UserSearchWorker(onResults: (List<UserSearchWorkerResult>, String, String) -> Unit) {
   ...
   private fun mergeUsers(data: UserSearchUpdateUsersData) {
      ...
      for (Entry var23 : this.queries.entrySet()) {
         ...
         if (var28 == null || r.c(var28.getFriends(), var2) || var28.getGuild() != null && var8.contains(var28.getGuild())) {
   ...
   private fun searchUsers(uuid: String, payload: UserSearchQuerySetPayload) {
      ...
      if (var12.length() == 0) {
         ...
         val var25: ib.d = ib.d.l;
         val var14: Regex = new Regex(var10, ib.d.l);
         ...
         for (Entry var26 : this.users.entrySet()) {
            ...
            if (this.isValid(var16, var27, var2)) {
               ...
               if (r.c(var16, var12)) {
                  ...
                  val var40: java.util.Iterator = i.e0(var30).iterator();
         ...
         this.onResults.invoke(i.N0(i.L0(var13, F9.a.b(new Function1[]{new b(), new c()})), var2.getLimit()), var12, var1);
      }
   }

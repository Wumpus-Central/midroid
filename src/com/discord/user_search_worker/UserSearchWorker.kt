...
internal class UserSearchWorker(onResults: (List<UserSearchWorkerResult>, String, String) -> Unit) {
   ...
   private fun mergeUsers(data: UserSearchUpdateUsersData) {
      ...
      while (var9.hasNext()) {
         ...
         if (var10 != null) {
            ...
            var14 = var10.copy(var12, var13, var15, var3, var21, var5, S8.q.p(var10.getNicknames(), var6.getNicknames()));
            if (var14 == null) {
               var14 = var6;
            }
         }
   ...
   private fun searchUsers(uuid: String, payload: UserSearchQuerySetPayload) {
      ...
      if (var13.length() == 0) {
         ...
         this.onResults.invoke(i.K0(i.I0(var11, V8.a.b(new Function1[]{new b(), new c()})), var2.getLimit()), var13, var1);
      }
   }

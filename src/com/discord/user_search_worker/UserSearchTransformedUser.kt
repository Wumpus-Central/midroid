   ...
   internal object Serializer : KSerializer {
      ...
      public open fun deserialize(decoder: Decoder): UserSearchTransformedUser {
         ...
         for (Entry var4 : var5.entrySet()) {
            ...
            if (!TRANSFORMED_USER_KEYS.contains(var3) && (la.g.p(var7).m() || la.g.p(var7) is JsonNull)) {
         ...
         while (true) {
            ...
            if (!var2) {
               ...
               label55: {
                  ...
                  q.e(var14);
                  var8 = la.g.p(var14 as JsonElement).a();
                  var14 = var5.get("username");
                  q.e(var14);
                  var9 = la.g.p(var14 as JsonElement).a();
                  var14 = var5.get("isBot") as JsonElement;
                  if (var14 != null) {
                     var14 = la.g.p((JsonElement)var14);
                     if (var14 != null) {
                        var24 = la.g.f((JsonPrimitive)var14);
                        break label55;
                     }
                  }
               ...
               label50: {
                  ...
                  if (var18 != null) {
                     val var19: JsonPrimitive = la.g.p(var18);
                     if (var19 != null) {
                        var26 = la.g.f(var19);
                        break label50;
                     }
               ...
               label45: {
                  ...
                  if (var20 != null) {
                     val var21: JsonPrimitive = la.g.p(var20);
                     if (var21 != null) {
                        if (var21.m()) {
                           var22 = var21.a();
                        } else {
               ...
               if (var10 != null) {
                  val var33: JsonPrimitive = la.g.p(var10);
                  var27 = null;
                  if (var33 != null) {
                     var27 = null;
                     if (var33.m()) {
            ...
            if (la.g.p(var31).m()) {
               var13 = la.g.p(var31).a();
            }

            var23.add(o8.w.a(var29, var13));
         }
      }

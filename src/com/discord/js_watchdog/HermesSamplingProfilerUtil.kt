...
public object HermesSamplingProfilerUtil {
   ...
   public fun findSampleTrace(cacheDir: File): String? {
      ...
      // 048: astore 1
      // 049: aload 9
      // 04b: invokestatic kotlin/jvm/internal/Intrinsics.checkNotNull (Ljava/lang/Object;)V
      // 04e: aload 9
      // 050: astore 1
      // 051: aload 0
      // 052: aload 9
      ...
      // 068: astore 1
      // 069: aload 11
      // 06b: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 06e: ldc "samples"
      ...
      // 07f: astore 1
      // 080: aload 8
      // 082: invokestatic bv/h.m (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonArray;
      // 085: astore 8
      // 087: goto 0a1
      // 08a: astore 9
      // 08c: aload 1
      ...
      // 0b4: ifeq 0ba
      // 0b7: goto 32d
      // 0ba: getstatic kotlin/Result.e Lkotlin/Result$a;
      // 0bd: astore 1
      // 0be: aload 8
      ...
      // 0db: astore 1
      // 0dc: aload 1
      // 0dd: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 0e0: ldc "sf"
      ...
      // 0ec: ifnull 115
      // 0ef: aload 8
      // 0f1: invokestatic bv/h.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0f4: astore 8
      // 0f6: aload 8
      // 0f8: ifnull 115
      // 0fb: aload 8
      // 0fd: invokestatic bv/h.l (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 100: astore 8
      // 102: aload 8
      // 104: ifnull 115
      // 107: aload 8
      ...
      // 1a6: astore 1
      // 1a7: aload 11
      // 1a9: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1ac: invokestatic kotlin/collections/s0.y (Ljava/util/Map;)Ljava/util/Map;
      // 1af: astore 8
      // 1b1: aload 9
      // 1b3: astore 1
      ...
      // 1bc: aload 12
      // 1be: aload 10
      // 1c0: invokestatic kotlin/collections/CollectionsKt.e (Ljava/lang/Object;)Ljava/util/List;
      ...
      // 1d7: astore 1
      // 1d8: aload 11
      // 1da: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1dd: ldc "stackFrames"
      ...
      // 1ee: astore 1
      // 1ef: aload 11
      // 1f1: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1f4: astore 12
      // 1f6: aload 12
      // 1f8: ifnull 2df
      // 1fb: aload 9
      // 1fd: astore 1
      // 1fe: aload 10
      // 200: invokestatic bv/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 203: ldc "sf"
      ...
      // 20c: astore 1
      // 20d: aload 10
      // 20f: invokestatic kotlin/jvm/internal/Intrinsics.checkNotNull (Ljava/lang/Object;)V
      // 212: aload 9
      // 214: astore 1
      // 215: aload 10
      // 217: checkcast kotlinx/serialization/json/JsonElement
      // 21a: invokestatic bv/h.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 21d: invokestatic bv/h.l (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 220: astore 11
      // 222: aload 11
      // 224: ifnull 2df
      // 227: aload 9
      ...
      // 309: aload 11
      // 30b: aload 12
      // 30d: invokevirtual kotlinx/serialization/json/Json.c (Lxu/o;Ljava/lang/Object;)Ljava/lang/String;
      // 310: astore 8
      // 312: iload 5
      // 314: istore 2
      // 315: aload 9
      ...
      // 347: aload 8
      // 349: astore 1
      // 34a: getstatic com/discord/crash_reporting/CrashReporting.INSTANCE Lcom/discord/crash_reporting/CrashReporting;
      // 34d: aload 10
      // 34f: bipush 0
      // 350: bipush 2
      // 351: aconst_null
      ...
      // 38c: ifeq 395
      // 38f: aload 8
      // 391: invokevirtual java/io/File.delete ()Z
      // 394: pop
      // 395: aload 1
      // 396: athrow
   }

...
public object HermesSamplingProfilerUtil {
   ...
   public fun findSampleTrace(cacheDir: File): String? {
      ...
      // 068: astore 1
      // 069: aload 11
      // 06b: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 06e: ldc "samples"
      ...
      // 07f: astore 1
      // 080: aload 8
      // 082: invokestatic uc/h.m (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonArray;
      // 085: astore 8
      // 087: goto 0a1
      // 08a: astore 8
      // 08c: aload 1
      ...
      // 0db: astore 1
      // 0dc: aload 1
      // 0dd: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 0e0: ldc "sf"
      ...
      // 0ec: ifnull 115
      // 0ef: aload 8
      // 0f1: invokestatic uc/h.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0f4: astore 8
      // 0f6: aload 8
      // 0f8: ifnull 115
      // 0fb: aload 8
      // 0fd: invokestatic uc/h.l (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 100: astore 8
      // 102: aload 8
      // 104: ifnull 115
      // 107: aload 8
      ...
      // 1a6: astore 1
      // 1a7: aload 11
      // 1a9: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      ...
      // 1d7: astore 1
      // 1d8: aload 11
      // 1da: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1dd: ldc "stackFrames"
      ...
      // 1ee: astore 1
      // 1ef: aload 11
      // 1f1: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1f4: astore 12
      // 1f6: aload 12
      // 1f8: ifnull 2df
      // 1fb: aload 9
      // 1fd: astore 1
      // 1fe: aload 10
      // 200: invokestatic uc/h.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 203: ldc "sf"
      ...
      // 21a: invokestatic uc/h.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 21d: invokestatic uc/h.l (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 220: astore 11
      // 222: aload 11
      // 224: ifnull 2df
      // 227: aload 9
      ...
      // 309: aload 11
      // 30b: aload 10
      // 30d: invokevirtual kotlinx/serialization/json/Json.c (Lqc/o;Ljava/lang/Object;)Ljava/lang/String;
      // 310: astore 8
      // 312: iload 5
      // 314: istore 2
      // 315: aload 9

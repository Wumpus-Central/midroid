...
public object HermesSamplingProfilerUtil {
   ...
   public fun findSampleTrace(cacheDir: File): String? {
      ...
      // 041: astore 1
      // 042: aload 6
      // 044: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 047: ldc "samples"
      ...
      // 056: astore 1
      // 057: aload 3
      // 058: invokestatic yk/g.n (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonArray;
      // 05b: astore 3
      // 05c: goto 073
      // 05f: astore 4
      // 061: aload 1
      ...
      // 0a8: astore 1
      // 0a9: aload 1
      // 0aa: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 0ad: ldc "sf"
      ...
      // 0b7: ifnull 0dc
      // 0ba: aload 3
      // 0bb: invokestatic yk/g.p (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0be: astore 3
      // 0bf: aload 3
      // 0c0: ifnull 0dc
      // 0c3: aload 3
      // 0c4: invokestatic yk/g.m (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 0c7: astore 3
      // 0c8: aload 3
      // 0c9: ifnull 0dc
      // 0cc: aload 3
      ...
      // 0ea: ifnull 0f5
      // 0ed: aload 3
      // 0ee: invokestatic ch/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 0f1: astore 3
      // 0f2: goto 114
      ...
      // 101: aload 4
      // 103: astore 1
      // 104: getstatic ch/r.k Lch/r$a;
      // 107: astore 3
      // 108: aload 4
      // 10a: astore 1
      // 10b: aload 5
      // 10d: invokestatic ch/s.a (Ljava/lang/Throwable;)Ljava/lang/Object;
      // 110: invokestatic ch/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 113: astore 3
      // 114: aload 4
      // 116: astore 1
      // 117: aload 3
      // 118: astore 5
      // 11a: aload 3
      // 11b: invokestatic ch/r.g (Ljava/lang/Object;)Z
      // 11e: ifeq 124
      // 121: aconst_null
      // 122: astore 5
      // 124: aload 4
      ...
      // 146: astore 1
      // 147: aload 6
      // 149: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 14c: invokestatic dh/r.x (Ljava/util/Map;)Ljava/util/Map;
      // 14f: astore 3
      // 150: aload 4
      // 152: astore 1
      ...
      // 175: astore 1
      // 176: aload 6
      // 178: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 17b: ldc "stackFrames"
      ...
      // 18c: astore 1
      // 18d: aload 6
      // 18f: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 192: astore 7
      // 194: aload 7
      // 196: ifnull 26e
      // 199: aload 4
      // 19b: astore 1
      // 19c: aload 5
      // 19e: invokestatic yk/g.o (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
      // 1a1: ldc "sf"
      ...
      // 1b8: invokestatic yk/g.p (Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1bb: invokestatic yk/g.m (Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
      // 1be: astore 6
      // 1c0: aload 6
      // 1c2: ifnull 26e
      // 1c5: aload 4
      ...
      // 297: aload 6
      // 299: aload 5
      // 29b: invokevirtual kotlinx/serialization/json/Json.c (Luk/h;Ljava/lang/Object;)Ljava/lang/String;
      // 29e: astore 3
      // 29f: aload 4

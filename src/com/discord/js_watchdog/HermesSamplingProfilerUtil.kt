...
public object HermesSamplingProfilerUtil {
   ...
   public fun findSampleTrace(cacheDir: File): String? {
      ...
      // 048: astore 1
      // 049: aload 9
      // 04b: invokestatic kotlin/jvm/internal/q.e (Ljava/lang/Object;)V
      // 04e: aload 9
      // 050: astore 1
      // 051: aload 0
      // 052: aload 9
      ...
      // 1ac: invokestatic u9/q.x (Ljava/util/Map;)Ljava/util/Map;
      // 1af: astore 8
      // 1b1: aload 9
      // 1b3: astore 1
      ...
      // 20c: astore 1
      // 20d: aload 10
      // 20f: invokestatic kotlin/jvm/internal/q.e (Ljava/lang/Object;)V
      // 212: aload 9
      // 214: astore 1
      // 215: aload 10
      ...
      // 309: aload 10
      // 30b: aload 12
      // 30d: invokevirtual kotlinx/serialization/json/Json.c (Lmb/h;Ljava/lang/Object;)Ljava/lang/String;
      // 310: astore 8
      // 312: iload 5
      // 314: istore 2
      // 315: aload 9

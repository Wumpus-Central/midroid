...
public object JSWatchdogManager {
   ...
   public fun ping(resetTimestamps: Boolean, sentTimestamp: Long, sessionId: String, enableTrace: Boolean, promise: Promise) {
      this.cancelExistingJobs();
      pingCoroutineJob = gu.g.d(
         v0.d,
         null,
         null,
         new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var1, var2, var6, var4, var5, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  try {
                     ...
                     JSWatchdogManager.access$setRecentPingTS$p(kotlin.coroutines.jvm.internal.b.f(this.$sentTimestamp));
                  ...
                  try {
                     if (JSWatchdogManager.access$getEnabled$p()) {
                        ...
                        var18.scheduleAtFixedRate(var21, 1500L, 1000L);

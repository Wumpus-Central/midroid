...
public object PlayAssetDelivery {
   ...
   private final lateinit var assetPackManagerWeakRef: WeakReference<O5.a>
   ...
   fun `assetPackStateUpdateListener$lambda$0`(var0: AssetPackState) {
      ...
      val var7: O5.a = var1.get() as O5.a;
      if (var7 != null) {
   ...
   private fun fetchAssetPackLocation(assetPackName: String, successCallback: ((Boolean) -> Unit)? = null): AssetPackLocation? {
      ...
      // 025: aload 6
      // 027: aload 1
      // 028: invokeinterface O5/a.c (Ljava/lang/String;)Lcom/google/android/play/core/assetpacks/AssetPackLocation; 2
      // 02d: astore 3
      // 02e: goto 033
      // 031: aconst_null
      // 032: astore 3
      ...
      // 0da: invokeinterface O5/a.b (Ljava/util/List;)Lcom/google/android/gms/tasks/Task; 2
      // 0df: new com/discord/play_delivery/b
      // 0e2: dup
      // 0e3: aload 1
      // 0e4: invokespecial com/discord/play_delivery/b.<init> (Ljava/lang/String;)V
      // 0e7: invokevirtual com/google/android/gms/tasks/Task.d (Lw5/d;)Lcom/google/android/gms/tasks/Task;
      // 0ea: pop
      // 0eb: aload 4
      // 0ed: astore 1
      // 0ee: goto 10c
   ...
   public fun initialize(applicationContext: Context) {
      ...
      val var2: O5.a = com.google.android.play.core.assetpacks.b.a(var1);

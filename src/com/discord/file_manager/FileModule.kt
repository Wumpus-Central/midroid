...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec(var1) {
   private final val ioScope: CoroutineScope = g.a(k0.b())
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     ...
                     try {
                        ...
                        var70 = FileModule.access$getReactApplicationContext(var6).getContentResolver().openFileDescriptor(Uri.parse(var5), "r");
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      return n0.n(new Pair[]{(Pair)var1, v.a("CacheDirPath", var2)});
   }
         ...
         new Function2<CoroutineScope, Continuation, Object>(var1, this, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        var319 = pm.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {

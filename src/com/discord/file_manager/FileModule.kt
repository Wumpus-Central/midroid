...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     try {
                        val var6: a = Result.k;
                        var73 = FileModule.access$getReactApplicationContext(var4).getContentResolver().openFileDescriptor(Uri.parse(var5), "r");
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      r.e(var2);
      return q.m(new Pair[]{(Pair)var1, s.a("CacheDirPath", var2)});
   }
         ...
         new Function2(var1, this, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        var320 = L9.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {

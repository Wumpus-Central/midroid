...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     try {
                        val var5: a = r.k;
                        var69 = FileModule.access$getReactApplicationContext(var4).getContentResolver().openFileDescriptor(Uri.parse(var6), "r");
                  ...
                  val var66: java.lang.Throwable = r.e(var1);
                  if (var66 != null) {
                     var74.reject(var66);
                  }
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var1);
      return i8.q.m(new Pair[]{var2, w.a("CacheDirPath", var1)});
   }
         ...
         new Function2(var1, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  try {
                     this.$promise.resolve(h.s(var48));
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label == 0) {
               ...
               if (var1 != null && !h.d0(var1)) {
                  ...
                  var7.append(". Supported storage directories: ");
                  var7.append(var4);
                  var2x.reject("err", var7.toString());
                  return Unit.a;
               }
            } else {
               throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");

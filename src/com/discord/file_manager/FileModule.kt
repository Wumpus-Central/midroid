...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               if (var6 != null && !h.d0(var6)) {
                  ...
                  var8.append(var18);
                  var15.reject("err", var8.toString());
                  return Unit.a;
               }
            }
         }
         ...
         new Function2(this, var1, var2, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  val var67: java.lang.Throwable = r.e(var1);
                  if (var67 != null) {
                     var75.reject(var67);
                  }
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var2);
      return m8.q.m(new Pair[]{(Pair)var1, w.a("CacheDirPath", var2)});
   }
               ...
               if (var3 == null) {
                  ...
                  if (var19 != null) {
                     ...
                     try {
                        ...
                        val var17: java.lang.String = this.$destinationPath;
                        val var20: StringBuilder = new StringBuilder();
                        var20.append("Failed to move file from ");
                        var20.append(var21);
                        var20.append(" to ");
                        var20.append(var17);
                        var14.reject("err", var20.toString());
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        q.e(var1);
                        var320 = x8.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label == 0) {
               ...
               if (var2x != null && !h.d0(var2x)) {
                  ...
                  var6.append("Unknown storage directory ");
                  var6.append(var4);
                  var6.append(". Supported storage directories: ");
                  var6.append(var8);
                  var3.reject("err", var6.toString());
                  return Unit.a;
               }
            } else {
               throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");

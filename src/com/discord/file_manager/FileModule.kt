...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               if (var6 != null && !h.d0(var6)) {
                  ...
                  var15.append(var7);
                  var8.reject("err", var15.toString());
                  return Unit.a;
               }
            }
         }
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     try {
                        val var6: a = r.k;
                        var74 = FileModule.access$getReactApplicationContext(var4).getContentResolver().openFileDescriptor(Uri.parse(var5), "r");
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var2);
      return p8.q.m(new Pair[]{(Pair)var1, w.a("CacheDirPath", var2)});
   }

            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     try {
                        val var5: a = Result.e;
                        var73 = FileModule.access$getReactApplicationContext(var4).getContentResolver().openFileDescriptor(Uri.parse(var6), "r");
               ...
               if (var3 == null) {
                  ...
                  if (var19 != null) {
                     ...
                     try {
                        ...
                        var20.append(" to ");
                        var20.append(var21);
                        var17.reject("err", var20.toString());
         ...
         new Function2<CoroutineScope, Continuation, Object>(var1, this, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        var319 = K9.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {

...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     try {
                        val var5: a = Result.k;
                        var70 = FileModule.access$getReactApplicationContext(var6).getContentResolver().openFileDescriptor(Uri.parse(var4), "r");
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var1);
      return f9.q.m(new Pair[]{var2, s.a("CacheDirPath", var1)});
   }
         ...
         new Function2(var1, this, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        var320 = q9.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {

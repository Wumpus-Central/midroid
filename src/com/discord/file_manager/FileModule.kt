...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  label66: {
                     ...
                     try {
                        val var68: a = r.k;
                        var69 = FileModule.access$getReactApplicationContext(var6).getContentResolver().openFileDescriptor(Uri.parse(var5), "r");
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var2);
      return g8.q.m(new Pair[]{(Pair)var1, w.a("CacheDirPath", var2)});
   }
            ...
            if (this.label == 0) {
               ...
               if (var3 == null) {
                  try {
                     ...
                     var1.append(var4);
                     var2x.reject("err", var1.toString());
                     return Unit.a;
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  if (var1 != null) {
                     try {
                        q.e(var1);
                        var320 = q8.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {

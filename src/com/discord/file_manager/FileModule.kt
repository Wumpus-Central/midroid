...
public class FileModule(reactContext: ReactApplicationContext) : NativeFileModuleSpec {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               if (var6 != null && !h.d0(var6)) {
                  ...
                  val var15: java.lang.String = this.$storageDir;
                  val var8: java.util.Set = FileModule.access$getStorageDirs$p(this.this$0).keySet();
                  val var18: StringBuilder = new StringBuilder();
                  var18.append("Unknown storage directory ");
                  var18.append(var15);
                  var18.append(". Supported storage directories: ");
                  var18.append(var8);
                  var7.reject("err", var18.toString());
                  return Unit.a;
               }
            }
         }
         ...
         new Function2(this, var1, var2, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  val var72: java.lang.Throwable = r.e(var1);
                  if (var72 != null) {
                     var75.reject(var72);
                  }
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      ...
      q.e(var2);
      return i8.q.m(new Pair[]{(Pair)var1, w.a("CacheDirPath", var2)});
   }
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                     ...
                     if (var1 != null) {
                        ...
                        if (var2x != 3143036) {
                           ...
                           label1436: {
                              ...
                              try {
                                 var1 = this.this$0.openRawResource(h.C0(var1, new java.lang.String[]{"."}, false, 0, 6, null).get(0) as java.lang.String);
                                 break label1437;
                  ...
                  if (var1 != null) {
                     try {
                        q.e(var1);
                        var319 = s8.b.c((InputStream)var1);
                     } catch (var12: java.lang.Throwable) {
         ...
         new Function2(var1, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  try {
                     this.$promise.resolve(h.s(var47));
   ...
   public override fun removeFile(storageDir: String, path: String, promise: Promise) {
      ...
      f.d(this.ioScope, null, null, new Function2(this, var1, var3, var2, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label == 0) {
               s.b(var1);
               var var2x: java.lang.String = FileModule.access$getStorageDirs$p(this.this$0).get(this.$storageDir) as java.lang.String;
               if (var2x != null && !h.d0(var2x)) {
                  try {

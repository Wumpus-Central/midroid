...
internal object SystemLogReport {
   ...
   private fun checkHashChanged(context: Context, hash: String): Boolean {
      ...
      if (SystemLogReport.LastStoredTombstoneCache.INSTANCE.get(var1) == var2) {
         return false;
      } else {
         var3.set(var1, var2);
         return true;
      ...
      label35: {
         ...
         if (var3 != null) {
            ...
            if (var11 != null) {
               ...
               if (var12 != null) {
                  val var13: java.util.List = CollectionsKt.O0(var12);
                  if (var13 != null) {
                     var14 = CollectionsKt.x0(var13, "\n", null, null, 0, null, new com.discord.crash_reporting.system_logs.d(), 30, null);
                     break label35;
                  }
               }
            }
   ...
   internal fun reportLastCrash(context: Context, cb: (Reason?, Tombstone?, com.discord.crash_reporting.system_logs.SystemLogReport.SentryCrashData?) -> Unit) {
      SystemLogUtils.INSTANCE.fetchLastTombstone(new com.discord.crash_reporting.system_logs.c(var1, var2));
   }

   @SourceDebugExtension(["SMAP\nSystemLogReport.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SystemLogReport.kt\ncom/discord/crash_reporting/system_logs/SystemLogReport$LastSentryCrashCache\n+ 2 SharedPreferences.kt\nandroidx/core/content/SharedPreferencesKt\n*L\n1#1,116:1\n45#2,8:117\n41#2,12:125\n*S KotlinDebug\n*F\n+ 1 SystemLogReport.kt\ncom/discord/crash_reporting/system_logs/SystemLogReport$LastSentryCrashCache\n*L\n80#1:117,8\n91#1:125,12\n*E\n"])
   ...
   @SourceDebugExtension(["SMAP\nSystemLogReport.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SystemLogReport.kt\ncom/discord/crash_reporting/system_logs/SystemLogReport$LastStoredTombstoneCache\n+ 2 SharedPreferences.kt\nandroidx/core/content/SharedPreferencesKt\n*L\n1#1,116:1\n41#2,12:117\n*S KotlinDebug\n*F\n+ 1 SystemLogReport.kt\ncom/discord/crash_reporting/system_logs/SystemLogReport$LastStoredTombstoneCache\n*L\n108#1:117,12\n*E\n"])
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            if (!(this.message == var1.message)) {
               ...
               return this.callStackTrace == var1.callStackTrace;
            }
         }
      }

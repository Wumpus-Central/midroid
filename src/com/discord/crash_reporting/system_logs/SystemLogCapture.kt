...
internal class SystemLogCapture {
   ...
   private fun readFromLogcat() {
      ...
      // 38: aload 2
      // 39: aload 3
      // 3a: invokestatic N9/q.c (Ljava/io/Reader;Lkotlin/jvm/functions/Function1;)V
      // 3d: getstatic kotlin/Unit.a Lkotlin/Unit;
      // 40: astore 3
      // 41: aload 2
      // 42: aconst_null
      // 43: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 46: aload 1
      ...
      // 54: aload 2
      // 55: aload 3
      // 56: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 59: aload 4
      // 5b: athrow
      // 5c: aload 1
   ...
   public fun startThread(context: Context) {
      ...
      G9.a.b(true, true, null, SystemLogCapture.class.getSimpleName(), 0, new e(this), 20, null);
   }

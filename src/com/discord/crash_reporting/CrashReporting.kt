...
public object CrashReporting {
   ...
   fun `init$lambda$1`(var0: java.lang.String, var1: java.lang.String, var2: Context, var3: Double, var5: SentryAndroidOptions) {
      ...
      var5.setProguardUuid("a7d48e76-3f9d-4130-ad58-9da0c31c1ea0");
   ...
   public fun addBreadcrumb(breadcrumbMessage: String, breadcrumbData: Map<String, String> = A9.q.h(), breadcrumbCategory: String? = null) {

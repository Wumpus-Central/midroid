...
public class PerformanceTracing : MarkerListener {
   ...
   private fun startTransaction(transaction: TraceTransaction) {
      if (!this.ongoingTransactions.containsKey(var1)) {
         val var2: x0 = o3.C(var1.getTransactionName(), var1.getOperation());
   ...
   public fun logSpanForTransaction(marker: com.discord.crash_reporting.PerformanceTracing.TransactionMarker) {
      ...
      // 039: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 03c: ifeq 05e
      // 03f: aload 0
      ...
      // 049: ifnull 059
      // 04c: aload 2
      // 04d: invokeinterface io/sentry/ISpan.c ()V 1
      // 052: goto 059
      // 055: astore 1
      // 056: goto 1fa
      // 059: aload 0
      ...
      // 064: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 067: ifeq 083
      // 06a: aload 0
      ...
      // 07a: ifnull 083
      // 07d: aload 2
      // 07e: invokeinterface io/sentry/ISpan.c ()V 1
      // 083: aload 1
      ...
      // 089: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 08c: ifeq 097
      // 08f: aload 0
      ...
      // 0e5: aload 2
      // 0e6: aload 4
      // 0e8: invokeinterface io/sentry/ISpan.f (Ljava/lang/String;)Lio/sentry/ISpan; 2
      // 0ed: astore 3
      // 0ee: aload 3
      // 0ef: ifnonnull 0f5
      // 0f2: goto 117
      ...
      // 121: aload 3
      // 122: aload 4
      // 124: invokeinterface io/sentry/ISpan.f (Ljava/lang/String;)Lio/sentry/ISpan; 2
      // 129: astore 2
      // 12a: aload 2
      // 12b: ldc_w "startChild(...)"
      // 12e: invokestatic kotlin/jvm/internal/Intrinsics.checkNotNullExpressionValue (Ljava/lang/Object;Ljava/lang/String;)V
      // 131: aload 0
      ...
      // 156: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 159: ifeq 179
      // 15c: aload 0
      // 15d: aload 2
      ...
      // 17f: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 182: ifeq 1f7
      // 185: aload 0
      ...
      // 1c1: ifnull 1f7
      // 1c4: aload 2
      // 1c5: invokeinterface io/sentry/ISpan.c ()V 1
      // 1ca: aload 0
      ...
      // 1dc: invokestatic kotlin/jvm/internal/Intrinsics.areEqual (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 1df: ifeq 1f7
      // 1e2: aload 0

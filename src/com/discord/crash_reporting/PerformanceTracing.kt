...
public class PerformanceTracing : MarkerListener {
   ...
   public fun logSpanForTransaction(marker: com.discord.crash_reporting.PerformanceTracing.TransactionMarker) {
      ...
      // 049: ifnull 059
      // 04c: aload 2
      // 04d: invokeinterface io/sentry/ISpan.l ()V 1
      // 052: goto 059
      // 055: astore 1
      // 056: goto 1fa
      // 059: aload 0
      ...
      // 07a: ifnull 083
      // 07d: aload 2
      // 07e: invokeinterface io/sentry/ISpan.l ()V 1
      // 083: aload 1
      ...
      // 0e5: aload 2
      // 0e6: aload 4
      // 0e8: invokeinterface io/sentry/ISpan.o (Ljava/lang/String;)Lio/sentry/ISpan; 2
      // 0ed: astore 3
      // 0ee: aload 3
      // 0ef: ifnonnull 0f5
      // 0f2: goto 117
      ...
      // 121: aload 3
      // 122: aload 4
      // 124: invokeinterface io/sentry/ISpan.o (Ljava/lang/String;)Lio/sentry/ISpan; 2
      // 129: astore 2
      // 12a: aload 2
      ...
      // 1c1: ifnull 1f7
      // 1c4: aload 2
      // 1c5: invokeinterface io/sentry/ISpan.l ()V 1
      // 1ca: aload 0

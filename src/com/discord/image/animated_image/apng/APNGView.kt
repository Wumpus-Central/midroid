               ...
               if (this.label != 0) {
                  ...
                  val var6: FlowCollector = new FlowCollector(this.this$0, this.$config) {
                     ...
                     public final Object emit(DownloadState var1, Continuation var2x) {
                           ...
                           label82: {
                              ...
                              if (var1 !is DownloadState.Completed) {
                                 if (var1 is DownloadState.Failure) {
                                    ...
                                    if (gc.f.g(var13, (Function2)var5, (Continuation)var14) === var16) {
                                       return var16;
                                    }
                              ...
                              try {
                                 ...
                                 var12 = gc.f.g(var11, var6x, (Continuation)var14);
                        ...
                        return if (gc.f.g((CoroutineContext)var5, var10, (Continuation)var14) === var16) var16 else Unit.a;
                     }
                  };
                  this.label = 1;

...
public class APNGView(context: Context) : m {
               ...
               if (this.label != 0) {
                  ...
                  val var7: FlowCollector = new FlowCollector(this.this$0, this.$config) {
                     ...
                     public final Object emit(DownloadState var1, Continuation var2x) {
                           ...
                           label82: {
                              ...
                              if (var1 !is DownloadState.Completed) {
                                 if (var1 is DownloadState.Failure) {
                                    ...
                                    if (Na.f.g(var13, (Function2)var5, (Continuation)var14) === var16) {
                                       return var16;
                                    }
                              ...
                              try {
                                 ...
                                 val var6x: d0 = K.c();
                                 var5 = new Function2(this.this$0, var11, this.$config, null) {
                                    final APNGView.Config $config;
                                 ...
                                 var12 = Na.f.g(var6x, (Function2)var5, (Continuation)var14);
                        ...
                        return if (Na.f.g((CoroutineContext)var5, var10, (Continuation)var14) === var16) var16 else Unit.a;
                     }
                  };
                  this.label = 1;
   ...
   public companion object {
      private fun getFilename(url: String): String {
         ...
         val var7: ByteArray = var1.getBytes(La.a.b);
         q.g(var7, "getBytes(...)");

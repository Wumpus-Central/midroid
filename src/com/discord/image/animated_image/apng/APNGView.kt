...
public class APNGView(context: Context) : m {
   ...
   init {
      r.h(var1, "context");
      super(var1);
      this.apngStateManager = new AnimatedImageStateManager<>(new b(this), new c(this), new d(this), new e(this), new f(this), new g(this));
   }
               ...
               if (this.label != 0) {
                  ...
                  val var6: FlowCollector = new FlowCollector(this.this$0, this.$config) {
                     ...
                     public final Object emit(DownloadState var1, Continuation var2x) {
                           ...
                           label82: {
                              ...
                              if (var1 !is DownloadState.Completed) {
                                 if (var1 is DownloadState.Failure) {
                                    ...
                                    if (jb.f.g((CoroutineContext)var5, var13, (Continuation)var14) === var16) {
                                       return var16;
                                    }
                              ...
                              try {
                                 ...
                                 val var11: d0 = K.c();
                                 val var6x: Function2 = new Function2(this.this$0, (ApngDrawable)var5, this.$config, null) {
                                    final APNGView.Config $config;
                                 ...
                                 var12 = jb.f.g(var11, var6x, (Continuation)var14);
                        ...
                        var5 = K.c();
                        val var10: Function2 = new Function2(var9.this$0, null) {
                           int label;
                           final APNGView this$0;
                        ...
                        return if (jb.f.g((CoroutineContext)var5, var10, (Continuation)var14) === var16) var16 else Unit.a;
                     }
                  };
                  this.label = 1;
   ...
   public companion object {
      private fun getFilename(url: String): String {
         ...
         val var7: ByteArray = var1.getBytes(hb.a.b);
         r.g(var7, "getBytes(...)");
      ...
      private fun hasFilename(url: String): Boolean {
         return h.c0(this.getFilename(var1)) xor true;
      }
   }

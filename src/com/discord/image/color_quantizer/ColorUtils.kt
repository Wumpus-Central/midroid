...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = x8.a.c((var8 + var4) * 255.0F);
            var6 = x8.a.c((var9 + var4) * 255.0F);
            var7 = x8.a.c(var4 * 255.0F);
            break;
         case 1:
            var5 = x8.a.c((var9 + var4) * 255.0F);
            var6 = x8.a.c((var8 + var4) * 255.0F);
            var7 = x8.a.c(var4 * 255.0F);
            break;
         case 2:
            var5 = x8.a.c(var4 * 255.0F);
            var6 = x8.a.c((var8 + var4) * 255.0F);
            var7 = x8.a.c((var9 + var4) * 255.0F);
            break;
         case 3:
            var5 = x8.a.c(var4 * 255.0F);
            var6 = x8.a.c((var9 + var4) * 255.0F);
            var7 = x8.a.c((var8 + var4) * 255.0F);
            break;
         case 4:
            var5 = x8.a.c((var9 + var4) * 255.0F);
            var6 = x8.a.c(var4 * 255.0F);
            var7 = x8.a.c((var8 + var4) * 255.0F);
            break;
         case 5:
         case 6:

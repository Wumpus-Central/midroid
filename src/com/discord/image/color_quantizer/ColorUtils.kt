...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = x8.a.c((var8 + var9) * 255.0F);
            var6 = x8.a.c((var4 + var9) * 255.0F);
            var7 = x8.a.c(var9 * 255.0F);
            break;
         case 1:
            var5 = x8.a.c((var4 + var9) * 255.0F);
            var6 = x8.a.c((var8 + var9) * 255.0F);
            var7 = x8.a.c(var9 * 255.0F);
            break;
         case 2:
            var5 = x8.a.c(var9 * 255.0F);
            var6 = x8.a.c((var8 + var9) * 255.0F);
            var7 = x8.a.c((var4 + var9) * 255.0F);
            break;
         case 3:
            var5 = x8.a.c(var9 * 255.0F);
            var6 = x8.a.c((var4 + var9) * 255.0F);
            var7 = x8.a.c((var8 + var9) * 255.0F);
            break;
         case 4:
            var5 = x8.a.c((var4 + var9) * 255.0F);
            var6 = x8.a.c(var9 * 255.0F);
            var7 = x8.a.c((var8 + var9) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      var var4: Float = Math.max(var8, Math.max(var10, (float)var2 / 255.0F));
      val var7: Float = Math.min(var8, Math.min(var10, (float)var2 / 255.0F));
      var var5: Float = var4 - var7;
      val var6: Float = (var4 + var7) / 2.0F;
      if (var4 == var7) {
         var4 = 0.0F;
         var5 = 0.0F;
      } else {
         if (var4 == var8) {
            var4 = (var10 - var9) / var5 % 6.0F;
         } else if (var4 == var10) {
            var4 = (var9 - var8) / var5 + 2.0F;
         } else {
            var4 = (var8 - var10) / var5 + 4.0F;
         }

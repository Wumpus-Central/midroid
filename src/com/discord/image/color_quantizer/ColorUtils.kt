...
internal object ColorUtils {
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var7: Float = Math.max(var9, Math.max(var4, (float)var2 / 255.0F));
      val var10: Float = Math.min(var9, Math.min(var4, (float)var2 / 255.0F));
      var var5: Float = var7 - var10;
      val var6: Float = (var7 + var10) / 2.0F;
      if (var7 == var10) {
         var4 = 0.0F;
         var5 = 0.0F;
      } else {

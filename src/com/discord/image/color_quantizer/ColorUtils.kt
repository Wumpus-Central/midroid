...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = zh.a.b((var8 + var9) * 255.0F);
            var6 = zh.a.b((var4 + var9) * 255.0F);
            var7 = zh.a.b(var9 * 255.0F);
            break;
         case 1:
            var5 = zh.a.b((var4 + var9) * 255.0F);
            var6 = zh.a.b((var8 + var9) * 255.0F);
            var7 = zh.a.b(var9 * 255.0F);
            break;
         case 2:
            var5 = zh.a.b(var9 * 255.0F);
            var6 = zh.a.b((var8 + var9) * 255.0F);
            var7 = zh.a.b((var4 + var9) * 255.0F);
            break;
         case 3:
            var5 = zh.a.b(var9 * 255.0F);
            var6 = zh.a.b((var4 + var9) * 255.0F);
            var7 = zh.a.b((var8 + var9) * 255.0F);
            break;
         case 4:
            var5 = zh.a.b((var4 + var9) * 255.0F);
            var6 = zh.a.b(var9 * 255.0F);
            var7 = zh.a.b((var8 + var9) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var7: Float = Math.max(var8, Math.max(var9, (float)var2 / 255.0F));

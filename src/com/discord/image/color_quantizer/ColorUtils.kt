...
internal object ColorUtils {
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      var var4: Float = Math.max(var10, Math.max(var7, (float)var2 / 255.0F));
      val var9: Float = Math.min(var10, Math.min(var7, (float)var2 / 255.0F));
      var var5: Float = var4 - var9;
      val var6: Float = (var4 + var9) / 2.0F;
      if (var4 == var9) {
         var4 = 0.0F;
         var5 = 0.0F;
      } else {
         if (var4 == var10) {
            ...
            var4 = (var8 - var10) / var5 + 2.0F;
         } else {
            var4 = (var10 - var7) / var5 + 4.0F;
         }

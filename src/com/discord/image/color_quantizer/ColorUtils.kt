...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = ak.a.b((var8 + var9) * 255.0F);
            var6 = ak.a.b((var4 + var9) * 255.0F);
            var7 = ak.a.b(var9 * 255.0F);
            break;
         case 1:
            var5 = ak.a.b((var4 + var9) * 255.0F);
            var6 = ak.a.b((var8 + var9) * 255.0F);
            var7 = ak.a.b(var9 * 255.0F);
            break;
         case 2:
            var5 = ak.a.b(var9 * 255.0F);
            var6 = ak.a.b((var8 + var9) * 255.0F);
            var7 = ak.a.b((var4 + var9) * 255.0F);
            break;
         case 3:
            var5 = ak.a.b(var9 * 255.0F);
            var6 = ak.a.b((var4 + var9) * 255.0F);
            var7 = ak.a.b((var8 + var9) * 255.0F);
            break;
         case 4:
            var5 = ak.a.b((var4 + var9) * 255.0F);
            var6 = ak.a.b(var9 * 255.0F);
            var7 = ak.a.b((var8 + var9) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var8: Float = Math.min(var4, Math.min(var10, (float)var2 / 255.0F));

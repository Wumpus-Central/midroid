...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = E8.a.c((var8 + var4) * 255.0F);
            var6 = E8.a.c((var9 + var4) * 255.0F);
            var7 = E8.a.c(var4 * 255.0F);
            break;
         case 1:
            var5 = E8.a.c((var9 + var4) * 255.0F);
            var6 = E8.a.c((var8 + var4) * 255.0F);
            var7 = E8.a.c(var4 * 255.0F);
            break;
         case 2:
            var5 = E8.a.c(var4 * 255.0F);
            var6 = E8.a.c((var8 + var4) * 255.0F);
            var7 = E8.a.c((var9 + var4) * 255.0F);
            break;
         case 3:
            var5 = E8.a.c(var4 * 255.0F);
            var6 = E8.a.c((var9 + var4) * 255.0F);
            var7 = E8.a.c((var8 + var4) * 255.0F);
            break;
         case 4:
            var5 = E8.a.c((var9 + var4) * 255.0F);
            var6 = E8.a.c(var4 * 255.0F);
            var7 = E8.a.c((var8 + var4) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var10: Float = Math.max(var7, Math.max(var9, (float)var2 / 255.0F));
      var var4: Float = Math.min(var7, Math.min(var9, (float)var2 / 255.0F));

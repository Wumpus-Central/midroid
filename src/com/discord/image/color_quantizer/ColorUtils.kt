...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = J9.a.c((var8 + var9) * 255.0F);
            var6 = J9.a.c((var4 + var9) * 255.0F);
            var7 = J9.a.c(var9 * 255.0F);
            break;
         case 1:
            var5 = J9.a.c((var4 + var9) * 255.0F);
            var6 = J9.a.c((var8 + var9) * 255.0F);
            var7 = J9.a.c(var9 * 255.0F);
            break;
         case 2:
            var5 = J9.a.c(var9 * 255.0F);
            var6 = J9.a.c((var8 + var9) * 255.0F);
            var7 = J9.a.c((var4 + var9) * 255.0F);
            break;
         case 3:
            var5 = J9.a.c(var9 * 255.0F);
            var6 = J9.a.c((var4 + var9) * 255.0F);
            var7 = J9.a.c((var8 + var9) * 255.0F);
            break;
         case 4:
            var5 = J9.a.c((var4 + var9) * 255.0F);
            var6 = J9.a.c(var9 * 255.0F);
            var7 = J9.a.c((var8 + var9) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var7: Float = Math.max(var4, Math.max(var9, (float)var2 / 255.0F));
      val var10: Float = Math.min(var4, Math.min(var9, (float)var2 / 255.0F));
      ...
      if (var7 == var10) {
         ...
         if (var7 == var4) {
            var4 = (var9 - var8) / var5 % 6.0F;
         } else if (var7 == var9) {
            var4 = (var8 - var4) / var5 + 2.0F;
         } else {
            var4 = (var4 - var9) / var5 + 4.0F;
         }

...
internal object ColorUtils {
   ...
   public fun HSLtoRGB(hsl: FloatArray): Int {
      ...
      switch ((int)var1 / 60) {
         case 0:
            var5 = N9.a.c((var8 + var9) * 255.0F);
            var6 = N9.a.c((var4 + var9) * 255.0F);
            var7 = N9.a.c(var9 * 255.0F);
            break;
         case 1:
            var5 = N9.a.c((var4 + var9) * 255.0F);
            var6 = N9.a.c((var8 + var9) * 255.0F);
            var7 = N9.a.c(var9 * 255.0F);
            break;
         case 2:
            var5 = N9.a.c(var9 * 255.0F);
            var6 = N9.a.c((var8 + var9) * 255.0F);
            var7 = N9.a.c((var4 + var9) * 255.0F);
            break;
         case 3:
            var5 = N9.a.c(var9 * 255.0F);
            var6 = N9.a.c((var4 + var9) * 255.0F);
            var7 = N9.a.c((var8 + var9) * 255.0F);
            break;
         case 4:
            var5 = N9.a.c((var4 + var9) * 255.0F);
            var6 = N9.a.c(var9 * 255.0F);
            var7 = N9.a.c((var8 + var9) * 255.0F);
            break;
         case 5:
         case 6:
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var8: Float = Math.max(var10, Math.max(var4, (float)var2 / 255.0F));
      val var7: Float = Math.min(var10, Math.min(var4, (float)var2 / 255.0F));
      var var5: Float = var8 - var7;
      val var6: Float = (var8 + var7) / 2.0F;
      if (var8 == var7) {
         var4 = 0.0F;
         var5 = 0.0F;
      } else {

...
internal object ColorUtils {
   ...
   public fun RGBtoHSL(r: Int, g: Int, b: Int, hsl: FloatArray) {
      ...
      val var10: Float = Math.max(var8, Math.max(var7, (float)var2 / 255.0F));
      val var9: Float = Math.min(var8, Math.min(var7, (float)var2 / 255.0F));
      ...
      if (var10 == var9) {
         ...
         if (var10 == var8) {
            var4 = (var7 - var4) / var5 % 6.0F;
         } else if (var10 == var7) {
            var4 = (var4 - var8) / var5 + 2.0F;
         } else {
            var4 = (var8 - var7) / var5 + 4.0F;
         }

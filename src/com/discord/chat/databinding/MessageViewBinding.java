            ...
            if (var9 != null) {
               ...
               if (var2 != null) {
                  ...
                  if (var18 != null) {
                     ...
                     ConnectionsRoleTagView var22 = (ConnectionsRoleTagView)a.a(var0, var1);
                     if (var22 != null) {
                        var1 = R.id.game_icon;
                        GameIconView var12 = (GameIconView)a.a(var0, var1);
                        if (var12 != null) {
                           ...
                           if (var13 != null) {
                              ...
                              if (var20 != null) {
                                 ...
                                 MessageAltRemixTagView var8 = (MessageAltRemixTagView)a.a(var0, var1);
                                 if (var8 != null) {
                                    var1 = R.id.message_frame_header;
                                    MessageFrameHeaderView var21 = (MessageFrameHeaderView)a.a(var0, var1);
                                    if (var21 != null) {
                                       ...
                                       if (var4 != null) {
                                          ...
                                          if (var14 != null) {
                                             ...
                                             if (var6 != null) {
                                                ...
                                                if (var15 != null) {
                                                   var1 = R.id.role_dot;
                                                   RoleDotView var7 = (RoleDotView)a.a(var0, var1);
                                                   if (var7 != null) {
                                                      var1 = R.id.role_icon;
                                                      RoleIconView var19 = (RoleIconView)a.a(var0, var1);
                                                      if (var19 != null) {
                                                         var1 = R.id.shadow_view;
                                                         MaskedShadowView var3 = (MaskedShadowView)a.a(var0, var1);
                                                         if (var3 != null) {

...
public final class MessageViewBinding implements ViewBinding {
   ...
   public static MessageViewBinding bind(View var0) {
      ...
      MessageAccessoriesView var14 = (MessageAccessoriesView)a.a(var0, var1);
      if (var14 != null) {
            ...
            if (var22 != null) {
               ...
               if (var3 != null) {
                  ...
                  if (var12 != null) {
                     ...
                     if (var15 != null) {
                        var1 = R.id.game_icon;
                        GameIconView var4 = (GameIconView)a.a(var0, var1);
                        if (var4 != null) {
                           ...
                           if (var8 != null) {
                              ...
                              if (var5 != null) {
                                 ...
                                 if (var17 != null) {
                                    ...
                                    MessageFrameHeaderView var6 = (MessageFrameHeaderView)a.a(var0, var1);
                                    if (var6 != null) {
                                                ...
                                                if (var2 != null) {
                                                   ...
                                                   if (var20 != null) {
                                                      ...
                                                      if (var7 != null) {
                                                         ...
                                                         MaskedShadowView var19 = (MaskedShadowView)a.a(var0, var1);
                                                         if (var19 != null) {
                                                            ...
                                                            if (var10 != null) {
                                                               ...
                                                               ViewStub var18 = (ViewStub)a.a(var0, var1);
                                                               if (var18 != null) {
                                                                  var1 = R.id.timestamp;

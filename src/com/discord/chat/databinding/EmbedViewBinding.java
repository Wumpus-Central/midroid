...
public final class EmbedViewBinding implements ViewBinding {
   ...
   private EmbedViewBinding(
      ...
      TextView var14,
      FrameLayout var15,
      ConstraintLayout var16,
      EmbedViewResizingMediaView var17,
      EmbedViewResizingMediaView var18,
      EmbedViewResizingMediaView var19,
      EmbedViewResizingMediaView var20,
      EmbedViewResizingMediaView var21,
      SimpleDraweeSpanTextView var22,
      Space var23,
      SpoilerView var24,
      SimpleDraweeView var25,
      SimpleDraweeSpanTextView var26
   ) {
      this.rootView = var1;
   ...
   public static EmbedViewBinding bind(View var0) {
      ...
      if (var2 != null) {
         ...
         LinearLayout var24 = (LinearLayout)a.a(var0, var1);
         if (var24 != null) {
            ...
            if (var19 != null) {
               ...
               if (var12 != null) {
                  ...
                  SimpleDraweeSpanTextView var22 = (SimpleDraweeSpanTextView)a.a(var0, var1);
                  if (var22 != null) {
                     var1 = R.id.error;
                                             ...
                                             if (var3 != null) {
                                                ...
                                                if (var23 != null) {
                                                   ...
                                                   if (var6 != null) {
                                                      ...
                                                      EmbedViewResizingMediaView var20 = (EmbedViewResizingMediaView)a.a(var0, var1);
                                                      if (var20 != null) {
                                                         var1 = R.id.inline_media_view3;
                                                         EmbedViewResizingMediaView var4 = (EmbedViewResizingMediaView)a.a(var0, var1);
                                                         if (var4 != null) {
                                                            ...
                                                            if (var17 != null) {
                                                               ...
                                                               if (var7 != null) {
                                                                  ...
                                                                  if (var8 != null) {
                                                                     ...
                                                                     if (var16 != null) {
                                                                        var1 = R.id.spoiler;
                                                                        SpoilerView var18 = (SpoilerView)a.a(var0, var1);
                                                                        if (var18 != null) {
                                                                           var1 = R.id.thumbnail;
                                                                           SimpleDraweeView var14 = (SimpleDraweeView)a.a(var0, var1);
                                                                           if (var14 != null) {
                                                                              var1 = R.id.title;
                                                                              SimpleDraweeSpanTextView var15 = (SimpleDraweeSpanTextView)a.a(var0, var1);
                                                                              if (var15 != null) {

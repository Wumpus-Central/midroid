...
public final class ObscureOverlayViewBinding implements ViewBinding {
   ...
   public static ObscureOverlayViewBinding bind(@NonNull View var0) {
      ...
      BlurView var5 = (BlurView)k5.a.a(var0, var1);
      if (var5 != null) {
         var1 = R.id.description_label;
         TextView var7 = (TextView)k5.a.a(var0, var1);
         if (var7 != null) {
            var1 = R.id.hide_button;
            IconButtonView var3 = (IconButtonView)k5.a.a(var0, var1);
            if (var3 != null) {
                  ...
                  if (var4 != null) {
                     ...
                     if (var8 != null) {
                        ...
                        if (var6 != null) {
                           ...
                           IconButtonView var2 = (IconButtonView)k5.a.a(var0, var1);
                           if (var2 != null) {
                              return new ObscureOverlayViewBinding(var0, var5, var7, var3, var9, var4, var8, var6, var2);
                           }
                        }
                     }
                  }

...
public final class SpoilerOverlayViewBinding implements ViewBinding {
   ...
   private SpoilerOverlayViewBinding(@NonNull View var1, @NonNull TextView var2, @NonNull FrameLayout var3) {
      this.rootView = var1;
      this.label = var2;
   ...
   @NonNull
   public static SpoilerOverlayViewBinding inflate(@NonNull LayoutInflater var0, @NonNull ViewGroup var1) {
      if (var1 != null) {

   ...
   public static AttachmentUploadOverlayViewBinding bind(@NonNull View var0) {
      ...
      if (var7 != null) {
         ...
         if (var4 != null) {
            ...
            MaterialCardView var6 = (MaterialCardView)k5.a.a(var0, var1);
            if (var6 != null) {
               var1 = R.id.upload_complete_layout;
               ConstraintLayout var2 = (ConstraintLayout)k5.a.a(var0, var1);
               if (var2 != null) {
                  var1 = R.id.upload_progress;
                  CircularProgressIndicator var5 = (CircularProgressIndicator)k5.a.a(var0, var1);
                  if (var5 != null) {
                     ...
                     if (var3 != null) {
                        ...
                        if (var8 != null) {
                           return new AttachmentUploadOverlayViewBinding(var0, var7, var4, var6, var2, var5, var3, var8);
                        }
                     }
                  }
               }

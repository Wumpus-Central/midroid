   ...
   public static AttachmentUploadOverlayViewBinding bind(View var0) {
      ...
      if (var2 != null) {
         ...
         if (var6 != null) {
            ...
            MaterialCardView var8 = (MaterialCardView)a.a(var0, var1);
            if (var8 != null) {
               var1 = R.id.upload_complete_layout;
               ConstraintLayout var5 = (ConstraintLayout)a.a(var0, var1);
               if (var5 != null) {
                  var1 = R.id.upload_progress;
                  CircularProgressIndicator var4 = (CircularProgressIndicator)a.a(var0, var1);
                  if (var4 != null) {
                     ...
                     if (var7 != null) {
                        ...
                        if (var3 != null) {
                           return new AttachmentUploadOverlayViewBinding(var0, var2, var6, var8, var5, var4, var7, var3);
                        }
                     }
                  }
               }

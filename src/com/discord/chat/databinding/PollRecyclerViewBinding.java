...
public final class PollRecyclerViewBinding implements ViewBinding {
   ...
   public static PollRecyclerViewBinding bind(@NonNull View var0) {
      ...
      if (var2 != null) {
         ...
         PollActionButton var6 = (PollActionButton)k5.a.a(var0, var1);
         if (var6 != null) {
            ...
            if (var7 != null) {
               ...
               if (var3 != null) {
                  ...
                  if (var4 != null) {
                     ...
                     PollActionButton var5 = (PollActionButton)k5.a.a(var0, var1);
                     if (var5 != null) {
                        return new PollRecyclerViewBinding(var0, var2, var6, var7, var3, var4, var5);
                     }
                  }
               }
            }

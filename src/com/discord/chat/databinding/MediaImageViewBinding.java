         ...
         if (var7 != null) {
            ...
            if (var2 != null) {
               ...
               if (var3 != null) {
                  ...
                  FrameLayout var6 = (FrameLayout)k5.a.a(var0, var1);
                  if (var6 != null) {
                     var1 = R.id.media_view_alt_text_button;
                     AltTextButtonView var4 = (AltTextButtonView)k5.a.a(var0, var1);
                     if (var4 != null) {
                        return new MediaImageViewBinding(var0, var5, var7, var2, var3, var6, var4);
                     }
                  }
               }
            }

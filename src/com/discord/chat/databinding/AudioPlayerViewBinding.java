      ...
      if (var11 != null) {
         ...
         if (var4 != null) {
            ...
            if (var12 != null) {
               ...
               AudioProgressBar var8 = (AudioProgressBar)a.a(var0, var1);
               if (var8 != null) {
                           ...
                           if (var5 != null) {
                              ...
                              if (var10 != null) {
                                 ...
                                 if (var14 != null) {
                                    ...
                                    AttachmentUploadOverlayView var6 = (AttachmentUploadOverlayView)a.a(var0, var1);
                                    if (var6 != null) {
                                       var1 = R.id.upload_overlay_background;
                                       LinearLayout var15 = (LinearLayout)a.a(var0, var1);
                                       if (var15 != null) {
                                          var1 = R.id.wave;
                                          AudioWaveView var7 = (AudioWaveView)a.a(var0, var1);
                                          if (var7 != null) {
                                             var1 = R.id.wipe;
                                             View var9 = a.a(var0, var1);
                                             if (var9 != null) {
                                                return new AudioPlayerViewBinding(
                                                   var0, var11, var4, var12, var8, var13, var2, var3, var5, var10, var14, var6, var15, var7, var9
                                                );
                                             }
                                          }
                                       }

                           ...
                           if (var12 != null) {
                              ...
                              if (var8 != null) {
                                 ...
                                 if (var3 != null) {
                                    ...
                                    AttachmentUploadOverlayView var14 = (AttachmentUploadOverlayView)a.a(var0, var1);
                                    if (var14 != null) {
                                       var1 = R.id.upload_overlay_background;
                                       LinearLayout var9 = (LinearLayout)a.a(var0, var1);
                                       if (var9 != null) {
                                          var1 = R.id.wave;
                                          AudioWaveView var15 = (AudioWaveView)a.a(var0, var1);
                                          if (var15 != null) {
                                             var1 = R.id.wipe;
                                             View var7 = a.a(var0, var1);
                                             if (var7 != null) {
                                                return new AudioPlayerViewBinding(
                                                   var0, var11, var2, var13, var10, var5, var6, var4, var12, var8, var3, var14, var9, var15, var7
                                                );
                                             }
                                          }
                                       }

      ...
      if (var7 != null) {
         ...
         if (var3 != null) {
            ...
            if (var5 != null) {
               ...
               FlaggedMessageEmbedFooterView var2 = (FlaggedMessageEmbedFooterView)a.a(var0, var1);
               if (var2 != null) {
                     ...
                     if (var4 != null) {
                        ...
                        if (var6 != null) {
                           ...
                           if (var9 != null) {
                              ...
                              if (var10 != null) {
                                 return new FlaggedMessageEmbedViewBinding(var0, var7, var3, var5, var2, var8, var4, var6, var9, var10);
                              }
                           }
                        }
                     }

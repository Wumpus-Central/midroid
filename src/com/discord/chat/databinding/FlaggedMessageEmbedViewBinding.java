   ...
   public static FlaggedMessageEmbedViewBinding bind(@NonNull View var0) {
      ...
      if (var9 != null) {
         ...
         if (var4 != null) {
            ...
            ConnectionsRoleTagView var7 = (ConnectionsRoleTagView)k5.a.a(var0, var1);
            if (var7 != null) {
               var1 = R.id.content_footer_view;
               FlaggedMessageEmbedFooterView var2 = (FlaggedMessageEmbedFooterView)k5.a.a(var0, var1);
               if (var2 != null) {
                  var1 = R.id.content_view;
                  MessageContentView var5 = (MessageContentView)k5.a.a(var0, var1);
                  if (var5 != null) {
                     ...
                     if (var3 != null) {
                        ...
                        if (var6 != null) {
                           ...
                           Guideline var8 = (Guideline)k5.a.a(var0, var1);
                           if (var8 != null) {
                              var1 = R.id.role_icon;
                              RoleIconView var10 = (RoleIconView)k5.a.a(var0, var1);
                              if (var10 != null) {
                                 return new FlaggedMessageEmbedViewBinding(var0, var9, var4, var7, var2, var5, var3, var6, var8, var10);
                              }
                           }
                        }
                     }

...
public class ChatPackage : TurboReactPackage {
   public open fun createViewManagers(reactContext: ReactApplicationContext): List<BaseViewManager<out ViewGroup, LayoutShadowNode>> {

...
public class BlockedMessageGroupView  public constructor(context: Context, attrs: AttributeSet? = null) : ChatListConstraintLayout {
   ...
   init {
      ...
      r.g(var6.blockedMessageGroupButton, "binding.blockedMessageGroupButton");
   ...
   fun `bind$lambda$2`(var0: ChatEventHandler, var1: BlockedGroupChatListItem, var2: View) {
      ...
      r.h(var1, "$item");
      var0.onTapToggleBlockedMessages_1xi1bu0(MessageId.constructor_impl(var1.getId()));
   }
   ...
   public fun bind(item: BlockedGroupChatListItem, eventHandler: ChatEventHandler) {
      ...
      r.g(this.binding.closeIcon, "binding.closeIcon");
      ...
      r.g(this.binding.blockedMessages, "binding.blockedMessages");
      val var13: Byte;
      if (var1.isRevealed()) {
         var13 = 0;
      } else {

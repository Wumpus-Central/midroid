                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    val var240: RoleColors = RoleColorsKt.toAndroidColors((var28 as UserOrRoleMentionContentNode).getRoleColors());
                                    ...
                                    label727: {
                                       ...
                                       if (var103 && !var16) {
                                          val var155: Int;
                                          if (var240 != null) {
                                             var155 = var240.getSecondaryColor();
                                          } else {
                                             var155 = null;
                                          }

                                          if (var155 != null) {
                                             val var157: java.util.List = CollectionsKt.q(new Integer[]{var240.getPrimaryColor(), var240.getSecondaryColor()});
                                             if (var240.getTertiaryColor() != null) {
                                                var157.add(var240.getTertiaryColor());
                                             }
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var15, var1.getSingleLine(), var27, var6, var118, var240);
                                    var22.append(toSpannable$default(var285.getContent(), var1, null, false, 6, null));

                                    for (int var46 = 0; var46 < 4; var46++) {
                                       var25 = (BackgroundColorSpan)new Object[]{var188, var219, var276, var156}[var46];
                                       if (var25 != null) {
                                    ...
                                    val var218: ForegroundColorSpan = new ForegroundColorSpan(var11);
                                    var7 = var2.length();
                                    ...
                                    if (var284 != null) {
                                       ...
                                       appendImage$default(
                                          var2, var27, var1, ReactAsset.Caret.getUri(var27), var6, var6, var218.getForegroundColor(), 0.0F, 0.0F, 192, null
                                       );
                                    }
                                    ...
                                    for (int var43 = 0; var43 < 4; var43++) {
                                       var27 = (Context)new Object[]{var188, var239, var153, var218}[var43];
                                       if (var27 != null) {
                                    ...
                                    if (var9 == 1 || var9 == 2) {
                                       appendImage$default(
                                          var2, var27, var1, ReactAsset.Home.getUri(var27), var6, var6, var216.getForegroundColor(), 0.0F, 0.0F, 192, null
                                       );
                                    } else if (var9 != 3) {
                                       if (var9 != 4) {
                                          if (var9 != 5) {
                                    ...
                                    for (int var40 = 0; var40 < 4; var40++) {
                                       var27 = (Context)new Object[]{var188, var151, var237, var216}[var40];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var251, var24, var287, var203, var289}[var68];
                                                                  if (var27 != null) {

...
private fun DraweeSpanStringBuilder.appendBulletPoint(content: List<ContentNode>, rc: RenderContext, isOrderedList: Boolean) {
   ...
   if (var3) {
      ...
      val var27: BulletSpan = new BulletSpan(var8, var6, false, var7, 0.0F, var26, 20, null);
      SpannableStringBuilderExtensionsKt.ensureNewline(var0, new AbsoluteSizeSpan(var4));
      var5 = var0.length();
      appendToExistingBuilder(var1, var2, var0);
                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var15, var1.getSingleLine(), var27, var6, var118, var276);
                                    var22.append(toSpannable$default(var240.getContent(), var1, null, false, 6, null));

                                    for (int var46 = 0; var46 < 4; var46++) {
                                       var25 = (BackgroundColorSpan)new Object[]{var188, var219, var285, var156}[var46];
                                       if (var25 != null) {
                                    ...
                                    for (int var36 = 0; var36 < 3; var36++) {
                                       var27 = (Context)new Object[]{var232, var214, var148}[var36];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }

                                    val var149: Any = new Object[]{var189}[0];
                                    if (var149 != null) {
                                       ...
                                       if (var28 is StrikethroughContentNode) {
                                          ...
                                          if (var15) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var203, var24, var287, var251, var289}[var68];
                                                                  if (var27 != null) {
                                             ...
                                             if (!var1.getSingleLine()) {
                                                ...
                                                var25 = (BackgroundColorSpan)new Object[]{var243}[0];
                                                if (var25 != null) {
                                                ...
                                                if (var9 == 0) {
                                                   ...
                                                   var7 = var2.length();
                                                   var2.append("\n");
                                                   var25 = (BackgroundColorSpan)new Object[]{var245}[0];
                                                   if (var25 != null) {
                                                   ...
                                                   var7 = var2.length();
                                                   var2.append("\n\u200b");
                                                   var25 = (BackgroundColorSpan)new Object[]{var247}[0];
                                                   if (var25 != null) {
                                                      var2.setSpan(var25, var7, var2.length(), 33);
                                                   }
                                                }
                                                ...
                                                for (int var92 = 0; var92 < 3; var92++) {
                                                   var25 = (BackgroundColorSpan)new Object[]{var171, var221, var195}[var92];
                                                   if (var25 != null) {

...
private fun DraweeSpanStringBuilder.appendBulletPoint(content: List<ContentNode>, rc: RenderContext, isOrderedList: Boolean) {
   ...
   if (var3) {
      ...
      val var7: Int = ColorUtilsKt.getThemeColor(var2.getContext(), color.primary_360, color.primary_400, var2.getTheme());
      val var26: Style;
      if (var6 > 0) {
         var26 = Style.STROKE;
      } else {
      ...
      val var27: BulletSpan = new BulletSpan(var7, var8, false, var20, 0.0F, var26, 20, null);
      var20 = var0.length();
      appendToExistingBuilder(var1, var2, var0);
      SpannableStringBuilderExtensionsKt.ensureNewline(var0, new AbsoluteSizeSpan(var4));
...
public fun DraweeSpanStringBuilder.appendImage(
   ...
   var0.append('\u200b');
   val var13: com.facebook.drawee.controller.a = (w5.c.g().F(ImageRequestBuilder.w(Uri.parse(ReactAssetUtilsKt.getReactImageUrl(var1, var3))).a()) as PipelineDraweeControllerBuilder)
      .d();
   q.g(var13, "build(...)");
...
private fun List<ContentNode>.toSpannable(rc: RenderContext, builder: DraweeSpanStringBuilder = new DraweeSpanStringBuilder()): DraweeSpanStringBuilder {
   ...
   while (var25.hasNext()) {
      ...
      label573: {
         ...
         val var13: Int = androidx.core.graphics.c.k(ColorUtilsKt.getThemeColor(var26, color.green_330, color.green_330, var1.getTheme()), 25);
         val var11: Int = ColorUtilsKt.getThemeColor(var26, color.green_330, color.green_330, var1.getTheme());
         if (var27 is BlockQuoteContentNode) {
            ...
            label455: {
               var217 = var1.getLinkStyle().invoke(var27) as LinkStyle;
               var171 = var27 as LinkContentNode;
               if (q.c((var27 as LinkContentNode).getTarget(), "usernameOnClick")) {
                  val var148: LinkContext = var171.getContext();
                  if (var148 != null) {
            ...
            val var29: LinkBackgroundStyle = var217.getBackgroundStyle();
            ...
            val var227: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), var217.getFont());
            var6 = var2.length();
            if (var5 != 0) {
               var21.append(' ');
            }
            ...
            val var30: ReactAsset = var217.getIcon();
            if (var30 != null) {
               appendImage$default(var2, var26, var1, var30.getUri(var26), var87, var87, var217.getLinkColor(), 0.0F, 0.0F, 192, null);
               var21.append(' ');
            }

            appendToExistingBuilder(var171.getContent(), var22, var21);
            if (var5 != 0) {
               var21.append(' ');
            }
            ...
            for (int var65 = 0; var65 < 3; var65++) {
               var24 = (BackgroundColorSpan)new Object[]{var206, var227, var153}[var65];
               if (var24 != null) {
            ...
            if (var27 !is MentionContentNode) {
               if (var27 !is ParagraphContentNode) {
                  if (var27 is SpoilerContentNode) {
                     ...
                     val var105: Boolean = SpoilerManager.INSTANCE.isRevealed-V2PEE7g(var186);
                     ...
                     if (!var105) {
                        var142 = new ClickableSpan(TouchPriority.HIGH, null, null, null, new Function1(var186, var22) {
                                 ...
                                 while (true) {
                                    ...
                                    for (int var53 = 0; var201.hasNext(); var53++) {
                                       ...
                                       if (var103 || var77) {
                                          ...
                                          var120 = var22;
                                          appendBulletPoint(var2, var184, var22, var16);
                                          if (var1.getSingleLine()) {
                                             simulateInlineNewline(var2);
                                          }
               ...
               if (var27 as MentionContentNode is UserOrRoleMentionContentNode) {
                  ...
                  if (var207 == null) {
                     ...
                     var15 = UserId.equals-impl0(var207.unbox-impl(), var17);
                  }
                  ...
                  val var229: BackgroundSpan = makeMentionBackgroundSpan(var22, var12);
                  val var219: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  var6 = var2.length();
                  ...
                  if (var209 != null) {
                     ...
                     appendImage$default(var2, var26, var1, ReactAsset.Caret.getUri(var26), var5, var5, var219.getForegroundColor(), 0.0F, 0.0F, 192, null);
                  }
                  ...
                  for (int var37 = 0; var37 < 4; var37++) {
                     var24 = (BackgroundColorSpan)new Object[]{var154, var232, var229, var219}[var37];
                     if (var24 != null) {
                  ...
                  val var230: BackgroundSpan = makeMentionBackgroundSpan(var22, var12);
                  val var210: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  var5 = var2.length();
                  val var90: Int = getIconSize(null, var1.getBaselineHeightPx());
                  appendImage$default(var2, var26, var1, ReactAsset.Attachment.getUri(var26), var90, var90, var210.getForegroundColor(), 0.0F, 0.0F, 192, null);
                  var21.append(' ');
                  ...
                  for (int var70 = 0; var70 < 4; var70++) {
                     var24 = (BackgroundColorSpan)new Object[]{var154, var220, var230, var210}[var70];
                     if (var24 != null) {
                        var21.setSpan(var24, var5, var2.length(), 33);
                     }
                  }
                  ...
                  val var221: BackgroundSpan = makeMentionBackgroundSpan(var22, var12);
                  val var181: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  ...
                  if (var91 == 1 || var91 == 2) {
                     appendImage$default(var2, var26, var1, ReactAsset.Home.getUri(var26), var6, var6, var181.getForegroundColor(), 0.0F, 0.0F, 192, null);
                  } else if (var91 != 3) {
                     if (var91 != 4) {
                        if (var91 != 5) {
                           var21.append("#");
                        } else {
                           appendImage$default(var2, var26, var1, ReactAsset.Link.getUri(var26), var6, var6, var181.getForegroundColor(), 0.0F, 0.0F, 192, null);
                        }
                     } else {
                        appendImage$default(
                           var2, var26, var1, ReactAsset.ChannelBrowse.getUri(var26), var6, var6, var181.getForegroundColor(), 0.0F, 0.0F, 192, null
                        );
                     }
                  } else {
                     appendImage$default(
                  ...
                  for (int var72 = 0; var72 < 4; var72++) {
                     var26 = (Context)new Object[]{var154, var231, var221, var181}[var72];
                     if (var26 != null) {

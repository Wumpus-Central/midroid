...
public fun DraweeSpanStringBuilder.appendImage(
   ...
   var0.append('\u200b');
   val var13: com.facebook.drawee.controller.a = (J2.d.g().F(ImageRequestBuilder.x(Uri.parse(ReactAssetUtilsKt.getReactImageUrl(var1, var3))).a()) as PipelineDraweeControllerBuilder)
      .d();
   kotlin.jvm.internal.q.g(var13, "build(...)");
                  ...
                  if (var28 !is EmojiContentNode) {
                     ...
                     if (var28 !is LineBreakContentNode && var28 !is NewLineContentNode) {
                        if (var28 is LinkContentNode) {
                           ...
                           val var123: Boolean = kotlin.jvm.internal.q.c(var279.getShouldShowRoleDot(), java.lang.Boolean.TRUE);
                           val var242: RoleColors = RoleColorsKt.toAndroidColors(var279.getRoleColors());
                           ...
                           val var243: ReactAsset = var281.getIcon();
                           if (var243 != null) {
                              appendImage$default(var2, var27, var1, var243.getUri(var27), var6, var6, var281.getLinkColor(), 0.0F, 0.0F, 192, null);
                              var22.append(' ');
                           }
                           ...
                           label729: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    label703: {
                                       var231 = makeMentionBackgroundSpan(var1, var6);
                                       if (var100 && !var16) {
                                          val var151: Int;
                                          if (var267 != null) {
                                          ...
                                          if (var151 != null) {
                                             ...
                                             var152 = new EnhancedRoleColorsSpan(kotlin.collections.i.Q0(var153));
                                             break label703;
                                          }
                                       }
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var15, var1.getSingleLine(), var27, var6, var115, var267);
                                    var22.append(toSpannable$default(var276.getContent(), var1, null, false, 6, null));

                                    for (int var44 = 0; var44 < 4; var44++) {
                                       var27 = (Context)new Object[]{var184, var214, var231, var152}[var44];
                                       if (var27 != null) {
                                    ...
                                    appendImage$default(
                                       var2, var27, var1, ReactAsset.Attachment.getUri(var27), var7, var7, var212.getForegroundColor(), 0.0F, 0.0F, 192, null
                                    );
                                    var22.append(' ');
                                    ...
                                    for (int var77 = 0; var77 < 4; var77++) {
                                       var27 = (Context)new Object[]{var184, var229, var148, var212}[var77];
                                       if (var27 != null) {
                                    ...
                                    for (int var38 = 0; var38 < 4; var38++) {
                                       var27 = (Context)new Object[]{var184, var147, var228, var211}[var38];
                                       if (var27 != null) {
                                          var126.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                 ...
                                 if (var28 !is ParagraphContentNode) {
                                          ...
                                          if (var15) {
                                             ...
                                             if (var28 !is LHeadingContentNode) {
                                                ...
                                                if (var28 is BulletListContentNode) {
                                                   ...
                                                   val var240: java.util.Iterator = var217.getItems().iterator();
                                                   ...
                                                   for (int var59 = 0; var240.hasNext(); var59++) {
                                                      ...
                                                      for (int var111 = 0; var271.hasNext(); var111++) {
                                                         ...
                                                         if (var15 || var113 != 0) {
                                                            ...
                                                            var21 = var173;
                                                            appendBulletPoint(var2, var261, var173, var122);
                                                            if (var1.getSingleLine()) {
                                                               simulateInlineNewline(var2);
                                                            }
                                                   ...
                                                   if (var28 is StrongContentNode) {
                                                      ...
                                                      if (var28 is TextContentNode) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            val var241: VerticalPaddingSpan = new VerticalPaddingSpan(SizeUtilsKt.getDpToPx(4));
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var66 = 0; var66 < 5; var66++) {
                                                                  var27 = (Context)new Object[]{var241, var219, var199, var278, var280}[var66];
                                                                  if (var27 != null) {
                                    ...
                                    while (true) {
                                       ...
                                       var21 = (RenderContext)new Object[]{var156, var215, var232}[var7];
                                       if (var21 != null) {

...
private fun DraweeSpanStringBuilder.appendBulletPoint(content: List<ContentNode>, rc: RenderContext, isOrderedList: Boolean) {
   ...
   val var15: Standard = new Standard(SizeUtilsKt.getDpToPx(var5 * 16));
   val var8: Int = SizeUtilsKt.getDpToPx(2);
   val var14: VerticalPaddingSpan = new VerticalPaddingSpan(var8);
   if (var3) {
      ...
      val var27: BulletSpan = new BulletSpan(var6, var7, false, var18, 0.0F, var26, 20, null);
      SpannableStringBuilderExtensionsKt.ensureNewline(var0, new AbsoluteSizeSpan(var8));
      var5 = var0.length();
      appendToExistingBuilder(var1, var2, var0);
               ...
               if (var28 is CodeBlockContentNode) {
                  if (var1.getSingleLine()) {
                     ...
                     for (int var74 = 0; var74 < 3; var74 += var6) {
                        var23 = new Object[]{var29, var25, var24}[var74];
                        if (var23 != null) {
                  ...
                  if (var28 !is EmojiContentNode) {
                     ...
                     if (var19) {
                        ...
                        for (int var73 = 0; var73 < 5; var73++) {
                           var28 = (ContentNode)new Object[]{var23, var29, var25, var24, var273}[var73];
                           if (var28 != null) {
                     ...
                     if (var28 !is LineBreakContentNode && var28 !is NewLineContentNode) {
                        if (var28 is LinkContentNode) {
                           ...
                           var7 = var2.length();
                           maybeAddRoleDot(var2, var128, var1.getSingleLine(), var27, var10, var6, var251);
                           if (var19) {
                              var22.append(' ');
                           }
                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    val var285: UserOrRoleMentionContentNode = var28 as UserOrRoleMentionContentNode;
                                    ...
                                    val var154: UserId = var285.getUserId-wUX8bhU();
                                    ...
                                    label727: {
                                       ...
                                       if (var103 && !var20) {
                                          val var155: Int;
                                          if (var276 != null) {
                                             var155 = var276.getSecondaryColor();
                                          } else {
                                             var155 = null;
                                          }

                                          if (var155 != null) {
                                             val var157: java.util.List = CollectionsKt.q(new Integer[]{var276.getPrimaryColor(), var276.getSecondaryColor()});
                                             if (var276.getTertiaryColor() != null) {
                                                var157.add(var276.getTertiaryColor());
                                             }
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var19, var1.getSingleLine(), var27, var6, var118, var276);
                                    var22.append(toSpannable$default(var285.getContent(), var1, null, false, 6, null));
                                    ...
                                    for (int var43 = 0; var43 < 4; var43++) {
                                       var27 = (Context)new Object[]{var188, var218, var153, var239}[var43];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                    ...
                                    appendImage$default(
                                       var2, var27, var1, ReactAsset.Attachment.getUri(var27), var7, var7, var152.getForegroundColor(), 0.0F, 0.0F, 192, null
                                    );
                                    var22.append(' ');
                                    ...
                                    for (int var80 = 0; var80 < 4; var80++) {
                                       var27 = (Context)new Object[]{var188, var217, var238, var152}[var80];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var6, var2.length(), 33);
                                       }
                                    }
                                 } else if (var147 is StaticChannelMentionContentNode) {
                                    val var237: ClickableSpan = new ClickableSpan(null, -1, null, null, 0.0F, null, null, new u(var1, var28), 125, null);
                                    val var151: BackgroundSpan = makeMentionBackgroundSpan(var1, var10);
                                    val var216: ForegroundColorSpan = new ForegroundColorSpan(var11);
                                    ...
                                    if (var6 == 1 || var6 == 2) {
                                       appendImage$default(
                                          var2, var27, var1, ReactAsset.Home.getUri(var27), var9, var9, var216.getForegroundColor(), 0.0F, 0.0F, 192, null
                                       );
                                    } else if (var6 != 3) {
                                       if (var6 != 4) {
                                          if (var6 != 5) {
                                    ...
                                    for (int var40 = 0; var40 < 4; var40++) {
                                       var27 = (Context)new Object[]{var188, var237, var151, var216}[var40];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                    ...
                                    for (int var38 = 0; var38 < 3; var38++) {
                                       var25 = (RelativeSizeSpan)new Object[]{var188, var150, var215}[var38];
                                       if (var25 != null) {
                                 ...
                                 if (var28 !is ParagraphContentNode) {
                                       ...
                                       if (var28 is StrikethroughContentNode) {
                                          ...
                                          if (var19) {
                                                   ...
                                                   if (var28 is StrongContentNode) {
                                                      ...
                                                      if (var28 is TextContentNode) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            val var203: VerticalPaddingSpan = new VerticalPaddingSpan(SizeUtilsKt.getDpToPx(4));
                                                            val var250: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), DiscordFont.PrimarySemibold);
                                                            val var224: ClickableSpan = new ClickableSpan(
                                                               null, null, null, null, 0.0F, null, null, new S(var1, var28), 127, null
                                                            );
                                                            val var287: ForegroundColorSpan = new ForegroundColorSpan(ThemeManagerKt.getTheme().getTextNormal());
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var203, var250, var224, var287, var289}[var68];
                                                                  if (var27 != null) {
                                             ...
                                             if (!var1.getSingleLine()) {
                                                ...
                                                var25 = (RelativeSizeSpan)new Object[]{var242}[0];
                                                if (var25 != null) {
                                                ...
                                                if (var9 == 0) {
                                                   ...
                                                   var7 = var2.length();
                                                   var2.append("\n");
                                                   var25 = (RelativeSizeSpan)new Object[]{var244}[0];
                                                   if (var25 != null) {
                                                   ...
                                                   var7 = var2.length();
                                                   var2.append("\n\u200b");
                                                   var25 = (RelativeSizeSpan)new Object[]{var246}[0];
                                                   if (var25 != null) {
                                                      var2.setSpan(var25, var7, var2.length(), 33);
                                                   }
                                                }
                                    ...
                                    val var241: SpoilerSpan = new SpoilerSpan(var19);
                                    var6 = var2.length();
                                    appendToExistingBuilder(
                                       var191.getContent(),
                                       RenderContext.copy$default(
                                    ...
                                    while (true) {
                                       ...
                                       var21 = (RenderContext)new Object[]{var160, var220, var241}[var7];
                                       if (var21 != null) {

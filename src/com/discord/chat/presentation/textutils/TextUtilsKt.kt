...
private fun DraweeSpanStringBuilder.appendBulletPoint(content: List<ContentNode>, rc: RenderContext, isOrderedList: Boolean) {
   ...
   if (var3) {
      ...
      val var27: BulletSpan = new BulletSpan(var7, var4, false, var6, 0.0F, var26, 20, null);
      SpannableStringBuilderExtensionsKt.ensureNewline(var0, new AbsoluteSizeSpan(var5));
      var5 = var0.length();
      appendToExistingBuilder(var1, var2, var0);
                  ...
                  if (var28 !is EmojiContentNode) {
                     ...
                     if (var28 !is LineBreakContentNode && var28 !is NewLineContentNode) {
                        if (var28 is LinkContentNode) {
                           ...
                           val var128: Boolean = var286.getShouldShowRoleDot() == java.lang.Boolean.TRUE;
                           ...
                           var7 = var2.length();
                           maybeAddRoleDot(var2, var128, var1.getSingleLine(), var27, var10, var6, var249);
                           if (var19) {
                              var22.append(' ');
                           }
                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var19, var1.getSingleLine(), var27, var6, var118, var283);
                                    ...
                                    for (int var43 = 0; var43 < 4; var43++) {
                                       var27 = (Context)new Object[]{var188, var216, var153, var237}[var43];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                 } else if (var147 is AttachmentLinkContentNode) {
                                    val var236: ClickableSpan = new ClickableSpan(
                                    ...
                                    for (int var80 = 0; var80 < 4; var80++) {
                                       var27 = (Context)new Object[]{var188, var236, var152, var215}[var80];
                                       if (var27 != null) {
                                    ...
                                    for (int var38 = 0; var38 < 3; var38++) {
                                       var25 = (DiscordFontSpan)new Object[]{var188, var213, var150}[var38];
                                       if (var25 != null) {
                                    ...
                                    for (int var36 = 0; var36 < 3; var36++) {
                                       var27 = (Context)new Object[]{var189, var230, var212}[var36];
                                       if (var27 != null) {
                                 ...
                                 if (var28 !is ParagraphContentNode) {
                                                   ...
                                                   for (int var61 = 0; var247.hasNext(); var61++) {
                                                      ...
                                                      for (int var114 = 0; var278.hasNext(); var114++) {
                                                         ...
                                                         if (var127 || var116 != 0) {
                                                            ...
                                                            var21 = var177;
                                                            appendBulletPoint(var2, var268, var177, var19);
                                                            if (var1.getSingleLine()) {
                                                               simulateInlineNewline(var2);
                                                            }
                                                   ...
                                                   if (var28 is StrongContentNode) {
                                                      ...
                                                      if (var28 is TextContentNode) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            val var285: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), DiscordFont.PrimarySemibold);
                                                            val var248: ClickableSpan = new ClickableSpan(
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var201, var285, var248, var222, var287}[var68];
                                                                  if (var27 != null) {
                                    ...
                                    val var239: SpoilerSpan = new SpoilerSpan(var19);
                                    var6 = var2.length();
                                    appendToExistingBuilder(
                                       var190.getContent(),
                                       RenderContext.copy$default(
                                    ...
                                    while (true) {
                                       ...
                                       var21 = (RenderContext)new Object[]{var160, var218, var239}[var7];
                                       if (var21 != null) {

                  ...
                  if (var28 !is EmojiContentNode) {
                     ...
                     if (var15) {
                        ...
                        for (int var73 = 0; var73 < 5; var73++) {
                           var28 = (ContentNode)new Object[]{var23, var25, var29, var24, var272}[var73];
                           if (var28 != null) {
                     ...
                     if (var28 !is LineBreakContentNode && var28 !is NewLineContentNode) {
                        if (var28 is LinkContentNode) {
                           ...
                           val var126: Boolean = kotlin.jvm.internal.r.c(var287.getShouldShowRoleDot(), java.lang.Boolean.TRUE);
                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                       ...
                                       if (var103 && !var16) {
                                          ...
                                          if (var155 != null) {
                                             val var157: java.util.List = kotlin.collections.i.q(
                                                new Integer[]{var284.getPrimaryColor(), var284.getSecondaryColor()}
                                             );
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var15, var1.getSingleLine(), var27, var6, var118, var284);
                                    var22.append(toSpannable$default(var239.getContent(), var1, null, false, 6, null));

                                    for (int var46 = 0; var46 < 4; var46++) {
                                       var25 = (BackgroundColorSpan)new Object[]{var188, var218, var275, var156}[var46];
                                       if (var25 != null) {
                                    ...
                                    for (int var38 = 0; var38 < 3; var38++) {
                                       var25 = (BackgroundColorSpan)new Object[]{var188, var214, var150}[var38];
                                       if (var25 != null) {
                                          var129.setSpan(var25, var7, var2.length(), 33);
                                       }
                                    }
                                    ...
                                    for (int var36 = 0; var36 < 3; var36++) {
                                       var27 = (Context)new Object[]{var231, var189, var213}[var36];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                       ...
                                       if (var28 is StrikethroughContentNode) {
                                          ...
                                          if (var15) {
                                                   ...
                                                   for (int var61 = 0; var249.hasNext(); var61++) {
                                                      ...
                                                      for (int var114 = 0; var279.hasNext(); var114++) {
                                                         ...
                                                         if (var125 || var116 != 0) {
                                                            ...
                                                            var21 = var177;
                                                            appendBulletPoint(var2, var269, var177, var15);
                                                            if (var1.getSingleLine()) {
                                                               simulateInlineNewline(var2);
                                                            }
                                                   ...
                                                   if (var28 is StrongContentNode) {
                                                      ...
                                                      if (var28 is TextContentNode) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            val var250: ClickableSpan = new ClickableSpan(
                                                               null, null, null, null, 0.0F, null, null, new S(var1, var28), 127, null
                                                            );
                                                            val var286: ForegroundColorSpan = new ForegroundColorSpan(ThemeManagerKt.getTheme().getTextNormal());
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var223, var202, var250, var286, var288}[var68];
                                                                  if (var27 != null) {
                                             ...
                                             if (!var1.getSingleLine()) {
                                                ...
                                                } else if (kotlin.text.h.I(var267.getClassName(), "fixed", false, 2, null)) {
                                                   var51 = ThemeManagerKt.getTheme().getTextDanger();
                                                } else if (kotlin.text.h.I(var267.getClassName(), "progress", false, 2, null)) {
                                                   var51 = ThemeManagerKt.getTheme().getTextWarning();
                                                } else if (kotlin.text.h.I(var267.getClassName(), "improved", false, 2, null)) {
                                                ...
                                                for (int var92 = 0; var92 < 3; var92++) {
                                                   var25 = (BackgroundColorSpan)new Object[]{var171, var195, var220}[var92];
                                                   if (var25 != null) {

                  ...
                  if (var28 !is EmojiContentNode) {
                     ...
                     if (var19) {
                        ...
                        for (int var73 = 0; var73 < 5; var73++) {
                           var28 = (ContentNode)new Object[]{var23, var24, var29, var25, var271}[var73];
                           if (var28 != null) {
                     ...
                     if (var28 !is LineBreakContentNode && var28 !is NewLineContentNode) {
                        if (var28 is LinkContentNode) {
                           ...
                           val var128: Boolean = kotlin.jvm.internal.r.c(var286.getShouldShowRoleDot(), java.lang.Boolean.TRUE);
                           val var250: RoleColors = RoleColorsKt.toAndroidColors(var286.getRoleColors());
                           ...
                           val var229: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), var288.getFont());
                           var7 = var2.length();
                           ...
                           val var251: ReactAsset = var288.getIcon();
                           if (var251 != null) {
                              appendImage$default(var2, var27, var1, var251.getUri(var27), var6, var6, var288.getLinkColor(), 0.0F, 0.0F, 192, null);
                              var22.append(' ');
                           }
                           ...
                           for (int var96 = 0; var96 < 3; var96++) {
                              val var183: Any = new Object[]{var206, var229, var146}[var96];
                              if (var183 != null) {
                           ...
                           label755: {
                              ...
                              if (var28 is MentionContentNode) {
                                 ...
                                 if (var28 as MentionContentNode is UserOrRoleMentionContentNode) {
                                    ...
                                    val var238: UserOrRoleMentionContentNode = var28 as UserOrRoleMentionContentNode;
                                    val var118: Int = (var28 as UserOrRoleMentionContentNode).getRoleColor();
                                    val var274: RoleColors = RoleColorsKt.toAndroidColors((var28 as UserOrRoleMentionContentNode).getRoleColors());
                                    ...
                                    val var154: UserId = var238.getUserId-wUX8bhU();
                                    ...
                                    label727: {
                                       var283 = makeMentionBackgroundSpan(var1, var6);
                                       if (var103 && !var20) {
                                          val var155: Int;
                                          if (var274 != null) {
                                             var155 = var274.getSecondaryColor();
                                          } else {
                                             var155 = null;
                                          }
                                          ...
                                          if (var155 != null) {
                                             val var157: java.util.List = kotlin.collections.i.q(
                                                new Integer[]{var274.getPrimaryColor(), var274.getSecondaryColor()}
                                             );
                                             if (var274.getTertiaryColor() != null) {
                                                var157.add(var274.getTertiaryColor());
                                             }
                                    ...
                                    var7 = var2.length();
                                    maybeAddRoleDot(var2, var19, var1.getSingleLine(), var27, var6, var118, var274);
                                    var22.append(toSpannable$default(var238.getContent(), var1, null, false, 6, null));

                                    for (int var46 = 0; var46 < 4; var46++) {
                                       var25 = (DiscordFontSpan)new Object[]{var188, var217, var283, var156}[var46];
                                       if (var25 != null) {
                                    ...
                                    val var263: java.util.List = var273.getContent();
                                    if (var263 != null) {
                                    ...
                                    appendImage$default(
                                       var2, var27, var1, ReactAsset.Attachment.getUri(var27), var7, var7, var236.getForegroundColor(), 0.0F, 0.0F, 192, null
                                    );
                                    var22.append(' ');
                                    ...
                                    for (int var80 = 0; var80 < 4; var80++) {
                                       var27 = (Context)new Object[]{var188, var215, var152, var236}[var80];
                                       if (var27 != null) {
                                    ...
                                    val var235: BackgroundSpan = makeMentionBackgroundSpan(var1, var10);
                                    ...
                                    if (var9 == 1 || var9 == 2) {
                                       appendImage$default(
                                          var2, var27, var1, ReactAsset.Home.getUri(var27), var6, var6, var214.getForegroundColor(), 0.0F, 0.0F, 192, null
                                       );
                                    } else if (var9 != 3) {
                                       if (var9 != 4) {
                                          if (var9 != 5) {
                                    ...
                                    for (int var40 = 0; var40 < 4; var40++) {
                                       var27 = (Context)new Object[]{var188, var151, var235, var214}[var40];
                                       if (var27 != null) {
                                          var129.setSpan(var27, var7, var2.length(), 33);
                                       }
                                    }
                                    ...
                                    for (int var38 = 0; var38 < 3; var38++) {
                                       var25 = (DiscordFontSpan)new Object[]{var188, var150, var213}[var38];
                                       if (var25 != null) {
                                          var129.setSpan(var25, var7, var2.length(), 33);
                                       }
                                    }
                                 } else {
                                    val var212: BackgroundSpan = makeMentionBackgroundSpan(var1, var10);
                                    ...
                                    for (int var36 = 0; var36 < 3; var36++) {
                                       var27 = (Context)new Object[]{var189, var212, var230}[var36];
                                       if (var27 != null) {
                                 ...
                                 if (var28 !is ParagraphContentNode) {
                                       ...
                                       if (var28 is StrikethroughContentNode) {
                                          ...
                                          if (var19) {
                                                ...
                                                if (var28 is BulletListContentNode) {
                                                   ...
                                                   if (var127) {
                                                      ...
                                                      var21 = RenderContext.copy$default(
                                                         ...
                                                         0,
                                                         null,
                                                         (long)(var220.getItems().size() - 1) + var120,
                                                         false,
                                                         null,
                                                         null,
                                                         0.0F,
                                                   ...
                                                   val var248: java.util.Iterator = var220.getItems().iterator();
                                                   ...
                                                   for (int var61 = 0; var248.hasNext(); var61++) {
                                                      ...
                                                      for (int var114 = 0; var278.hasNext(); var114++) {
                                                         ...
                                                         if (var19 || var116 != 0) {
                                                            ...
                                                            var21 = var177;
                                                            appendBulletPoint(var2, var268, var177, var127);
                                                            if (var1.getSingleLine()) {
                                                               simulateInlineNewline(var2);
                                                            }
                                                   ...
                                                   if (var28 is StrongContentNode) {
                                                      ...
                                                      if (var28 is TextContentNode) {
                                                         ...
                                                         if (var28 !is GuildNameContentNode) {
                                                            ...
                                                            val var285: VerticalPaddingSpan = new VerticalPaddingSpan(SizeUtilsKt.getDpToPx(4));
                                                            val var201: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), DiscordFont.PrimarySemibold);
                                                            val var222: ClickableSpan = new ClickableSpan(
                                                               null, null, null, null, 0.0F, null, null, new S(var1, var28), 127, null
                                                            );
                                                            val var249: ForegroundColorSpan = new ForegroundColorSpan(ThemeManagerKt.getTheme().getTextNormal());
                                                            ...
                                                            if (var1.spoilerExists() && !var1.spoilerIsRevealed()) {
                                                               var51 = var2.length();
                                                               var269.invoke(var22);
                                                               var23 = (Integer)new Object[]{var285}[0];
                                                               if (var23 != null) {
                                                               ...
                                                               for (int var68 = 0; var68 < 5; var68++) {
                                                                  var27 = (Context)new Object[]{var285, var201, var222, var249, var287}[var68];
                                                                  if (var27 != null) {
                                                         ...
                                                         val var200: GuildNameContentNode = var28 as GuildNameContentNode;
                                                         ...
                                                         var22.append(var200.getContent());
                                                         var196 = var22;
                                                      }
                                                   }
                                                }
                                             ...
                                             if (!var1.getSingleLine()) {
                                                ...
                                                } else if (kotlin.text.h.I(var266.getClassName(), "fixed", false, 2, null)) {
                                                   var51 = ThemeManagerKt.getTheme().getTextDanger();
                                                } else if (kotlin.text.h.I(var266.getClassName(), "progress", false, 2, null)) {
                                                   var51 = ThemeManagerKt.getTheme().getTextWarning();
                                                } else if (kotlin.text.h.I(var266.getClassName(), "improved", false, 2, null)) {
                                                ...
                                                var10 = var2.length();
                                                val var267: java.util.List = var266.getContent();
                                                var51 = var7;
                                                val var277: RenderContext = RenderContext.copy$default(
                                                   var1,
                                                   null,
                                                   null,
                                                   null,
                                                ...
                                                var129 = var2;
                                                appendToExistingBuilder(var267, var277, var2);
                                                var25 = (DiscordFontSpan)new Object[]{var241}[0];
                                                if (var25 != null) {
                                                ...
                                                for (int var92 = 0; var92 < 3; var92++) {
                                                   var25 = (DiscordFontSpan)new Object[]{var171, var194, var219}[var92];
                                                   if (var25 != null) {
                                    ...
                                    val var218: SpoilerSpan = new SpoilerSpan(var19);
                                    var6 = var2.length();
                                    appendToExistingBuilder(
                                       var190.getContent(),
                                       RenderContext.copy$default(
                                    ...
                                    while (true) {
                                       ...
                                       var21 = (RenderContext)new Object[]{var160, var240, var218}[var7];
                                       if (var21 != null) {

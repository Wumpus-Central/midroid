...
public fun DraweeSpanStringBuilder.appendImage(
   ...
   var0.append('\u200b');
   val var10: com.facebook.drawee.controller.a = (l4.c.g().D(ImageRequestBuilder.s(Uri.parse(ReactAssetUtilsKt.getReactImageUrl(var1, var3))).a()) as PipelineDraweeControllerBuilder)
      .c();
   r.g(var10, "newDraweeControllerBuild…build())\n        .build()");
   ...
   for (int var7 = 0; var25.hasNext(); var7++) {
      ...
      if (var27 is BlockQuoteContentNode) {
         if (var1.getSingleLine()) {
            ...
            val var178: QuoteSpan = new QuoteSpan(var1.getTheme().getInteractiveMuted(), SizeUtilsKt.getDpToPx(3), SizeUtilsKt.getDpToPx(8));
            var23 = new Object[1];
            ((Object[])var23)[var5] = var178;
            var6 = var2.length();
            appendToExistingBuilder(
               (var27 as BlockQuoteContentNode).getContent(), var21.updateInsets(new Function1<RenderContext.Insets, RenderContext.Insets>(var178) {
         ...
         var177[var5] = new GGSansItalicSpan((Context)var23);
         var6 = var2.length();
            ...
            if (var27 is LinkContentNode) {
               label539: {
                  ...
                  if (r.c((var27 as LinkContentNode).getTarget(), "usernameOnClick")) {
                     val var150: LinkContext = var224.getContext();
                     if (var150 != null) {
               ...
               val var227: LinkBackgroundStyle = var176.getBackgroundStyle();
               var var79: Byte;
               ...
               val var232: DiscordFontSpan = new DiscordFontSpan(var1.getContext(), var176.getFont());
               ...
               val var30: MentionContentNode = var27 as MentionContentNode;
               if (var27 as MentionContentNode is UserOrRoleMentionContentNode) {
                  ...
                  val var105: Long = UserId.constructor-impl(1081004946872352958L);
                  if (var213 == null) {
                     var15 = false;
                  } else {
                     var15 = UserId.equals-impl0(var213.unbox-impl(), var105);
                  }
                  ...
                  val var226: BackgroundSpan = makeMentionBackgroundSpan(var21, var5);
                  if (var15) {
                     var6 = var11;
                  } else {
                     var6 = var10;
                  ...
                  val var214: ForegroundColorSpan = new ForegroundColorSpan(var6);
                  var6 = var2.length();
                  if (var94) {
                  ...
                  for (int var60 = 0; var60 < 4; var60++) {
                     var26 = (Context)new Object[]{var145, var175, var226, var214}[var60];
                     if (var26 != null) {
                        var22.setSpan(var26, var6, var2.length(), 33);
                     }
                  }
               } else if (var30 is ChannelMentionContentNode) {
                  ...
                  val var222: BackgroundSpan = makeMentionBackgroundSpan(var21, var13);
                  ...
                  val var198: java.util.List = var30.getContent();
                  if (var198 != null) {
                     appendToExistingBuilder(var198, var21, var22);
                  }

                  for (int var58 = 0; var58 < 4; var58++) {
                     var26 = (Context)new Object[]{var145, var174, var222, var225}[var58];
                     if (var26 != null) {
                        var22.setSpan(var26, var6, var2.length(), 33);
                     }
                  }
               } else if (var30 is AttachmentLinkContentNode) {
                  ...
                  val var221: BackgroundSpan = makeMentionBackgroundSpan(var21, var13);
                  val var173: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  var6 = var2.length();
                  var5 = getIconSize(null, var1.getBaselineHeightPx());
                  appendImage$default(var2, var26, var1, ReactAsset.Attachment.getUri(var26), var5, var5, var173.getForegroundColor(), 0.0F, 0.0F, 192, null);
                  var22.append(' ');
                  val var194: java.util.List = var30.getContent();
                  if (var194 != null) {
                     appendToExistingBuilder(var194, var21, var22);
                  }

                  for (int var56 = 0; var56 < 4; var56++) {
                     var26 = (Context)new Object[]{var145, var211, var221, var173}[var56];
                     if (var26 != null) {
                        var22.setSpan(var26, var6, var2.length(), 33);
                     }
                  }
               } else if (var30 is StaticChannelMentionContentNode) {
                  ...
                  val var231: BackgroundSpan = makeMentionBackgroundSpan(var21, var13);
                  val var220: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  var6 = getIconSize(null, var1.getBaselineHeightPx());
                  val var172: Array<Any> = new Object[]{var145, var29, var231, var220};
                  var5 = var2.length();
                  ...
                  if (var8 != 1) {
                     if (var8 != 2) {
                        if (var8 != 3) {
                           ...
                           appendImage$default(
                              var2, var26, var1, ReactAsset.ChannelBrowse.getUri(var26), var6, var6, var220.getForegroundColor(), 0.0F, 0.0F, 192, null
                           );
                        }
                     } else {
                        appendImage$default(
                     ...
                     appendImage$default(var2, var26, var1, ReactAsset.Home.getUri(var26), var6, var6, var220.getForegroundColor(), 0.0F, 0.0F, 192, null);
                  }
                  ...
                  if (var30 !is CommandMentionContentNode) {
                     throw new p();
                  }

                  val var171: BackgroundSpan = makeMentionBackgroundSpan(var21, var13);
                  val var146: ForegroundColorSpan = new ForegroundColorSpan(var10);
                  val var189: ClickableSpan = new ClickableSpan(null, -1, null, new Function1<View, java.lang.Boolean>(var21, var27) {
                     final ContentNode $contentNode;
                     final RenderContext $rc;
                  ...
                  val var219: GGSansBoldSpan = new GGSansBoldSpan(var1.getContext());
                  var6 = var2.length();
                  var8 = var2.length();
                  var22.append("/");
                  ...
                  for (int var53 = 0; var53 < 3; var53++) {
                     var27 = (ContentNode)new Object[]{var189, var171, var146}[var53];
                     if (var27 != null) {
               ...
               if (var27 is ParagraphContentNode) {
                  ...
                  val var188: java.lang.String = SpoilerIdentifier.Companion.forNode-2sfwrmE(var27 as SpoilerContentNode, var1.getContainerId(), var7);
                  var15 = SpoilerManager.INSTANCE.isRevealed-V2PEE7g(var188);
                     ...
                     if (var27 is StrikethroughContentNode) {
                        ...
                        if (var15) {
                              ...
                              if (var27 !is BulletListContentNode) {
                                 if (var27 is StrongContentNode) {
                                    ...
                                    for (int var48 = 0; var48 < 2; var48++) {
                                       var24 = (DiscordFontSpan)new Object[]{var128, var143}[var48];
                                       if (var24 != null) {
                           ...
                           if (!var1.getSingleLine()) {
                              ...
                              val var206: java.util.List = var205.getContent();
                              var42 = var8;
                              ...
                              var107 = var2;
                              appendToExistingBuilder(var206, var218, var2);

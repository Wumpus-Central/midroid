...
public class CallSystemMessageView  public constructor(context: Context, attrs: AttributeSet? = null) : ChatListConstraintLayout(var1, var2) {
   private final val greenIconColor: Int = ColorUtilsKt.getColorCompat(this, color.green_360)
   private final val redIconColor: Int = ColorUtilsKt.getColorCompat(this, color.red_400)
   ...
   public fun setMessage(message: Message, eventHandler: ChatEventHandler) {
      ...
      if (var1.isCallActive() == var7) {
         ...
         ac.f.d(
            ...
            null,
            null,
            new Function2<CoroutineScope, Continuation, Object>(this, var14, var1, null) {
               ...
               public final Object invokeSuspend(Object var1) {
                  ...
                  if (this.label != 0) {
                     ...
                     val var5: Lifecycle.State = Lifecycle.State.s;
                     var1 = new Function2<CoroutineScope, Continuation, Object>(this.$start, this.this$0, this.$message, null) {
                        final Message $message;
                        final long $start;
                        int label;
                        final CallSystemMessageView this$0;
                        ...
                        public final Object invokeSuspend(Object var1) {
                           ...
                           if (this.label != 0) {
                              ...
                              kotlin.c.b(var1);
                              var1 = Duration.e;
                              val var6: Flow = dc.e.r(
                                 new Flow(IntervalFlowKt.intervalFlow-QTBD994(kotlin.time.b.s(1, Yb.b.t), Duration.e.c()), this.$start) {
                                                ...
                                                public final Object emit(Object var1, @NotNull Continuation var2x) {
                                                   ...
                                                   if (((<unrepresentable>)var9).label != 0) {
                                                      ...
                                                      val var8: java.lang.Comparable = kotlin.ranges.e.g(
                                                         Duration.m(kotlin.time.b.t(System.currentTimeMillis() - this.$start$inlined, Yb.b.s)),
                                                         Duration.m(Duration.e.c())
                                                      );
                     ...
                     this.label = 1;
                     if (CoroutineViewUtilsKt.repeatOnLifecycleOwner(var4, var5, var1, this) === var3) {
                        return var3;
                     }
                  }
      ...
      if (var17 == null) {
         var15 = CollectionsKt.k();
      }

      val var18: ArrayList = new ArrayList(CollectionsKt.v(var15, 10));
      ...
      Z.o0(this, new androidx.core.view.a(this, var10) {
         ...
         public void onInitializeAccessibilityNodeInfo(View var1, AccessibilityNodeInfoCompat var2) {
            ...
            var2.S0(I18nUtilsKt.i18nFormat$default(var3, I18nMessage.A11Y_ROLE_BUTTON, null, 2, null));
         }

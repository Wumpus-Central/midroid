...
public class AutomodSystemMessageView  public constructor(context: Context, attrs: AttributeSet? = null) : ChatListConstraintLayout(var1, var2),
   ...
   init {
      ...
      var6.messageHeaderDivider.setBackgroundColor(ColorUtilsKt.getThemeColor(var1, color.message_divider_light, color.message_divider_dark));
      ...
      var6.automodMessageChannel.setBackgroundColor(ColorUtilsKt.getThemeColor(var1, R.color.brand_500, R.color.brand_600));

...
public class MessageAccessoriesAdapter(measureAndLayout: () -> Unit = new f()) : RecyclerView.Adapter {
   ...
   public open fun onBindViewHolder(holder: MessagePartViewHolder, position: Int) {
      ...
      if (var10 is EmbedMessageAccessory) {
         ...
         val var94: SpoilerAttributes = var13.getSpoilerAttributes();
         ...
         var11.bind(var8, var13, var5, var2, new z(this, var1), var95, new A(var1, var10, this), var12, var13.getPortal());
         ...
         val var132: ForumPostActionBar = var10 as ForumPostActionBar;
         val var156: ReactionsTheme = (var10 as ForumPostActionBar).getReactionsTheme();
         val var162: g = new g(this);
         val var169: h = new h(this);
         val var166: j = new j(this);
         val var170: k = new k(this);
         val var146: l = new l(this);
         val var168: m = new m(this);
         val var167: n = new n(this);
         ...
         val var148: MessageComponentsAccessory = var10 as MessageComponentsAccessory;
         ...
         var163.bind(var148, this.botComponentProvider, new s(var10, this), var76, new t(this, var1), new v(this, var10), var117);
   ...
   public open fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessagePartViewHolder {
      ...
      switch (var2) {
         ...
         case 28:
            ...
            var16 = new InviteToSpeakViewHolder(var77, new Function1(var40) {
               {
         ...
         case 40:
            ...
            val var86: ActivityInstanceEmbedView = new ActivityInstanceEmbedView(var26, null, 0, 6, null);
            ...
            var16 = new ActivityInstanceEmbedViewHolder(var86, var27);
            break;
         case 41:

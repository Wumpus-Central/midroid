...
public class MessageAccessoriesAdapter(measureAndLayout: () -> Unit = new f()) : RecyclerView.Adapter {
   ...
   public open fun onBindViewHolder(holder: MessagePartViewHolder, position: Int) {
      ...
      if (var10 is EmbedMessageAccessory) {
         ...
         val var150: h = new h(this);
         val var166: j = new j(this);
         val var171: k = new k(this);
         val var174: l = new l(this);
         val var160: m = new m(this);
         val var135: n = new n(this);
         ...
         var152.bind(var161, this.botComponentProvider, new s(var10, this), var77, new t(this, var1), new v(this, var10), var119);
         ...
         if (var125 != null) {
            var39 = var125.configure(new x(this, var1), new y(this, var10));
         } else {
            var39 = null;
         }

...
internal class MessageViewAccessibilityDelegate(message: Message, contentView: MessageContentView?, onClick: OnClickListener?, onLongClick: OnLongClickListener?)
   ...
   private fun getReferencedMessageLabel(context: Context, referencedMessage: ReferencedMessage?): CharSequence? {
      return if (var2 is LoadedReferencedMessage)
         I18nUtilsKt.i18nFormat(
            var1, I18nMessage.MOBILE_REPLYING_TO_A11Y_LABEL, new Function1<RenderContext, Unit>((var2 as LoadedReferencedMessage).getMessage().getUsername()) {
   ...
   public open fun onInitializeAccessibilityNodeInfo(host: View, info: AccessibilityNodeInfoCompat) {
      ...
      for (int var3 = 0; var3 < var4; var3++) {
         ...
         if (!var18[var3].isRevealed()) {
            ...
            kotlin.jvm.internal.r.g(var23, "host.context");
      ...
      val var20: Array<EmojiAccessibilitySpan> = var8 as EmojiAccessibilitySpan[];
      ...
      kotlin.jvm.internal.r.g(var10, "host.context");
      ...
      if (var8.isEmpty() xor true) {
         val var12: java.lang.String = kotlin.collections.h.j0(var8, ", ", null, null, 0, null, null, 62, null);
      ...
      var2.T0(var16);
      var2.i0(androidx.core.view.accessibility.AccessibilityNodeInfoCompat.a.i);
      var2.F0(15);
   }

...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var85 != null) {
         ...
         for (int var62 = 0; var121.hasNext(); var62++) {
            ...
            var86 = var86;
            val var144: ArrayList = this.accessories;
            ...
            val var145: java.lang.Boolean = var1.getShowInlineForwardButton();
            if (var145 != null) {
               var11 = var145;
            } else {
               var11 = false;
            ...
            var144.add(
               new EmbedMessageAccessory(var138, var62, var78, var6, var7, var86, var18, var76, var75, var17, var74, var108, var131, var12, var11, var71, null)
            );
   ...
   public fun setMessage(
      ...
      var20.setAccessories-MNg-vQI(var18, var13, var19, var34, var4, var5, var7);

...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var85 != null) {
         ...
         for (int var62 = 0; var121.hasNext(); var62++) {
            ...
            var145.add(
               new EmbedMessageAccessory(var144, var62, var78, var6, var7, var86, var76, var17, var75, var74, var18, var108, var131, var12, var11, var71, null)
            );
   ...
   public fun setMessage(
      ...
      var20.setAccessories-MNg-vQI(var18, var13, var34, var19, var4, var5, var7);

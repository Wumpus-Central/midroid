...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_COMPONENTS_V2)) {
         ...
         for (Object var146 : var127) {
            if (((var146 as u9.k).d() as Attachment).type() != AttachmentType.Image && ((var146 as u9.k).d() as Attachment).type() != AttachmentType.Video) {
               var89.add(var146);
            } else {
               var113.add(var146);
            }
            ...
            if (var1.getShowForwardShortcut()) {
               ...
               if (var1.getAttachments() != null) {
                  ...
                  for (Object var54 : var53) {
                     if (((var54 as u9.k).d() as Attachment).type() != AttachmentType.Image
                        && ((var54 as u9.k).d() as Attachment).type() != AttachmentType.Video) {
                        var108.add(var54);
                     } else {
                        var124.add(var54);
                     }
   ...
   public fun setMessage(
      ...
      var30.setAccessories-mFdI1tY(var17, var11, var18, var16, var4, var5, var2, var8, var7);

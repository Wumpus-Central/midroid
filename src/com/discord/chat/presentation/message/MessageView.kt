...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var85 != null) {
         ...
         for (int var62 = 0; var121.hasNext(); var62++) {
            ...
            var131.add(
               new EmbedMessageAccessory(var108, var62, var78, var6, var7, var86, var76, var18, var17, var75, var74, var144, var145, var12, var11, var71, null)
            );
   ...
   public fun setMessage(
      ...
      var18.setAccessories-MNg-vQI(var19, var13, var20, var34, var4, var5, var7);

...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_COMPONENTS_V2)) {
         ...
         for (Object var114 : var103) {
            if (((var114 as B9.k).d() as Attachment).type() != AttachmentType.Image && ((var114 as B9.k).d() as Attachment).type() != AttachmentType.Video) {
               var70.add(var114);
            } else {
               var89.add(var114);
            }
      ...
      if (var78 != null) {
         ...
         for (int var55 = 0; var111.hasNext(); var55++) {
            ...
            if (var80.getObscureOrNull() != null) {
               ...
               var116.add(new InfoLinkMessageAccessory(var122, var64, null, (java.lang.String)var79, var97, ReactAsset.Info, null));
            }
         }
      }
      ...
      if (var44 != null && var44.isEmpty() xor true && !var1.isFirstForumPostMessage() || var3 is MessageFrameMediaViewer) {
         ...
         var117.add(new ReactionsMessageAccessory(var112, var87, var11, var124, var123, var24, null, var46, var101, 64, null));
      }
   ...
   public fun setMessage(
      ...
      var31.setAccessories-mFdI1tY(var19, var12, var17, var18, var4, var5, var2, var8, var7);

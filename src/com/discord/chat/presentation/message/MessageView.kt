...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getPollData() != null && var1.getPollData().getLayoutType() != PollLayoutType.UNKNOWN) {
         ...
         val var88: PollMessageAccessory.Companion = PollMessageAccessory.Companion;
         val var102: Context = this.getContext();
         kotlin.jvm.internal.r.g(var102, "getContext(...)");
         var67.add(var88.create(var102, var1, var1.getPollData()));
      }
      ...
      if (var44 != null && var44.isEmpty() xor true && !var1.isFirstForumPostMessage() || var3 is MessageFrameMediaViewer) {
         ...
         var112.add(new ReactionsMessageAccessory(var117, var87, var11, var24, var123, var124, null, var46, var101, 64, null));
      }
   ...
   public fun setMessage(
      ...
      var18.setAccessories-mFdI1tY(var17, var12, var31, var19, var4, var5, var2, var8, var7);

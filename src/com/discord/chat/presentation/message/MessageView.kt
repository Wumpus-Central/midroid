...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_COMPONENTS_V2)) {
         ...
         for (var127 : var127) {
            if (((var127 as S8.k).d() as Attachment).type() != AttachmentType.Image && ((var127 as S8.k).d() as Attachment).type() != AttachmentType.Video) {
               var113.add(var127);
            } else {
               var89.add(var127);
            }
            ...
            if (var1.getShowForwardShortcut()) {
               ...
               if (var1.getAttachments() != null) {
                  ...
                  for (Object var142 : var53) {
                     if (((var142 as S8.k).d() as Attachment).type() != AttachmentType.Image
                        && ((var142 as S8.k).d() as Attachment).type() != AttachmentType.Video) {
                        var108.add(var142);
                     } else {
                        var124.add(var142);
                     }

...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun configureAuthor(message: Message, eventHandler: ChatEventHandler, chainPart: com.discord.chat.presentation.message.MessageView.ChainPart) {
      if (var3 != MessageView.ChainPart.START && var3 != MessageView.ChainPart.ONLY) {
         ...
         NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(var12, false, new Z(var1, var2), 1, null);
         NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(var12, false, new a0(var1, var2), 1, null);
   ...
   private fun generateMessageAccessories(
      ...
      if (var65 != null && var65.getHasContent() && var1.getType() != MessageType.CUSTOM_GIFT) {
         ...
         val var66: java.lang.String = var1.getId-3Eiw7ao();
      ...
      if (var1.getPollData() != null && var1.getPollData().getLayoutType() != PollLayoutType.UNKNOWN) {
         ...
         kotlin.jvm.internal.r.g(var88, "getContext(...)");
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_COMPONENTS_V2)) {
         ...
         for (var103 : var103) {
            if (((var103 as B9.k).d() as Attachment).type() != AttachmentType.Image && ((var103 as B9.k).d() as Attachment).type() != AttachmentType.Video) {
               var70.add(var103);
            } else {
               var89.add(var103);
            }
      ...
      if (var44 != null && var44.isEmpty() xor true && !var1.isFirstForumPostMessage() || var3 is MessageFrameMediaViewer) {
         ...
         var117.add(new ReactionsMessageAccessory(var112, var87, var11, var124, var24, var123, null, var46, var101, 64, null));
      }
   ...
   public fun setMessage(
      ...
      if (var23 != null) {
         ...
         val var16: ThreadStarterMessageHeaderView = this.getThreadStarterMessageHeaderView();
      ...
      var17.setAccessories-mFdI1tY(var18, var12, var19, var31, var4, var5, var2, var8, var7);

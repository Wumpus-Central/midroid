...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getPollData() != null && var1.getPollData().getLayoutType() != PollLayoutType.UNKNOWN) {
         ...
         var125.add(var98.create(var113, var1, var1.getPollData()));
      }
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_UIKIT_COMPONENTS)) {
         ...
         if (var60) {
            ...
            var105.add(new InfoLinkMessageAccessory(var122, var77, null, null, var81, ReactAsset.Info, null));
            var71 = var11;
         }
      } else {
         var71 = var11;
      ...
      if (var85 != null) {
         ...
         for (int var62 = 0; var123.hasNext(); var62++) {
            ...
            val var147: OnLongClickListener = generateMessageAccessories$getLongClickListener(var4, var1, var62, MediaType.Embed);
            ...
            var133.add(
               new EmbedMessageAccessory(var146, var62, var78, var6, var7, var86, var18, var76, var17, var75, var74, var140, var147, var12, var11, var71, null)
            );

...
public class MessageView  public constructor(context: Context, attrs: AttributeSet? = null)
   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getPollData() != null && var1.getPollData().getLayoutType() != PollLayoutType.UNKNOWN) {
         ...
         val var125: PollMessageAccessory.Companion = PollMessageAccessory.Companion;
         val var113: Context = this.getContext();
         kotlin.jvm.internal.q.g(var113, "getContext(...)");
         var98.add(var125.create(var113, var1, var1.getPollData()));
      }
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_UIKIT_COMPONENTS)) {
         ...
         if (var128.isEmpty() xor true && var2.getUseAttachmentGridLayout()) {
            ...
            for (mj.l var28 : var116) {
               ...
               var27.add(CreateAttachmentAccessoryKt.createAttachmentAccessory(var129, var1, var69, var6, var67, var148));
            }
            ...
            var145.add(new MediaMosaicAttachmentMessageAccessory(var103, var19, var27, var6, var12, var71, var119, var73, var11, null));
         } else {
            var80 = "getContext(...)";
         }
         ...
         for (mj.l var138 : var120) {
            val var121: Attachment = var138.d() as Attachment;
            val var68: Int = var138.c();
            val var139: Context = this.getContext();
            kotlin.jvm.internal.q.g(var139, var80);
            var104.add(CreateAttachmentAccessoryKt.createAttachmentAccessory(var121, var1, var68, var6, var7, var139));
         }
      ...
      if (var85 != null) {
         ...
         for (int var62 = 0; var123.hasNext(); var62++) {
            ...
            var86 = var86;
            val var133: ArrayList = this.accessories;
            val var146: java.lang.String = var1.getId-3Eiw7ao();
            ...
            val var76: Boolean = MessageKt.shouldShowLinkDecorations(var1);
            val var75: Boolean = var1.getShouldShowRoleDot();
            ...
            val var140: OnLongClickListener = generateMessageAccessories$getLongClickListener(var4, var1, var62, MediaType.Embed);
            ...
            var133.add(
               new EmbedMessageAccessory(var146, var62, var78, var6, var7, var86, var74, var18, var76, var75, var17, var147, var140, var12, var11, var71, null)
            );
            if (var86.getObscureOrNull() != null) {
               ...
               var141.add(new InfoLinkMessageAccessory(var134, var78, null, var89, var110, ReactAsset.Info, null));
            }
         }
      }
      ...
      if (var51 != null && var51.isEmpty() xor true && !var1.isFirstForumPostMessage() || var3 is MessageFrameMediaViewer) {
         ...
         val var124: java.lang.String = var1.getId-3Eiw7ao();
      ...
      if (var1.getForwardInfo() != null) {
         kotlin.collections.i.y(this.accessories, new r(<unrepresentable>.INSTANCE));
      }
   ...
   public fun setMessage(
      ...
      var20.setAccessories-MNg-vQI(var19, var13, var18, var34, var4, var5, var7);

   ...
   private fun generateMessageAccessories(
      ...
      if (var1.getAttachments() != null && var1.getPollData() == null && !MessageFlagKt.hasMessageFlag(var1.getFlags(), MessageFlag.IS_COMPONENTS_V2)) {
         ...
         for (Object var146 : var127) {
            if (((var146 as B9.k).d() as Attachment).type() != AttachmentType.Image && ((var146 as B9.k).d() as Attachment).type() != AttachmentType.Video) {
               var113.add(var146);
            } else {
               var89.add(var146);
            }
            ...
            if (var1.getShowForwardShortcut()) {
               ...
               if (var1.getAttachments() != null) {
                  ...
                  for (Object var54 : var53) {
                     if (((var54 as B9.k).d() as Attachment).type() != AttachmentType.Image
                        && ((var54 as B9.k).d() as Attachment).type() != AttachmentType.Video) {
                        var124.add(var54);
                     } else {
                        var108.add(var54);
                     }

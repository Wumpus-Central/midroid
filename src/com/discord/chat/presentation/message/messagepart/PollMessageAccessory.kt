         ...
         for (PollAnswer var14 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (CollectionsKt.Z(var14.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var15, var17, var14, (java.util.List)var25, var9, var6, var5, var7, var8, var12, var19, var16, var4, var10, var11, null, 32768, null
               )
            );
         }

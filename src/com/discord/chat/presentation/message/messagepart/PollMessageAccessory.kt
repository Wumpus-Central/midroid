         ...
         for (PollAnswer var19 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (CollectionsKt.X(var19.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var18, var14, var19, (java.util.List)var25, var7, var9, var6, var5, var8, var12, var16, var17, var4, var11, var10, null, 32768, null
               )
            );
         }

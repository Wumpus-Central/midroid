         ...
         for (PollAnswer var14 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (i.X(var14.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var16, var15, var14, (java.util.List)var25, var8, var9, var5, var7, var6, var12, var19, var18, var4, var11, var10, null, 32768, null
               )
            );
         }

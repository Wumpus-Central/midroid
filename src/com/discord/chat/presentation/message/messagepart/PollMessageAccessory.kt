      ...
      public fun create(context: Context, message: Message, pollData: PollData): PollMessageAccessory {
         ...
         for (PollAnswer var18 : var23) {
            ...
            if (var20 != null) {
               ...
               for (var20 : var20) {
                  if (i.U(var18.getPollMedia().getAttachmentIds(), (var20 as Attachment).getId())) {
                     var25.add(var20);
                  }
               }
            } else {
            ...
            var12.add(
               new PollAnswerAccessory(
                  var14, var17, var18, (java.util.List)var25, var5, var6, var9, var7, var8, var13, var15, var19, var4, var10, var11, null, 32768, null
               )
            );
         }

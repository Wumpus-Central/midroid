...
public data class PollMessageAccessory(channelId: ChannelId,
   ...
   public companion object {
      public fun create(context: Context, message: Message, pollData: PollData): PollMessageAccessory {
         val var14: java.lang.String = ReactAssetUtilsKt.inflateUrl(var1, var3.getMyAvatarUrl());
         val var23: java.lang.Iterable = var3.getAnswers();
         val var13: ArrayList = new ArrayList(CollectionsKt.w(var23, 10));
         ...
         for (PollAnswer var16 : var23) {
            ...
            val var7: Boolean = var3.getCanShowVoteCounts();
            ...
            val var15: java.lang.String = var3.getAnswerTapAccessibilityLabel();
            ...
            if (var25 != null) {
               ...
               while (true) {
                  ...
                  if (CollectionsKt.d0(var16.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var12.add(var22);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(var18, var19, var16, var26, var9, var5, var7, var8, var6, var14, var17, var15, var4, var10, var11, null, 32768, null)
            );
         }

         return new PollMessageAccessory(var2.getChannelId-o4g7jtM(), var2.getId-3Eiw7ao(), var14, var3, var13, null, 32, null);
      }
   }
}

         ...
         for (PollAnswer var16 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var22 : var20) {
                  if (CollectionsKt.Z(var16.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var25.add(var22);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var18, var19, var16, (java.util.List)var25, var9, var6, var5, var7, var8, var12, var14, var17, var4, var10, var11, null, 32768, null
               )
            );
         }

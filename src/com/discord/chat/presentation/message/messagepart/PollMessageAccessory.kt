   ...
   public companion object {
      public fun create(context: Context, message: Message, pollData: PollData): PollMessageAccessory {
         ...
         for (PollAnswer var18 : var23) {
            val var20: java.lang.String = var2.getId-3Eiw7ao();
            ...
            if (var25 != null) {
               ...
               while (true) {
                  ...
                  if (CollectionsKt.d0(var18.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var12.add(var22);
                  }
               }
            } else {
            ...
            var14.add(
               new PollAnswerAccessory(var20, var16, var18, var26, var5, var6, var8, var9, var7, var13, var15, var19, var4, var10, var11, null, 32768, null)
            );
         }

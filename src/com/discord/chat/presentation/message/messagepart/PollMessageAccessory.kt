         ...
         for (PollAnswer var15 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (i.V(var15.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var12.add(
               new PollAnswerAccessory(
                  var19, var17, var15, (java.util.List)var25, var8, var7, var5, var9, var6, var13, var18, var14, var4, var11, var10, null, 32768, null
               )
            );
         }

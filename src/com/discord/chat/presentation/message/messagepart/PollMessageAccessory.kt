         ...
         for (PollAnswer var16 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (CollectionsKt.X(var16.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var19, var18, var16, (java.util.List)var25, var5, var7, var8, var6, var9, var12, var14, var15, var4, var11, var10, null, 32768, null
               )
            );
         }

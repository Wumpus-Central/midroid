         ...
         for (PollAnswer var19 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var22 : var20) {
                  if (i.X(var19.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var25.add(var22);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var14, var15, var19, (java.util.List)var25, var6, var5, var9, var7, var8, var12, var17, var18, var4, var10, var11, null, 32768, null
               )
            );
         }

      ...
      public fun create(context: Context, message: Message, pollData: PollData): PollMessageAccessory {
         ...
         for (PollAnswer var14 : var23) {
            ...
            if (var20 != null) {
               ...
               for (var20 : var20) {
                  if (CollectionsKt.X(var14.getPollMedia().getAttachmentIds(), (var20 as Attachment).getId())) {
                     var25.add(var20);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var15, var18, var14, (java.util.List)var25, var7, var9, var5, var6, var8, var12, var19, var16, var4, var11, var10, null, 32768, null
               )
            );
         }

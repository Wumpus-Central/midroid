         ...
         for (PollAnswer var17 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var22 : var20) {
                  if (i.V(var17.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var25.add(var22);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var14, var16, var17, (java.util.List)var25, var9, var6, var7, var5, var8, var12, var18, var15, var4, var11, var10, null, 32768, null
               )
            );
         }

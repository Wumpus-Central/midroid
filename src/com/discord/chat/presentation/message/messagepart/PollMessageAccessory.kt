      ...
      public fun create(context: Context, message: Message, pollData: PollData): PollMessageAccessory {
         ...
         for (PollAnswer var17 : var23) {
            ...
            if (var20 != null) {
               ...
               for (var20 : var20) {
                  if (i.V(var17.getPollMedia().getAttachmentIds(), (var20 as Attachment).getId())) {
                     var25.add(var20);
                  }
               }
            } else {
            ...
            var12.add(
               new PollAnswerAccessory(
                  var19, var16, var17, (java.util.List)var25, var9, var7, var8, var6, var5, var13, var14, var18, var4, var11, var10, null, 32768, null
               )
            );
         }

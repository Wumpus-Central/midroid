         ...
         for (PollAnswer var17 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var22 : var20) {
                  if (i.X(var17.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var25.add(var22);
                  }
               }
            } else {
            ...
            var12.add(
               new PollAnswerAccessory(
                  var18, var14, var17, (java.util.List)var25, var6, var5, var8, var7, var9, var13, var19, var16, var4, var10, var11, null, 32768, null
               )
            );
         }

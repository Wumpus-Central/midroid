         ...
         for (PollAnswer var14 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var22 : var20) {
                  if (i.V(var14.getPollMedia().getAttachmentIds(), (var22 as Attachment).getId())) {
                     var25.add(var22);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var18, var19, var14, (java.util.List)var25, var5, var9, var6, var8, var7, var12, var16, var15, var4, var10, var11, null, 32768, null
               )
            );
         }

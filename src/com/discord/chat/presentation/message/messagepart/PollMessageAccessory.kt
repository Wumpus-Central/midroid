         ...
         for (PollAnswer var18 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (h.P(var18.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var13.add(
               new PollAnswerAccessory(
                  var16, var15, var18, (java.util.List)var25, var6, var5, var9, var7, var8, var12, var14, var17, var4, var10, var11, null, 32768, null
               )
            );
         }

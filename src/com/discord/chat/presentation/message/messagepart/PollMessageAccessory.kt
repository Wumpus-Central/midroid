         ...
         for (PollAnswer var18 : var23) {
            ...
            if (var20 != null) {
               ...
               for (Object var21 : var20) {
                  if (CollectionsKt.X(var18.getPollMedia().getAttachmentIds(), (var21 as Attachment).getId())) {
                     var25.add(var21);
                  }
               }
            } else {
            ...
            var12.add(
               new PollAnswerAccessory(
                  var17, var16, var18, (java.util.List)var25, var7, var5, var9, var6, var8, var13, var19, var15, var4, var10, var11, null, 32768, null
               )
            );
         }

...
public data class ReactionsMessageAccessory(messageId: MessageId,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         if (!MessageId.equals-impl0(this.messageId, var1.messageId)) {
            ...
            return r.c(this.embedIndex, var1.embedIndex);
         }
      }
   }
   ...
   public override fun hashCode(): Int {
      ...
      val var7: Int = this.reactions.hashCode();
      ...
      return (((((((var6 * 31 + var7) * 31 + var8) * 31 + var9) * 31 + var5) * 31 + var1) * 31 + var2) * 31 + var3) * 31 + var4;
   }
   ...
   public override fun toString(): String {
      ...
      var6.append("ReactionsMessageAccessory(messageId=");
      var6.append(var7);

...
public data class MessageContentAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var14: Int = Integer.hashCode(this.messageTextColor);
      val var13: Int = this.messageFont.hashCode();
      val var7: Int = Integer.hashCode(this.textSizeSp);
      val var8: Int = java.lang.Boolean.hashCode(this.boldLinkText);
   ...
   public override fun toString(): String {
      ...
      val var13: Int = this.editedLabelTextColor;

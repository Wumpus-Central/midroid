...
public data class MessageContentAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var14: Int = this.messageContent.hashCode();
      ...
      val var4: Int = java.lang.Boolean.hashCode(this.boldLinkText);
      val var5: Int = Integer.hashCode(this.constrainedWidth);
      var var3: Int = 0;
      val var1: Int;
   ...
   public override fun toString(): String {
      ...
      val var5: Int = this.bottomSpacingPx;

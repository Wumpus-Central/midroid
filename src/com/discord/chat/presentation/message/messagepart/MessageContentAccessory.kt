...
public data class MessageContentAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var4: Int = Integer.hashCode(this.bottomSpacingPx);
      val var9: Int = Integer.hashCode(this.linkColor);
      val var7: Int = Integer.hashCode(this.messageTextColor);
      val var12: Int = this.messageFont.hashCode();
      val var8: Int = Integer.hashCode(this.textSizeSp);
      val var15: Int = java.lang.Boolean.hashCode(this.boldLinkText);

...
public data class PollAnswerAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var7: Int = this.attachments.hashCode();
      ...
      val var10: Int = java.lang.Boolean.hashCode(this.hasVoted);
      val var5: Int = java.lang.Boolean.hashCode(this.isExpired);
      var var2: Int = 0;
      val var1: Int;
                                                   ...
                                                   (
                                                            (
                                                                     (
                                                                              (
                                                                                       (
                                                                                                ((((var9 * 31 + var11) * 31 + var6) * 31 + var7) * 31 + var3)
                                                                                                      * 31
                                                                                                   + var4
                                                                                             )
                                                                                             * 31
   ...
   public override fun toString(): String {
      ...
      val var8: Boolean = this.canSelectMultipleAnswers;
      ...
      val var2: Boolean = this.shouldAutoPlayGifs;
      val var13: PollStyleSet = this.styleSet;

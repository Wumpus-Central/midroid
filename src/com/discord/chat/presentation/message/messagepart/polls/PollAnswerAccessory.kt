...
public data class PollAnswerAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var4: Int = this.resources.hashCode();
      val var3: Int = this.answer.hashCode();
      val var6: Int = this.attachments.hashCode();
      ...
      val var7: Int = java.lang.Boolean.hashCode(this.hasVoted);
      val var10: Int = java.lang.Boolean.hashCode(this.isExpired);
      var var2: Int = 0;
      val var1: Int;
                                                   ...
                                                   (
                                                            (
                                                                     (
                                                                              (
                                                                                       (
                                                                                                ((((var5 * 31 + var4) * 31 + var3) * 31 + var6) * 31 + var9)
                                                                                                      * 31
                                                                                                   + var11
                                                                                             )
                                                                                             * 31
   ...
   public override fun toString(): String {
      ...
      val var12: PollAnswer = this.answer;
      val var11: java.util.List = this.attachments;
      val var8: Boolean = this.canTapAnswers;
      val var6: Boolean = this.canSelectMultipleAnswers;
      val var1: Boolean = this.canShowVoteCounts;
      val var2: Boolean = this.hasVoted;
      val var7: Boolean = this.isExpired;
      val var9: java.lang.String = this.myAvatarUrl;
      val var17: PollChatAnswerInteractionType = this.interactionType;
      val var10: java.lang.String = this.tapAccessibilityLabel;
      val var4: Boolean = this.shouldAnimateTransition;
      val var5: Boolean = this.shouldAnimateEmoji;
      val var3: Boolean = this.shouldAutoPlayGifs;
      val var15: PollStyleSet = this.styleSet;
      val var14: StringBuilder = new StringBuilder();
      var14.append("PollAnswerAccessory(messageId=");
      var14.append(var13);
      var14.append(", resources=");
      var14.append(var16);
      var14.append(", answer=");
      var14.append(var12);
      var14.append(", attachments=");
      var14.append(var11);
      ...
      var14.append(var9);
      var14.append(", interactionType=");
      var14.append(var17);
      var14.append(", tapAccessibilityLabel=");
      var14.append(var10);
      var14.append(", shouldAnimateTransition=");
      var14.append(var4);
      var14.append(", shouldAnimateEmoji=");
      var14.append(var5);
      var14.append(", shouldAutoPlayGifs=");
      var14.append(var3);
      var14.append(", styleSet=");
      var14.append(var15);
      var14.append(")");

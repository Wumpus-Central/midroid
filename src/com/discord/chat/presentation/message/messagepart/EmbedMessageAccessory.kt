...
public data class EmbedMessageAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var3: Int = java.lang.Boolean.hashCode(this.shouldShowRoleDot);
                                                   ...
                                                   (
                                                            (
                                                                     (
                                                                              (
                                                                                       (
                                                                                                ((((var11 * 31 + var13) * 31 + var9) * 31 + var12) * 31 + var7)
                                                                                                      * 31
                                                                                                   + var8
                                                                                             )
                                                                                             * 31
   ...
   public override fun toString(): String {
      ...
      val var10: Boolean = this.isShowingInlineForward;

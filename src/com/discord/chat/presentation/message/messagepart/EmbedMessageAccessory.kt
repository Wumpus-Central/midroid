...
public data class EmbedMessageAccessory(messageId: MessageId,
   ...
   public override fun hashCode(): Int {
      ...
      val var11: Int = this.embed.hashCode();
      val var6: Int = java.lang.Boolean.hashCode(this.shouldAutoPlayGifs);
      ...
      return (
               (
                        (
                                 (
                                          (
                                                   (((((((var10 * 31 + var7) * 31 + var5) * 31 + var13) * 31 + var9) * 31 + var11) * 31 + var6) * 31 + var8)
                                                         * 31
                                                      + var4
                                                )
                                                * 31

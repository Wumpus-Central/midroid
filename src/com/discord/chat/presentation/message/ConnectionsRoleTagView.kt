...
public class ConnectionsRoleTagView(context: Context, attrs: AttributeSet) : FrameLayout {
   ...
   public fun configureConnectionsRoleTag(
      ...
      kotlin.jvm.internal.q.h(var4, "connectionsRoleTag");
      kotlin.jvm.internal.q.h(var5, "eventHandler");
      var var6: ImageView = this.binding.verifiedCheckIconBackground;
      kotlin.jvm.internal.q.g(this.binding.verifiedCheckIconBackground, "verifiedCheckIconBackground");
      ColorUtilsKt.setTintColor(var6, var4.getBackgroundColor());
      var6 = this.binding.verifiedCheckIcon;
      kotlin.jvm.internal.q.g(this.binding.verifiedCheckIcon, "verifiedCheckIcon");
      ...
      if (var1 != null && var2 != null && var3 != null) {
         ...
         kotlin.jvm.internal.q.g(this.binding.connectionsRoleTagContainer, "connectionsRoleTagContainer");

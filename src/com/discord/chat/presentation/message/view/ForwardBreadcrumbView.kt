...
public class ForwardBreadcrumbView  public constructor(context: Context, attrs: AttributeSet? = null) : ConstraintLayout {
   ...
   init {
      ...
      kotlin.jvm.internal.r.g(var4.icon, "binding.icon");
      ...
      kotlin.jvm.internal.r.g(var4.label, "binding.label");
      DiscordFontUtilsKt.setDiscordFont(var7, DiscordFont.PrimaryMedium);
      var var3: TextView = var4.separator;
      kotlin.jvm.internal.r.g(var4.separator, "binding.separator");
      ...
      var3 = var4.timestamp;
      kotlin.jvm.internal.r.g(var4.timestamp, "binding.timestamp");
      ...
      kotlin.jvm.internal.r.g(var4.arrow, "binding.arrow");
   ...
   fun `configure_JjTCmh4$lambda$0`(var0: Function3, var1: ForwardInfo, var2: Long, var4: java.lang.String, var5: View) {
      kotlin.jvm.internal.r.h(var0, "$onTapForwardFooter");

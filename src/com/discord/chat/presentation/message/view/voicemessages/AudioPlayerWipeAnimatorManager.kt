...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = gh.l.b(new Function0(var1) {
      ...
      this.buttonContainerActiveDrawable$delegate = gh.l.b(<unrepresentable>.INSTANCE);
      this.scaleAnimator$delegate = gh.l.b(
      ...
      this.textColorAnimator$delegate = gh.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.buttonIconColorAnimator$delegate = gh.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.progressColorAnimator$delegate = gh.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;

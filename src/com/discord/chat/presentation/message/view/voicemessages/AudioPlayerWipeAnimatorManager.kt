...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = Q8.j.b(new D(var1));
      this.buttonContainerActiveDrawable$delegate = Q8.j.b(new E());
      this.scaleAnimator$delegate = Q8.j.b(new F(var2, this));
      this.textColorAnimator$delegate = Q8.j.b(new G(var2));
      this.buttonIconColorAnimator$delegate = Q8.j.b(new H(var2));
      this.progressColorAnimator$delegate = Q8.j.b(new I(var2));
   }

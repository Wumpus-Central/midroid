...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = Da.l.b(new D(var1));
      this.buttonContainerActiveDrawable$delegate = Da.l.b(new E());
      this.scaleAnimator$delegate = Da.l.b(new F(var2, this));
      this.textColorAnimator$delegate = Da.l.b(new G(var2));
      this.buttonIconColorAnimator$delegate = Da.l.b(new H(var2));
      this.progressColorAnimator$delegate = Da.l.b(new I(var2));
   }

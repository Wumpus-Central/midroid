...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = f8.l.b(new Function0(var1) {
      ...
      this.buttonContainerActiveDrawable$delegate = f8.l.b(<unrepresentable>.INSTANCE);
      this.scaleAnimator$delegate = f8.l.b(
      ...
      this.textColorAnimator$delegate = f8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.buttonIconColorAnimator$delegate = f8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.progressColorAnimator$delegate = f8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;

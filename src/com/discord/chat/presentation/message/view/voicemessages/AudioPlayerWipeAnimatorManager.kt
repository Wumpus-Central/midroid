...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = m8.l.a(new Function0(var1) {
      ...
      this.buttonContainerActiveDrawable$delegate = m8.l.a(<unrepresentable>.INSTANCE);
      this.scaleAnimator$delegate = m8.l.a(
      ...
      this.textColorAnimator$delegate = m8.l.a(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.buttonIconColorAnimator$delegate = m8.l.a(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.progressColorAnimator$delegate = m8.l.a(new Function0(var2) {
         final AudioPlayerViewBinding $binding;

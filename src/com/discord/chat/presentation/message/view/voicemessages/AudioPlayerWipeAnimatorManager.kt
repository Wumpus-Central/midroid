...
public class AudioPlayerWipeAnimatorManager(context: Context, binding: AudioPlayerViewBinding) {
   ...
   init {
      ...
      this.buttonContainerDefaultDrawable$delegate = j8.l.b(new Function0(var1) {
      ...
      this.buttonContainerActiveDrawable$delegate = j8.l.b(<unrepresentable>.INSTANCE);
      this.scaleAnimator$delegate = j8.l.b(
      ...
      this.textColorAnimator$delegate = j8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.buttonIconColorAnimator$delegate = j8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;
      ...
      this.progressColorAnimator$delegate = j8.l.b(new Function0(var2) {
         final AudioPlayerViewBinding $binding;

...
public class ThreadEmbedView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ConstraintLayout {
   ...
   init {
      ...
      kotlin.jvm.internal.r.g(var7.threadEmbedName, "_init_$lambda$0");
      ...
      kotlin.jvm.internal.r.g(var7.threadEmbedMessagesCount, "_init_$lambda$1");
      ...
      kotlin.jvm.internal.r.g(var7.threadEmbedMostRecentMessageName, "_init_$lambda$2");
      DiscordFontUtilsKt.setDiscordFont(var4, var5);
      SetTextSizeSpKt.setTextSizeSp(var4, 14.0F);
      ...
      kotlin.jvm.internal.r.g(var7.threadEmbedMostRecentMessageContent, "_init_$lambda$3");

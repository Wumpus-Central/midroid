...
public open class FileAttachmentView  public constructor(context: Context, attrs: AttributeSet? = null) : ConstraintLayout {
   ...
   public fun setContent(
      ...
      val var22: Paint = var25.getPaint();
      val var23: Context = this.getContext();
      kotlin.jvm.internal.q.g(var23, "getContext(...)");
      var22.setColor(ColorUtilsKt.getColorCompat(var23, 17170445));
      val var12: Int = ThemeManagerKt.getTheme().getBackgroundModifierAccent();
      kotlin.jvm.internal.q.e(var18);
      AttachmentUploadOverlayView.configureProgressView$default(var18, null, var25, null, var11, null, var12, 21, null);

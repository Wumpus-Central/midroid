...
public class MediaVideoView  public constructor(context: Context, attrs: AttributeSet? = null) : FrameLayout(var1, var2), MosaicView {
   ...
   @JvmStatic
   fun `setContent_w__JTRs$lambda$1`(var0: Boolean, var1: MediaVideoView): Unit {
      if (var0) {
         val var2: SpoilerView = var1.spoilerViewManager.getSpoilerView();
         if (var2 != null) {
            var2.makeObscureHideButtonHidden();
         }
      }
   ...
   public fun setContent(
      ...
      label56: {
         ...
         this.targetUrl = var31;
         val var45: MediaView = this.binding.mediaView;
         val var46: StringBuilder = new StringBuilder();
         var46.append("video attachment: ");
         var46.append(var4);
         val var32: MediaSource = new MediaSource(var4, var5, var8, var9, var46.toString(), MediaType.VIDEO, false, var1, var2, var3, var25, null, 2112, null);
         val var28: Int;
         if (var14) {
            var28 = 0;
         } else {
            var28 = this.thumbnailFadeDuration;
         }
      ...
      var41.configureSpoiler(var13, var35, var42, var38, null, var11, var15, var12, var10, var16, var17);
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            if (!(this.sourceUrl == var1.sourceUrl)) {
               ...
               return this.previewUrl == var1.previewUrl;
            }
         }
      }

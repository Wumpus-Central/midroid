...
public class AppMessageEmbedView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ConstraintLayout {
   ...
   public fun initView(acc: AppMessageEmbedAccessory, eventHandler: ChatEventHandler) {
      ...
      if (var13.getStaticBannerSrc() != null) {
         ...
         var3 = var32 / var3;
         val var18: MediaContainingViewResizer = MediaContainingViewResizer.INSTANCE;
         val var40: SimpleDraweeView = this.view.banner;
         kotlin.jvm.internal.q.g(this.view.banner, "banner");
         var18.resizeLayoutParams(var40, var32, (int)var3, var32, (int)var3, MediaContainingViewResizer.ResizeMode.Fill);
      } else {
      ...
      if (var24 != null && !var24.isEmpty()) {
         ...
         for (int var35 = 0; var26.hasNext(); var35++) {
            ...
            val var15: java.lang.String = var16.getLabel();
            var42 = var16.getId();
            ...
            var48.setOnClickButtonListener(new c(this, var2, var13, (java.lang.String)var42));

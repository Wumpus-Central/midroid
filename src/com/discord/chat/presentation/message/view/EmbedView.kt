...
public class EmbedView  public constructor(context: Context, attrs: AttributeSet? = null) : FrameLayout {
   ...
   private fun setAuthorOnClickListener(listener: OnClickListener?, onTapCopyText: (CharSequence) -> Unit) {
      ...
      NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(var3, false, new w(var2, this), 1, null);
   }
   ...
   private fun setDescription(rawDescription: String, description: DraweeSpanStringBuilder?, descriptionColor: Int, onTapCopyText: (CharSequence) -> Unit) {
      ...
      NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(var5, false, new z(var4, var1), 1, null);
   }
   ...
   private fun setFields(
      ...
      for (int var27 = 0; var20.hasNext(); var27++) {
         ...
         var var19: StructurableText = var22.getName();
   ...
   public fun setEmbed(
      ...
      if (EmbedUtilsKt.isInlineMedia(var1)) {
         ...
         if (var34 != null) {
            ...
            val var77: TextPaint = this.binding.title.getPaint();
         ...
         val var49: s;
         if (var36 != null) {
            var49 = new s(var13, var4, var36, var78);
         } else {
            var49 = null;
         }
         ...
         val var80: StructurableText = var1.getDescription();
         val var71: DraweeSpanStringBuilder;
         if (var80 != null) {
            val var84: Context = this.getContext();
            val var82: TextPaint = this.binding.description.getPaint();
            val var85: FontMetrics = this.binding.description.getPaint().getFontMetrics();
            kotlin.jvm.internal.q.g(var85, "getFontMetrics(...)");
            val var32: Float = TextUtilsKt.getBaselineHeightPx(var85);
            kotlin.jvm.internal.q.e(var84);
            kotlin.jvm.internal.q.e(var82);
            var71 = TextUtilsKt.toSpannable$default(var80, var84, var4, var9, var10, var11, var12, var82, new Function1(var17, var4) {
               final java.lang.String $messageId;
               final Function2 $onLinkClicked;
         ...
         if (var60 != null) {
            ...
            for (int var44 = 0; var41.hasNext(); var44++) {
               ...
               var70.setOnMediaClickListeners(new u(var15, var62, var44), var16);
            }
         } else {
            ...
            if (var42 != null) {
               ...
               this.binding.inlineMediaView.setOnMediaClickListeners(new v(var15, var42, var28, this), var16);
            }

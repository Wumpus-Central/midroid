   ...
   public fun setEmbed(
      ...
      if (EmbedUtilsKt.isInlineMedia(var1)) {
         ...
         if (var88 != null) {
            ...
            val var90: FontMetrics = this.binding.description.getPaint().getFontMetrics();
            kotlin.jvm.internal.q.g(var90, "getFontMetrics(...)");
            val var34: Float = TextUtilsKt.getBaselineHeightPx(var90);
            kotlin.jvm.internal.q.e(var80);
            kotlin.jvm.internal.q.e(var91);
            var74 = TextUtilsKt.toSpannable$default(var88, var80, var5, var10, var11, var12, var13, var91, new Function1(var18, var5) {
               final java.lang.String $messageId;
               final Function2 $onLinkClicked;

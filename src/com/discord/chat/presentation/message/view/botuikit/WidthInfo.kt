...
public data class WidthInfo(topLevelAvailableWidth: Int, topLevelMaxWidth: Int, widthReductions: Int = 0) {
   ...
   public final val isLargeWidthRenderingMode: Boolean
      public final get() {
         val var1: Boolean;
         if (this.getTopLevelWidth() > SizeUtilsKt.getDpToPx(480) && this.getAvailableWidth() >= SizeUtilsKt.getDpToPx(440)) {
            var1 = true;
         } else {
            var1 = false;
         }
   ...
   public override fun toString(): String {
      val var1: Int = this.topLevelAvailableWidth;
      val var2: Int = this.topLevelMaxWidth;
      val var3: Int = this.widthReductions;

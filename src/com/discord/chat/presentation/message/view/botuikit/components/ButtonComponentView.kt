...
public class ButtonComponentView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ConstraintLayout(var1, var2, var3),
   ...
   private fun configureEmoji(emojiView: SimpleDraweeSpanTextView, emoji: ComponentEmoji?, isLoading: Boolean) {
      if (!(var2 == this.currentEmoji) || var3 != this.currentIsLoading) {
   ...
   private fun configureLabelPadding(label: TextView, messageComponent: ButtonComponent) {
      if (this.currentLabel == var2.getLabel()) {
      ...
      if (!(var1 == this.currentComponent)) {
         ...
         if (!var8) {
            ...
            NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(
               var10, false, new com.discord.chat.presentation.message.view.botuikit.components.c(), 1, null
            );
         }

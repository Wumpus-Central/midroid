...
internal class AttachmentUploadOverlayView  public constructor(context: Context, attrs: AttributeSet? = null) : ConstraintLayout(var1, var2) {
   ...
   private fun setUploadCompleteBackgroundVisible(): ValueAnimator {
      ...
      var1.setDuration(0L);
      var1.addUpdateListener(new com.discord.chat.presentation.message.view.i(this));
      return var1;
   }
   ...
   private fun uploadCompleteCheckmarkFadeOutAnim(): AnimatorSet {
      ...
      var1.addUpdateListener(new com.discord.chat.presentation.message.view.j(this));
      val var4: ValueAnimator = new ValueAnimator();

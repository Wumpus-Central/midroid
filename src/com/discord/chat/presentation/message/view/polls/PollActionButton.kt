         ...
         if (var7 != 1) {
            if (var7 != 2) {
               if (var7 != 3) {
                  ...
                  var19.setOnClickButtonListener(new com.discord.chat.presentation.message.view.polls.f(var1, var5, var2, var4));
                  var11 = var19;
               } else {
                  ...
                  var21.setOnClickButtonListener(new com.discord.chat.presentation.message.view.polls.e(var1, var5, var2, var4));
                  var11 = var21;
               }
            } else {
               ...
               var25.setOnClickListener(new com.discord.chat.presentation.message.view.polls.d(var1, var5, var2, var4));
            ...
            var23.setOnClickListener(new com.discord.chat.presentation.message.view.polls.c(var1, var5, var2, var4));

...
public class AutoModerationNotificationEmbedView  public constructor(context: Context, attrs: AttributeSet? = null) : ConstraintLayout, SpacingProviderView {
   ...
   init {
      ...
      kotlin.jvm.internal.r.g(var9, "inflate(LayoutInflater.from(context), this)");
      this.binding = var9;
      ...
      kotlin.jvm.internal.r.g(var12, "_init_$lambda$2");
      ...
      kotlin.jvm.internal.r.g(var6, "_init_$lambda$8");
   ...
   public fun configure(moderationContext: AutoModerationContext, onTapAutoModerationActions: OnClickListener, onTapAutoModerationFeedback: OnClickListener) {
      kotlin.jvm.internal.r.h(var1, "moderationContext");
      ...
      kotlin.jvm.internal.r.g(this.binding.header, "binding.header");
      var var5: Byte = 8;
      var7.setVisibility(8);
      val var13: SimpleDraweeView = this.binding.headerIcon;
      kotlin.jvm.internal.r.g(this.binding.headerIcon, "binding.headerIcon");
      var13.setVisibility(8);
      var7 = this.binding.subtitleLeft;
      kotlin.jvm.internal.r.g(this.binding.subtitleLeft, "binding.subtitleLeft");
      var7.setVisibility(8);
      var7 = this.binding.subtitleRight;
      kotlin.jvm.internal.r.g(this.binding.subtitleRight, "binding.subtitleRight");
      var7.setVisibility(8);
      val var16: SimpleDraweeView = this.binding.subtitleLeftAvatar;
      kotlin.jvm.internal.r.g(this.binding.subtitleLeftAvatar, "binding.subtitleLeftAvatar");
      var16.setVisibility(8);
      var7 = this.binding.subtitleLeftAuthor;
      kotlin.jvm.internal.r.g(this.binding.subtitleLeftAuthor, "binding.subtitleLeftAuthor");
      var7.setVisibility(8);
      ...
      if (var6 != null) {
         ...
         kotlin.jvm.internal.r.g(this.binding.actions, "binding.actions");
         val var4: Byte;
         ...
         kotlin.jvm.internal.r.g(this.binding.subtitleDivider, "binding.subtitleDivider");
         val var11: Boolean;

...
public open class MessageContentView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : SimpleDraweeSpanTextView(
   ...
   private fun appendEditedLabel(spannableStringBuilder: SpannableStringBuilder, editedLabel: String, editedLabelTextColor: Int?) {
      ...
      val var8: QuoteSpan = kotlin.collections.m.Y(var6) as QuoteSpan;
   ...
   private fun truncate(
      ...
      if (var3 > var7 || var9) {
         ...
         if (var8) {
            ...
            var4.setSpan(new ClickableSpan(var20, var3, null, null, 0.0F, null, null, new c2(var5, var1), 124, null), var7, var4.length(), 33);
   ...
   public fun setMessageContent(
      ...
      androidx.core.view.h0.n0(this, new MessageContentView.MessageContentViewAccessibilityDelegate(this));
   }
   ...
   public class MessageContentViewAccessibilityDelegate(view: MessageContentView) : androidx.core.view.a {
      ...
      public open fun onInitializeAccessibilityNodeInfo(host: View, info: AccessibilityNodeInfoCompat) {
         ...
         // c8: aload 2
         // c9: aload 5
         // cb: invokevirtual androidx/core/view/accessibility/AccessibilityNodeInfoCompat.b1 (Ljava/lang/CharSequence;)V
         // ce: return
      }
   }
}

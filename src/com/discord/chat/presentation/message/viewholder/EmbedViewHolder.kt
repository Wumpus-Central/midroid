...
public class EmbedViewHolder(embedView: EmbedView) : MessagePartViewHolder(var1) {
   ...
   public fun bind(
      ...
      val var23: Function2 = new Function2<MessageId, LinkContentNode, Unit>(var1) {
         {
            super(
               2,
               var1,
      ...
      val var31: Function1 = new Function1<LinkContentNode, Unit>(var1) {
         {
      ...
      val var24: Function1 = new Function1<EmojiContentNode, Unit>(var1) {
         {
      ...
      val var28: Function4 = new Function4(var1) {
         {
            super(
               4,
               var1,

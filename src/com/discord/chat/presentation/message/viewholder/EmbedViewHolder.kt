...
public class EmbedViewHolder(embedView: EmbedView) : MessagePartViewHolder(var1) {
   ...
   public fun bind(
      ...
      val var11: Boolean;
      if (var22 != null && !StringsKt.i0(var22)) {
         var11 = false;
      } else {
         var11 = true;
      }
      ...
      val var32: Function2 = new Function2<MessageId, LinkContentNode, Unit>(var1) {
         {
            super(
               2,
               var1,
      ...
      val var28: Function1 = new Function1<LinkContentNode, Unit>(var1) {
         {
      ...
      val var29: Function1 = new Function1<java.lang.CharSequence, Unit>(var1) {
         {
      ...
      val var23: Function1 = new Function1<EmojiContentNode, Unit>(var1) {
         {
      ...
      val var25: Function4 = new Function4(var1) {
         {
            super(
               4,
               var1,

...
public class EmbedViewHolder(embedView: EmbedView) : MessagePartViewHolder(var1) {
   ...
   public fun bind(
      ...
      val var35: EmbedView = this.embedView;
      ...
      val var29: Function3 = new Function3(var1) {
         {
            super(3, var1, ChatEventHandler::class.java, "onLinkClicked", "onLinkClicked-u7_MRrM(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", 0);
         }
      ...
      val var31: Function2 = new Function2<MessageId, LinkContentNode, Unit>(var1) {
         {
            super(
               2,
               var1,
      ...
      val var27: Function1 = new Function1<LinkContentNode, Unit>(var1) {
         {
      ...
      val var25: Function1 = new Function1<java.lang.CharSequence, Unit>(var1) {
         {
      ...
      val var28: Function1 = new Function1<EmojiContentNode, Unit>(var1) {
         {

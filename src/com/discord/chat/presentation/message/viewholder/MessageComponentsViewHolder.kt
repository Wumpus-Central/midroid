...
public class MessageComponentsViewHolder(messageComponentsView: MessageComponentsView) : MessagePartViewHolder(var1) {
   ...
   public fun bind(
      ...
      val var14: GeneralEventHandlers = new GeneralEventHandlers(new w(var7, var15), var5);
      ...
      val var35: MarkdownTextRenderEventHandlers = new MarkdownTextRenderEventHandlers(
         new x(var7, var15),
         new Function1<LinkContentNode, Unit>(var7) {
            {
         ...
         new Function1<java.lang.String, Unit>(var7) {
            {
         ...
         new Function2<java.lang.String, java.lang.String, Unit>(var7) {
            {
         ...
         new Function1<InlineCodeContentNode, Unit>(var7) {
            {
               super(
         ...
         new Function1<EmojiContentNode, Unit>(var7) {
            {
         ...
         new Function1<SoundmojiContentNode, Unit>(var7) {
            {
      ...
      val var28: MediaItemEventHandlers = new MediaItemEventHandlers(var3, var4, var5, new Function1<java.lang.String, Unit>(var7) {
         {
      ...
      val var30: ComponentActionEventHandlers = new ComponentActionEventHandlers(new y(var7, var15), new z(var7, var15), new A(var7, var15), new B(var7, var15));
      ...
      this.messageComponentsView
         .setComponents(var1.getMessageComponents(), var2, new ComponentContext(var13, var14, var12, var35, var28, var30, var32, var9, var10, false, false));
   }
}

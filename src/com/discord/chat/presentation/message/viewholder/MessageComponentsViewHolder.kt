...
public class MessageComponentsViewHolder(messageComponentsView: MessageComponentsView, eventHandler: ChatEventHandler)
   ...
   public fun bind(
      ...
      val var28: MarkdownTextRenderEventHandlers = new MarkdownTextRenderEventHandlers(
         ...
         new Function3<java.lang.String, java.lang.String, java.lang.String, Unit>(var6) {
            {
         ...
         new Function4<java.lang.String, java.lang.String, java.lang.String, java.lang.String, Unit>(var6) {
            {
               super(
                  4,
                  var1,
         ...
         new Function1<java.lang.String, Unit>(var6) {
            {
         ...
         new Function2<java.lang.String, java.lang.String, Unit>(var6) {
            {
         ...
         new Function1<CommandMentionContentNode, Unit>(var6) {
            {
         ...
         new Function1<EmojiContentNode, Unit>(var6) {
            {
      ...
      val var25: ContentInventoryEventHandlers = new ContentInventoryEventHandlers(
         new Function3<UserId, java.lang.String, java.lang.String, Unit>(var6, this) {
            final ChatEventHandler $eventHandler;
            final MessageComponentsViewHolder this$0;

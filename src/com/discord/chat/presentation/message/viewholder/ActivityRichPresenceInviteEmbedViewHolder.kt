...
public class ActivityRichPresenceInviteEmbedViewHolder(activityRichPresenceInviteEmbedView: ActivityRichPresenceInviteEmbedView) : MessagePartViewHolder {
   ...
   public fun bind(accessory: ActivityRichPresenceInviteEmbedMessageAccessory) {
      ...
      val var6: java.lang.String = var10.getIconSrc();
      ...
      val var18: java.lang.String = var10.getPartySizeText();
      val var12: java.util.List = var10.getPartyMemberAvatarURIs();
      val var13: java.util.List = var10.getPlatformIconKeys();
      ...
      var15.setActivityRichPresenceInviteEmbed(var5, var8, var7, var6, var3, var16, var2, var18, var12, var13, var14, var4);
   }
}

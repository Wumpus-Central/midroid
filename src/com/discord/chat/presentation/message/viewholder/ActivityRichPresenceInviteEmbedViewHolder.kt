...
public class ActivityRichPresenceInviteEmbedViewHolder(activityRichPresenceInviteEmbedView: ActivityRichPresenceInviteEmbedView) : MessagePartViewHolder {
   ...
   public fun bind(accessory: ActivityRichPresenceInviteEmbedMessageAccessory) {
      ...
      val var7: java.lang.String = var9.getHeaderText();
      val var15: java.lang.String = var9.getTitle();
      ...
      val var12: java.lang.String = var9.getPartySizeText();
      val var13: java.util.List = var9.getPartyMemberAvatarURIs();
      val var14: java.util.List = var9.getPlatformIconKeys();
      ...
      var8.setActivityRichPresenceInviteEmbed(var7, var15, var6, var5, var3, var17, var2, var12, var13, var14, var18, var4);
   }
}

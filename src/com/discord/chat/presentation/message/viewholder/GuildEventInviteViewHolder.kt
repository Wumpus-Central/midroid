...
public class GuildEventInviteViewHolder(guildEventInviteView: GuildEventInviteView,
   ...
   public fun bind(inviteAccessory: GuildEventInviteMessageAccessory) {
      ...
      var17.setCreatorAvatar(var16.getCreatorAvatar());
      var17.setBadge(var16.getBadgeIcon(), var16.getBadgeCount());
      var17.setTitle(var16.getTitleText(), var16.getTitleColor());
      ...
      var17.setGuild(var16.getGuildName(), var16.getGuildIcon());
      var17.setChannel(var16.getChannelIcon(), var16.getChannelName());
      ...
      var17.setSecondaryButton(var16.getSecondaryActionIcon(), new p(this, var1));
   }
}

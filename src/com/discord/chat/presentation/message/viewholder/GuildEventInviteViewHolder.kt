...
public class GuildEventInviteViewHolder(guildEventInviteView: GuildEventInviteView,
   ...
   public fun bind(inviteAccessory: GuildEventInviteMessageAccessory) {
      ...
      var9.setCreatorAvatar(var16.getCreatorAvatar());
      var9.setBadge(var16.getBadgeIcon(), var16.getBadgeCount());
      var9.setTitle(var16.getTitleText(), var16.getTitleColor());
      ...
      var9.setGuild(var16.getGuildName(), var16.getGuildIcon());
      var9.setChannel(var16.getChannelIcon(), var16.getChannelName());
      ...
      var9.setSecondaryButton(var16.getSecondaryActionIcon(), new p(this, var1));
   }
}

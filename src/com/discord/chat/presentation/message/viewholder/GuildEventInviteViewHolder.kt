...
public class GuildEventInviteViewHolder(guildEventInviteView: GuildEventInviteView,
   ...
   public fun bind(inviteAccessory: GuildEventInviteMessageAccessory) {
      ...
      var22.setCreatorAvatar(var20.getCreatorAvatar());
      var22.setBadge(var20.getBadgeIcon(), var20.getBadgeCount());
      var22.setTitle(var20.getTitleText(), var20.getTitleColor());
      ...
      var22.setGuild(var20.getGuildName(), var20.getGuildIcon());
      var22.setChannel(var20.getChannelIcon(), var20.getChannelName());
      ...
      var22.setSecondaryButton(var20.getSecondaryActionIcon(), new n(this, var1));
   }
}

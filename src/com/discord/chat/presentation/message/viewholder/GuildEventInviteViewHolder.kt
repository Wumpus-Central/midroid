...
public class GuildEventInviteViewHolder(guildEventInviteView: GuildEventInviteView,
   ...
   public fun bind(inviteAccessory: GuildEventInviteMessageAccessory) {
      ...
      var18.setCreatorAvatar(var21.getCreatorAvatar());
      var18.setBadge(var21.getBadgeIcon(), var21.getBadgeCount());
      var18.setTitle(var21.getTitleText(), var21.getTitleColor());
      ...
      var18.setGuild(var21.getGuildName(), var21.getGuildIcon());
      var18.setChannel(var21.getChannelIcon(), var21.getChannelName());
      ...
      var18.setSecondaryButton(var21.getSecondaryActionIcon(), new n(this, var1));
   }
}

...
public class GuildEventInviteViewHolder(guildEventInviteView: GuildEventInviteView,
   ...
   public fun bind(inviteAccessory: GuildEventInviteMessageAccessory) {
      ...
      var23.setCreatorAvatar(var6.getCreatorAvatar());
      var23.setBadge(var6.getBadgeIcon(), var6.getBadgeCount());
      var23.setTitle(var6.getTitleText(), var6.getTitleColor());
      ...
      var23.setGuild(var6.getGuildName(), var6.getGuildIcon());
      var23.setChannel(var6.getChannelIcon(), var6.getChannelName());
      ...
      var23.setSecondaryButton(var6.getSecondaryActionIcon(), new q(this, var1));
   }
}

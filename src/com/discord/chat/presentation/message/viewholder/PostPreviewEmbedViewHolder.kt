...
public class PostPreviewEmbedViewHolder(postPreviewEmbedView: PostPreviewEmbedView) : MessagePartViewHolder {
   ...
   public fun bind(postPreviewEmbed: PostPreviewEmbed, onTapPostPreviewEmbed: (GuildId, ChannelId, ChannelId, MessageId) -> Unit, spoilerConfig: SpoilerConfig?) {
      ...
      val var18: PostPreviewEmbedView = this.postPreviewEmbedView;
      val var9: java.lang.String = var1.getTitle();
      val var11: java.lang.String = var1.getSubtitle();
      val var16: java.lang.String = var1.getCtaText();
      val var4: Int = var1.getCtaButtonColor();
      val var12: java.lang.String = var1.getCoverImage();
      val var13: java.lang.String = var1.getBlurredCoverImage();
      ...
      var18.setPostPreviewEmbed-4itWklQ(var9, var11, var16, var4, var10, var15, var12, var13, var17, var14, var21, var8, var5, var6, var7, var3);
   }
}

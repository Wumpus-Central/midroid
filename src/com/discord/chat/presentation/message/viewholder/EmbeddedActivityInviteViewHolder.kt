...
public class EmbeddedActivityInviteViewHolder(embeddedActivityInviteView: EmbeddedActivityInviteView, eventHandler: ChatEventHandler) : MessagePartViewHolder {
   ...
   public fun bind(embeddedActivityInviteAccessory: EmbeddedActivityInviteMessageAccessory) {
      ...
      var13.setTitleText(var12.getTitleText());
      var13.setHeaderText(var12.getHeaderText());
      ...
      var13.setNoParticipantsText(var12.getNoParticipantsText());
      var13.setLaunchButton(var12.getAcceptLabelText(), var12.getAcceptLabelBackgroundColor(), var12.getCtaEnabled());
      var13.setAvatarUris(var12.getParticipantAvatarUris());
      var13.setOnLaunchButtonClickListener(new j(this, var1));
   }
}

...
public class EmbeddedActivityInviteViewHolder(embeddedActivityInviteView: EmbeddedActivityInviteView, eventHandler: ChatEventHandler) : MessagePartViewHolder {
   ...
   public fun bind(embeddedActivityInviteAccessory: EmbeddedActivityInviteMessageAccessory) {
      ...
      var2.setTitleText(var9.getTitleText());
      var2.setHeaderText(var9.getHeaderText());
      var2.setSubtitleText-oCLp7l4(
      ...
      var2.setNoParticipantsText(var9.getNoParticipantsText());
      var2.setLaunchButton(var9.getAcceptLabelText(), var9.getAcceptLabelBackgroundColor(), var9.getCtaEnabled());
      var2.setAvatarUris(var9.getParticipantAvatarUris());
      var2.setOnLaunchButtonClickListener(new k(this, var1));
   }
}

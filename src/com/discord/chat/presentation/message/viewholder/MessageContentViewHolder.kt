...
public class MessageContentViewHolder(messageContentView: MessageContentView) : MessagePartViewHolder(var1) {
   ...
   @JvmStatic
   fun `bind$lambda$1`(var0: Function1, var1: MessageContentViewHolder): Unit {
      var0.invoke(var1);
      return Unit.a;
   }
   ...
   public fun bind(
      ...
      if (!(this.lastMessageContent == var25)) {
         ...
         val var32: TextPaint = this.messageContentView.getPaint();
         ...
         this.messageContentView
            .setMessageContent-AeCz66Y(
               ...
               var1.getTruncation(),
               var1.getTheme(),
               TextUtilsKt.getBaselineHeightForFontSizePx(var32, var27.getScaledSpToPx(16, var26))
            );
      }
   }
}

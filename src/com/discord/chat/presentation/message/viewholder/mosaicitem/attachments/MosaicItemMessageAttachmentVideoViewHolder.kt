...
public class MosaicItemMessageAttachmentVideoViewHolder(view: MediaVideoView) : MediaVideoViewHolder(var1) {
   ...
   public fun bindAttachment(
      ...
      val var29: UploadItemProps = var2.getUploadItemProps(new Function2<java.lang.String, java.lang.String, Unit>(var1) {
         {
   ...
   public fun bindGalleryItem(
      ...
      val var22: Companion = SpoilerAttributes.Companion;
      val var23: StringBuilder = new StringBuilder();
      var23.append("MediaGalleryDisplayComponent(");
      var23.append(var2);
      ...
      val var16: Boolean = var3.isObscureAwaitingScan();
      val var20: Boolean = var3.getObscureHideControls();

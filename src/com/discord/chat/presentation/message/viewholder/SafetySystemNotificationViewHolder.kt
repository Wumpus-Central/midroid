...
public class SafetySystemNotificationViewHolder(safetySystemNotificationView: SafetySystemNotificationView) : MessagePartViewHolder(var1) {
   ...
   public fun bind(safetySystemNotificationEmbed: SafetySystemNotificationEmbed, onTapCta: (String, String) -> Unit) {
      val var11: SafetySystemNotificationView = this.safetySystemNotificationView;
      val var12: java.lang.String = var1.getTitleText();
      val var10: java.lang.String = var1.getTitleIcon();
      val var14: java.lang.String = var1.getSubtitleText();
      val var13: java.lang.String = var1.getDescriptionText();
      ...
      var11.setContent(var12, var10, var14, var13, var3, var4, var5, var6, var7, var8, var1.getFooterTheme(), var2);
   }
}

...
public class ClanTagChipletView(context: Context, attrs: AttributeSet) : FrameLayout {
   ...
   init {
      ...
      kotlin.jvm.internal.r.g(var3.container, "binding.container");
   ...
   public fun configure(tagContent: String, badgeUrl: String?, guildId: GuildId, eventHandler: ChatEventHandler?, scale: Float = ...) {
      kotlin.jvm.internal.r.h(var1, "tagContent");
      ...
      if (var2 != null) {
         ...
         kotlin.jvm.internal.r.g(this.binding.badge, "binding.badge");
      ...
      kotlin.jvm.internal.r.g(this.binding.tag, "binding.tag");
      SetTextSizeSpKt.setTextSizeSp(var10, 12.0F * var6);
      if (var5 != null) {
         val var11: LinearLayout = this.binding.container;
         kotlin.jvm.internal.r.g(this.binding.container, "configure_D0ylKIU$lambda$3");

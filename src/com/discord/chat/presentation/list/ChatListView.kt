...
public class ChatListView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RecyclerView {
   ...
   private fun configureRecycledViewPoolSizes() {
      var var4: Pair = g9.s.a(RegularMessageDelegate.class, 50);
      val var3: Int = 25;

      for (Entry var7 : h9.q.l(new Pair[]{var4, g9.s.a(SystemMessageDelegate.class, var3), g9.s.a(SeparatorDelegate.class, var3)}).entrySet()) {
   ...
   private fun sync() {
      ...
      this.updateSubscriptionJob = Pa.f.d(CoroutineViewUtilsKt.attachedScope(this, true), null, null, new Function2(this, null) {
         int label;
         final ChatListView this$0;

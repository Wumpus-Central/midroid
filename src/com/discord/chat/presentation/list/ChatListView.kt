...
public class ChatListView(context: Context, componentProvider: ComponentProvider) : RecyclerView(var1) {
   ...
   private final var chatListAdapter: ChannelChatListAdapter

   public final var onFirstDrawDoneCallback: () -> Unit
      internal final set(value) {
         this.onFirstDrawDoneCallback = var1;
         this.chatListAdapter.setOnFirstDraw(var1);
      }
   ...
   init {
      ...
      this.chatListAdapter = new ChannelChatListAdapter(new com.discord.chat.presentation.list.i(this), new m(this), new n(this), null, 8, null);
      this.onFirstDrawDoneCallback = new o();
      this.scroller = new Scroller(this);
      val var3: TransitionResilientLinearLayoutManager = new TransitionResilientLinearLayoutManager(var1, 0, false, null, 14, null);
      this.linearLayoutManager = var3;
      ...
      this.scrollStateObserver = new ChatScrollStateObserver(new p(this));
      this.isFirstLayout = true;
      this.setRecycledViewPool(SharedRecycledViewPools.INSTANCE.getChatListViewPool());
      ...
      new ChatListItemTouchHelper(new SwipeHelper(var1, new q(this), new r(this))).attachToRecyclerView(this);
   ...
   @JvmStatic
   fun `_init_$lambda$6`(var0: ChatListView): Unit {
   ...
   private fun forceRecreateAllViewHolders() {
      ...
      val var1: SharedRecycledViewPools = SharedRecycledViewPools.INSTANCE;
      SharedRecycledViewPools.INSTANCE.getChatListViewPool().forceClear();
      var1.getAccessoriesViewPool().forceClear();
      this.chatListAdapter = new ChannelChatListAdapter(new s(this), new t(this), new u(this), this.onFirstDrawDoneCallback);
   ...
   private fun measureAndLayout() {
      try {
         ...
         var4.append("\n Recycler State: ");
         var4.append(var3);
         CrashReporting.addBreadcrumb$default(var7, var4.toString(), null, null, null, 14, null);
         throw var6;
      }
   }
         ...
         ChannelChatListAdapter.setItems$default(
            ...
            new Function1<java.lang.Boolean, Unit>(var4, this, var1) {
               ...
               public final void invoke(boolean var1) {
                  ...
                  var5.element = var2;
                  if (this.$update.getAction() is Clear) {
            ...
            new Function0<Unit>(var1, this, var4) {
               ...
               public final void invoke() {
                  ...
                  if (var9 is ScrollTo) {
                     val var10: ChatListItem = CollectionsKt.q0(this.$update.getItems(), (this.$update.getAction() as ScrollTo).getPosition()) as ChatListItem;
                     ...
                     this.this$0
                        .scrollToPosition(
                           (this.$update.getAction() as ScrollTo).getPosition(),
                           var9,
                           (this.$update.getAction() as ScrollTo).getAnimate(),
                           (this.$update.getAction() as ScrollTo).getHighlight()
                        );
                  } else {
                     if (var9 is StickToBottomIfAtBottom) {
                        if (this.$wasAtBottom.element) {
                           this.this$0.scrollToPosition(0, Scroller.TargetAlignment.Anywhere.INSTANCE, false, false);
                           return;
                        }
                     } else if (var9 !is Clear) {
                        if (var9 is Noop) {
   ...
   @JvmStatic
   fun `onFirstDrawDoneCallback$lambda$3`(): Unit {
      return Unit.a;
   }
   ...
   @JvmStatic
   fun `scrollStateObserver$lambda$4`(var0: ChatListView, var1: ScrollState): Unit {
      if (var0.eventHandler != null) {
         var var2: ChatEventHandler = var0.eventHandler;
         if (var0.eventHandler == null) {
            Intrinsics.throwUninitializedPropertyAccessException("eventHandler");
   ...
   @JvmStatic
   fun `scrollToPosition$lambda$10`(var0: ChatListView, var1: Boolean, var2: Int): Unit {
   ...
   @JvmStatic
   fun `scrollToPosition$lambda$11`(var0: ChatListView): Unit {
      var0.measureAndLayout();
      return Unit.a;
   }

   @JvmStatic
   fun `scrollToPosition$lambda$9`(var0: ChatListView): Unit {
   ...
   private fun sync() {
      ...
      this.updateSubscriptionJob = gu.g.d(
         CoroutineViewUtilsKt.attachedScope(this, true), null, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(this, null) {
            int label;
            final ChatListView this$0;
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label != 0) {
                  ...
                  val var8: FlowCollector = new FlowCollector(var5, this.this$0) {
                     ...
                     public final Object emit(ChatListUpdate var1, Continuation<? super Unit> var2x) {
   ...
   public fun scrollToPosition(position: Int, targetAlignment: TargetAlignment, animate: Boolean, highlight: Boolean) {
      this.scroller.scrollToPosition(var1, var2, var3, new com.discord.chat.presentation.list.j(this), new k(this, var4, var1), new l(this));
   }

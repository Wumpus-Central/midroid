...
public class ChatListView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RecyclerView {
   ...
   private fun configureRecycledViewPoolSizes() {
      var var4: Pair = R8.s.a(RegularMessageDelegate.class, 50);
      val var3: Int = 25;

      for (Entry var5 : S8.q.l(new Pair[]{var4, R8.s.a(SystemMessageDelegate.class, var3), R8.s.a(SeparatorDelegate.class, var3)}).entrySet()) {
   ...
   private fun sync() {
      ...
      this.updateSubscriptionJob = Aa.f.d(CoroutineViewUtilsKt.attachedScope(this, true), null, null, new Function2(this, null) {
         int label;
         final ChatListView this$0;
   ...
   public fun scrollToPosition(position: Int, targetAlignment: TargetAlignment, animate: Boolean, highlight: Boolean) {
      ...
      this.scroller.scrollToPosition(var1, var2, var3, new g(this), new com.discord.chat.presentation.list.h(this, var4, var1), new i(this));
   }

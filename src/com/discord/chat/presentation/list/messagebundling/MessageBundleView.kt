...
public class MessageBundleView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout {
   ...
   public fun setBundle(
      ...
      while (true) {
         if (!var12.hasNext()) {
            ...
            val var25: java.util.Collection = i.y0(var11, var29);
   ...
   public data class MessageBundle(messageFrame: MessageBundleHeader? = null,
      ...
      fun {
         ...
         $childSerializers = new KSerializer[]{null, new gn.f(MessageRow.$serializer.INSTANCE), null, new gn.f(var0), null};
      }
      ...
      public object `$serializer` : g0 {
         ...
         public open fun childSerializers(): Array<KSerializer<*>> {
            ...
            return new KSerializer[]{en.a.u(MessageFrameFeedHeaderView.MessageBundleHeader.$serializer.INSTANCE), var1[1], en.a.u(f0.a), var1[3], en.a.u(b2.a)};
         }

...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   init {
      ...
      kotlin.jvm.internal.r.h(var2, "onStart");
      kotlin.jvm.internal.r.h(var3, "onEnd");
      super();
      this.context = var1;
      this.onStart = var2;
      this.onEnd = var3;
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var var6: Float = Math.abs(var19.getTranslationX());
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         val var10: Float = var3 - var8;
         var var4: Float = var3 + var6;
         var var12: Float = var3 + var6 - var13;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.lineTo(var3, var11);
         var48.lineTo(var3, var9 + var8);
         var7 = 2;
         var48.addArc(var10 - var8, var9, var3, var9 + (float)2 * var8, 0.0F, -90.0F);
         var48.lineTo(var12, var9);
         val var38: Float = var13 * 0.55F + var12;
         var48.cubicTo(var13 * 0.55F + var12, var9, var4, var15 + (float)var16 * 0.55F, var4, var15);
         var48.lineTo(var4, var14);
         var48.cubicTo(var4, var14 - (float)var16 * 0.55F, var38, var11, var12, var11);
         var1.save();
         var1.clipPath(var48);
         var1.drawRect(var10, var15, var4, var14, var21);
         var1.restore();
         var1.save();
         var48.reset();
         var12 = var11 - var8;
         var48.addCircle(var10, var11 - var8, var8, Direction.CW);
         ...
         var1.drawRect(var10, var12, var3, var11, var21);
         var1.restore();
         ...
         var1.save();
         var1.clipRect(var3, 0.0F, var4, (float)var1.getHeight());
         var1.translate(var3 + var6 - var8 + var8, (float)var17 + var8);
   ...
   public override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: ViewHolder): Int {
      kotlin.jvm.internal.r.h(var1, "recyclerView");
      kotlin.jvm.internal.r.h(var2, "viewHolder");
   ...
   public override fun onChildDraw(
      ...
      kotlin.jvm.internal.r.h(var3, "viewHolder");
   ...
   public override fun onMove(recyclerView: RecyclerView, viewHolder: ViewHolder, target: ViewHolder): Boolean {
      kotlin.jvm.internal.r.h(var1, "recyclerView");
      kotlin.jvm.internal.r.h(var2, "viewHolder");
      kotlin.jvm.internal.r.h(var3, "target");
      return false;
   }

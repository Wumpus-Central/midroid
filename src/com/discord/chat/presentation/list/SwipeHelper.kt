...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var3 = var4 + var6;
         var var11: Float = var4 + var6 - var13;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.cubicTo(var13 * 0.55F + var11, var35, var3, var15 + (float)var16 * 0.55F, var3, var15);
         var48.lineTo(var3, var14);
         var48.cubicTo(var3, var14 - (float)var16 * 0.55F, var38, var12, var11, var12);
         var1.save();
         var1.clipPath(var48);
         ...
         var48.reset();
         var11 = var12 - var8;
         var48.addCircle(var10, var12 - var8, var8, Direction.CW);
         ...
         var1.translate(var4 + var6 - var8 + var8, (float)var17 + var8);

...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var3 = var4 + var6;
         var var11: Float = var4 + var6 - var12;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.lineTo(var4, var35 + var9);
         val var8: Float = 2;
         var48.addArc(var10 - var9, var35, var4, var35 + (float)2 * var9, 0.0F, -90.0F);
         var48.lineTo(var11, var35);
         val var38: Float = var12 * 0.55F + var11;
         var48.cubicTo(var12 * 0.55F + var11, var35, var3, var14 + (float)var16 * 0.55F, var3, var14);
         var48.lineTo(var3, var15);
         var48.cubicTo(var3, var15 - (float)var16 * 0.55F, var38, var13, var11, var13);
         var1.save();
         var1.clipPath(var48);

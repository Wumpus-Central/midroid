...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var3 = var4 + var6;
         val var13: Float = var4 + var6 - var12;
         var19 = this.mView;
         if (this.mView == null) {
            q.y("mView");
            var19 = null;
         ...
         var48.lineTo(var4, var36 + var7);
         val var9: Float = 2;
         var48.addArc(var10 - var7, var36, var4, var36 + (float)2 * var7, 0.0F, -90.0F);
         var48.lineTo(var13, var36);
         val var37: Float = var12 * 0.55F + var13;
         var48.cubicTo(var12 * 0.55F + var13, var36, var3, var15 + (float)var16 * 0.55F, var3, var15);
         var48.lineTo(var3, var14);
         var48.cubicTo(var3, var14 - (float)var16 * 0.55F, var37, var11, var13, var11);
         var1.save();
         var1.clipPath(var48);
         ...
         var48.reset();
         var12 = var11 - var7;
         var48.addCircle(var10, var11 - var7, var7, Direction.CW);

...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var3 = var4 + var6;
         val var12: Float = var4 + var6 - var11;
         var19 = this.mView;
         if (this.mView == null) {
            q.y("mView");
            var19 = null;
         ...
         var48.lineTo(var4, var9 + var7);
         var8 = 2;
         var48.addArc(var10 - var7, var9, var4, var9 + (float)2 * var7, 0.0F, -90.0F);
         var48.lineTo(var12, var9);
         val var37: Float = var11 * 0.55F + var12;
         var48.cubicTo(var11 * 0.55F + var12, var9, var3, var15 + (float)var16 * 0.55F, var3, var15);
         ...
         var1.translate(var4 + var6 - var7 + var7, (float)var17 + var7);
   ...
   private fun easterEggStartAnimation(recyclerView: RecyclerView, viewHolder: ViewHolder) {
      if (!DeviceReducedMotion.INSTANCE.isReducedMotionEnabled(this.context)) {
         ...
         var6.addUpdateListener(new g(this, var1));

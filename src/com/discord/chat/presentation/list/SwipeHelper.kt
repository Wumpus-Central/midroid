...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var3 = var6 + var4;
         val var13: Float = var6 + var4 - var11;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.lineTo(var6, var9 + var8);
         var7 = 2;
         var48.addArc(var10 - var8, var9, var6, var9 + (float)2 * var8, 0.0F, -90.0F);
         var48.lineTo(var13, var9);
         val var37: Float = var11 * 0.55F + var13;
         var48.cubicTo(var11 * 0.55F + var13, var9, var3, var14 + (float)var16 * 0.55F, var3, var14);
         var48.lineTo(var3, var15);
         var48.cubicTo(var3, var15 - (float)var16 * 0.55F, var37, var12, var13, var12);
         var1.save();
         var1.clipPath(var48);
         ...
         var1.translate(var6 + var4 - var8 + var8, (float)var17 + var8);

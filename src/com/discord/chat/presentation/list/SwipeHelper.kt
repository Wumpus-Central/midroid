...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         val var10: Float = var3 - var9;
         var var4: Float = var3 + var6;
         val var13: Float = var3 + var6 - var11;
         var19 = this.mView;
         if (this.mView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("mView");
            var19 = null;
         ...
         val var12: Float = var15 + var5 + RIGHT_BEVEL_HEIGHT * 2 - RIGHT_BEVEL_HEIGHT;
         val var48: Path = new Path();
         var48.moveTo(var13, var12);
         var48.lineTo(var3, var12);
         var48.lineTo(var3, var8 + var9);
         var7 = 2;
         var48.addArc(var10 - var9, var8, var3, var8 + (float)2 * var9, 0.0F, -90.0F);
         var48.lineTo(var13, var8);
         val var37: Float = var11 * 0.55F + var13;
         var48.cubicTo(var11 * 0.55F + var13, var8, var4, var15 + (float)var16 * 0.55F, var4, var15);
         var48.lineTo(var4, var14);
         var48.cubicTo(var4, var14 - (float)var16 * 0.55F, var37, var12, var13, var12);
         var1.save();
         var1.clipPath(var48);
         ...
         var48.reset();
         var11 = var12 - var9;
         var48.addCircle(var10, var12 - var9, var9, Direction.CW);
         ...
         var1.translate(var3 + var6 - var9 + var9, (float)var17 + var9);
   ...
   private fun easterEggStartAnimation(recyclerView: RecyclerView, viewHolder: ViewHolder) {
      if (!DeviceReducedMotion.INSTANCE.isReducedMotionEnabled(this.context)) {
         ...
         var7.addUpdateListener(new w(this, var1));
   ...
   private fun triggerEditEntranceTransition(recyclerView: RecyclerView) {
      ...
      var7.setDuration(300L);
      var7.setInterpolator(new AccelerateDecelerateInterpolator());
      var7.addUpdateListener(new y(this, var1));
   ...
   private fun triggerEditExitTransition(recyclerView: RecyclerView) {
      ...
      var2.addUpdateListener(new x(this, var1));

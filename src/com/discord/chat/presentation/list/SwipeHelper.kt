...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         val var10: Float = var6 - var7;
         var3 = var6 + var4;
         val var12: Float = var6 + var4 - var11;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.moveTo(var12, var13);
         var48.lineTo(var6, var13);
         var48.lineTo(var6, var36 + var7);
         val var9: Float = 2;
         var48.addArc(var10 - var7, var36, var6, var36 + (float)2 * var7, 0.0F, -90.0F);
         var48.lineTo(var12, var36);
         val var37: Float = var11 * 0.55F + var12;
         var48.cubicTo(var11 * 0.55F + var12, var36, var3, var14 + (float)var16 * 0.55F, var3, var14);
         var48.lineTo(var3, var15);
         var48.cubicTo(var3, var15 - (float)var16 * 0.55F, var37, var13, var12, var13);
         var1.save();
         var1.clipPath(var48);
         var1.drawRect(var10, var14, var3, var15, var21);
         var1.restore();
         var1.save();
         var48.reset();
         var11 = var13 - var7;
         var48.addCircle(var10, var13 - var7, var7, Direction.CW);
         ...
         var1.translate(var6 + var4 - var7 + var7, (float)var17 + var7);

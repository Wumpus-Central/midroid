...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var var12: Float = var3 + var4 - var13;
         var19 = this.mView;
         if (this.mView == null) {
            kotlin.jvm.internal.r.y("mView");
            var19 = null;
         ...
         var48.cubicTo(var13 * 0.55F + var12, var8, var6, var15 + (float)var16 * 0.55F, var6, var15);
         var48.lineTo(var6, var14);
         var48.cubicTo(var6, var14 - (float)var16 * 0.55F, var38, var11, var12, var11);
         var1.save();
         var1.clipPath(var48);
         ...
         var1.translate(var3 + var4 - var9 + var9, (float)var17 + var9);

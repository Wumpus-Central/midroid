...
internal class SwipeHelper(context: Context, onStart: () -> Unit, onEnd: () -> Unit) : ChatListCallback {
   ...
   private fun drawContextArea(canvas: Canvas) {
      if (this.currentItemViewHolder != null && this.dX != 0.0F) {
         ...
         var48.lineTo(var3, var35 + var8);
         val var9: Float = 2;
         var48.addArc(var10 - var8, var35, var3, var35 + (float)2 * var8, 0.0F, -90.0F);
         var48.lineTo(var11, var35);
         val var38: Float = var13 * 0.55F + var11;
         var48.cubicTo(var13 * 0.55F + var11, var35, var4, var15 + (float)var16 * 0.55F, var4, var15);

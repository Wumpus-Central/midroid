...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   mc.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2<CoroutineScope, Continuation, Object>(var1, var0, var2, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var1.hasNext()) {
            ...
            this.L$3 = var1;
            this.label = 1;
            if (mc.f.g(var19, var17, this) === var9) {
               return var9;
            }
         }
...
public fun fillChatList(
   ...
   mc.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2<CoroutineScope, Continuation, Object>(var2, var1, var0, var3, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var7.hasNext()) {
            ...
            var var17: java.util.List = (java.util.List)var8.get(var11);
            val var3: Int = (var17 as java.lang.Number).intValue();
            var17 = new ArrayList();

            for (int var14 = 0; var14 < var4; var14++) {
               val var20: RecyclerView.ViewHolder = var1.createViewHolder(var5, var3);
            ...
            val var21: d0 = K.c();
            val var19: Function2 = new Function2<CoroutineScope, Continuation, Object>(var17, var6, null) {
               final RecyclerView.RecycledViewPool $chatListViewPool;
               final java.util.List<RecyclerView.ViewHolder> $items;
               int label;
            ...
            this.L$4 = var7;
            this.label = 1;
            if (mc.f.g(var21, var19, this) === var10) {
               return var10;
            }
         }

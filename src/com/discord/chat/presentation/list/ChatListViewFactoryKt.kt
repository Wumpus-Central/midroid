...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   fc.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2<CoroutineScope, Continuation, Object>(var1, var0, var2, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var6.hasNext()) {
            ...
            for (int var13 = 0; var13 < var4; var13++) {
               val var10: RecyclerView.ViewHolder = var1.createViewHolder(var7, var3);
            ...
            val var19: d0 = K.c();
            val var17: Function2 = new Function2<CoroutineScope, Continuation, Object>(var16, var5, null) {
               final RecyclerView.RecycledViewPool $accessoriesViewPool;
            ...
            this.L$3 = var6;
            this.label = 1;
            if (fc.f.g(var19, var17, this) === var9) {
               return var9;
            }
         }
...
public fun fillChatList(
   ...
   fc.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2<CoroutineScope, Continuation, Object>(var2, var1, var0, var3, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var7.hasNext()) {
            ...
            for (int var14 = 0; var14 < var3; var14++) {
               val var12: RecyclerView.ViewHolder = var6.createViewHolder(var8, var4);
            ...
            val var21: d0 = K.c();
            val var19: Function2 = new Function2<CoroutineScope, Continuation, Object>(var17, var1, null) {
               final RecyclerView.RecycledViewPool $chatListViewPool;
               final java.util.List<RecyclerView.ViewHolder> $items;
               int label;
            ...
            this.L$4 = var7;
            this.label = 1;
            if (fc.f.g(var21, var19, this) === var10) {
               return var10;
            }
         }

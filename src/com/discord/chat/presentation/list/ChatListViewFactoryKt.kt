...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   gu.g.d(
      ...
      m0.a(),
      null,
      new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var1, var0, var2, null) {
         final MessageAccessoriesAdapter $accessoriesAdapter;
         final RecycledViewPool $accessoriesViewPool;
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            val var6: java.util.Iterator;
            val var7: RecycledViewPool;
            if (this.label != 0) {
               if (this.label != 1) {
                  throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
               }

               var6 = this.L$3 as java.util.Iterator;
               var7 = this.L$2 as RecycledViewPool;
               val var8: RecyclerView = this.L$1 as RecyclerView;
               ...
               var1 = this.$recycler;
               var7 = this.$accessoriesViewPool;
               var6 = var14.entrySet().iterator();
            }

            while (var6.hasNext()) {
               val var15: Entry = var6.next() as Entry;
               ...
               for (int var13 = 0; var13 < var4; var13++) {
                  val var10: ViewHolder = var5.createViewHolder(var1, var3);
               ...
               val var19: c1 = m0.c();
               val var17: Function2 = new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var16, var7, null) {
                  final RecycledViewPool $accessoriesViewPool;
                  final java.util.List<ViewHolder> $items;
                  int label;
                  ...
                  public final Object invokeSuspend(Object var1) {
                     ...
                     if (this.label != 0) {
                        ...
                        kotlin.c.b(var1);
                        val var4: java.lang.Iterable = this.$items;
                        var1 = this.$accessoriesViewPool;
                        val var7: java.util.Iterator = var4.iterator();

                        while (var7.hasNext()) {
                           var1.putRecycledView(var7.next() as ViewHolder);
                        }
               ...
               this.L$3 = var6;
               this.label = 1;
               if (gu.g.g(var19, var17, this) === var9) {
                  return var9;
               }
            }
...
public fun fillChatList(
   ...
   gu.g.d(
      ...
      m0.a(),
      null,
      new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var2, var1, var0, var3, null) {
         final BaseChatListAdapter $chatListAdapter;
         final RecycledViewPool $chatListViewPool;
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               var8 = this.L$3 as RecycledViewPool;
            ...
            while (var1.hasNext()) {
               ...
               val var3: Int = (var16.getValue() as java.lang.Number).intValue();
               var var17: java.util.List = (java.util.List)var7.get(var11);
               val var4: Int = (var17 as java.lang.Number).intValue();
               var17 = new ArrayList();

               for (int var15 = 0; var15 < var3; var15++) {
                  val var20: ViewHolder = var5.createViewHolder(var6, var4);
               ...
               val var21: c1 = m0.c();
               val var19: Function2 = new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var17, var8, null) {
                  final RecycledViewPool $chatListViewPool;
                  final java.util.List<ViewHolder> $items;
                  int label;
                  ...
                  public final Object invokeSuspend(Object var1) {
                     ...
                     if (this.label != 0) {
                        ...
                        kotlin.c.b(var1);
                        val var2x: java.lang.Iterable = this.$items;
                        var1 = this.$chatListViewPool;
                        val var4: java.util.Iterator = var2x.iterator();

                        while (var4.hasNext()) {
                           var1.putRecycledView(var4.next() as ViewHolder);
                        }
               ...
               this.L$4 = var1;
               this.label = 1;
               if (gu.g.g(var21, var19, this) === var10) {
                  return var10;
               }
            }

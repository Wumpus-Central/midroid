...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   ...
   ab.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var1, var0, var2, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var7.hasNext()) {
            ...
            for (int var13 = 0; var13 < var4; var13++) {
               val var10: RecyclerView.ViewHolder = var1.createViewHolder(var5, var3);
            ...
            this.L$3 = var7;
            this.label = 1;
            if (ab.f.g(var19, var17, this) === var9) {
               return var9;
            }
         }
...
public fun fillChatList(
   ...
   ab.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var2, var1, var0, var3, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         if (this.label != 0) {
            ...
            var5 = this.L$3 as RecyclerView.RecycledViewPool;
         ...
         while (var6.hasNext()) {
            ...
            var var17: java.util.List = (java.util.List)var1.get(var11);
            kotlin.jvm.internal.q.e(var17);
            val var3: Int = (var17 as java.lang.Number).intValue();
            var17 = new ArrayList();

            for (int var14 = 0; var14 < var4; var14++) {
               val var20: RecyclerView.ViewHolder = var7.createViewHolder(var8, var3);
            ...
            val var21: d0 = K.c();
            val var19: Function2 = new Function2(var17, var5, null) {
               final RecyclerView.RecycledViewPool $chatListViewPool;
               final java.util.List<RecyclerView.ViewHolder> $items;
               int label;
            ...
            this.L$4 = var6;
            this.label = 1;
            if (ab.f.g(var21, var19, this) === var10) {
               return var10;
            }
         }

...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   ...
   cb.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var1, var0, var2, null) {
...
public fun fillChatList(
   ...
   cb.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var2, var1, var0, var3, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (var5.hasNext()) {
            ...
            for (int var14 = 0; var14 < var4; var14++) {
               val var20: RecyclerView.ViewHolder = var1.createViewHolder(var7, var3);
            ...
            val var21: d0 = K.c();
            val var19: Function2 = new Function2(var18, var8, null) {
               final RecyclerView.RecycledViewPool $chatListViewPool;
               final java.util.List<RecyclerView.ViewHolder> $items;
               int label;

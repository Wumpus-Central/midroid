...
public fun fillAccessories(recycler: RecyclerView, accessoriesAdapter: MessageAccessoriesAdapter, accessoriesViewPool: RecycledViewPool) {
   ...
   S9.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var1, var0, var2, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         while (true) {
            ...
            this.I$2 = var15;
            this.label = 1;
            if (S9.f.g(var27, var28, this) === var10) {
               return var10;
            }
...
public fun fillChatList(
   ...
   S9.f.d(CoroutineViewUtilsKt.attachedScope(var0, false), K.a(), null, new Function2(var2, var1, var0, var3, null) {
      ...
      public final Object invokeSuspend(Object var1) {
         ...
         if (this.label != 0) {
            ...
            val var34: Class = var9.getKey() as Class;
            var3 = (var9.getValue() as java.lang.Number).intValue();
            var9 = (Entry)var14.get(var34);
            q.e(var9);
         ...
         while (true) {
            while (var16 >= var3) {
               ...
               var9 = var8.next() as Entry;
               val var37: Class = var9.getKey() as Class;
               var3 = (var9.getValue() as java.lang.Number).intValue();
               var9 = (Entry)var7.get(var37);
               q.e(var9);
               var4 = (var9 as java.lang.Number).intValue();
            ...
            val var42: RecyclerView.ViewHolder = var6.createViewHolder(var5, var4);
            ...
            this.I$2 = var16;
            this.label = 1;
            if (S9.f.g(var40, var43, this) === var12) {
               return var12;
            }

...
public data class ScrollState(isDragging: Boolean,
   ...
   public override fun hashCode(): Int {
      ...
      val var9: Int = java.lang.Boolean.hashCode(this.isAtTop);
      var var3: Int = 0;
      val var1: Int;
      ...
      return ((((((((((var5 * 31 + var7) * 31 + var4) * 31 + var8) * 31 + var6) * 31 + var9) * 31 + var1) * 31 + var10) * 31 + var11) * 31 + var2) * 31 + var12)
            * 31
         + var3;
   }
   ...
   public override fun toString(): String {
      ...
      val var7: Boolean = this.isSettling;

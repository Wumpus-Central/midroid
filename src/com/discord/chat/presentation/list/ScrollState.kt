...
public data class ScrollState(isDragging: Boolean,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         if (this.isDragging != var1.isDragging) {
            ...
            return false;
         } else if (!kotlin.jvm.internal.r.c(this.firstVisibleMessagePercentVisible, var1.firstVisibleMessagePercentVisible)) {
            return false;
         } else if (this.lastVisibleMessageIndex != var1.lastVisibleMessageIndex) {
            return false;
         } else {
            return kotlin.jvm.internal.r.c(this.lastVisibleMessagePercentVisible, var1.lastVisibleMessagePercentVisible);
         }
      }
   }

   public override fun hashCode(): Int {
      val var7: Int = java.lang.Boolean.hashCode(this.isDragging);
      ...
      return ((((((((((var7 * 31 + var4) * 31 + var9) * 31 + var5) * 31 + var8) * 31 + var6) * 31 + var1) * 31 + var11) * 31 + var10) * 31 + var2) * 31 + var12)
            * 31
         + var3;
   }
   ...
   public override fun toString(): String {
      ...
      val var8: Boolean = this.isAtTop;
      val var12: ScrollDirection = this.scrollDirection;
      ...
      var10.append(var1);
      var10.append(", firstVisibleMessagePercentVisible=");
      var10.append(var13);
      var10.append(", lastVisibleMessageIndex=");
      var10.append(var2);
      var10.append(", lastVisibleMessagePercentVisible=");
      var10.append(var11);
      var10.append(")");

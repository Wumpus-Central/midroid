...
public class ChatListItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
      ...
      this.mScrollRunnable = new Runnable(this) {
         ...
         public void run() {
            ...
            if (var1x.mSelected != null && var1x.scrollIfNecessary()) {
               ...
               Z.g0(this.this$0.mRecyclerView, this);
            }
         }
      };
      ...
      this.mOnItemTouchListener = new RecyclerView.OnItemTouchListener(this) {
         ...
         public void onTouchEvent(@NonNull RecyclerView var1, @NonNull MotionEvent var2) {
            ...
            if (this.this$0.mActivePointerId != -1) {
               ...
               RecyclerView.ViewHolder var7 = var15.mSelected;
               if (var7 != null) {
                  byte var3 = 0;
                  if (var5 != 1) {
                     if (var5 == 2) {
                        if (var4 >= 0) {
                           var15.updateDxDy(var2, var15.mSelectedFlags, var4);
   ...
   private List<RecyclerView.ViewHolder> findSwapTargets(RecyclerView.ViewHolder var1) {
      ...
      RecyclerView.LayoutManager var22 = this.mRecyclerView.getLayoutManager();
      int var8 = var22.getChildCount();
      ...
      for (int var18 = 0; var18 < var8; var18++) {
         ...
         if (var16 != var1.itemView && var16.getBottom() >= var5 && var16.getTop() <= var10 && var16.getRight() >= var6 && var16.getLeft() <= var7) {
            RecyclerView.ViewHolder var15 = this.mRecyclerView.getChildViewHolder(var16);
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var15)) {
               int var4 = Math.abs(var9 - (var16.getLeft() + var16.getRight()) / 2);
               var3 = Math.abs(var11 - (var16.getTop() + var16.getBottom()) / 2);
   ...
   private int swipeIfNecessary(RecyclerView.ViewHolder var1) {
      if (this.mActionState == 2) {
         ...
         int var2 = (this.mCallback.convertToAbsoluteDirection(var3, Z.z(this.mRecyclerView)) & 0xFF00) >> 8;
         if (var2 == 0) {
            return 0;
         } else {
            ...
            if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
               ...
               if (var3 > 0) {
                  if ((var4 & var3) == 0) {
                     return androidx.recyclerview.widget.e.convertToRelativeDirection(var3, Z.z(this.mRecyclerView));
                  }
               ...
               if (var3 > 0) {
                  var2 = var3;
                  if ((var4 & var3) == 0) {
                     var2 = androidx.recyclerview.widget.e.convertToRelativeDirection(var3, Z.z(this.mRecyclerView));
                  }
   ...
   public void attachToRecyclerView(RecyclerView var1) {
      ...
      if (var2 != var1) {
         ...
         if (var1 != null) {
            ...
            this.mSwipeEscapeVelocity = var3.getDimension(l0.b.f);
            this.mMaxSwipeVelocity = var3.getDimension(l0.b.e);
            this.setupCallbacks();
         }
      }
   }
      ...
      if (!this.mRecyclerView.isLayoutRequested()) {
         if (this.mActionState == 2) {
            ...
            if (!(Math.abs(var5 - var1.itemView.getTop()) < var1.itemView.getHeight() * var2)
               ...
               if (var7.size() != 0) {
                  RecyclerView.ViewHolder var8 = this.mCallback.chooseDropTarget(var1, var7, var4, var5);
                  if (var8 == null) {
                     ...
                     if (this.mCallback.onMove(this.mRecyclerView, var1, var8)) {
                        this.mCallback.onMoved(this.mRecyclerView, var1, var6, var8, var3, var4, var5);
                     }
                  }
               }
            }
   ...
   void select(RecyclerView.ViewHolder var1, int var2) {
      if (var1 != this.mSelected || var2 != this.mActionState) {
         ...
         RecyclerView.ViewHolder var10 = this.mSelected;
         boolean var16;
         if (var10 != null) {
            if (var10.itemView.getParent() == null) {
               this.removeChildDrawingOrderCallbackIfNecessary(var10.itemView);
               this.mCallback.clearView(this.mRecyclerView, var10);
               var16 = 0;
            } else {
               int var8;
               if (!this.mCallback.shouldReturnToOriginalPosition() && var9 != 2) {
                  var8 = this.swipeIfNecessary(var10);
               } else {
                  var8 = 0;
               }
               ...
               var17.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, var16, var12 - var15, var4 - var6));

...
public class ChatListItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
   ...
   private List<RecyclerView.ViewHolder> findSwapTargets(RecyclerView.ViewHolder var1) {
      ...
      int var9 = (var5 + var8) / 2;
      RecyclerView.LayoutManager var22 = this.mRecyclerView.getLayoutManager();
      int var11 = var22.getChildCount();

      for (int var18 = 0; var18 < var11; var18++) {
         View var15 = var22.getChildAt(var18);
         if (var15 != var1.itemView && var15.getBottom() >= var5 && var15.getTop() <= var8 && var15.getRight() >= var6 && var15.getLeft() <= var7) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var16)) {
               int var4 = Math.abs(var10 - (var15.getLeft() + var15.getRight()) / 2);
               var3 = Math.abs(var9 - (var15.getTop() + var15.getBottom()) / 2);
   ...
   void moveIfNecessary(RecyclerView.ViewHolder var1) {
      if (!this.mRecyclerView.isLayoutRequested()) {
         if (this.mActionState == 2) {
            ...
            int var6 = (int)(this.mSelectedStartY + this.mDy);
            if (!(Math.abs(var6 - var1.itemView.getTop()) < var1.itemView.getHeight() * var2)
               ...
               if (var7.size() != 0) {
                  RecyclerView.ViewHolder var8 = this.mCallback.chooseDropTarget(var1, var7, var5, var6);
                  if (var8 == null) {
                     ...
                     if (this.mCallback.onMove(this.mRecyclerView, var1, var8)) {
                        this.mCallback.onMoved(this.mRecyclerView, var1, var4, var8, var3, var5, var6);
                     }
                  }
               }
            }
               ...
               ChatListItemTouchHelper.RecoverAnimation var17 = new ChatListItemTouchHelper.RecoverAnimation(
                  ...
                  public void onAnimationEnd(Animator var1) {
                     ...
                     if (!super.mOverridden) {
                        ...
                        View var3 = var4x.mOverdrawChild;
                        View var6x = this.val$prevSelected.itemView;
                        if (var3 == var6x) {
                           var4x.removeChildDrawingOrderCallbackIfNecessary(var6x);
                        }
                     }
                  }
               };

      ...
      for (int var18 = 0; var18 < var8; var18++) {
         ...
         if (var22 != var1.itemView && var22.getBottom() >= var6 && var22.getTop() <= var9 && var22.getRight() >= var5 && var22.getLeft() <= var7) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var16)) {
               ...
               var3 = Math.abs(var10 - (var22.getTop() + var22.getBottom()) / 2);
   ...
   public void attachToRecyclerView(RecyclerView var1) {
      ...
      if (var2 != var1) {
         ...
         if (var1 != null) {
            ...
            this.mSwipeEscapeVelocity = var3.getDimension(j1.b.f);
            this.mMaxSwipeVelocity = var3.getDimension(j1.b.e);
            this.setupCallbacks();
         }
      }
   }
               ...
               if (var7.size() != 0) {
                  ...
                  if (var8 == null) {
                     ...
                     if (this.mCallback.onMove(this.mRecyclerView, var1, var8)) {
                        this.mCallback.onMoved(this.mRecyclerView, var1, var6, var8, var4, var3, var5);
                     }
                  }
               }
            }

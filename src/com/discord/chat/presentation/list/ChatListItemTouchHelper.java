...
public class ChatListItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
      ...
      this.mScrollRunnable = new Runnable(this) {
         ...
         public void run() {
            ...
            if (var1x.mSelected != null && var1x.scrollIfNecessary()) {
               ...
               a0.h0(this.this$0.mRecyclerView, this);
            }
         }
      };
   ...
   private List<RecyclerView.ViewHolder> findSwapTargets(RecyclerView.ViewHolder var1) {
      ...
      for (int var17 = 0; var17 < var8; var17++) {
         ...
         if (var15 != var1.itemView && var15.getBottom() >= var6 && var15.getTop() <= var11 && var15.getRight() >= var5 && var15.getLeft() <= var7) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var22)) {
               var3 = Math.abs(var10 - (var15.getLeft() + var15.getRight()) / 2);
               int var4 = Math.abs(var9 - (var15.getTop() + var15.getBottom()) / 2);
   ...
   private int swipeIfNecessary(RecyclerView.ViewHolder var1) {
      if (this.mActionState == 2) {
         ...
         int var2 = (this.mCallback.convertToAbsoluteDirection(var3, a0.A(this.mRecyclerView)) & 0xFF00) >> 8;
         if (var2 == 0) {
            return 0;
         } else {
            ...
            if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
               ...
               if (var3 > 0) {
                  if ((var4 & var3) == 0) {
                     return androidx.recyclerview.widget.e.convertToRelativeDirection(var3, a0.A(this.mRecyclerView));
                  }
               ...
               if (var3 > 0) {
                  var2 = var3;
                  if ((var4 & var3) == 0) {
                     var2 = androidx.recyclerview.widget.e.convertToRelativeDirection(var3, a0.A(this.mRecyclerView));
                  }
   ...
   public void attachToRecyclerView(RecyclerView var1) {
      ...
      if (var2 != var1) {
         ...
         if (var1 != null) {
            ...
            this.mSwipeEscapeVelocity = var3.getDimension(f0.b.f);
            this.mMaxSwipeVelocity = var3.getDimension(f0.b.e);
            this.setupCallbacks();
         }
      }
   }

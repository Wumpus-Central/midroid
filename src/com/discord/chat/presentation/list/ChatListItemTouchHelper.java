...
public class ChatListItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
   ...
   public ChatListItemTouchHelper(@NonNull ChatListCallback var1) {
      this.mSelected = null;
      ...
      this.mScrollRunnable = new Runnable(this) {
         ...
         public void run() {
            ...
            if (var1x.mSelected != null && var1x.scrollIfNecessary()) {
               var1x = this.this$0;
               ViewHolder var2 = var1x.mSelected;
               if (var2 != null) {
               ...
               h0.f0(this.this$0.mRecyclerView, this);
            }
         }
      };
      ...
      this.mOnItemTouchListener = new OnItemTouchListener(this) {
         ...
         public boolean onInterceptTouchEvent(@NonNull RecyclerView var1, @NonNull MotionEvent var2) {
            ...
            if (var3 == 0) {
               ...
               if (var6.mSelected == null) {
                  ChatListItemTouchHelper.RecoverAnimation var7 = var6.findAnimation(var2);
                  if (var7 != null) {
                     ChatListItemTouchHelper var5 = this.this$0;
                     var5.mInitialTouchX = var5.mInitialTouchX - var7.mX;
                     var5.mInitialTouchY = var5.mInitialTouchY - var7.mY;
                     var5.endRecoverAnimation(var7.mViewHolder, true);
                     if (this.this$0.mPendingCleanup.remove(var7.mViewHolder.itemView)) {
                        var5 = this.this$0;
                        var5.mCallback.clearView(var5.mRecyclerView, var7.mViewHolder);
                     }
               ...
               ChatListItemTouchHelper var13 = this.this$0;
               var13.mCallback.onReleased(var1, var13.mSelected);
               ChatListItemTouchHelper var9 = this.this$0;
               var9.mActivePointerId = -1;
               var9.select(null, 0);
            }

            VelocityTracker var10 = this.this$0.mVelocityTracker;
            if (var10 != null) {
               var10.addMovement(var2);
            }
      ...
      if (this.mChildDrawingOrderCallback == null) {
         this.mChildDrawingOrderCallback = new ChildDrawingOrderCallback(this) {
            ...
            public int onGetChildDrawingOrder(int var1, int var2) {
               ChatListItemTouchHelper var6 = this.this$0;
               View var5 = var6.mOverdrawChild;
               if (var5 != null) {
                  int var4 = var6.mOverdrawChildPosition;
                  int var3 = var4;
                  if (var4 == -1) {
                     var3 = var6.mRecyclerView.indexOfChild(var5);
   ...
   private int checkHorizontalSwipe(ViewHolder var1, int var2) {
      if ((var2 & 12) != 0) {
         ...
         var3 = this.mRecyclerView.getWidth();
         float var11 = this.mCallback.getSwipeThreshold(var1);
         if ((var2 & var5) != 0 && Math.abs(this.mDx) > var3 * var11) {
            return var5;
         }
      }
   ...
   private List<ViewHolder> findSwapTargets(ViewHolder var1) {
      ...
      int var6 = Math.round(this.mSelectedStartX + this.mDx) - var2;
      int var5 = Math.round(this.mSelectedStartY + this.mDy) - var2;
      int var3 = var1.itemView.getWidth();
      var2 *= 2;
      int var7 = var3 + var6 + var2;
      int var8 = var1.itemView.getHeight() + var5 + var2;
      int var11 = (var6 + var7) / 2;
      int var10 = (var5 + var8) / 2;
      LayoutManager var22 = this.mRecyclerView.getLayoutManager();
      int var9 = var22.getChildCount();

      for (int var18 = 0; var18 < var9; var18++) {
         View var16 = var22.getChildAt(var18);
         if (var16 != var1.itemView && var16.getBottom() >= var5 && var16.getTop() <= var8 && var16.getRight() >= var6 && var16.getLeft() <= var7) {
            ViewHolder var15 = this.mRecyclerView.getChildViewHolder(var16);
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var15)) {
               var3 = Math.abs(var11 - (var16.getLeft() + var16.getRight()) / 2);
               int var4 = Math.abs(var10 - (var16.getTop() + var16.getBottom()) / 2);
               ...
               this.mSwapTargets.add(var4, var15);
   ...
   private static boolean hitTest(View var0, float var1, float var2, float var3, float var4) {
      return var1 >= var3 && var1 <= var3 + var0.getWidth() && var2 >= var4 && var2 <= var4 + var0.getHeight();
   }
   ...
   private int swipeIfNecessary(ViewHolder var1) {
      if (this.mActionState == 2) {
         ...
         int var2 = (this.mCallback.convertToAbsoluteDirection(var3, h0.z(this.mRecyclerView)) & 0xFF00) >> 8;
         if (var2 == 0) {
            return 0;
         } else {
            ...
            if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
               ...
               if (var3 > 0) {
                  if ((var4 & var3) == 0) {
                     return androidx.recyclerview.widget.h.convertToRelativeDirection(var3, h0.z(this.mRecyclerView));
                  }
               ...
               if (var3 > 0) {
                  var2 = var3;
                  if ((var4 & var3) == 0) {
                     var2 = androidx.recyclerview.widget.h.convertToRelativeDirection(var3, h0.z(this.mRecyclerView));
                  }
   ...
   public void attachToRecyclerView(RecyclerView var1) {
      ...
      if (var2 != var1) {
         ...
         if (var1 != null) {
            ...
            this.mSwipeEscapeVelocity = var3.getDimension(w4.b.f);
            this.mMaxSwipeVelocity = var3.getDimension(w4.b.e);
            this.setupCallbacks();
         }
      }
   }
   ...
   void checkSelectForSwipe(int var1, MotionEvent var2, int var3) {
      if (this.mSelected == null && var1 == 2 && this.mActionState != 2 && this.mCallback.isItemViewSwipeEnabled() && this.mRecyclerView.getScrollState() != 1) {
         ...
         if (var8 != null) {
            ...
            if (var1 != 0) {
               ...
               var3 = this.mSlop;
               if ((!(var6 < var3) || !(var7 < var3))
                  && (
                     var6 > var7
                        ? (!(var4 < 0.0F) || (var1 & 4) != 0) && (!(var4 > 0.0F) || (var1 & 8) != 0)
                        : (!(var5 < 0.0F) || (var1 & 1) != 0) && (!(var5 > 0.0F) || (var1 & 2) != 0)
                  )) {
                  this.mDy = 0.0F;
                  this.mDx = 0.0F;
   ...
   void moveIfNecessary(ViewHolder var1) {
      if (!this.mRecyclerView.isLayoutRequested() && this.mActionState == 2) {
         ...
         if (!(Math.abs(var4 - var1.itemView.getTop()) < var1.itemView.getHeight() * var2)
            || !(Math.abs(var3 - var1.itemView.getLeft()) < var1.itemView.getWidth() * var2)) {
            List var7 = this.findSwapTargets(var1);
            if (var7.size() != 0) {
               ViewHolder var8 = this.mCallback.chooseDropTarget(var1, var7, var3, var4);
               if (var8 == null) {
               ...
               int var6 = var8.getAbsoluteAdapterPosition();
               int var5 = var1.getAbsoluteAdapterPosition();
               if (this.mCallback.onMove(this.mRecyclerView, var1, var8)) {
                  this.mCallback.onMoved(this.mRecyclerView, var1, var5, var8, var6, var3, var4);
               }
            }
         }
      }
   ...
   public void onChildViewAttachedToWindow(@NonNull View var1) {
   }

   public void onChildViewDetachedFromWindow(@NonNull View var1) {
   ...
   boolean scrollIfNecessary() {
      if (this.mSelected == null) {
         ...
         label69: {
            ...
            label68: {
               ...
               if (var9.canScrollHorizontally()) {
                  var12 = (int)(this.mSelectedStartX + this.mDx);
                  var2 = var12 - this.mTmpRect.left - this.mRecyclerView.getPaddingLeft();
                  float var1 = this.mDx;
                  if (var1 < 0.0F && var2 < 0) {
                     break label68;
                  }
         ...
         int var13 = var12;
         if (var12 != 0) {
            var13 = this.mCallback
               .interpolateOutOfBoundsScroll(this.mRecyclerView, this.mSelected.itemView.getWidth(), var12, this.mRecyclerView.getWidth(), var5);
         }
         ...
         if (var13 == 0 && var11 == 0) {
            ...
            this.mRecyclerView.scrollBy(var13, var11);
            return true;
         }
      }
   }
         ...
         if (var11 != null) {
            if (var11.itemView.getParent() == null) {
               ...
               if (var8 == 1 || var8 == 2) {
                  ...
                  float var14 = this.mRecyclerView.getHeight();
                  var12 = 0.0F;
                  var4 *= var14;
                  ...
                  var12 = Math.signum(this.mDx);
                  float var5 = this.mRecyclerView.getWidth();
                  var4 = 0.0F;
                  var12 *= var5;
               }
               ...
               ChatListItemTouchHelper.RecoverAnimation var17 = new ChatListItemTouchHelper.RecoverAnimation(
                  this, var11, var7, var9, var15, var6, var12, var4, var8, var11
               ) {
                  final ChatListItemTouchHelper this$0;
               ...
               var17.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, var7, var12 - var15, var4 - var6));
   ...
   public void startDrag(@NonNull ViewHolder var1) {
      if (this.mCallback.hasDragFlag(this.mRecyclerView, var1) && var1.itemView.getParent() == this.mRecyclerView) {
               ...
               if (var10 != null) {
                  ...
                  if (var7.mCallback.hasDragFlag(var7.mRecyclerView, var10)) {
                     ...
                     if (var5 == var4) {
                        ...
                        ChatListItemTouchHelper var8 = this.this$0;
                        var8.mInitialTouchX = var3;
                        var8.mInitialTouchY = var2;
                        var8.mDy = 0.0F;
                        var8.mDx = 0.0F;

...
public data class ChatInputNode(type: Int,
   ...
   public object `$serializer` : g0 {
      ...
      fun {
         ...
         var1.c("length", false);
         var1.c("style", true);
         var1.c("deleteNodeOnBackspace", true);
         var1.c("tapAction", true);
         var1.c("editDisabled", true);
         descriptor = var1;
      }
      ...
      public open fun deserialize(decoder: Decoder): ChatInputNode {
         ...
         var var24: Byte;
         if (var13.p()) {
            var21 = var13.i(var12, 0);
            var6 = var13.i(var12, 1);
            var24 = var13.i(var12, 2);
            ...
            while (var25) {
               ...
               switch (var9) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     var22 = var13.C(var12, 4);
                     var16 |= 16;
                     break;
                  case 5:
                     var27 = var13.n(var12, 5, TapAction.$serializer.INSTANCE, var27) as TapAction;
                     var16 |= 32;
                     break;
                  case 6:
                     var23 = var13.C(var12, 6);
                     var16 |= 64;
                     break;
                  default:
                     throw new n(var9);
         ...
         var13.c(var12);
         return new ChatInputNode(var4, var7, var6, var21, var10, (boolean)var24, var14, (boolean)var17, null);
      }

...
public class ChatInputRootView  public constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RelativeLayout, KeyboardEvent {
   ...
   init {
      ...
      r.g(var6, "inflate(\n        LayoutI…ext),\n        this,\n    )");
      this.binding = var6;
      this.lineHeightMeasurer = new ChatInputRootViewMeasurer(this, new Function1<Integer, Unit>(this) {
         ...
         public final void invoke(int var1) {
            val var2: ChatInputRootView.ChatInputListener = this.this$0.getListener();
            if (var2 != null) {
               var2.onContentSizeChange((int)SizeUtilsKt.getPxToDp(this.this$0.getWidth()), (int)SizeUtilsKt.getPxToDp(var1));
            }
         }
      });
      val var7: DCDChatInput = var6.chatInputEditText;
      r.g(var6.chatInputEditText, "binding.chatInputEditText");
      this.editText = var7;
      ...
      var7.setOnRequestSend(new Function0<Unit>(this) {
         ...
         public final void invoke() {
            val var1: ChatInputRootView.ChatInputListener = this.this$0.getListener();
            if (var1 != null) {
               var1.onRequestSend();
            }
         }
      });
      var7.setOnSelectionChanged(
         new Function2<Integer, Integer, Unit>(this) {
            final ChatInputRootView this$0;
               ...
               ChatInputRootView.access$getCurrentTextFlow$p(this.this$0)
                  .setValue(
                     new ChatInputRootView.CurrentTextAndSelection(
                        var1,
                        var2,
                        java.lang.String.valueOf(ChatInputRootView.access$getEditText$p(this.this$0).getText()),
      ...
      var7.setOnFocusChangeListener(new c(this));
      f1.H0(var7, new java.lang.String[]{"image/*"}, new d(this, var1));
   ...
   @JvmStatic
   fun `_init_$lambda$0`(var0: ChatInputRootView, var1: View, var2: Boolean) {
      r.h(var0, "this$0");
      if (var2) {
   ...
   @JvmStatic
   fun `_init_$lambda$5`(var0: ChatInputRootView, var1: Context, var2: View, var3: ContentInfoCompat): ContentInfoCompat {
      r.h(var0, "this$0");
      r.h(var1, "$context");
      r.h(var2, "<anonymous parameter 0>");
      r.h(var3, "payload");
      val var16: Pair = var3.i(new a(var1));
      r.g(var16, "partition {\n            …/\") == true\n            }");
      val var10: ContentInfoCompat = var16.first as ContentInfoCompat;
      val var17: ContentInfoCompat = var16.second as ContentInfoCompat;
      val var20: Boolean;
      if (var10 != null) {
         var0.insertedPayloads.add(var3);
      ...
      var var11: ContentInfoCompat = var17;
      if (var17 != null) {
         val var12: Editable = var0.editText.getText();
         var var22: Int = 1;
         if (var12 != null) {
            if (kotlin.text.f.x(var12)) {
               var22 = 1;
            } else {
               var22 = 0;
            }
         ...
         var11 = var17;
         if (var22) {
            val var13: Pair = var17.i(new b());
            r.g(var13, "partition {\n            …\"data\")\n                }");
            val var18: ContentInfoCompat = var13.first as ContentInfoCompat;
            var11 = var13.second as ContentInfoCompat;
            if (var18 != null) {
               if (!var20) {
                  var0.insertedPayloads.add(var3);
               }

               var22 = var18.c().getItemCount();
   ...
   private inline fun ContentInfoCompat.forEachIntent(action: (Intent) -> Unit) {
      ...
      for (int var3 = 0; var3 < var4; var3++) {
         ...
         r.g(var5, "clip.getItemAt(itemIndex).intent");
         var2.invoke(var5);
      }
   }
   ...
   private inline fun ContentInfoCompat.forEachUri(action: (Uri) -> Unit) {
      ...
      for (int var3 = 0; var3 < var4; var3++) {
         ...
         r.g(var5, "clip.getItemAt(itemIndex).uri");
         var2.invoke(var5);
      }
   }

   @JvmStatic
   fun `lambda$5$lambda$1`(var0: Context, var1: Item): Boolean {
      r.h(var0, "$context");
      val var5: Uri = var1.getUri();
      var var3: Boolean = false;
      if (var5 != null) {
         val var6: java.lang.String = var0.getContentResolver().getType(var1.getUri());
         val var2: Boolean;
         if (var6 != null && kotlin.text.f.I(var6, "image/", false, 2, null)) {
            var2 = true;
         } else {
            var2 = false;
         }
   ...
   @JvmStatic
   fun `lambda$5$lambda$3`(var0: Item): Boolean {
      val var1: Boolean;
   ...
   private fun updateChatNodes(chatInputNodes: List<ChatInputNode>, offset: Int = 0) {
      ...
      if (!(var15 xor true)) {
         ...
         r.g(var10, "editText.editableText");
      ...
      if (!(var15 xor true)) {
         ...
         r.g(var13, "editText.editableText");

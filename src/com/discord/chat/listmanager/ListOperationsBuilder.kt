...
public class ListOperationsBuilder {
   ...
   private fun addChange(changeOperation: Change) {
      ...
      if (var3 is ListOperation.Change) {
         ...
         if (var2 == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.ChangeRange(new IntRange(var6.getIndex(), var1.getIndex())));
         } else if (var2 == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.ChangeRange(new IntRange(var1.getIndex(), var6.getIndex())));
         } else {
         ...
         if ((var3 as ListOperation.ChangeRange).getLast() == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.ChangeRange(new IntRange(var5.getFirst(), var1.getIndex())));
         } else if (var5.getFirst() == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.ChangeRange(new IntRange(var1.getIndex(), var5.getLast())));
         } else {
            this.listOperations.add(var1);
         }
      } else {
   ...
   private fun addInsert(insertOperation: Insert) {
      ...
      if (var3 is ListOperation.Insert) {
         ...
         if (var2 == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.InsertRange(new IntRange(var6.getIndex(), var1.getIndex())));
         } else if (var2 == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.InsertRange(new IntRange(var1.getIndex(), var6.getIndex())));
         } else {
            this.listOperations.add(var1);
         }
         ...
         if ((var3 as ListOperation.InsertRange).getLast() == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.InsertRange(new IntRange(var5.getFirst(), var1.getIndex())));
         } else if (var5.getFirst() == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.InsertRange(new IntRange(var1.getIndex(), var5.getLast())));
         } else {
            this.listOperations.add(var1);
         }
      } else {
   ...
   private fun addRemove(removeOperation: Remove) {
      ...
      if (var3 is ListOperation.Remove) {
         ...
         if (var2 == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.RemoveRange(new IntRange(var6.getIndex(), var1.getIndex())));
         } else if (var2 == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.RemoveRange(new IntRange(var1.getIndex(), var6.getIndex())));
         } else {
            this.listOperations.add(var1);
         }
         ...
         if ((var3 as ListOperation.RemoveRange).getLast() == var1.getIndex() - 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.RemoveRange(new IntRange(var5.getFirst(), var1.getIndex())));
         } else if (var5.getFirst() == var1.getIndex() + 1) {
            this.listOperations.set(CollectionsKt.m(this.listOperations), new ListOperation.RemoveRange(new IntRange(var1.getIndex(), var5.getLast())));
         } else {
            this.listOperations.add(var1);
         }
      } else {

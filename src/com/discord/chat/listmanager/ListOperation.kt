   ...
   public data class ChangeRange(range: IntRange) : ListOperation() {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return this.range == (var1 as ListOperation.ChangeRange).range;
         }
      }
   ...
   public data class InsertRange(range: IntRange) : ListOperation() {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return this.range == (var1 as ListOperation.InsertRange).range;
         }
      }
   ...
   public data class RemoveRange(range: IntRange) : ListOperation() {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return this.range == (var1 as ListOperation.RemoveRange).range;
         }
      }

...
public class ChatListManager(coroutineScope: CoroutineScope) {
   ...
   private fun modifyExistingRows(updates: List<Row>): com.discord.chat.listmanager.ChatListManager.RowsModificationResult {
      ...
      while (true) {
         ...
         for (var4 = false; var13.hasNext(); var4 = true) {
            val var16: Row = var13.next() as Row;
         ...
         for (Object var19 : var10) {
            if ((var19 as Row).getChangeType() === ChangeType.DELETE || (var19 as Row).getChangeType() === ChangeType.UPDATE) {
               var14.add(var19);
            }
         }
   ...
   private fun Row.toChatListItem(): ChatListItem {
      ...
      if (var1 is MessageRow) {
         ...
         var9 = new BlockedGroupChatListItem(var7, var8, var2, var4, var3, var5, i.L(var13));
      }

...
internal data class OnTruncateMessageData(messageId: MessageId) : OnTruncateMessageData(var1), ReactEvent {
   ...
   fun OnTruncateMessageData(var1: Int, var2: java.lang.String, var3: SerializationConstructorMarker) {
      if (1 != (var1 and 1)) {
         n1.b(var1, 1, OnTruncateMessageData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   @JvmStatic
   public fun `write$Self`(self: OnTruncateMessageData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<OnTruncateMessageData> {
      ...
      public open fun serialize(encoder: Encoder, value: OnTruncateMessageData) {
         ...
         OnTruncateMessageData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

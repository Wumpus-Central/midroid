...
public data class MediaAttachmentPlaybackEndedData(messageId: MessageId,
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): MediaAttachmentPlaybackEndedData {
            ...
            while (var7) {
               ...
               switch (var8) {
                  ...
                  case 0:
                     val var23: MessageId;
                     if (var11 != null) {
                        var23 = MessageId.box-impl(var11);
                     } else {
                        var23 = null;
                     }
         ...
         var14.b(var13);
         return new MediaAttachmentPlaybackEndedData(var6, var11, var3, var4, (UserId)var10, var2, var9, var17, null, null);
      }

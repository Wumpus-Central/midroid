...
public data class MediaAttachmentPlaybackEndedData(messageId: MessageId,
   ...
   fun MediaAttachmentPlaybackEndedData(
      ...
      if (127 != (var1 and 127)) {
         p0.b(var1, 127, MediaAttachmentPlaybackEndedData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{MessageId.$serializer.INSTANCE, F.a, F.a, UserId.$serializer.INSTANCE, F.a, h.a, C0.a};
      }
      ...
      public open fun deserialize(decoder: Decoder): MediaAttachmentPlaybackEndedData {
         ...
         if (var14.y()) {
            ...
            var12 = var14.m(var13, 3, UserId.$serializer.INSTANCE, null) as UserId;
            var2 = var14.G(var13, 4);
            var9 = var14.s(var13, 5);
            val var11: java.lang.String = var14.t(var13, 6);
            var10 = var16;
            var17 = var11;
            var6 = 127;
         } else {
            ...
            while (var7) {
               ...
               switch (var8) {
                  ...
                  case 0:
                     ...
                     val var24: MessageId = var14.m(var13, 0, MessageId.$serializer.INSTANCE, var23) as MessageId;
                     if (var24 != null) {
         ...
         var14.b(var13);
         return new MediaAttachmentPlaybackEndedData(var6, var10, var4, var3, (UserId)var12, var2, var9, var17, null, null);
      }

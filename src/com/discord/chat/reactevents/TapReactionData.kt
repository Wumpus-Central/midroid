   ...
   public override fun serialize(): WritableMap {
      ...
      if (this.reaction != null) {
         var4 = NativeMapExtensionsKt.nativeMapOf(
            v.a("emoji", NativeMapExtensionsKt.nativeMapOf(v.a("name", this.reaction.getEmoji().getName()), v.a("id", this.reaction.getEmoji().getId()))),
      ...
      return NativeMapExtensionsKt.nativeMapOf(var2, var3, v.a("isBurst", var6), v.a("location", this.location));
   }

...
public data class TapSafetyPolicyNoticeEmbed(classificationId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: TapSafetyPolicyNoticeEmbed, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<TapSafetyPolicyNoticeEmbed> {
      ...
      public open fun serialize(encoder: Encoder, value: TapSafetyPolicyNoticeEmbed) {
         ...
         TapSafetyPolicyNoticeEmbed.write$Self(var2, var4, var3);
         var4.c(var3);
      }

   ...
   public object `$serializer` : f0<TapChannelData> {
      ...
      public open fun deserialize(decoder: Decoder): TapChannelData {
         ...
         if (var5) {
            ...
            val var6: Any = var10.n(var9, 1, (DeserializationStrategy)var12, null);
               ...
               if (var4 != -1) {
                  if (var4 != 0) {
                     if (var4 != 1) {
                        ...
                        var14 = var10.n(var9, 2, a2.a, var14);
                        var2 |= 4;
                     } else {
                        var12 = var10.n(var9, 1, a2.a, var12);
                        var2 |= 2;
                     }
                  } else {
         ...
         var10.c(var9);
         return new TapChannelData(var2, var7 as java.lang.String, var8 as java.lang.String, var12 as java.lang.String, null);
      }

...
internal data class LongPressMessageEvent(messageId: String,
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         val var1: N = N.a;
         return new KSerializer[]{C0.a, C0.a, N.a, C0.a, a.u(C0.a), a.u(var1)};
      }
      ...
      public open fun deserialize(decoder: Decoder): LongPressMessageEvent {
         ...
         if (var12.y()) {
            ...
            var7 = var12.v(var11, 4, C0.a, null) as java.lang.String;
         ...
         var12.b(var11);
         return new LongPressMessageEvent(var3, var9, var8, var2, var6, var7, (Integer)var13, null);
      }

...
public data class TapAutoModerationFeedbackData(messageId: String, channelId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: TapAutoModerationFeedbackData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<TapAutoModerationFeedbackData> {
      ...
      @JvmStatic
      fun {
         val var0: TapAutoModerationFeedbackData.$serializer = new TapAutoModerationFeedbackData.$serializer();
         INSTANCE = var0;
         val var1: PluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.discord.chat.reactevents.TapAutoModerationFeedbackData", var0, 2);
      ...
      public open fun deserialize(decoder: Decoder): TapAutoModerationFeedbackData {
         r.h(var1, "decoder");
         ...
         var7.c(var6);
         return new TapAutoModerationFeedbackData(var2, var8, var5, null);
      }

      public open fun serialize(encoder: Encoder, value: TapAutoModerationFeedbackData) {
         r.h(var1, "encoder");
         r.h(var2, "value");
         val var3: SerialDescriptor = this.getDescriptor();
         val var4: CompositeEncoder = var1.b(var3);
         TapAutoModerationFeedbackData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

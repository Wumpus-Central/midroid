...
public data class LongPressAvatarData(messageId: String, userId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: LongPressAvatarData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public override fun toString(): String {
      ...
      var1.append("LongPressAvatarData(messageId=");
      var1.append(var2);
      var1.append(", userId=");
      var1.append(var3);
      var1.append(")");
   ...
   public object `$serializer` : f0<LongPressAvatarData> {
      ...
      @JvmStatic
      fun {
         val var0: LongPressAvatarData.$serializer = new LongPressAvatarData.$serializer();
         INSTANCE = var0;
         val var1: PluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.discord.chat.reactevents.LongPressAvatarData", var0, 2);
      ...
      public open fun deserialize(decoder: Decoder): LongPressAvatarData {
         r.h(var1, "decoder");
         ...
         var7.c(var6);
         return new LongPressAvatarData(var2, var8, var5, null);
      }

      public open fun serialize(encoder: Encoder, value: LongPressAvatarData) {
         r.h(var1, "encoder");
         r.h(var2, "value");
         val var3: SerialDescriptor = this.getDescriptor();
         val var4: CompositeEncoder = var1.b(var3);
         LongPressAvatarData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

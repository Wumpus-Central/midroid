...
public data class TapUsernameData(messageId: String, userId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: TapUsernameData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public override fun toString(): String {
      ...
      var3.append("TapUsernameData(messageId=");
      var3.append(var2);
      var3.append(", userId=");
      var3.append(var1);
      var3.append(")");
   ...
   public object `$serializer` : f0<TapUsernameData> {
      ...
      @JvmStatic
      fun {
         val var0: TapUsernameData.$serializer = new TapUsernameData.$serializer();
         INSTANCE = var0;
         val var1: PluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.discord.chat.reactevents.TapUsernameData", var0, 2);
      ...
      public open fun deserialize(decoder: Decoder): TapUsernameData {
         r.h(var1, "decoder");
         ...
         var7.c(var6);
         return new TapUsernameData(var2, var8, var5, null);
      }

      public open fun serialize(encoder: Encoder, value: TapUsernameData) {
         r.h(var1, "encoder");
         r.h(var2, "value");
         val var3: SerialDescriptor = this.getDescriptor();
         val var4: CompositeEncoder = var1.b(var3);
         TapUsernameData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

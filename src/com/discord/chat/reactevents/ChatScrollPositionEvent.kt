...
internal data class ChatScrollPositionEvent(isAtBottom: Boolean,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         if (this.isAtBottom != var1.isAtBottom) {
            ...
            return false;
         } else if (!r.c(this.lastVisibleMessagePercentVisible, var1.lastVisibleMessagePercentVisible)) {
            return false;
         } else {
   ...
   public override fun hashCode(): Int {
      ...
      return ((((((((((var8 * 31 + var7) * 31 + var3) * 31 + var6) * 31 + var10) * 31 + var4) * 31 + var9) * 31 + var5) * 31 + var1) * 31 + var11) * 31 + var2)
            * 31

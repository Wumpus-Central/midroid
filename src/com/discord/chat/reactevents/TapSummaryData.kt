...
internal data class TapSummaryData(channelId: String, messageId: String, summaryId: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: TapSummaryData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
      var1.z(var2, 0, var0.channelId);
      var1.z(var2, 1, var0.messageId);
      var1.z(var2, 2, var0.summaryId);
   }
   ...
   public object `$serializer` : f0<TapSummaryData> {
      ...
      public open fun deserialize(decoder: Decoder): TapSummaryData {
         ...
         var9.c(var8);
         return new TapSummaryData(var2, var5, var7, var10, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: TapSummaryData) {
         ...
         TapSummaryData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

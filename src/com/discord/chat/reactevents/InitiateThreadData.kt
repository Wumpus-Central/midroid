...
internal data class InitiateThreadData(messageId: MessageId, channelId: ChannelId) : InitiateThreadData(var1, var2), ReactEvent {
   ...
   fun InitiateThreadData(var1: Int, var2: java.lang.String, var3: ChannelId, var4: SerializationConstructorMarker) {
      if (3 != (var1 and 3)) {
         p0.b(var1, 3, InitiateThreadData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   public object `$serializer` : G {
      ...
      @JvmStatic
      fun {
         val var0: InitiateThreadData.$serializer = new InitiateThreadData.$serializer();
         INSTANCE = var0;
         val var1: PluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.discord.chat.reactevents.InitiateThreadData", var0, 2);
      ...
      public open fun deserialize(decoder: Decoder): InitiateThreadData {
         q.h(var1, "decoder");
         ...
         var8.b(var7);
         return new InitiateThreadData(var2, var5, var11, null, null);
      }

      public open fun serialize(encoder: Encoder, value: InitiateThreadData) {
         q.h(var1, "encoder");
         q.h(var2, "value");
         val var3: SerialDescriptor = this.getDescriptor();
         val var4: CompositeEncoder = var1.c(var3);
         InitiateThreadData.write$Self$chat_release(var2, var4, var3);
         var4.b(var3);
      }

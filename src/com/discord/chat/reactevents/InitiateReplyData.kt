...
internal data class InitiateReplyData(messageId: MessageId, channelId: ChannelId) : InitiateReplyData(var1, var2), ReactEvent {
   ...
   fun InitiateReplyData(var1: Int, var2: java.lang.String, var3: ChannelId, var4: SerializationConstructorMarker) {
      if (3 != (var1 and 3)) {
         n1.b(var1, 3, InitiateReplyData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   @JvmStatic
   public fun `write$Self`(self: InitiateReplyData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<InitiateReplyData> {
      ...
      public open fun deserialize(decoder: Decoder): InitiateReplyData {
         ...
         return new InitiateReplyData(var2, (java.lang.String)var10, var6 as ChannelId, null, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: InitiateReplyData) {
         ...
         InitiateReplyData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

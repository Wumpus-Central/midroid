...
public data class TapRemixData(messageId: MessageId) : TapRemixData(var1), ReactEvent {
   ...
   fun TapRemixData(var1: Int, var2: java.lang.String, var3: SerializationConstructorMarker) {
      if (1 != (var1 and 1)) {
         n1.b(var1, 1, TapRemixData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   @JvmStatic
   public fun `write$Self`(self: TapRemixData, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<TapRemixData> {
      ...
      public open fun serialize(encoder: Encoder, value: TapRemixData) {
         r.h(var1, "encoder");
         r.h(var2, "value");
         val var3: SerialDescriptor = this.getDescriptor();
         val var4: CompositeEncoder = var1.b(var3);
         TapRemixData.write$Self(var2, var4, var3);
         var4.c(var3);
      }

...
public data class TapTagData(messageId: MessageId, channelId: ChannelId, tagType: String?) : TapTagData(var1, var2, var4), ReactEvent {
   ...
   fun TapTagData(var1: Int, var2: java.lang.String, var3: ChannelId, var4: java.lang.String, var5: SerializationConstructorMarker) {
      if (7 != (var1 and 7)) {
         p0.b(var1, 7, TapTagData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{MessageId.$serializer.INSTANCE, ChannelId.$serializer.INSTANCE, a.u(C0.a)};
      }
      ...
      public open fun deserialize(decoder: Decoder): TapTagData {
         ...
         if (var9.y()) {
            ...
            val var7: java.lang.String = var9.v(var8, 2, C0.a, null) as java.lang.String;
            var6 = var11;
            var12 = var7;
            var2 = 7;
         } else {
               ...
               if (var4 != -1) {
                  if (var4 != 0) {
                     if (var4 != 1) {
                        ...
                        var5 = var9.v(var8, 2, C0.a, var5) as java.lang.String;
                        var2 |= 4;
                     } else {

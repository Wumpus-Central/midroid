...
public data class TapSelectActionComponent(messageId: MessageId, componentId: String) : TapSelectActionComponent(var1, var2), ReactEvent {
   ...
   fun TapSelectActionComponent(var1: Int, var2: java.lang.String, var3: java.lang.String, var4: SerializationConstructorMarker) {
      if (3 != (var1 and 3)) {
         n1.b(var1, 3, TapSelectActionComponent.$serializer.INSTANCE.getDescriptor());
      }
   ...
   @JvmStatic
   public fun `write$Self`(self: TapSelectActionComponent, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<TapSelectActionComponent> {
      ...
      public open fun deserialize(decoder: Decoder): TapSelectActionComponent {
         ...
         return new TapSelectActionComponent(var2, (java.lang.String)var10, var6, null, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: TapSelectActionComponent) {
         ...
         TapSelectActionComponent.write$Self(var2, var4, var3);
         var4.c(var3);
      }

                  ...
                  label131: {
                     ...
                     label118: {
                        try {
                           ...
                           var1 = this.$rowsJSON;
                           var44.a();
                           var45 = var44.b(new f(Row.Companion.serializer()), var1) as java.util.List;
                           if (this.$scrollDataJSON != null) {
                              val var65: Json = ChatModule.access$getJson$cp();
                              var1 = this.$scrollDataJSON;
                              var65.a();
                              var1 = var65.b(ChatScrollData.Companion.serializer(), var1) as ChatScrollData;
                              break label118;
                           }
                     ...
                     while (true) {
                        label127: {
                           ...
                           try {
                              ...
                              var71.append(var41);
                              CrashReporting.captureException$default(var69, new Exception(var71.toString()), false, 2, null);

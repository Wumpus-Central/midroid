...
public class ChatModule(reactContext: ReactApplicationContext) : NativeChatModuleSpec(var1) {
   ...
   public override fun clearRows(tagValue: Double, changesetUpdateIdValue: Double) {
      ChatModule.Companion.access$withChatManager(
         Companion,
         (int)var1,
         new Function2<ChatListManager, Continuation, Object>(this, (int)var1, (int)var3, null) {
                     ...
                     label118: {
                        try {
                           ...
                           if (this.$scrollDataJSON != null) {
                              ...
                              val var24: java.lang.String = this.$scrollDataJSON;
                              var53.a();
                              var1 = var53.b(ChatScrollData.Companion.serializer(), var24) as ChatScrollData;
                              break label118;
                           }
                     ...
                     while (true) {
                        label127: {
                           ...
                           try {
                              ...
                              var7 = (var1 as Data).getData().entrySet().iterator();
                           ...
                           while (true) {
                              ...
                              try {
                                 ...
                                 var9 = var7.next() as Entry;
                                 if (var8.contains(var9.getKey())) {
                                    var67.put(var9.getKey(), "<REDACTED>");
                                    continue;
                                 }
                              ...
                              try {
                                 var67.put(var9.getKey(), var9.getValue());
   ...
   public companion object {
      ...
      private fun cancelCoroutineChildren() {
         ...
         kotlinx.coroutines.v.g(var2, new CancellationException(var3.toString()));
      }

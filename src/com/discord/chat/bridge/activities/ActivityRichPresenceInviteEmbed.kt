...
public data class ActivityRichPresenceInviteEmbed(ctaButtonEnabled: Boolean? = java.lang.Boolean.FALSE,
   ...
   fun {
      ...
      val var1: E0 = E0.a;
      $childSerializers = new KSerializer[]{null, null, null, var0, null, null, null, null, null, null, new f(E0.a), null, new f(var1), null, null};
   }
   ...
   init {
      ...
      this.footerLabel = var3;
      this.gradientColors = var4;
      this.headerText = var5;
      this.iconSrc = var6;
      this.isActive = var7;
      this.isPlatformSupported = var8;
      this.isSpotifyParty = var9;
      this.maxPartySize = var10;
      this.partyMemberAvatarURIs = var11;
      this.partySizeText = var12;
      this.platformIconKeys = var13;
      this.subtitle = var14;
      this.title = var15;
   }
   ...
   public operator fun component11(): List<String>? {
   ...
   public operator fun component13(): List<String>? {
   ...
   public operator fun component4(): List<RGBAColorModel>? {
   ...
   public fun copy(
      ...
      return new ActivityRichPresenceInviteEmbed(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15);
   }
   ...
   public override fun hashCode(): Int {
      ...
      if (this.footerLabel == null) {
         ...
         var3 = this.footerLabel.hashCode();
      }
      ...
      if (this.gradientColors == null) {
         ...
         var4 = this.gradientColors.hashCode();
      }
      ...
      if (this.isPlatformSupported == null) {
         ...
         var8 = this.isPlatformSupported.hashCode();
      }
      ...
      if (this.isSpotifyParty == null) {
         ...
         var9 = this.isSpotifyParty.hashCode();
      }
      ...
      if (this.maxPartySize == null) {
         ...
         var10 = this.maxPartySize.hashCode();
      }
      ...
      if (this.partyMemberAvatarURIs == null) {
         ...
         var11 = this.partyMemberAvatarURIs.hashCode();
      }
      ...
      if (this.partySizeText == null) {
         ...
         var12 = this.partySizeText.hashCode();
      }
      ...
      if (this.platformIconKeys == null) {
         ...
         var13 = this.platformIconKeys.hashCode();
      }
      ...
      if (this.subtitle == null) {
         ...
         var14 = this.subtitle.hashCode();
      }

      if (this.title != null) {
         var15 = this.title.hashCode();
      }
                        ...
                        (
                                 (
                                          (
                                                   (
                                                            (
                                                                     ((((((var1 * 31 + var2) * 31 + var3) * 31 + var4) * 31 + var5) * 31 + var6) * 31 + var7)
                                                                           * 31
                                                                        + var8
                                                                  )
                                                                  * 31
   ...
   public override fun toString(): String {
      val var3: java.lang.Boolean = this.ctaButtonEnabled;
      val var4: java.lang.String = this.ctaButtonText;
      ...
      val var15: java.lang.String = this.iconSrc;
      val var2: java.lang.Boolean = this.isActive;
      val var8: java.lang.Boolean = this.isPlatformSupported;
      ...
      val var5: java.util.List = this.platformIconKeys;
      val var13: java.lang.String = this.subtitle;
      val var11: java.lang.String = this.title;
      val var16: StringBuilder = new StringBuilder();
      var16.append("ActivityRichPresenceInviteEmbed(ctaButtonEnabled=");
      var16.append(var3);
      var16.append(", ctaButtonText=");
      var16.append(var4);
      var16.append(", footerLabel=");
      var16.append(var7);
      var16.append(", gradientColors=");
      var16.append(var10);
      var16.append(", headerText=");
      var16.append(var14);
      var16.append(", iconSrc=");
      var16.append(var15);
      var16.append(", isActive=");
      var16.append(var2);
      var16.append(", isPlatformSupported=");
      var16.append(var8);
      var16.append(", isSpotifyParty=");
      var16.append(var1);
      var16.append(", maxPartySize=");
      var16.append(var12);
      var16.append(", partyMemberAvatarURIs=");
      var16.append(var6);
      var16.append(", partySizeText=");
      var16.append(var9);
      var16.append(", platformIconKeys=");
      var16.append(var5);

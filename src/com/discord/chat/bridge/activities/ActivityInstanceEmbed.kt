...
public data class ActivityInstanceEmbed(applicationId: ApplicationId,
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): ActivityInstanceEmbed {
         ...
         if (var11) {
            var14 = var19.y(var18, 0, ApplicationId.$serializer.INSTANCE, null) as ApplicationId;
            var16 = var19.y(var18, 1, ChannelId.$serializer.INSTANCE, null) as ChannelId;
         ...
         return new ActivityInstanceEmbed(
            var4, (ApplicationId)var14, (ChannelId)var16, var13, var15, var27, (boolean)var5, var12, var7, (boolean)var3, null, null
         );
      }

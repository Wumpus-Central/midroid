...
public data class ConnectionsRoleTag(id: String, name: String, backgroundColor: Int, iconColor: Int) {
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{C0.a, C0.a, N.a, N.a};
      }
      ...
      public open fun deserialize(decoder: Decoder): ConnectionsRoleTag {
         ...
         if (var10.y()) {
            ...
            val var7: java.lang.String = var10.t(var9, 1);
            var4 = var10.k(var9, 2);
            var2 = var10.k(var9, 3);
            var3 = 15;
            var8 = var11;
         ...
         var10.b(var9);
         return new ConnectionsRoleTag(var3, var8, var12, var4, var2, null);
      }

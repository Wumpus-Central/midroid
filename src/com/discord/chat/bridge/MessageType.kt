...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   @JvmStatic
   fun {
      val var14: MessageType = new MessageType(1);
      RECIPIENT_ADD = var14;
      ...
      val var15: MessageType = new MessageType(9);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_1 = var15;
      ...
      val var35: MessageType = new MessageType(15);
      GUILD_DISCOVERY_REQUALIFIED = var35;
      ...
      val var13: MessageType = new MessageType(21);
      THREAD_STARTER_MESSAGE = var13;
      ...
      val var4: MessageType = new MessageType(63);
      EMOJI_ADDED = var4;

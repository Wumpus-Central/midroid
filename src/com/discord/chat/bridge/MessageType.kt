...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   fun {
      ...
      val var20: MessageType = new MessageType(7);
      USER_JOIN = var20;
      ...
      val var37: MessageType = new MessageType(17);
      GUILD_DISCOVERY_GRACE_PERIOD_FINAL_WARNING = var37;
      ...
      STAGE_START = var3;
      val var32: MessageType = new MessageType(28);
      STAGE_END = var32;
      ...
      val var29: MessageType = new MessageType(34);
      PRIVATE_CHANNEL_INTEGRATION_REMOVED = var29;
      ...
      val var4: MessageType = new MessageType(54);
      GUILD_JOIN_REQUEST_WITHDRAWN_NOTIFICATION = var4;

...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   @JvmStatic
   fun {
      val var36: MessageType = new MessageType(1);
      RECIPIENT_ADD = var36;
      ...
      val var15: MessageType = new MessageType(7);
      USER_JOIN = var15;
      val var14: MessageType = new MessageType(8);
      USER_PREMIUM_GUILD_SUBSCRIPTION = var14;
      val var10: MessageType = new MessageType(9);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_1 = var10;
      val var16: MessageType = new MessageType(10);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_2 = var16;
      val var7: MessageType = new MessageType(11);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_3 = var7;
      val var39: MessageType = new MessageType(12);
      CHANNEL_FOLLOW_ADD = var39;
      val var0: MessageType = new MessageType(13);
      GUILD_STREAM = var0;
      val var24: MessageType = new MessageType(14);
      GUILD_DISCOVERY_DISQUALIFIED = var24;
      val var30: MessageType = new MessageType(15);
      GUILD_DISCOVERY_REQUALIFIED = var30;
      val var25: MessageType = new MessageType(16);
      GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING = var25;
      val var28: MessageType = new MessageType(17);
      GUILD_DISCOVERY_GRACE_PERIOD_FINAL_WARNING = var28;
      val var3: MessageType = new MessageType(18);
      THREAD_CREATED = var3;
      val var18: MessageType = new MessageType(21);
      THREAD_STARTER_MESSAGE = var18;
      val var27: MessageType = new MessageType(22);
      GUILD_INVITE_REMINDER = var27;
      val var29: MessageType = new MessageType(25);
      ROLE_SUBSCRIPTION_PURCHASE = var29;
      val var9: MessageType = new MessageType(27);
      STAGE_START = var9;
      ...
      STAGE_TOPIC = var13;
      val var34: MessageType = new MessageType(32);
      GUILD_APPLICATION_PREMIUM_SUBSCRIPTION = var34;
      ...
      val var22: MessageType = new MessageType(40);
      GUILD_DEADCHAT_REVIVE_PROMPT = var22;
      val var2: MessageType = new MessageType(42);
      GUILD_GAMING_STATS_PROMPT = var2;
      val var12: MessageType = new MessageType(46);
      POLL_RESULT = var12;
      val var37: MessageType = new MessageType(49);
      CHANNEL_LINKED_TO_LOBBY = var37;
      val var8: MessageType = new MessageType(51);
      IN_GAME_MESSAGE_NUX = var8;
      val var4: MessageType = new MessageType(52);
      GUILD_JOIN_REQUEST_ACCEPT_NOTIFICATION = var4;
      val var5: MessageType = new MessageType(53);
      GUILD_JOIN_REQUEST_REJECT_NOTIFICATION = var5;
      val var26: MessageType = new MessageType(54);
      GUILD_JOIN_REQUEST_WITHDRAWN_NOTIFICATION = var26;
      val var17: MessageType = new MessageType(56);
      CHAT_WALLPAPER_SET = var17;
      val var6: MessageType = new MessageType(57);
      CHAT_WALLPAPER_REMOVED = var6;
      val var38: MessageType = new MessageType(63);
      EMOJI_ADDED = var38;
      val var20: Array<MessageType> = $values();
      $VALUES = var20;
      $ENTRIES = a.a(var20);

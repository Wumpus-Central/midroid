...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   @JvmStatic
   fun {
      val var15: MessageType = new MessageType(1);
      RECIPIENT_ADD = var15;
      ...
      USER_JOIN = var8;
      val var21: MessageType = new MessageType(8);
      USER_PREMIUM_GUILD_SUBSCRIPTION = var21;
      val var32: MessageType = new MessageType(9);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_1 = var32;
      val var40: MessageType = new MessageType(10);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_2 = var40;
      val var36: MessageType = new MessageType(11);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_3 = var36;
      val var37: MessageType = new MessageType(12);
      CHANNEL_FOLLOW_ADD = var37;
      val var1: MessageType = new MessageType(13);
      GUILD_STREAM = var1;
      val var7: MessageType = new MessageType(14);
      GUILD_DISCOVERY_DISQUALIFIED = var7;
      val var3: MessageType = new MessageType(15);
      GUILD_DISCOVERY_REQUALIFIED = var3;
      val var12: MessageType = new MessageType(16);
      GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING = var12;
      ...
      val var26: MessageType = new MessageType(25);
      ROLE_SUBSCRIPTION_PURCHASE = var26;
      val var39: MessageType = new MessageType(27);
      STAGE_START = var39;
      val var16: MessageType = new MessageType(28);
      STAGE_END = var16;
      val var14: MessageType = new MessageType(29);
      STAGE_SPEAKER = var14;
      val var27: MessageType = new MessageType(30);
      STAGE_RAISE_HAND = var27;
      val var25: MessageType = new MessageType(31);
      STAGE_TOPIC = var25;
      val var6: MessageType = new MessageType(32);
      GUILD_APPLICATION_PREMIUM_SUBSCRIPTION = var6;
      val var9: MessageType = new MessageType(33);
      PRIVATE_CHANNEL_INTEGRATION_ADDED = var9;
      val var35: MessageType = new MessageType(34);
      PRIVATE_CHANNEL_INTEGRATION_REMOVED = var35;
      ...
      val var4: MessageType = new MessageType(46);
      POLL_RESULT = var4;
      val var19: MessageType = new MessageType(49);
      CHANNEL_LINKED_TO_LOBBY = var19;
      val var20: MessageType = new MessageType(51);
      IN_GAME_MESSAGE_NUX = var20;
      val var5: MessageType = new MessageType(52);
      GUILD_JOIN_REQUEST_ACCEPT_NOTIFICATION = var5;
      val var10: MessageType = new MessageType(53);
      GUILD_JOIN_REQUEST_REJECT_NOTIFICATION = var10;
      val var34: MessageType = new MessageType(54);
      GUILD_JOIN_REQUEST_WITHDRAWN_NOTIFICATION = var34;
      val var29: MessageType = new MessageType(56);
      CHAT_WALLPAPER_SET = var29;
      val var2: MessageType = new MessageType(57);
      CHAT_WALLPAPER_REMOVED = var2;

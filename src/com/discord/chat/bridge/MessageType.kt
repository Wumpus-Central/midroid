...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   fun {
      ...
      USER_JOIN = var2;
      val var31: MessageType = new MessageType(8);
      USER_PREMIUM_GUILD_SUBSCRIPTION = var31;
      ...
      val var29: MessageType = new MessageType(12);
      CHANNEL_FOLLOW_ADD = var29;
      ...
      val var32: MessageType = new MessageType(16);
      GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING = var32;
      ...
      val var23: MessageType = new MessageType(53);
      GUILD_JOIN_REQUEST_REJECT_NOTIFICATION = var23;
      val var8: MessageType = new MessageType(54);
      GUILD_JOIN_REQUEST_WITHDRAWN_NOTIFICATION = var8;

...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   @JvmStatic
   fun {
      val var5: MessageType = new MessageType(1);
      RECIPIENT_ADD = var5;
      val var19: MessageType = new MessageType(2);
      RECIPIENT_REMOVE = var19;
      val var1: MessageType = new MessageType(3);
      CALL = var1;
      val var29: MessageType = new MessageType(4);
      CHANNEL_NAME_CHANGE = var29;
      ...
      val var9: MessageType = new MessageType(7);
      USER_JOIN = var9;
      ...
      val var12: MessageType = new MessageType(11);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_3 = var12;
      ...
      val var25: MessageType = new MessageType(15);
      GUILD_DISCOVERY_REQUALIFIED = var25;
      ...
      val var39: MessageType = new MessageType(25);
      ROLE_SUBSCRIPTION_PURCHASE = var39;
      val var4: MessageType = new MessageType(27);
      STAGE_START = var4;
      val var20: MessageType = new MessageType(28);
      STAGE_END = var20;
      val var13: MessageType = new MessageType(29);
      STAGE_SPEAKER = var13;
      val var37: MessageType = new MessageType(30);
      STAGE_RAISE_HAND = var37;
      ...
      val var16: MessageType = new MessageType(46);
      POLL_RESULT = var16;
      val var14: MessageType = new MessageType(49);
      CHANNEL_LINKED_TO_LOBBY = var14;
      ...
      val var40: MessageType = new MessageType(53);
      GUILD_JOIN_REQUEST_REJECT_NOTIFICATION = var40;
      ...
      val var26: MessageType = new MessageType(57);
      CHAT_WALLPAPER_REMOVED = var26;
      val var6: MessageType = new MessageType(63);
      EMOJI_ADDED = var6;
      val var34: Array<MessageType> = $values();
      $VALUES = var34;
      $ENTRIES = a.a(var34);

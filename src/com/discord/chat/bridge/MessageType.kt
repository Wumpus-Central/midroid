...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   fun {
      ...
      val var19: MessageType = new MessageType(7);
      USER_JOIN = var19;
      ...
      val var28: MessageType = new MessageType(25);
      ROLE_SUBSCRIPTION_PURCHASE = var28;
      ...
      val var20: MessageType = new MessageType(34);
      PRIVATE_CHANNEL_INTEGRATION_REMOVED = var20;

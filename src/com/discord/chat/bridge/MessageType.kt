...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   fun {
      ...
      val var3: MessageType = new MessageType(5);
      CHANNEL_ICON_CHANGE = var3;
      val var28: MessageType = new MessageType(6);
      CHANNEL_PINNED_MESSAGE = var28;
      val var37: MessageType = new MessageType(7);
      USER_JOIN = var37;
      val var14: MessageType = new MessageType(8);
      USER_PREMIUM_GUILD_SUBSCRIPTION = var14;
      val var30: MessageType = new MessageType(9);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_1 = var30;
      val var25: MessageType = new MessageType(10);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_2 = var25;
      val var38: MessageType = new MessageType(11);
      USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_3 = var38;
      ...
      val var35: MessageType = new MessageType(16);
      GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING = var35;
      ...
      val var8: MessageType = new MessageType(22);
      GUILD_INVITE_REMINDER = var8;
      val var2: MessageType = new MessageType(25);
      ROLE_SUBSCRIPTION_PURCHASE = var2;
      val var7: MessageType = new MessageType(27);
      STAGE_START = var7;
      val var17: MessageType = new MessageType(28);
      STAGE_END = var17;
      val var5: MessageType = new MessageType(29);
      STAGE_SPEAKER = var5;
      val var33: MessageType = new MessageType(30);
      STAGE_RAISE_HAND = var33;
      ...
      POLL_RESULT = var11;
      val var31: MessageType = new MessageType(49);
      CHANNEL_LINKED_TO_LOBBY = var31;
      val var13: MessageType = new MessageType(51);
      IN_GAME_MESSAGE_NUX = var13;
      val var12: MessageType = new MessageType(52);
      GUILD_JOIN_REQUEST_ACCEPT_NOTIFICATION = var12;
      ...
      val var29: MessageType = new MessageType(57);
      CHAT_WALLPAPER_REMOVED = var29;

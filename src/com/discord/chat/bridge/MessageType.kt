...
public enum class MessageType(serialNumber: Int) : IntEnum {
   ...
   @JvmStatic
   fun {
      val var11: MessageType = new MessageType(1);
      RECIPIENT_ADD = var11;
      val var15: MessageType = new MessageType(2);
      RECIPIENT_REMOVE = var15;
      val var0: MessageType = new MessageType(3);
      CALL = var0;
      val var7: MessageType = new MessageType(4);
      CHANNEL_NAME_CHANGE = var7;
      ...
      val var4: MessageType = new MessageType(16);
      GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING = var4;
      ...
      val var20: MessageType = new MessageType(33);
      PRIVATE_CHANNEL_INTEGRATION_ADDED = var20;
      val var17: MessageType = new MessageType(34);
      PRIVATE_CHANNEL_INTEGRATION_REMOVED = var17;
      val var27: MessageType = new MessageType(40);
      GUILD_DEADCHAT_REVIVE_PROMPT = var27;
      ...
      val var32: MessageType = new MessageType(57);
      CHAT_WALLPAPER_REMOVED = var32;

...
public data class Message(type: MessageType,
   ...
   public override fun toString(): String {
      ...
      val var18: java.lang.String = ChannelId.toString-impl(this.channelId);
      val var44: GuildId = this.guildId;
      val var63: MessageState = this.state;
      val var83: UserId = this.authorId;
      val var6: Long = this.flags;
      val var85: java.lang.String = this.edited;
      ...
      val var39: java.util.List = this.attachments;
      val var14: java.lang.Float = this.attachmentsOpacity;
      val var35: StructurableText = this.content;
      val var29: java.util.List = this.reactions;
      val var13: java.util.List = this.codedLinks;
      val var94: ActivityInstanceEmbed = this.activityInstanceEmbed;
      val var61: java.util.List = this.stickers;
      val var88: RoleIcon = this.roleIcon;
      val var92: ConnectionsRoleTag = this.connectionsRoleTag;
      val var69: ThreadEmbed = this.threadEmbed;
      ...
      val var50: ReferencedMessage = this.referencedMessage;
      val var31: ExecutedCommand = this.executedCommand;
      val var91: java.util.List = this.components;
      val var65: java.lang.String = this.threadStarterMessageHeader;
      val var55: java.lang.Boolean = this.communicationDisabled;
      val var56: java.lang.String = this.tagText;
      val var57: java.lang.Boolean = this.tagVerified;
      val var66: Int = this.tagTextColor;
      val var71: Int = this.tagBackgroundColor;
      val var59: java.lang.String = this.tagType;
      val var37: java.lang.String = this.tagIconUrl;
      val var46: java.lang.String = this.opTagText;
      val var51: EphemeralIndication = this.ephemeralIndication;
      val var41: SurveyIndication = this.surveyIndication;
      val var23: InteractionStatus = this.interactionStatus;
      val var68: java.lang.Boolean = this.useAttachmentGridLayout;
      val var40: java.lang.Boolean = this.useAttachmentUploadPreview;
      val var89: java.lang.Boolean = this.isCurrentUserMessageAuthor;
      val var36: java.lang.String = this.obscureLearnMoreLabel;
      ...
      val var43: java.lang.Boolean = this.missed;
      val var81: java.lang.Long = this.rawMilliseconds;
      val var78: Sticker = this.sticker;
      val var70: java.lang.String = this.stickerLabel;
      val var93: java.lang.String = this.buttonLabel;
      val var26: java.lang.Boolean = this.showInviteToSpeakButton;
      ...
      val var64: ForumPostActions = this.postActions;
      val var73: AutoModerationContext = this.autoModerationContext;
      val var30: ReferralEmbed = this.referralTrialOfferInfo;
      val var62: java.util.List = this.giftCodes;
      val var80: GiftEmbed = this.referralTrialOffer;
      ...
      val var49: PollData = this.pollData;
      val var19: SharedCustomThemeData = this.sharedClientTheme;
      val var21: CtaButton = this.ctaButton;
      val var22: Int = this.audioAttachmentBackgroundColor;
      val var87: ForwardInfo = this.forwardInfo;
      val var47: java.lang.Boolean = this.showInlineForwardButton;
      val var60: GuildId = this.clanTagGuildId;
      val var11: java.lang.String = this.clanTag;
      ...
      var20.append(", state=");
      var20.append(var63);
      var20.append(", authorId=");
      var20.append(var83);
      var20.append(", flags=");
      var20.append(var6);
      var20.append(", edited=");
      var20.append(var85);
      var20.append(", editedColor=");
      var20.append(var33);
      var20.append(", _constrainedWidth=");
      var20.append(var12);
      var20.append(", textColor=");
      var20.append(var42);
      var20.append(", linkColor=");
      var20.append(var38);
      var20.append(", timestamp=");
      var20.append(var82);
      var20.append(", timestampColor=");
      var20.append(var74);
      var20.append(", username=");
      var20.append(var34);
      var20.append(", usernameColor=");
      var20.append(var79);
      var20.append(", roleColor=");
      var20.append(var53);
      var20.append(", roleColors=");
      var20.append(var24);
      var20.append(", shouldShowRoleDot=");
      var20.append(var3);
      var20.append(", shouldShowRoleOnName=");
      var20.append(var2);
      var20.append(", colorString=");
      var20.append(var25);
      var20.append(", avatarURL=");
      var20.append(var52);
      var20.append(", avatarDecorationURL=");
      var20.append(var76);
      var20.append(", embeds=");
      var20.append(var28);
      var20.append(", attachments=");
      var20.append(var39);
      var20.append(", attachmentsOpacity=");
      var20.append(var14);
      var20.append(", content=");
      var20.append(var35);
      var20.append(", reactions=");
      var20.append(var29);
      var20.append(", codedLinks=");
      var20.append(var13);
      var20.append(", activityInstanceEmbed=");
      var20.append(var94);
      var20.append(", stickers=");
      var20.append(var61);
      var20.append(", roleIcon=");
      var20.append(var88);
      var20.append(", connectionsRoleTag=");
      var20.append(var92);
      var20.append(", threadEmbed=");
      var20.append(var69);
      var20.append(", mentioned=");
      var20.append(var1);
      var20.append(", gifAutoPlay=");
      var20.append(var27);
      var20.append(", animateEmoji=");
      var20.append(var90);
      var20.append(", showLinkDecorations=");
      var20.append(var77);
      var20.append(", referencedMessage=");
      var20.append(var50);
      var20.append(", executedCommand=");
      var20.append(var31);
      var20.append(", components=");
      var20.append(var91);
      var20.append(", threadStarterMessageHeader=");
      var20.append(var65);
      var20.append(", communicationDisabled=");
      var20.append(var55);
      var20.append(", tagText=");
      var20.append(var56);
      var20.append(", tagVerified=");
      var20.append(var57);
      var20.append(", tagTextColor=");
      var20.append(var66);
      var20.append(", tagBackgroundColor=");
      var20.append(var71);
      var20.append(", tagType=");
      var20.append(var59);
      var20.append(", tagIconUrl=");
      var20.append(var37);
      var20.append(", opTagText=");
      var20.append(var46);
      var20.append(", ephemeralIndication=");
      var20.append(var51);
      var20.append(", surveyIndication=");
      var20.append(var41);
      var20.append(", interactionStatus=");
      var20.append(var23);
      var20.append(", useAttachmentGridLayout=");
      var20.append(var68);
      var20.append(", useAttachmentUploadPreview=");
      var20.append(var40);
      var20.append(", isCurrentUserMessageAuthor=");
      var20.append(var89);
      var20.append(", obscureLearnMoreLabel=");
      var20.append(var36);
      var20.append(", usingGradientTheme=");
      var20.append(var86);
      var20.append(", title=");
      var20.append(var15);
      var20.append(", description=");
      var20.append(var54);
      var20.append(", avatarURLs=");
      var20.append(var17);
      var20.append(", isCallActive=");
      var20.append(var72);
      var20.append(", missed=");
      var20.append(var43);
      var20.append(", rawMilliseconds=");
      var20.append(var81);
      var20.append(", sticker=");
      var20.append(var78);
      var20.append(", stickerLabel=");
      var20.append(var70);
      var20.append(", buttonLabel=");
      var20.append(var93);
      var20.append(", showInviteToSpeakButton=");
      var20.append(var26);
      var20.append(", activityRichPresenceInviteEmbed=");
      var20.append(var75);
      var20.append(", isFirstForumPostMessage=");
      var20.append(var5);
      var20.append(", postActions=");
      var20.append(var64);
      var20.append(", autoModerationContext=");
      var20.append(var73);
      var20.append(", referralTrialOfferInfo=");
      var20.append(var30);
      var20.append(", giftCodes=");
      var20.append(var62);
      var20.append(", referralTrialOffer=");
      var20.append(var80);
      var20.append(", totalMonthsSubscribed=");
      var20.append(var32);
      var20.append(", postPreviewEmbeds=");
      var20.append(var45);
      var20.append(", channelPromptData=");
      var20.append(var84);
      var20.append(", safetyPolicyNoticeEmbed=");
      var20.append(var16);
      var20.append(", safetySystemNotificationEmbed=");
      var20.append(var67);
      var20.append(", pollData=");
      var20.append(var49);
      var20.append(", sharedClientTheme=");
      var20.append(var19);
      var20.append(", ctaButton=");
      var20.append(var21);
      var20.append(", audioAttachmentBackgroundColor=");
      var20.append(var22);
      var20.append(", forwardInfo=");
      var20.append(var87);
      var20.append(", showInlineForwardButton=");
      var20.append(var47);
      var20.append(", clanTagGuildId=");
      var20.append(var60);
      var20.append(", clanTag=");
      var20.append(var11);
      var20.append(", clanBadgeUrl=");
      var20.append(var48);
      var20.append(", gameApplicationId=");
      var20.append(var58);
      var20.append(", isAnnouncementChannel=");
      var20.append(var4);
      var20.append(")");

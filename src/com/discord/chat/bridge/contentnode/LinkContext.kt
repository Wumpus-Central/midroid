...
public data class LinkContext(usernameOnClick: UserNameOnClick? = null,
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): LinkContext {
         ...
         var var14: Any;
         var var16: Any;
         val var18: RoleSubscriptionOnClick;
         val var19: Any;
         var var24: Any;
         var var31: Any;
         var var36: Any;
         val var39: HandleMessage;
         if (var6) {
            var24 = UserNameOnClick.$serializer.INSTANCE;
            var12 = var22.n(var21, 0, UserNameOnClick.$serializer.INSTANCE, null) as UserNameOnClick;
            var31 = var22.n(var21, 1, (DeserializationStrategy)var24, null) as UserNameOnClick;
            var16 = var22.n(var21, 2, CommandOnClick.$serializer.INSTANCE, null) as CommandOnClick;
            var36 = var22.n(var21, 3, ActorHook.$serializer.INSTANCE, null) as ActorHook;
            val var17: ThreadOnClick = var22.n(var21, 4, ThreadOnClick.$serializer.INSTANCE, null) as ThreadOnClick;
            var13 = var22.n(var21, 5, PinsOnClick.$serializer.INSTANCE, null) as PinsOnClick;
            val var9: WebhookNameOnClick = var22.n(var21, 6, WebhookNameOnClick.$serializer.INSTANCE, null) as WebhookNameOnClick;
            var8 = var22.n(var21, 7, HandleDelete.$serializer.INSTANCE, null) as HandleDelete;
            val var10: RoleSubscriptionOnClick = var22.n(var21, 8, RoleSubscriptionOnClick.$serializer.INSTANCE, null) as RoleSubscriptionOnClick;
            val var26: HandleMessage = var22.n(var21, 9, HandleMessage.$serializer.INSTANCE, null) as HandleMessage;
            var24 = var22.n(var21, 10, TitleOnClick.$serializer.INSTANCE, null) as TitleOnClick;
            var2 = 2047;
            var14 = var31;
            var31 = var36;
            var36 = var17;
            ...
            while (var3) {
               ...
               switch (var5) {
                  case -1:
                     ...
                     break;
                  case 0:
                     var7 = var22.n(var21, 0, UserNameOnClick.$serializer.INSTANCE, var7) as UserNameOnClick;
                     var2 |= 1;
                     break;
                  case 1:
                     var24 = var22.n(var21, 1, UserNameOnClick.$serializer.INSTANCE, var24) as UserNameOnClick;
                     var2 |= 2;
                     break;
                  case 2:
                     var8 = var22.n(var21, 2, CommandOnClick.$serializer.INSTANCE, var8) as CommandOnClick;
                     var2 |= 4;
                     break;
                  case 3:
                     var28 = var22.n(var21, 3, ActorHook.$serializer.INSTANCE, var28) as ActorHook;
                     var2 |= 8;
                     break;
                  case 4:
                     var30 = var22.n(var21, 4, ThreadOnClick.$serializer.INSTANCE, var30) as ThreadOnClick;
                     var2 |= 16;
                     break;
                  case 5:
                     var12 = var22.n(var21, 5, PinsOnClick.$serializer.INSTANCE, var12) as PinsOnClick;
                     var2 |= 32;
                     break;
                  case 6:
                     var31 = var22.n(var21, 6, WebhookNameOnClick.$serializer.INSTANCE, var31) as WebhookNameOnClick;
                     var2 |= 64;
                     break;
                  case 7:
                     var13 = var22.n(var21, 7, HandleDelete.$serializer.INSTANCE, var13) as HandleDelete;
                     var2 |= 128;
                     break;
                  case 8:
                     var14 = var22.n(var21, 8, RoleSubscriptionOnClick.$serializer.INSTANCE, var14) as RoleSubscriptionOnClick;
                     var2 |= 256;
                     break;
                  case 9:
                     var16 = var22.n(var21, 9, HandleMessage.$serializer.INSTANCE, var16) as HandleMessage;
                     var2 |= 512;
                     var4 = 10;
                     continue;
                  case 10:
                     var36 = var22.n(var21, var4, TitleOnClick.$serializer.INSTANCE, var36) as TitleOnClick;
                     var2 |= 1024;
                     continue;
                  default:
                     throw new n(var5);
            ...
            var31 = var28;
            var24 = var36;
            var39 = (HandleMessage)var16;
            var18 = (RoleSubscriptionOnClick)var14;
            var8 = var13;
            var13 = var12;
            var36 = var30;
            var16 = var8;

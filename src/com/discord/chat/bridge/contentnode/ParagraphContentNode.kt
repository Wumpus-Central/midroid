...
public data class ParagraphContentNode(content: List<ContentNode>) : ContentNode {
   ...
   @JvmStatic
   public fun `write$Self`(self: ParagraphContentNode, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         return r.c(this.content, (var1 as ParagraphContentNode).content);
      }
   }
   ...
   public object `$serializer` : f0<ParagraphContentNode> {
      ...
      public open fun deserialize(decoder: Decoder): ParagraphContentNode {
         ...
         var7.c(var6);
         return new ParagraphContentNode(var2, var8 as java.util.List, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: ParagraphContentNode) {
         ...
         ParagraphContentNode.write$Self(var2, var4, var3);
         var4.c(var3);
      }

...
public class LineBreakContentNode : ContentNode() {
   @JvmStatic
   public fun `write$Self`(self: LineBreakContentNode, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   }

   public object `$serializer` : f0<LineBreakContentNode> {
      ...
      public open fun serialize(encoder: Encoder, value: LineBreakContentNode) {
         ...
         LineBreakContentNode.write$Self(var2, var4, var3);
         var4.c(var3);
      }

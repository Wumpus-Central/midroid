...
public data class SubtextContentNode(content: List<ContentNode>) : ContentNode {
   ...
   public object `$serializer` : g0 {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{SubtextContentNode.access$get$childSerializers$cp()[0]};
      }
      ...
      public open fun deserialize(decoder: Decoder): SubtextContentNode {
         ...
         val var8: Array<KSerializer> = SubtextContentNode.access$get$childSerializers$cp();
         ...
         var7.c(var6);
         return new SubtextContentNode(var2, var9, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: SubtextContentNode) {
         ...
         SubtextContentNode.write$Self$chat_release(var2, var4, var3);
         var4.c(var3);
      }

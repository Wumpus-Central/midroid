   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): UserNameOnClick {
         ...
         if (var5) {
            ...
            var10 = var12.m(var11, 1, UserId.$serializer.INSTANCE, null) as UserId;
            val var7: ChannelId = var12.v(var11, 2, ChannelId.$serializer.INSTANCE, null) as ChannelId;
                  ...
                  if (var4 != 0) {
                     if (var4 != 1) {
                        if (var4 != 2) {
                           ...
                           var14 = var12.v(var11, 2, ChannelId.$serializer.INSTANCE, var14) as ChannelId;
                           var2 |= 4;
                        }
                     } else {
                        var15 = var12.m(var11, 1, UserId.$serializer.INSTANCE, var15) as UserId;
                        var2 |= 2;
                     }
                  } else {
         ...
         var12.b(var11);
         return new UserNameOnClick(var2, var6, var10, var9, (Integer)var13, null, null);
      }

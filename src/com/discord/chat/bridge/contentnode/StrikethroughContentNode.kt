...
public data class StrikethroughContentNode(content: List<ContentNode>) : ContentNode {
   ...
   @JvmStatic
   public fun `write$Self`(self: StrikethroughContentNode, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public object `$serializer` : f0<StrikethroughContentNode> {
      ...
      public open fun deserialize(decoder: Decoder): StrikethroughContentNode {
         ...
         var7.c(var6);
         return new StrikethroughContentNode(var2, var8 as java.util.List, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: StrikethroughContentNode) {
         ...
         StrikethroughContentNode.write$Self(var2, var4, var3);
         var4.c(var3);
      }

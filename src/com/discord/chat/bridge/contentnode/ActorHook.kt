...
public data class ActorHook(action: String, userId: UserId) : ActorHook(var1, var2) {
   ...
   public object `$serializer` : f0<ActorHook> {
      ...
      public open fun deserialize(decoder: Decoder): ActorHook {
         ...
         if (var5) {
            var10 = var9.m(var8, 0);
            var6 = (java.lang.String)var9.y(var8, 1, com.discord.primitives.UserId..serializer.INSTANCE, null);
            var2 = 3;
         } else {
            ...
            while (var3) {
               ...
               if (var4 != -1) {
                  if (var4 != 0) {
                     ...
                     var11 = var9.y(var8, 1, com.discord.primitives.UserId..serializer.INSTANCE, var11);
                     var2 |= 2;
                  } else {
                     var6 = var9.m(var8, 0);
                     var2 |= 1;
         ...
         var9.c(var8);
         return new ActorHook(var2, var10, var6 as UserId, null, null);
      }

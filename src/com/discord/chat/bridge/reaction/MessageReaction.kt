...
public data class MessageReaction(count: Int,
   ...
   public override fun hashCode(): Int {
      ...
      return ((((var5 * 31 + var2) * 31 + var6) * 31 + var4) * 31 + var3) * 31 + var1;
   }
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): MessageReaction {
            ...
            while (var21) {
               ...
               switch (var9) {
                  ...
                  case 4:
                     ...
                     break;
                  case 5:
                     var24 = var13.v(var12, 5, ThemedBurstReactionColorPalette.$serializer.INSTANCE, var24) as ThemedBurstReactionColorPalette;
                     var2 |= 32;
                     break;
                  case 6:
         ...
         var13.b(var12);
         return new MessageReaction(var5, var7, (boolean)var6, (boolean)var18, var10, var3, var14, (boolean)var2, null);
      }

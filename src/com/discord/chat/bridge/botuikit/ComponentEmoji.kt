   ...
   public object `$serializer` : f0<ComponentEmoji> {
      ...
      public open fun deserialize(decoder: Decoder): ComponentEmoji {
         ...
         if (var12.p()) {
            ...
            var13 = var12.n(var11, 2, var7, null);
            var5 = var12.C(var11, 3);
            var9 = var12.n(var11, 4, var7, null);
            var2 = 31;
         } else {
            ...
            while (var3) {
               ...
               if (var4 != -1) {
                  if (var4 != 0) {
                     ...
                     var8 = (java.lang.String)var12.n(var11, 0, a2.a, var8);
                     var2 |= 1;
                  }
               } else {
                  var3 = false;
         ...
         var12.c(var11);
         return new ComponentEmoji(var2, var6 as java.lang.String, var8, var13 as java.lang.String, var5, var9 as java.lang.String, null);
      }

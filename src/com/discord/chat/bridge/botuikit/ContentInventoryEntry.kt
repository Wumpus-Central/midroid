...
public data class ContentInventoryEntry(authorId: UserId,
   ...
   public override fun hashCode(): Int {
      ...
      val var3: Int = this.avatarUrl.hashCode();
      val var1: Int;
      ...
      return (
               ((((((var2 * 31 + var4) * 31 + var5) * 31 + var3) * 31 + var1) * 31 + this.userActionDescription.hashCode()) * 31 + this.title.hashCode()) * 31
   ...
   public override fun toString(): String {
      ...
      var1.append("ContentInventoryEntry(authorId=");
      var1.append(var3);
      var1.append(", contentId=");
      var1.append(var10);
      var1.append(", imageUrl=");
      var1.append(var6);
      var1.append(", avatarUrl=");
      var1.append(var7);
      var1.append(", platformIconUrl=");
      var1.append(var9);
      var1.append(", userActionDescription=");
      var1.append(var5);
      var1.append(", title=");
      var1.append(var8);
      var1.append(", subtitles=");
      var1.append(var4);
      var1.append(", gradientColors=");
      var1.append(var2);
      var1.append(")");
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): ContentInventoryEntry {
         ...
         if (var6) {
            ...
            var10 = var17.t(var16, 1);
            var12 = var17.t(var16, 2);
            var8 = var17.t(var16, 3);
            var15 = var17.v(var16, 4, b2.a, null) as java.lang.String;
            var22 = var17.t(var16, 5);
            val var19: java.lang.String = var17.t(var16, 6);
            val var9: java.util.List = var17.m(var16, 7, var18[7], null) as java.util.List;
            var14 = var17.m(var16, 8, var18[8], null) as java.util.List;
            var2 = 511;
            var13 = var22;
            var22 = var19;
            var20 = var9;
            ...
            while (var3) {
               ...
               switch (var5) {
                  case -1:
                     ...
                     break;
                  case 0:
                     var11 = var17.m(var16, 0, UserId.$serializer.INSTANCE, var11) as UserId;
                     var2 |= 1;
                     var4 = 6;
                     break;
                  case 1:
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     var12 = var17.v(var16, 4, b2.a, var12) as java.lang.String;
                     var2 |= 16;
                     break;
                  case 5:
                     var22 = var17.t(var16, 5);
                     ...
                     break;
                  case 6:
                     var21 = var17.t(var16, var4);
                     var2 |= 64;
                     break;
                  case 7:
                     var13 = var17.m(var16, 7, var18[7], var13) as java.util.List;
                     var2 |= 128;
                     break;
                  case 8:
                     var14 = var17.m(var16, 8, var18[8], var14) as java.util.List;
                     var2 |= 256;
                     break;
                  default:
                     throw new n(var5);

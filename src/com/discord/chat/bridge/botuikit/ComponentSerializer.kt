...
public object ComponentSerializer : e(Component::class) {
   ...
   fun {
      ...
      componentClassSerializer = new SealedClassSerializer(
         ...
         new KSerializer[]{
            ...
            CheckpointCardComponent.Companion.serializer()
         }
      );
   }
   ...
   protected open fun selectDeserializer(element: JsonElement): DeserializationStrategy<Component> {
      ...
      if (var1 != null) {
         ...
         if (var4 != null) {
            return (DeserializationStrategy)(if (CollectionsKt.d0(var2, h.k(var4))) componentClassSerializer else UnknownComponent.Companion.serializer());
         }
      }

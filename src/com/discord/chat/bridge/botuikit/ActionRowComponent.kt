...
public data class ActionRowComponent(type: Int, id: String, errorText: String? = null, components: List<Component>) : BaseLayoutComponent {
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{N.a, C0.a, a.u(C0.a), ActionRowComponent.access$get$childSerializers$cp()[3]};
      }
      ...
      public open fun deserialize(decoder: Decoder): ActionRowComponent {
         ...
         if (var10.y()) {
            var2 = var10.k(var9, 0);
            var7 = var10.t(var9, 1);
            var12 = var10.v(var9, 2, C0.a, null) as java.lang.String;
         ...
         var10.b(var9);
         return new ActionRowComponent(var4, var2, var7, var6, (java.util.List)var12, null);
      }

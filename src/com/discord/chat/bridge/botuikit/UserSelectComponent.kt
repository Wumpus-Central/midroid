...
public data class UserSelectComponent(type: Int,
   ...
   @JvmStatic
   public fun `write$Self`(self: UserSelectComponent, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public override fun hashCode(): Int {
      val var5: Int = Integer.hashCode(this.getType());
      ...
      return ((((((((var5 * 31 + var8) * 31 + var6) * 31 + var7) * 31 + var1) * 31 + var2) * 31 + var10) * 31 + var9) * 31 + var3) * 31
   ...
   public override fun toString(): String {
      ...
      val var5: ActionComponentState = this.getState();
      val var9: java.lang.String = this.getCustomId();
      val var8: java.lang.String = this.getPlaceholder();
      val var11: java.lang.String = this.getAccessibilityLabel();
   ...
   public object `$serializer` : f0<UserSelectComponent> {
      ...
      public open fun deserialize(decoder: Decoder): UserSelectComponent {
         ...
         if (var12) {
            ...
            var17 = var21.n(var20, 5, (DeserializationStrategy)var30, null);
            var3 = var21.i(var20, 6);
                  ...
                  label37: {
                     ...
                     switch (var11) {
                        ...
                        case 1:
                           ...
                           break label37;
                        case 2:
                           var23 = var21.y(var20, 2, ActionComponentState.Serializer.INSTANCE, var23);
                           var2 |= 4;
                           break label37;
                        case 3:
                           var30 = var21.m(var20, 3);
                           var2 |= 8;
                           break;
                        case 4:
                           var28 = var21.n(var20, 4, a2.a, var28);
                           var2 |= 16;
                           break;
                        case 5:
      ...
      public open fun serialize(encoder: Encoder, value: UserSelectComponent) {
         ...
         UserSelectComponent.write$Self(var2, var4, var3);
         var4.c(var3);
      }

...
public data class Truncation(numberOfLines: Int, expandable: Boolean, seeMoreLabel: String? = null, seeMoreLabelColor: Int? = null, forceShow: Boolean? = null) {
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): Truncation {
         ...
         var var14: Int;
         if (var11.y()) {
            var14 = var11.k(var10, 0);
            val var5: Byte = var11.s(var10, 1);
            var8 = var11.v(var10, 2, b2.a, null) as java.lang.String;
            var13 = var11.v(var10, 3, n0.a, null) as Int;
            val var7: java.lang.Boolean = var11.v(var10, 4, h.a, null) as java.lang.Boolean;
            var3 = 31;
            var4 = var14;
            var14 = var5;
            var9 = (Integer)var13;
                     ...
                     if (var6 != 1) {
                        if (var6 != 2) {
                           if (var6 != 3) {
                              ...
                              var19 = var11.v(var10, 3, n0.a, var19) as Int;
                              var14 |= 8;
                           }
                        } else {
         ...
         var11.b(var10);
         return new Truncation(var3, var4, (boolean)var14, var8, var9, (java.lang.Boolean)var13, null);
      }

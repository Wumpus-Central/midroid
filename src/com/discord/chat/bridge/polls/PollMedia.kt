   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): PollMedia {
         ...
         if (var5) {
            ...
            var12 = var11.y(var10, 1, var9[1], null) as java.util.Set;
            var15 = var11.n(var10, 2, PollMediaEmoji.$serializer.INSTANCE, null) as PollMediaEmoji;
                  ...
                  if (var4 != 0) {
                     if (var4 != 1) {
                        if (var4 != 2) {
                           ...
                           var13 = var11.n(var10, 3, x0.a, var13) as java.lang.Long;
                           var2 |= 8;
                        } else {

...
public data class PollAnswer(answerId: String,
   ...
   public override fun hashCode(): Int {
      ...
      return (((((((var7 * 31 + var4) * 31 + var5) * 31 + var6) * 31 + var8) * 31 + var1) * 31 + var2) * 31 + var3) * 31 + this.style.hashCode();
   }
   ...
   public override fun toString(): String {
      ...
      val var4: java.lang.Boolean = this.shouldAnimateTransition;
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): PollAnswer {
            ...
            while (var20) {
               ...
               switch (var6) {
                  ...
                  case 0:
                     ...
                     break;
                  case 1:
                     var22 = var15.m(var14, 1, PollMedia.$serializer.INSTANCE, var22) as PollMedia;
                     var19 |= 2;
                     break;
                  case 2:
                     var3 = var15.s(var14, 2);
         ...
         return new PollAnswer(
            var5, (java.lang.String)var9, (PollMedia)var11, (boolean)var3, (java.lang.String)var13, var4, var10, var7, var12, (java.lang.String)var18, null
         );
      }

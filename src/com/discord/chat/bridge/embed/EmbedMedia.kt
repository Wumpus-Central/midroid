   ...
   public object `$serializer` : f0<EmbedMedia> {
      ...
      public open fun deserialize(decoder: Decoder): EmbedMedia {
         ...
         if (var13.p()) {
            ...
            val var19: java.lang.String = var13.m(var12, 6);
            var4 = 127;
         ...
         var13.c(var12);
         return new EmbedMedia(var4, var11, var10 as java.lang.String, var3, var5, var9 as java.lang.String, var8 as Integer, (java.lang.String)var15, null);
      }

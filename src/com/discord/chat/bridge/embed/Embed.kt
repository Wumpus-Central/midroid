...
public data class Embed(type: EmbedType,
   ...
   public override fun toString(): String {
      ...
      val var7: java.lang.String = this.rawTitle;
      val var8: StructurableText = this.title;
      val var18: java.util.List = this.fields;
      ...
      val var31: java.util.List = this.images;
      val var3: EmbedMedia = this.video;
      ...
      val var4: Int = this.providerColor;

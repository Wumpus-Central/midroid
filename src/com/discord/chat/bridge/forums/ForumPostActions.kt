...
public data class ForumPostActions(numDisplayedReactions: Int,
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): ForumPostActions {
            ...
            while (var21) {
               ...
               switch (var6) {
                  ...
                  case 6:
                     ...
                     break;
                  case 7:
                     var25 = var15.n(var14, 7, PostSharePrompt.$serializer.INSTANCE, var25) as PostSharePrompt;
                     var2 |= 128;
                     break;
                  default:
                     throw new n(var6);
         ...
         var15.c(var14);
         return new ForumPostActions(var3, var2, (boolean)var5, var11, var9, var10, var8, (MessageReaction)var7, var12, null);
      }

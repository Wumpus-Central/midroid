   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         ...
         return new KSerializer[]{
            N.a, h.a, a.u(C0.a), var3, a.u(var3), var3, a.u(MessageReaction.$serializer.INSTANCE), a.u(PostSharePrompt.$serializer.INSTANCE)
         };
      }
      ...
      public open fun deserialize(decoder: Decoder): ForumPostActions {
         ...
         if (var14.y()) {
            ...
            var2 = var14.s(var13, 1);
            val var15: C0 = C0.a;
            var12 = var14.v(var13, 2, C0.a, null) as java.lang.String;
         ...
         var14.b(var13);
         return new ForumPostActions(var3, var4, (boolean)var2, var12, var9, var10, var8, (MessageReaction)var11, var21, null);
      }

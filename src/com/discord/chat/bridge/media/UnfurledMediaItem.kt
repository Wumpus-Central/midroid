...
public data class UnfurledMediaItem(url: String,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         if (!(this.url == var1.url)) {
            ...
            return false;
         } else if (!(this.contentType == var1.contentType)) {
            return false;
         } else if (!(this.placeholder == var1.placeholder)) {
            return false;
         } else if (!(this.placeholderVersion == var1.placeholderVersion)) {
            return false;
         } else if (!(this.contentScanMetadata == var1.contentScanMetadata)) {
            return false;
         } else {
   ...
   public override fun toString(): String {
      ...
      var2.append("UnfurledMediaItem(url=");
      var2.append(var6);
      var2.append(", proxyUrl=");
      var2.append(var7);
      var2.append(", loadingState=");
      var2.append(var3);
      var2.append(", height=");
      var2.append(var10);
      var2.append(", width=");
      var2.append(var9);
      var2.append(", contentType=");
      var2.append(var11);
      var2.append(", placeholder=");
      var2.append(var4);
      var2.append(", placeholderVersion=");
      var2.append(var5);
      var2.append(", contentScanMetadata=");
      var2.append(var8);
      var2.append(", srcIsAnimated=");
      var2.append(var1);
      var2.append(")");

...
public data class BlockedGroupButton(action: BlockedGroupButtonAction) {
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): BlockedGroupButton {
         ...
         if (var5) {
            var8 = var7.y(var6, 0, BlockedGroupButtonAction.$serializer.INSTANCE, null) as BlockedGroupButtonAction;
         } else {
            var2 = 0;
            var8 = null;
            ...
            while (var3) {
               ...
               if (var4 != -1) {
                  ...
                  var8 = var7.y(var6, 0, BlockedGroupButtonAction.$serializer.INSTANCE, var8) as BlockedGroupButtonAction;
                  var2 |= 1;
               } else {
                  var3 = false;
               }

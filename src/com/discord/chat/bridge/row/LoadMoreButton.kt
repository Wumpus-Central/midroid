...
public data class LoadMoreButton(action: LoadingAction, text: String, backgroundColor: Int, cornerRadius: Int? = null, color: Int? = null) {
   ...
   public object `$serializer` : f0<LoadMoreButton> {
      ...
      public open fun deserialize(decoder: Decoder): LoadMoreButton {
         ...
         var var12: Any;
         if (var10.p()) {
            var7 = var10.y(var9, 0, LoadingAction.$serializer.INSTANCE, null);
            var8 = var10.m(var9, 1);
            val var2: Int = var10.i(var9, 2);
            var12 = m0.a;
            var6 = var10.n(var9, 3, m0.a, null);
            ...
            while (var14) {
               ...
               if (var5 != -1) {
                  if (var5 != 0) {
                     ...
                     var7 = var10.y(var9, 0, LoadingAction.$serializer.INSTANCE, var7);
                     var13 |= 1;
                  }
               } else {
                  var14 = false;
         ...
         var10.c(var9);
         return new LoadMoreButton(var4, var7 as LoadingAction, var8, var3, var6 as Integer, var12 as Integer, null);
      }

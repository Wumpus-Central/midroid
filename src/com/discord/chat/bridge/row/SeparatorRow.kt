...
public data class SeparatorRow(changeType: ChangeType,
   ...
   public override fun hashCode(): Int {
      ...
      return ((((((var7 * 31 + var4) * 31 + var8) * 31 + var5) * 31 + var6) * 31 + var1) * 31 + var2) * 31 + var3;
   }
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): SeparatorRow {
         ...
         val var19: Summary;
         if (var8) {
            var12 = var17.m(var16, 0, ChangeType.Serializer.INSTANCE, null) as ChangeType;
         ...
         var17.b(var16);
         return new SeparatorRow(var5, (ChangeType)var12, var3, (java.lang.String)var14, (java.lang.String)var13, var2, var11, var9, var19, null);
      }

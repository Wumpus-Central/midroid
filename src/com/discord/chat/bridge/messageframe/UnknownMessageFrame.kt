...
public data class UnknownMessageFrame(type: MessageFrameType) : MessageFrame {
   ...
   @JvmStatic
   public fun `write$Self`(self: UnknownMessageFrame, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
   ...
   public fun copy(type: MessageFrameType = var0.getType()): UnknownMessageFrame {
      r.h(var1, "type");
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         return this.getType() === (var1 as UnknownMessageFrame).getType();
      }
   }
   ...
   public override fun toString(): String {
      val var1: MessageFrameType = this.getType();
   ...
   public object `$serializer` : f0<UnknownMessageFrame> {
      ...
      public open fun deserialize(decoder: Decoder): UnknownMessageFrame {
         ...
         var7.c(var6);
         return new UnknownMessageFrame(var2, var8 as MessageFrameType, null);
      }
      ...
      public open fun serialize(encoder: Encoder, value: UnknownMessageFrame) {
         ...
         UnknownMessageFrame.write$Self(var2, var4, var3);
         var4.c(var3);
      }

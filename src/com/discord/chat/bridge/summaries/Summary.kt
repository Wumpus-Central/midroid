...
public data class Summary(id: String,
   ...
   public override fun toString(): String {
      ...
      var3.append("Summary(id=");
      var3.append(var4);
      var3.append(", topic=");
      var3.append(var9);
      var3.append(", summShort=");
      var3.append(var7);
      var3.append(", people=");
      var3.append(var2);
      var3.append(", startId=");
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): Summary {
         ...
         if (var7) {
            ...
            var10 = var18.y(var17, 3, var14[3], null) as java.util.List;
            val var8: MessageId.$serializer = MessageId.$serializer.INSTANCE;
            val var19: MessageId = var18.y(var17, 4, MessageId.$serializer.INSTANCE, null) as MessageId;
            if (var19 != null) {
            ...
            val var25: MessageId = var18.y(var17, 5, var8, null) as MessageId;
            if (var25 != null) {
               var26 = var25.unbox-impl();
            } else {
               var26 = null;
            }

            val var2: Int = var18.i(var17, 6);
            var9 = var18.y(var17, 7, ChannelId.$serializer.INSTANCE, null) as ChannelId;
            var3 = 255;
            var4 = var2;
         } else {
               ...
               label63: {
                  ...
                  switch (var6) {
                     ...
                     case 0:
                        ...
                        break;
                     case 1:
                        var21 = var18.m(var17, 1);
                        var22 |= 2;
                        break label63;
                     case 2:
                        var26 = var18.m(var17, 2);
                        var22 |= 4;
                        break label63;
                     case 3:
                        var10 = var18.y(var17, 3, var14[3], var10) as java.util.List;
                        var22 |= 8;
                        break label63;
                     case 4:
                        if (var9 != null) {
                        ...
                        var9 = var18.y(var17, 4, MessageId.$serializer.INSTANCE, var9) as MessageId;
                        if (var9 != null) {
                     ...
                     case 5:
                        val var32: MessageId;
                        if (var11 != null) {
                           var32 = MessageId.box-impl(var11);
                        } else {
                           var32 = null;
                        }

                        val var33: MessageId = var18.y(var17, 5, MessageId.$serializer.INSTANCE, var32) as MessageId;
                        if (var33 != null) {
                           var11 = var33.unbox-impl();
                        } else {
                           var11 = null;
                        }
                     ...
                     case 6:
                        ...
                        continue;
                     case 7:
                        var12 = var18.y(var17, var4, ChannelId.$serializer.INSTANCE, var12) as ChannelId;
                        var22 |= 128;
                        continue;
                     default:
                        throw new n(var6);
         ...
         var18.c(var17);
         return new Summary(var3, var13, var12, var11, var10, var20, var26, var4, var9, null, null);
      }

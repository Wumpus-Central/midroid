   ...
   public companion object {
      private fun forItem(spoilerableData: SpoilerableData, containerId: String, key: String, verifyAge: Boolean?): SpoilerAttributes? {
         ...
         if (var5 != null) {
            ...
            var7.append("):");
            var7.append(var3);
            return new SpoilerAttributes(SpoilerIdentifier.constructor-impl(var7.toString()), new c(var5), new d(var5), SpoilerType.OBSCURE, var4, null);
         } else {
            ...
            if (var6 != null) {
               ...
               var8.append("):");
               var8.append(var3);
               return new SpoilerAttributes(SpoilerIdentifier.constructor-impl(var8.toString()), new e(), new f(var6), SpoilerType.SPOILER, var4, null);
            } else {
               return null;
            }
         }
      ...
      public fun forAttachment(attachment: Attachment, message: Message, index: Int, verifyAge: Boolean?): SpoilerAttributes? {
         ...
         var8.append(var3);
         var8.append(")");
         return this.forItem(var1, var9, var8.toString(), var4);
      }

      ...
      public data class Invalid(headerText: String,
         ...
         public object `$serializer` : g0 {
            ...
            public open fun deserialize(decoder: Decoder): com.discord.chat.bridge.gift.GiftEmbed.Resolved.Invalid {
               ...
               var17.b(var16);
               return new GiftEmbed.Resolved.Invalid(var7, var12, var9, var6, var5, var15, var13, var3, var18, var4, var8, null);
            }
      ...
      public object `$serializer` : g0 {
         ...
         public open fun deserialize(decoder: Decoder): com.discord.chat.bridge.gift.GiftEmbed.Resolving {
            ...
            if (var12.y()) {
               ...
               var6 = var12.k(var11, 1);
               var8 = var12.k(var11, 2);
               var3 = var12.k(var11, 3);
               var4 = var12.k(var11, 4);
               var2 = var12.k(var11, 5);
               var5 = 63;
            } else {
               var13 = null;
            ...
            var12.b(var11);
            return new GiftEmbed.Resolving(var5, var13, var6, var8, var3, var4, var2, null);
         }

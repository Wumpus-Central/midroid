...
public class BackgroundSpanDrawer(provider: TextView) : LineBackgroundSpan {
   ...
   public open fun drawBackground(
      ...
      val var18: java.util.List = k.y0(var24);
      ...
      for (BackgroundSpan var19 : var18) {
         ...
         if (var6 <= var11 && var11 <= var9) {
            ...
            val var14: Int = var5 + SizeUtilsKt.getDpToPx(var20.getMarginVertical());
            ...
            if (var31 != null) {
               ...
               this.drawBackground(var1, var2, var11, var6, var9, var4, var16, var14, var10, var13);
            }

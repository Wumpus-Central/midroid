...
public object UnicodeEmojis {
   ...
   public suspend fun load(context: Context): Map<String, List<com.discord.emoji.UnicodeEmojis.Emoji>> {
      ...
      // 037: astore 4
      // 039: invokestatic ot/b.f ()Ljava/lang/Object;
      // 03c: astore 6
      // 03e: aload 2
      ...
      // 0b0: aconst_null
      // 0b1: aload 2
      // 0b2: invokeinterface kotlinx/coroutines/sync/Mutex.b (Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object; 3
      // 0b7: aload 6
      // 0b9: if_acmpne 0bf
      // 0bc: goto 0ea
      ...
      // 11d: aload 2
      // 11e: aconst_null
      // 11f: invokeinterface kotlinx/coroutines/sync/Mutex.c (Ljava/lang/Object;)V 2
      // 124: aload 1
      // 125: areturn
      // 126: aload 1
      // 127: aconst_null
      // 128: invokeinterface kotlinx/coroutines/sync/Mutex.c (Ljava/lang/Object;)V 2
      // 12d: aload 2
      // 12e: athrow
   }
   ...
   public data class EmojiCategories(people: List<com.discord.emoji.UnicodeEmojis.Emoji>,
      ...
      fun {
         ...
         $childSerializers = new KSerializer[]{
            new av.f(UnicodeEmojis.Emoji.$serializer.INSTANCE),
            new av.f(var0),
            new av.f(var0),
            new av.f(var0),
            new av.f(var0),
      ...
      public fun toMap(): Map<String, List<com.discord.emoji.UnicodeEmojis.Emoji>> {
         return s0.m(
            new Pair[]{
               v.a("people", this.people),
               v.a("nature", this.nature),
               v.a("food", this.food),
               v.a("activity", this.activity),
               v.a("travel", this.travel),
               v.a("objects", this.objects),
               v.a("symbols", this.symbols),
               v.a("flags", this.flags)
            }
         );
      }
      ...
      public override fun toString(): String {
         ...
         val var6: java.util.List = this.travel;

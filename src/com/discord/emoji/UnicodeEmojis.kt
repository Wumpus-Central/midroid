...
public object UnicodeEmojis {
   ...
   private final val emojiLoadingMutex: Mutex = ga.b.b(false, 1, null)
   ...
   public suspend fun load(context: Context): Map<String, List<com.discord.emoji.UnicodeEmojis.Emoji>> {
      ...
      // 037: astore 4
      // 039: invokestatic v8/b.e ()Ljava/lang/Object;
      // 03c: astore 6
      // 03e: aload 2
      ...
      // 05a: astore 1
      // 05b: aload 4
      // 05d: invokestatic o8/s.b (Ljava/lang/Object;)V
      // 060: goto 0ef
      // 063: astore 2
      // 064: goto 126
      ...
      // 080: astore 5
      // 082: aload 4
      // 084: invokestatic o8/s.b (Ljava/lang/Object;)V
      // 087: aload 5
      // 089: astore 4
      // 08b: goto 0bf
      // 08e: aload 4
      // 090: invokestatic o8/s.b (Ljava/lang/Object;)V
   ...
   public data class EmojiCategories(people: List<com.discord.emoji.UnicodeEmojis.Emoji>,
      ...
      fun {
         ...
         $childSerializers = new KSerializer[]{
            new ka.f(UnicodeEmojis.Emoji.$serializer.INSTANCE),
            new ka.f(var0),
            new ka.f(var0),
            new ka.f(var0),
            new ka.f(var0),
      ...
      public override fun toString(): String {
         ...
         val var4: java.util.List = this.activity;
         val var3: java.util.List = this.travel;
         val var6: java.util.List = this.objects;
         val var7: java.util.List = this.symbols;
         val var5: java.util.List = this.flags;
         val var8: StringBuilder = new StringBuilder();
         var8.append("EmojiCategories(people=");
         var8.append(var2);
         var8.append(", nature=");
         var8.append(var1);
         var8.append(", food=");
         var8.append(var9);
         var8.append(", activity=");
         var8.append(var4);
         var8.append(", travel=");
         var8.append(var3);
         var8.append(", objects=");
               ...
               while (var4) {
                  ...
                  switch (var5) {
                     ...
                     case 1:
                        ...
                        break;
                     case 2:
                        var7 = var17.m(var16, 2, var14[2], var7) as java.util.List;
                        var2 |= 4;
                        break;
                     case 3:

...
public object UnicodeEmojis {
   ...
   private final val emojiLoadingMutex: Mutex = xk.b.b(false, 1, null)
   ...
   public suspend fun load(context: Context): Map<String, List<com.discord.emoji.UnicodeEmojis.Emoji>> {
      ...
      // 037: astore 4
      // 039: invokestatic mh/b.e ()Ljava/lang/Object;
      // 03c: astore 6
      // 03e: aload 2
      ...
      // 05a: astore 1
      // 05b: aload 4
      // 05d: invokestatic gh/s.b (Ljava/lang/Object;)V
      // 060: goto 0ef
      // 063: astore 2
      // 064: goto 126
      ...
      // 080: astore 5
      // 082: aload 4
      // 084: invokestatic gh/s.b (Ljava/lang/Object;)V
      // 087: aload 5
      // 089: astore 4
      // 08b: goto 0bf
      // 08e: aload 4
      // 090: invokestatic gh/s.b (Ljava/lang/Object;)V
   ...
   public data class Emoji(names: List<String>, surrogates: String) {
      ...
      public object `$serializer` : g0 {
         ...
         public open fun childSerializers(): Array<KSerializer<*>> {
            return new KSerializer[]{UnicodeEmojis.Emoji.access$get$childSerializers$cp()[0], b2.a};
         }
   ...
   public data class EmojiCategories(people: List<com.discord.emoji.UnicodeEmojis.Emoji>,
      ...
      fun {
         ...
         $childSerializers = new KSerializer[]{
            new bl.f(UnicodeEmojis.Emoji.$serializer.INSTANCE),
            new bl.f(var0),
            new bl.f(var0),
            new bl.f(var0),
            new bl.f(var0),
      ...
      public object `$serializer` : g0 {
         ...
         public open fun deserialize(decoder: Decoder): com.discord.emoji.UnicodeEmojis.EmojiCategories {
            ...
            if (var6) {
               ...
               var13 = var17.m(var16, 2, var14[2], null) as java.util.List;
            ...
            var17.b(var16);
            return new UnicodeEmojis.EmojiCategories(var2, var9, var8, var13, var12, var10, var11, var21, var19, null);
         }

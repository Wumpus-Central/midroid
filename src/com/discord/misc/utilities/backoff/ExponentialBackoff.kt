...
public class ExponentialBackoff(scope: CoroutineScope, initialDelay: Long = 1000L, maxDelay: Long = 300000L, maxAttempts: Int = 10) {
   ...
   public suspend fun <T> performBackoff(networkRequest: (Continuation<T>) -> Any?, shouldRetry: (T, Continuation<Boolean>) -> Any?): T {
      label54: {
         if (var3 is <unrepresentable>) {
            ...
            if ((var3.label and Integer.MIN_VALUE) != 0) {
               var7.label = var3.label + Integer.MIN_VALUE;
               var3 = var7;
               break label54;
            }
         }

         var3 = new d(this, var3) {
            Object L$0;
            Object L$1;
            Object L$2;
            Object L$3;
      ...
      if (var3.label != 0) {
         if (var3.label != 1) {
            if (var3.label != 2) {
               if (var3.label != 3) {
                  ...
                  var2 = var3.L$2 as Function2;
                  var1 = var3.L$1 as Function1;
                  var8 = var3.L$0 as ExponentialBackoff;
                  s.b(var26);
                  var13 = var2;
                  var18 = var1;
               } else {
               ...
               var3.L$3 = var26;
               var3.label = 2;
               val var10: Any = var13.invoke(var26, var3);
               var32 = var26;
               var26 = var10;
               if (var10 === var11) {
                  return var11;
               ...
               var32 = var3.L$3;
               var13 = var3.L$2 as Function2;
               var18 = var3.L$1 as Function1;
               var8 = var3.L$0 as ExponentialBackoff;
               s.b(var26);
            }
         } else {
            ...
            var3.L$3 = var26;
            var3.label = 2;
            val var37: Any = var2.invoke(var26, var3);
            var32 = var26;
            var26 = var37;
            if (var37 === var11) {
               return var11;
         ...
         var3.L$3 = var26;
         var3.label = 2;
         val var38: Any = var2.invoke(var26, var3);
         var32 = var26;
         var26 = var38;
         if (var38 === var11) {
            return var11;
      ...
      while ((java.lang.Boolean)var26) {
         ...
         var3.L$3 = var32;
         var3.label = 2;
         val var39: Any = var13.invoke(var32, var3);
         var32 = var32;
         var26 = var39;
         if (var39 === var11) {
            return var11;

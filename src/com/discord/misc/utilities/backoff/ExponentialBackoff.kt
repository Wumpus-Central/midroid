...
public class ExponentialBackoff(scope: CoroutineScope, initialDelay: Long = 1000L, maxDelay: Long = 300000L, maxAttempts: Int = 10) {
   ...
   public fun fail(action: (Continuation<Unit>) -> Any?) {
      ...
      if (this.currentAttempt <= this.maxAttempts) {
         ...
         this.currentDelay = e.k(var4, this.maxDelay);
         this.currentAttempt++;
         this.job = g.d(this.scope, null, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(this, var1, null) {

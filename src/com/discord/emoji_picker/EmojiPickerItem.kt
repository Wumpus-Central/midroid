...
internal sealed class EmojiPickerItem protected constructor() {
   ...
   public data class Category(title: String, id: Long = IdUtilsKt.convertToId(var1), isInsidePremiumRoadBlock: Boolean = false) : EmojiPickerItem {
      ...
      public override fun hashCode(): Int {
         ...
         var var1: Byte = this.isInsidePremiumRoadBlock;
         if (this.isInsidePremiumRoadBlock != 0) {
            var1 = 1;
         }
   ...
   public data class Emoji(id: Long,
      ...
      public final val unicodeUrl: String?
         public final get() {
            ...
            if (this.unicode != null) {
               var2 = Surrogates.toAssetUrl_impl(Surrogates.constructor_impl(this.unicode.getSurrogates()));
            } else {
               var2 = null;
            }
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            if (this.id != var1.id) {
               ...
               return false;
            } else if (!r.c(this.unicode, var1.unicode)) {
               return false;
            } else {
               return this.isInsidePremiumRoadBlock == var1.isInsidePremiumRoadBlock;
            }
      ...
      public override fun hashCode(): Int {
         ...
         val var7: Int = this.disabled.hashCode();
         val var9: Int;
         if (this.unicode == null) {
            var9 = 0;
         } else {
            var9 = this.unicode.hashCode();
         }

         if (this.isInsidePremiumRoadBlock == 0) {
            var3 = this.isInsidePremiumRoadBlock;
         }

         return ((((var6 * 31 + var5) * 31 + var1) * 31 + var7) * 31 + var9) * 31 + var3;
      }
      ...
      public override fun toString(): String {
         ...
         val var4: Boolean = this.isInsidePremiumRoadBlock;
         val var5: StringBuilder = new StringBuilder();
      ...
      public enum class DisabledType {
         ICON,
         NONE         @JvmStatic
         private EmojiPickerItem.Emoji.DisabledType[] $VALUES = $values();
         @JvmStatic
   ...
   public data class FooterUpsell(id: String) : EmojiPickerItem {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return r.c(this.id, (var1 as EmojiPickerItem.FooterUpsell).id);
         }
      }
   ...
   public enum class ItemType {
      ...
      @JvmStatic
      private EmojiPickerItem.ItemType[] $VALUES = $values();
      @JvmStatic
      ...
      public companion object {
         ...
         public fun create(value: Int): com.discord.emoji_picker.EmojiPickerItem.ItemType {
            ...
            if (var1 >= 0 && var1 <= kotlin.collections.b.I(var2)) {
               return var2[var1];
            } else {
               val var3: StringBuilder = new StringBuilder();
   ...
   public data class PremiumInlineRoadblockFooter(id: String) : EmojiPickerItem {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return r.c(this.id, (var1 as EmojiPickerItem.PremiumInlineRoadblockFooter).id);
         }
      }
   ...
   public data class PremiumInlineRoadblockHeader(id: String) : EmojiPickerItem {
      ...
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return r.c(this.id, (var1 as EmojiPickerItem.PremiumInlineRoadblockHeader).id);
         }
      }

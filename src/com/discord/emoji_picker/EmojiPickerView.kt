   ...
   private fun onItemsChanged(position: Int?, count: Int?) {
      ...
      try {
         ...
         label31: {
            ...
            var13 = A9.s.a("isAttached", java.lang.String.valueOf(this.isAttachedToWindow()));
            var7 = A9.s.a("wasComputingLayoutBeforeAdapter", java.lang.String.valueOf(var4));
            var12 = A9.s.a("isComputingLayoutAfterAdapter", java.lang.String.valueOf(this.isComputingLayout()));
         ...
         CrashReporting.addBreadcrumb$default(
            var9, "About to crash from EmojiPickerView.", L.l(new Pair[]{var10, var13, var7, var12, var8, var14, var19, A9.s.a("count", var17)}), null, 4, null
         );
         throw var15;
      }
   }

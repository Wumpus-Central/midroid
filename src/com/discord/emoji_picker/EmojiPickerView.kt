...
internal class EmojiPickerView(context: Context,
   ...
   init {
      this.visibilityTracker$delegate = Ca.l.b(new o(var11, this));
      this.scroller$delegate = Ca.l.b(new p(this, var13, var10, var6, var7, var8));
   ...
   private fun onItemsChanged(position: Int?, count: Int?) {
      ...
      try {
         ...
         var var8: Pair;
         var var9: Pair;
         var var10: CrashReporting;
         var var11: Pair;
         var var12: Pair;
         var var13: Pair;
         var var14: Pair;
         label31: {
            var10 = CrashReporting.INSTANCE;
            var11 = Ca.v.a("isInViewTransition", java.lang.String.valueOf(this.isInViewTransition));
            var9 = Ca.v.a("isAttached", java.lang.String.valueOf(this.isAttachedToWindow()));
            var8 = Ca.v.a("wasComputingLayoutBeforeAdapter", java.lang.String.valueOf(var4));
            var13 = Ca.v.a("isComputingLayoutAfterAdapter", java.lang.String.valueOf(this.isComputingLayout()));
            var12 = Ca.v.a("isComputingLayoutNow", java.lang.String.valueOf(this.isComputingLayout()));
            var14 = Ca.v.a("adapterTypeChange", var5);
            if (var1 != null) {
         ...
         val var19: Pair = Ca.v.a("position", var16);
         ...
         CrashReporting.addBreadcrumb$default(
            ...
            O.m(new Pair[]{var11, var9, var8, var13, var12, var14, var19, Ca.v.a("count", var17)}),
            null,
            4,
            null
         );

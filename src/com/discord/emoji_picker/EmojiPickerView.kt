...
internal class EmojiPickerView(context: Context,
   ...
   init {
      ...
      super(var1);
      this.visibilityTracker$delegate = t9.j.a(new o(var11, this));
      this.scroller$delegate = t9.j.a(new p(this, var13, var10, var6, var7, var8));
   ...
   private fun configureMountedChildren() {
      val var1: java.util.Iterator = e0.a(this).iterator();

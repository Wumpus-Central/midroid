...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var8.hasNext()) {
         val var7: ReadableMap = var1.getMap((var8 as n).a());
         r.e(var7);
         ...
         if (var5 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(i.e(var6), NativeMapExtensionsKt.getNonNullString(var7, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var8: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var11).iterator();

         while (var8.hasNext()) {
            val var7: java.lang.String = var11.getString((var8 as n).a());
            r.e(var7);
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var19: java.util.List = i.q(new EmojiPickerItem[]{var8});
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var9, var10, var18);
               }
            } else {

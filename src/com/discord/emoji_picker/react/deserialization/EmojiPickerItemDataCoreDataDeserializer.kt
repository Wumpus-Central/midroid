...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var5.hasNext()) {
         val var8: ReadableMap = var1.getMap((var5 as q0).nextInt());
         ...
         if (var6 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var7), NativeMapExtensionsKt.getNonNullString(var8, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 == null) {
         ...
         while (var11.hasNext()) {
            val var9: java.lang.String = var7.getString((var11 as q0).nextInt());
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var11: java.util.List = CollectionsKt.r(new EmojiPickerItem[]{var8});
      ...
      while (var10.hasNext()) {
         val var13: ReadableMap = var9.getMap((var10 as q0).nextInt());
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var11, var19, var12
      );
   }
}

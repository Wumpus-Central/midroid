...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var7.hasNext()) {
         ...
         val var5: java.lang.String = var6.getString("id");
         ...
         if (var5 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var8), NativeMapExtensionsKt.getNonNullString(var6, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var9: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var8).iterator();

         while (var9.hasNext()) {
            val var7: java.lang.String = var8.getString((var9 as I).nextInt());
            var11.add(java.lang.Long.parseLong(var7));
         }
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var19.hasNext()) {
         val var13: ReadableMap = var11.getMap((var19 as I).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var9, var12, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var10, var9, var12
      );
   }
}

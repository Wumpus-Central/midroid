...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var5.hasNext()) {
         val var7: ReadableMap = var1.getMap((var5 as q0).nextInt());
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 == null) {
         ...
         while (var9.hasNext()) {
            val var11: java.lang.String = var7.getString((var9 as q0).nextInt());
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var10: java.util.List = CollectionsKt.r(new EmojiPickerItem[]{var8});
      ...
      while (var19.hasNext()) {
         val var13: ReadableMap = var12.getMap((var19 as q0).nextInt());
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var10, var9, var11
      );
   }
}

...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var7.hasNext()) {
         val var6: ReadableMap = var1.getMap((var7 as n).a());
         q.e(var6);
         ...
         if (var5 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(i.e(var8), NativeMapExtensionsKt.getNonNullString(var6, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var7.hasNext()) {
            val var11: java.lang.String = var10.getString((var7 as n).a());
            q.e(var11);
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var10: java.util.List = i.q(new EmojiPickerItem[]{var8});
      ...
      while (var19.hasNext()) {
         val var13: ReadableMap = var9.getMap((var19 as n).a());
         q.e(var13);
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var10, var11, var12
      );
   }
}

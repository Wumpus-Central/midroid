...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var9.hasNext()) {
            val var7: java.lang.String = var11.getString((var9 as n).a());
            q.e(var7);
            var8.add(java.lang.Long.parseLong(var7));
         }
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var9.hasNext()) {
         val var13: ReadableMap = var11.getMap((var9 as n).a());
         q.e(var13);
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var12, var19, var10
      );
   }
}

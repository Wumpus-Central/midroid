...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var7.hasNext()) {
         ...
         val var8: java.lang.String = var5.getString("id");
         val var6: java.lang.String = NativeMapExtensionsKt.getNonNullString(var5, "name");
         ...
         if (var8 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var6), NativeMapExtensionsKt.getNonNullString(var5, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var8: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var7).iterator();

         while (var8.hasNext()) {
            val var11: java.lang.String = var7.getString((var8 as I).nextInt());
            var10.add(java.lang.Long.parseLong(var11));
         }

         var2.add(
            new EmojiPickerItemData.CoreData.NativeSection.Guild(
               var6, var9, var5, var10, var4, var1.getBoolean("hasPremiumInlineRoadblockHeader"), var1.getBoolean("hasPremiumInlineRoadblockFooter")
            )
         );
      } else {
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var10: java.util.List = CollectionsKt.q(new EmojiPickerItem[]{var8});
      ...
      val var12: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var11).iterator();
      var var6: Boolean = false;

      while (var12.hasNext()) {
         val var13: ReadableMap = var11.getMap((var12 as I).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var19, var9, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var10, var19, var9
      );
   }
}

...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var6.hasNext()) {
         val var8: ReadableMap = var1.getMap((var6 as n).a());
         r.e(var8);
         ...
         if (var7 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(i.e(var5), NativeMapExtensionsKt.getNonNullString(var8, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var11: java.util.List = i.q(new EmojiPickerItem[]{var8});
      ...
      while (var9.hasNext()) {
         val var13: ReadableMap = var10.getMap((var9 as n).a());
         r.e(var13);
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var22.deserializeTypeNativeSection(var13, var19, var12, var18);
               }
            } else {

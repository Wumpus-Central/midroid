...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var7.hasNext()) {
         val var8: ReadableMap = var1.getMap((var7 as o).c());
         q.g(var8, "getMap(...)");
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var11.hasNext()) {
            val var10: java.lang.String = var8.getString((var11 as o).c());
            q.g(var10, "getString(...)");
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var11: java.util.List = i.p(new EmojiPickerItem[]{var8});
      ...
      while (var9.hasNext()) {
         val var13: ReadableMap = var12.getMap((var9 as o).c());
         q.g(var13, "getMap(...)");
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var11, var10, var19
      );
   }
}

...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var8.hasNext()) {
         val var6: ReadableMap = var1.getMap((var8 as I).nextInt());
         ...
         if (var5 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var7), NativeMapExtensionsKt.getNonNullString(var6, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var7: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var10).iterator();

         while (var7.hasNext()) {
            val var8: java.lang.String = var10.getString((var7 as I).nextInt());
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var11: java.util.List = CollectionsKt.q(new EmojiPickerItem[]{var8});
      ...
      val var19: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var12).iterator();
      var var6: Boolean = false;

      while (var19.hasNext()) {
         val var13: ReadableMap = var12.getMap((var19 as I).nextInt());
            ...
            if (var5 != 2) {
               if (var5 != 3) {
                  if (var5 != 4) {
                     ...
                     INSTANCE.deserializeTypeFooterUpsell(var13, var11);
                  }
               } else {
                  ...
                  var22.deserializeTypeNativeSection(var13, var9, var10, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var11, var9, var10
      );
   }
}

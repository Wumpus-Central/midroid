...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var8.hasNext()) {
            val var7: java.lang.String = var10.getString((var8 as I).nextInt());
            var9.add(java.lang.Long.parseLong(var7));
         }
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var10, var9, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var19, var10, var9
      );
   }
}

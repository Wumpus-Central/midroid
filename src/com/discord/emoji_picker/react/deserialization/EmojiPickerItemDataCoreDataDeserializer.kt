...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var10: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var8).iterator();

         while (var10.hasNext()) {
            val var9: java.lang.String = var8.getString((var10 as I).nextInt());
            var7.add(java.lang.Long.parseLong(var9));
         }

         var2.add(
            new EmojiPickerItemData.CoreData.NativeSection.Guild(
               var6, var11, var5, var7, var4, var1.getBoolean("hasPremiumInlineRoadblockHeader"), var1.getBoolean("hasPremiumInlineRoadblockFooter")
            )
         );
      } else {
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var9.hasNext()) {
         val var13: ReadableMap = var11.getMap((var9 as I).nextInt());

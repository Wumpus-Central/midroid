...
internal object EmojiPickerItemDataCoreDataDeserializer {
         ...
         if (var7 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var8), NativeMapExtensionsKt.getNonNullString(var5, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var10.hasNext()) {
         val var13: ReadableMap = var11.getMap((var10 as I).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var12, var9, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var19, var12, var9
      );
   }
}

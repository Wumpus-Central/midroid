...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var8.hasNext()) {
         val var5: ReadableMap = var1.getMap((var8 as L).nextInt());
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var11.hasNext()) {
            val var9: java.lang.String = var7.getString((var11 as L).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var22.deserializeTypeNativeSection(var13, var12, var9, var18);
               }
            } else {

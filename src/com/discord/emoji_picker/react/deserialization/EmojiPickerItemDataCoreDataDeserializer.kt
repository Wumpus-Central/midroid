...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var7.hasNext()) {
            val var8: java.lang.String = var9.getString((var7 as I).nextInt());
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var10: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var19).iterator();
      var var6: Boolean = false;

      while (var10.hasNext()) {
         val var13: ReadableMap = var19.getMap((var10 as I).nextInt());
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var11, var12, var9
      );
   }
}

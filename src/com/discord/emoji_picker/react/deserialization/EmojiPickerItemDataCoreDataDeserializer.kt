...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var10.hasNext()) {
            val var9: java.lang.String = var8.getString((var10 as n).a());
            q.e(var9);
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var12.hasNext()) {
         val var13: ReadableMap = var11.getMap((var12 as n).a());
         q.e(var13);
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var19, var10, var18);
               }
            } else {

...
internal object EmojiPickerItemDataCoreDataDeserializer {
         ...
         if (var8 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  ...
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(i.e(var6), NativeMapExtensionsKt.getNonNullString(var5, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var9.hasNext()) {
            val var8: java.lang.String = var10.getString((var9 as n).a());
            q.e(var8);
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var12.hasNext()) {
         val var13: ReadableMap = var19.getMap((var12 as n).a());
         q.e(var13);

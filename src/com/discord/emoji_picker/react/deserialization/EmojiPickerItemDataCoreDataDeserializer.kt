...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var9.hasNext()) {
            val var7: java.lang.String = var11.getString((var9 as o).c());
            q.g(var7, "getString(...)");
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var11.hasNext()) {
         val var13: ReadableMap = var10.getMap((var11 as o).c());
         q.g(var13, "getMap(...)");
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var22.deserializeTypeNativeSection(var13, var9, var19, var18);
               }
            } else {

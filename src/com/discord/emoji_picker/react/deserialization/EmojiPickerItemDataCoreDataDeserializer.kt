...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var7: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var8).iterator();

         while (var7.hasNext()) {
            val var10: java.lang.String = var8.getString((var7 as I).nextInt());
            var9.add(java.lang.Long.parseLong(var10));
         }

         var2.add(
            new EmojiPickerItemData.CoreData.NativeSection.Guild(
               var6, var11, var5, var9, var4, var1.getBoolean("hasPremiumInlineRoadblockHeader"), var1.getBoolean("hasPremiumInlineRoadblockFooter")
            )
         );
      } else {
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var10, var19, var11
      );
   }
}

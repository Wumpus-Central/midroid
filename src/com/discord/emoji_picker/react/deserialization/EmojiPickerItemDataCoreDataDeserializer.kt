...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      ...
      while (var7.hasNext()) {
         val var5: ReadableMap = var1.getMap((var7 as q0).nextInt());
   ...
   private fun deserializeTypeFooterUpsell(section: ReadableMap, trailing: MutableList<EmojiPickerItem>) {
      ...
      if (var3 == null) {
         var2.add(CollectionsKt.n(var2), new EmojiPickerItem.FooterUpsell(NativeMapExtensionsKt.getNonNullString(var1, "id")));
      } else {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 == null) {
         ...
         while (var9.hasNext()) {
            val var11: java.lang.String = var8.getString((var9 as q0).nextInt());
            var7.add(java.lang.Long.parseLong(var11));
         }
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var17: java.util.List = CollectionsKt.r(new EmojiPickerItem[]{var16});
      val var12: java.util.List = CollectionsKt.r(new EmojiPickerItem[]{var8});
      ...
      while (var11.hasNext()) {
         val var13: ReadableMap = var9.getMap((var11 as q0).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var23.deserializeTypeNativeSection(var13, var10, var19, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var12, var10, var19
      );
   }
}

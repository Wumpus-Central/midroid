...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeEmojiRowSlim(emojisRow: ReadableArray, emojiItems: MutableList<EmojiPickerItem>, isSectionNitroLocked: Boolean) {
      val var7: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var1).iterator();

      while (var7.hasNext()) {
         val var8: ReadableMap = var1.getMap((var7 as I).nextInt());
         val var5: java.lang.String = var8.getString("id");
         val var6: java.lang.String = NativeMapExtensionsKt.getNonNullString(var8, "name");
         val var4: Boolean = NativeMapExtensionsKt.getBoolean(var8, "animated", false);
         if (var5 == null) {
            var2.add(
               new EmojiPickerItem.Emoji(
                  IdUtilsKt.convertToId(var6),
                  var6,
                  var4,
                  null,
                  new UnicodeEmojis.Emoji(CollectionsKt.e(var6), NativeMapExtensionsKt.getNonNullString(var8, "surrogates")),
                  false,
                  40,
                  null
               )
   ...
   private fun deserializeTypeFooterUpsell(section: ReadableMap, trailing: MutableList<EmojiPickerItem>) {
      ...
      if (var3 == null) {
         var2.add(CollectionsKt.m(var2), new EmojiPickerItem.FooterUpsell(NativeMapExtensionsKt.getNonNullString(var1, "id")));
      } else {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         val var11: HashSet = new HashSet();
         val var9: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var7).iterator();

         while (var9.hasNext()) {
            val var8: java.lang.String = var7.getString((var9 as I).nextInt());
            var11.add(java.lang.Long.parseLong(var8));
         }

         var2.add(
            new EmojiPickerItemData.CoreData.NativeSection.Guild(
               var6, var10, var5, var11, var4, var1.getBoolean("hasPremiumInlineRoadblockHeader"), var1.getBoolean("hasPremiumInlineRoadblockFooter")
            )
         );
      } else {
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      val var17: java.util.List = CollectionsKt.q(new EmojiPickerItem[]{var16});
      val var19: java.util.List = CollectionsKt.q(new EmojiPickerItem[]{var8});
      ...
      val var9: java.util.Iterator = NativeArrayExtensionsKt.sizeRange(var12).iterator();
      var var6: Boolean = false;

      while (var9.hasNext()) {
         val var13: ReadableMap = var12.getMap((var9 as I).nextInt());
         ...
         if (var5 != 1) {
            if (var5 != 2) {
               if (var5 != 3) {
                  ...
                  var22.deserializeTypeNativeSection(var13, var11, var10, var18);
               }
            } else {
      ...
      return new EmojiPickerItemData.CoreData(
         this.deserializeRowSize(var2), var2.getBoolean("hasGuildData"), var2.getBoolean("hasSearchData"), var6, var17, var19, var11, var10
      );
   }
}

...
internal object EmojiPickerItemDataCoreDataDeserializer {
   ...
   private fun deserializeTypeNativeSection(
      ...
      if (var6 != null) {
         ...
         while (var7.hasNext()) {
            val var8: java.lang.String = var10.getString((var7 as n).a());
            r.e(var8);
         ...
         var2.add(
            new EmojiPickerItemData.CoreData.NativeSection.Guild(
               var6, var9, var5, var11, var4, var1.getBoolean("hasPremiumInlineRoadblockHeader"), var1.getBoolean("hasPremiumInlineRoadblockFooter")
            )
         );
      } else {
   ...
   public fun Companion.deserialize(data: ReadableMap, contentPaddingBottom: Float = 0.0F, contentPaddingTop: Float = 0.0F): CoreData {
      ...
      while (var10.hasNext()) {
         val var13: ReadableMap = var11.getMap((var10 as n).a());
         r.e(var13);

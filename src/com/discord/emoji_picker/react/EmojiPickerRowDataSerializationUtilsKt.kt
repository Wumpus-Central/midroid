...
internal fun deserializeEmojiPickerRowData(data: ReadableMap): EmojiPickerRow {
   ...
   val var6: ArrayList = new ArrayList(CollectionsKt.w(var5, 10));
   val var8: java.util.Iterator = var5.iterator();

   while (var8.hasNext()) {
      val var9: ReadableMap = var7.getMap((var8 as q0).nextInt());
      val var10: EmojiPickerRow.Emoji;
      if (!StringsKt.i0(NativeMapExtensionsKt.getNonNullString(var9, "url"))) {

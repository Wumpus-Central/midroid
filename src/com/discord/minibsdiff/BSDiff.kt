...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // ba: aload 3
      // bb: aload 7
      // bd: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c0: aload 6
      // c2: athrow
      // c3: aload 6
      // c5: athrow
      ...
      // c7: aload 2
      // c8: aload 6
      // ca: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // cd: aload 3
      // ce: athrow
      // cf: aload 2
      // d0: athrow
      ...
      // d2: aload 5
      // d4: aload 2
      // d5: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // d8: aload 3
      // d9: athrow
      // da: aload 2
      // db: athrow
      ...
      // dd: aload 4
      // df: aload 2
      // e0: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // e3: aload 3
      // e4: athrow
      // e5: aload 3
      // e6: athrow
      ...
      // e8: aload 1
      // e9: aload 3
      // ea: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ed: aload 2
      // ee: athrow
   }

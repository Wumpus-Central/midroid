...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // b9: aload 3
      // ba: aload 6
      // bc: invokestatic q9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // bf: aload 7
      // c1: athrow
      // c2: aload 3
      // c3: athrow
      ...
      // dc: aload 4
      // de: aload 2
      // df: invokestatic q9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // e2: aload 3
      // e3: athrow
      // e4: aload 3
      // e5: athrow
      ...
      // e7: aload 1
      // e8: aload 3
      // e9: invokestatic q9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ec: aload 2
      // ed: athrow
   }

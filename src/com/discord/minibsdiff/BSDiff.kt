...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 103: aload 3
      // 104: aload 7
      // 106: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 109: aload 6
      // 10b: athrow
      // 10c: aload 6
      // 10e: athrow
      ...
      // 110: aload 2
      // 111: aload 6
      // 113: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 116: aload 3
      // 117: athrow
      // 118: aload 3
      // 119: athrow
      ...
      // 11b: aload 4
      // 11d: aload 3
      // 11e: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 121: aload 2
      // 122: athrow
      // 123: aload 3
      // 124: athrow
      ...
      // 126: aload 1
      // 127: aload 3
      // 128: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 12b: aload 2
      // 12c: athrow
      // 12d: aload 2
      // 12e: athrow
      ...
      // 130: aload 5
      // 132: aload 2
      // 133: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 136: aload 1
      // 137: athrow
   }

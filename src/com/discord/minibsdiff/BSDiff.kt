...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // b9: aload 3
      // ba: aload 6
      // bc: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // bf: aload 7
      // c1: athrow
      // c2: aload 3
      // c3: athrow
      ...
      // c6: aload 2
      // c7: aload 3
      // c8: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // cb: aload 6
      // cd: athrow
      // ce: aload 2
      // cf: athrow
      ...
      // d1: aload 5
      // d3: aload 2
      // d4: invokestatic K9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // d7: aload 3
      // d8: athrow
      // d9: aload 2
      // da: athrow

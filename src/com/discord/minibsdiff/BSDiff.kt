...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 86: aload 3
      // 87: aconst_null
      // 88: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      // 8c: aconst_null
      // 8d: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 90: aload 5
      // 92: aconst_null
      // 93: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 96: aload 4
      // 98: aconst_null
      // 99: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9c: aload 1
      // 9d: aconst_null
      ...
      // ba: aload 3
      // bb: aload 7
      // bd: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c0: aload 6
      // c2: athrow
      // c3: aload 6
      // c5: athrow

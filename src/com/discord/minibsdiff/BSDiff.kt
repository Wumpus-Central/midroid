...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 86: aload 3
      // 87: aconst_null
      // 88: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      // 8c: aconst_null
      // 8d: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 90: aload 5
      // 92: aconst_null
      // 93: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 96: aload 4
      // 98: aconst_null
      // 99: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9c: aload 1
      // 9d: aconst_null
      // 9e: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: return
      // a2: astore 3
      // a3: goto e5
      // a6: astore 3
      ...
      // ba: aload 3
      // bb: aload 6
      // bd: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c0: aload 7
      // c2: athrow
      // c3: aload 6
      // c5: athrow
      ...
      // c7: aload 2
      // c8: aload 6
      // ca: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // cd: aload 3
      // ce: athrow
      // cf: aload 3
      // d0: athrow
      ...
      // d2: aload 5
      // d4: aload 3
      // d5: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // d8: aload 2
      // d9: athrow
      // da: aload 3
      // db: athrow
      ...
      // dd: aload 4
      // df: aload 3
      // e0: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // e3: aload 2
      // e4: athrow
      // e5: aload 3
      // e6: athrow
      ...
      // e8: aload 1
      // e9: aload 3
      // ea: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ed: aload 2
      // ee: athrow
   }

...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 86: aload 3
      // 87: aconst_null
      // 88: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      // 8c: aconst_null
      // 8d: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 90: aload 5
      // 92: aconst_null
      // 93: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 96: aload 4
      // 98: aconst_null
      // 99: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9c: aload 1
      // 9d: aconst_null
      // 9e: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: return
      // a2: astore 3
      // a3: goto e4
      // a6: astore 2
      ...
      // b9: aload 3
      // ba: aload 6
      // bc: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // bf: aload 7
      // c1: athrow
      // c2: aload 3
      // c3: athrow
      ...
      // c6: aload 2
      // c7: aload 3
      // c8: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // cb: aload 6
      // cd: athrow
      // ce: aload 2
      // cf: athrow
      ...
      // d1: aload 5
      // d3: aload 2
      // d4: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // d7: aload 3
      // d8: athrow
      // d9: aload 2
      // da: athrow
      ...
      // dc: aload 4
      // de: aload 2
      // df: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // e2: aload 3
      // e3: athrow
      // e4: aload 3
      // e5: athrow
      ...
      // e7: aload 1
      // e8: aload 3
      // e9: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ec: aload 2
      // ed: athrow
   }

...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 8b: aload 2
      // 8c: aconst_null
      // 8d: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 90: aload 5
      // 92: aconst_null
      // 93: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 96: aload 4
      // 98: aconst_null
      // 99: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9c: aload 1
      // 9d: aconst_null
      ...
      // b9: aload 3
      // ba: aload 6
      // bc: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // bf: aload 7
      // c1: athrow
      // c2: aload 3
      // c3: athrow
      ...
      // c6: aload 2
      // c7: aload 3
      // c8: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // cb: aload 6
      // cd: athrow
      // ce: aload 2
      // cf: athrow
      ...
      // d1: aload 5
      // d3: aload 2
      // d4: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // d7: aload 3
      // d8: athrow
      // d9: aload 2
      // da: athrow
      ...
      // dc: aload 4
      // de: aload 2
      // df: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // e2: aload 3
      // e3: athrow
      // e4: aload 2
      // e5: athrow
      ...
      // e7: aload 1
      // e8: aload 2
      // e9: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ec: aload 3
      // ed: athrow
   }

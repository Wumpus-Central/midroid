...
public object BSDiff {
   ...
   public fun bspatchStreaming(oldPath: File, patchPath: File, newPath: File) {
      ...
      // 102: aload 3
      // 103: aload 6
      // 105: invokestatic yh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 108: aload 7
      // 10a: athrow
      // 10b: aload 3
      // 10c: athrow
      ...
      // 10f: aload 2
      // 110: aload 3
      // 111: invokestatic yh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 114: aload 6
      // 116: athrow
      // 117: aload 3
      // 118: athrow
      ...
      // 11a: aload 4
      // 11c: aload 3
      // 11d: invokestatic yh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 120: aload 2
      // 121: athrow
      // 122: aload 3
      // 123: athrow
      ...
      // 125: aload 1
      // 126: aload 3
      // 127: invokestatic yh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 12a: aload 2
      // 12b: athrow
      // 12c: aload 1
      // 12d: athrow
      ...
      // 12f: aload 5
      // 131: aload 1
      // 132: invokestatic yh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 135: aload 2
      // 136: athrow
   }

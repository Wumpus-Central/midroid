...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   if (var1.getBoolean("sectionHeaderSizeIsUniform")) {
      var7 = SizeUtilsKt.getDpToPx(var11.getDouble(0));
   } else {
      var7 = null;
   }
   ...
   if (var1.getBoolean("sectionFooterSizeIsUniform")) {
      var8 = SizeUtilsKt.getDpToPx(var13.getDouble(0));
   } else {
      var8 = null;
   }
   ...
   if (var2 > 0) {
      var25 = new FastestListSections.Entry.ListHeader(
         FastestListSections.Entry.ListHeader.Companion.createKey(var19, var24), FastestListSections.Section.constructor-impl(0), var2, null
      );
   } else {
      var25 = null;
   }
   ...
   val var29: FastestListSections.Entry.ListFooter;
   if (var2 > 0) {
      var29 = new FastestListSections.Entry.ListFooter(
         FastestListSections.Entry.ListFooter.Companion.createKey(var19, var9),
         FastestListSections.Section.constructor-impl(Math.max(0, CollectionsKt.m(var20))),
         var2,
         null
      );
   } else {
   ...
   val var16: a = new a(var12, var15, var18);
   var2 = 0;
   val var30: a = var16;

   while (var2 <= CollectionsKt.m(var20)) {
      if (var2 == 0) {
         var30.invoke(var25);
      }
      ...
      if (var4 == 0) {
         if (var2 == CollectionsKt.m(var20)) {
            var30.invoke(var29);
         }

         var2++;
      } else {
         var30.invoke(createSectionHeader(var19, var5, var2, var21, var7, var11));

         var var3: Int;
         for (var3 = 0; var3 < var4; var3++) {
            var30.invoke(createSectionItem(var19, var5, var2, var4, var3, var17, var6, var10));
         }

         if (var3 == var4) {
            var30.invoke(createSectionFooter(var19, var5, var2, var22, var8, var13));
            if (var2 == CollectionsKt.m(var20)) {
               var30.invoke(var29);
            }
         }
   ...
   return new FastestListSections.Versioned(var14, var12, var18.element, var15);
}

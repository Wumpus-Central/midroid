...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   if (var2 > 0) {
      var30 = new FastestListSections.Entry.ListFooter(
         ...
         FastestListSections.Section.constructor-impl(Math.max(0, i.l(var18))),
         var2,
         null
      );
   } else {
   ...
   while (var2 <= i.l(var18)) {
      ...
      if (var4 == 0) {
         ...
         for (var3 = 0; var3 < var4; var3++) {
            var31.invoke(createSectionItem(var20, var5, var2, var4, var3, var17, var6, var10));
         }

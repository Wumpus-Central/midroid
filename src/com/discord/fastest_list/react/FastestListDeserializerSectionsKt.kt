...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   val var16: Function1 = new Function1(var12, var14, var20) {
   ...
   while (var2 <= i.m(var17)) {
      ...
      if (var4 == 0) {
         ...
         for (var3 = 0; var3 < var4; var3++) {
            var30.invoke(createSectionItem(var18, var5, var2, var4, var3, var19, var6, var10));
         }
   ...
   return new FastestListSections.Versioned(var15, var12, var20.j, var14);
}

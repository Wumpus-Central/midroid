...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   if (var1.getBoolean("sectionHeaderSizeIsUniform")) {
      var7 = SizeUtilsKt.getDpToPx(var12.getDouble(0));
   } else {
      var7 = null;
   }
   ...
   val var16: a = new a(var11, var14, var20);
   var2 = 0;
   val var30: a = var16;
   ...
   while (var2 <= CollectionsKt.m(var18)) {
      ...
      if (var4 == 0) {
         ...
         var30.invoke(createSectionHeader(var19, var5, var2, var21, var7, var12));
   ...
   return new FastestListSections.Versioned(var15, var11, var20.element, var14);
}

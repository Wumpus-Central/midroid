...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   if (var2 > 0) {
      var24 = new FastestListSections.Entry.ListHeader(
         FastestListSections.Entry.ListHeader.Companion.createKey(var17, var23), FastestListSections.Section.constructor-impl(0), var2, null
      );
   } else {
      var24 = null;
   }
   ...
   while (var2 <= i.m(var20)) {
      ...
      if (var4 == 0) {
         ...
         var29.invoke(createSectionHeader(var17, var5, var2, var21, var7, var12));

         var var3: Int;
         for (var3 = 0; var3 < var4; var3++) {
            var29.invoke(createSectionItem(var17, var5, var2, var4, var3, var19, var6, var10));
         }

         if (var3 == var4) {
            var29.invoke(createSectionFooter(var17, var5, var2, var22, var8, var13));
            if (var2 == i.m(var20)) {
               var29.invoke(var28);
            }
         }

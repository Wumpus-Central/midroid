...
internal operator fun Companion.invoke(value: ReadableMap): Versioned {
   ...
   if (var2 > 0) {
      var29 = new FastestListSections.Entry.ListFooter(
         ...
         FastestListSections.Section.constructor-impl(Math.max(0, CollectionsKt.m(var18))),
         var2,
         null
      );
   } else {
   ...
   val var16: a = new a(var12, var14, var17);
   var2 = 0;
   val var30: a = var16;

   while (var2 <= CollectionsKt.m(var18)) {
      if (var2 == 0) {
         var30.invoke(var25);
      }
      ...
      if (var4 == 0) {
         ...
         for (var3 = 0; var3 < var4; var3++) {
            var30.invoke(createSectionItem(var19, var5, var2, var4, var3, var20, var6, var10));
         }
   ...
   return new FastestListSections.Versioned(var15, var12, var17.element, var14);
}

...
internal operator fun com.discord.fastest_list.android.placeholder.FastestListPlaceholderType.Companion.invoke(value: ReadableMap): FastestListPlaceholderType {
   ...
   if (var15 != 0) {
      if (var15 != 1) {
         ...
         val var2: Float = SizeUtilsKt.getDpToPx(var1.getInt("placeholderShapeGap"));
         ...
         val var5: Float = SizeUtilsKt.getDpToPx(var1.getInt("placeholderShapePaddingHorizontal"));

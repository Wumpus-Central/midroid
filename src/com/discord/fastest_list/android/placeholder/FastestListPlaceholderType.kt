...
internal sealed class FastestListPlaceholderType protected constructor() {
   ...
   public data class FeedItem(backgroundColor: Int,
      ...
      public override fun toString(): String {
         ...
         val var9: Float = this.borderRadius;
         val var6: Float = this.borderTopLeftRadius;
         val var11: Float = this.borderTopRightRadius;
         val var7: Float = this.borderBottomLeftRadius;
         val var2: Float = this.borderBottomRightRadius;
         val var14: Int = this.color;
         val var17: Boolean = this.divider;
         val var16: Int = this.dividerColor;
         val var13: Float = this.dividerPaddingLeft;
         val var3: Float = this.dividerPaddingRight;
         val var8: Float = this.padding;
         val var19: FastestListPlaceholderType.Shape.Type = this.shapeType;
         val var4: Float = this.shapeSize;
         val var5: Float = this.labelPadding;
         val var12: Float = this.labelPaddingInnerRatio;
         val var1: Float = this.labelSize;
         val var10: Float = this.labelSecondarySize;
   ...
   public data object None : FastestListPlaceholderType() {
      public override operator fun equals(other: Any?): Boolean {
         if (this === var1) {
            ...
            return var1 is FastestListPlaceholderType.None;
         }
      }
   ...
   public data class Shape(borderRadius: Float,
      ...
      init {
         r.h(var9, "type");
         r.h(var10, "verticalAlignment");
         r.h(var11, "horizontalAlignment");
         super(null);
      ...
      public override fun hashCode(): Int {
         ...
         val var8: Int = java.lang.Float.hashCode(this.gap);
         val var5: Int = java.lang.Float.hashCode(this.paddingHorizontal);
         val var4: Int = java.lang.Float.hashCode(this.paddingVertical);
         var var2: Int = 0;
         val var1: Int;
         if (this.width == null) {
            var1 = 0;
         ...
         return (
                  ((((((((var3 * 31 + var6) * 31 + var7) * 31 + var8) * 31 + var5) * 31 + var4) * 31 + var1) * 31 + var2) * 31 + this.type.hashCode()) * 31
      ...
      public override fun toString(): String {
         ...
         val var12: java.lang.Float = this.height;
         val var8: FastestListPlaceholderType.Shape.Type = this.type;
         val var9: FastestListPlaceholderAlignment.Vertical = this.verticalAlignment;
         val var7: FastestListPlaceholderAlignment.Horizontal = this.horizontalAlignment;
         val var10: StringBuilder = new StringBuilder();
         var10.append("Shape(borderRadius=");
         var10.append(var1);
         var10.append(", color=");
         var10.append(var5);
         var10.append(", count=");
         ...
         var10.append(", gap=");
         var10.append(var3);
         var10.append(", paddingHorizontal=");
         var10.append(var2);
         var10.append(", paddingVertical=");
         var10.append(var4);
         var10.append(", width=");
         var10.append(var11);
         var10.append(", height=");
         ...
         var10.append(", type=");
         var10.append(var8);
         var10.append(", verticalAlignment=");
         var10.append(var9);
         var10.append(", horizontalAlignment=");
         var10.append(var7);
         var10.append(")");

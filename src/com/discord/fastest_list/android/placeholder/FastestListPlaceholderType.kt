...
internal sealed class FastestListPlaceholderType protected constructor() {
   ...
   public data class FeedItem(backgroundColor: Int,
      ...
      public override fun toString(): String {
         ...
         val var12: Float = this.borderTopRightRadius;
         ...
         val var10: Float = this.shapeSize;
         val var6: Float = this.labelPadding;
         val var7: Float = this.labelPaddingInnerRatio;
         val var3: Float = this.labelSize;
         val var9: Float = this.labelSecondarySize;
   ...
   public data class Shape(borderRadius: Float,
      ...
      public override fun hashCode(): Int {
         ...
         val var7: Int = java.lang.Float.hashCode(this.gap);
         ...
         return (
                  ((((((((var6 * 31 + var3) * 31 + var5) * 31 + var7) * 31 + var4) * 31 + var8) * 31 + var1) * 31 + var2) * 31 + this.type.hashCode()) * 31

...
internal sealed class FastestListPlaceholderType protected constructor() {
   ...
   public data class FeedItem(backgroundColor: Int,
      ...
      public override fun toString(): String {
         ...
         val var11: Float = this.borderRadius;
         val var12: Float = this.borderTopLeftRadius;
         val var13: Float = this.borderTopRightRadius;
         val var8: Float = this.borderBottomLeftRadius;
         ...
         val var6: Float = this.dividerPaddingLeft;
   ...
   public data class Shape(borderRadius: Float,
      ...
      public override fun hashCode(): Int {
         val var8: Int = java.lang.Float.hashCode(this.borderRadius);
         ...
         return (
                  ((((((((var8 * 31 + var6) * 31 + var7) * 31 + var4) * 31 + var3) * 31 + var5) * 31 + var1) * 31 + var2) * 31 + this.type.hashCode()) * 31
      ...
      public override fun toString(): String {
         ...
         val var12: java.lang.Float = this.width;
         ...
         var8.append(", type=");
         var8.append(var9);
         var8.append(", verticalAlignment=");
         var8.append(var10);
         var8.append(", horizontalAlignment=");
         var8.append(var7);
         var8.append(")");

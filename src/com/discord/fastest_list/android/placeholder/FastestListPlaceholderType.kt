...
internal sealed class FastestListPlaceholderType protected constructor() {
   ...
   public data class FeedItem(backgroundColor: Int,
      ...
      public override fun hashCode(): Int {
         ...
         val var9: Int = java.lang.Float.hashCode(this.borderRadius);
         val var5: Int = java.lang.Float.hashCode(this.borderTopLeftRadius);
         val var4: Int = java.lang.Float.hashCode(this.borderTopRightRadius);
         val var6: Int = java.lang.Float.hashCode(this.borderBottomLeftRadius);
         val var7: Int = java.lang.Float.hashCode(this.borderBottomRightRadius);
      ...
      public override fun toString(): String {
         ...
         val var8: Float = this.borderRadius;
         val var13: Float = this.borderTopLeftRadius;
         val var10: Float = this.borderTopRightRadius;
         val var9: Float = this.borderBottomLeftRadius;
         val var3: Float = this.borderBottomRightRadius;
         ...
         val var6: Float = this.dividerPaddingRight;
         ...
         val var7: Float = this.labelSecondarySize;
   ...
   public data class Shape(borderRadius: Float,
      ...
      public override fun hashCode(): Int {
         ...
         return ((((((var7 * 31 + var6) * 31 + var5) * 31 + var3) * 31 + var4) * 31 + var1) * 31 + var2) * 31 + this.type.hashCode();
      }
      ...
      public override fun toString(): String {
         ...
         val var6: java.lang.Float = this.height;
         val var7: FastestListPlaceholderType.Shape.Type = this.type;
         val var8: StringBuilder = new StringBuilder();
         var8.append("Shape(borderRadius=");
         var8.append(var2);
         var8.append(", color=");
         var8.append(var4);
         var8.append(", count=");
         var8.append(var5);
         var8.append(", paddingHorizontal=");
         var8.append(var3);
         var8.append(", paddingVertical=");
         var8.append(var1);
         var8.append(", width=");
         var8.append(var9);
         var8.append(", height=");

...
internal sealed class FastestListPlaceholderType protected constructor() {
   ...
   public data class FeedItem(backgroundColor: Int,
      ...
      public override fun toString(): String {
         ...
         val var3: Float = this.borderTopLeftRadius;
         val var2: Float = this.borderTopRightRadius;
         val var11: Float = this.borderBottomLeftRadius;
         val var5: Float = this.borderBottomRightRadius;
         val var16: Int = this.color;
         val var17: Boolean = this.divider;
         val var14: Int = this.dividerColor;
         val var7: Float = this.dividerPaddingLeft;
         val var4: Float = this.dividerPaddingRight;
         val var10: Float = this.padding;
         val var19: FastestListPlaceholderType.Shape.Type = this.shapeType;
         val var8: Float = this.shapeSize;
         val var12: Float = this.labelPadding;
         val var1: Float = this.labelPaddingInnerRatio;
         val var9: Float = this.labelSize;
         val var13: Float = this.labelSecondarySize;
   ...
   public data class Shape(borderRadius: Float,
      ...
      public override fun hashCode(): Int {
         ...
         val var8: Int = Integer.hashCode(this.count);
         val var6: Int = java.lang.Float.hashCode(this.gap);
         ...
         return (
                  ((((((((var7 * 31 + var3) * 31 + var8) * 31 + var6) * 31 + var4) * 31 + var5) * 31 + var1) * 31 + var2) * 31 + this.type.hashCode()) * 31
      ...
      public override fun toString(): String {
         ...
         var11.append("Shape(borderRadius=");
         var11.append(var3);
         var11.append(", color=");
         var11.append(var5);
         var11.append(", count=");
         ...
         var11.append(", gap=");
         var11.append(var1);
         var11.append(", paddingHorizontal=");
         var11.append(var4);
         var11.append(", paddingVertical=");
         var11.append(var2);
         var11.append(", width=");
         var11.append(var7);
         var11.append(", height=");
         ...
         var11.append(", type=");
         var11.append(var8);
         var11.append(", verticalAlignment=");
         var11.append(var12);
         var11.append(", horizontalAlignment=");
         var11.append(var10);
         var11.append(")");

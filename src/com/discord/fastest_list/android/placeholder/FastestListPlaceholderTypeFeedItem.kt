...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var21: Float = this.config.getLabelPaddingInnerRatio() * var6 / var7;
         ...
         val var22: Float = (var14 - (var6 + var5)) / 2.0F + var6;
         var1.drawRoundRect(
            var11,
            ((float)var14 - (var6 + var5)) / 2.0F + var21,
            this.labelWidthRatio * var7,
            ((float)var14 - (var6 + var5)) / 2.0F + var6 - var21,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var11, var22 + var10, var7 * this.labelWidthRatioSecondary, var22 + var5 - var10, var19, var19, this.paint);

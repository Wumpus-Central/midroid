...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var14 - (var10 + var20)) / 2.0F + var10;
         var1.drawRoundRect(
            var9,
            ((float)var14 - (var10 + var20)) / 2.0F + var19,
            this.labelWidthRatio * var11,
            ((float)var14 - (var10 + var20)) / 2.0F + var10 - var19,
            var5,
            var5,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var6, var11 * this.labelWidthRatioSecondary, var23 + var20 - var6, var21, var21, this.paint);

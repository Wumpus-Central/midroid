...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var20: Float = var19 / 2;
         val var5: Float = this.config.getLabelPaddingInnerRatio() * var12 / var6;
         val var8: Float = this.config.getLabelPaddingInnerRatio() * var19 / var6;
         ...
         var1.drawRoundRect(
            var7,
            ((float)var15 - (var12 + var19)) / 2.0F + var5,
            this.labelWidthRatio * var6,
            ((float)var15 - (var12 + var19)) / 2.0F + var12 - var5,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var7, var23 + var8, var6 * this.labelWidthRatioSecondary, var23 + var19 - var8, var20, var20, this.paint);

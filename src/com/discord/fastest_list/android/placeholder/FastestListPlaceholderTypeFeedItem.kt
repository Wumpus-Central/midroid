...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public open fun draw(canvas: Canvas) {
         ...
         val var20: Float = this.config.getLabelPaddingInnerRatio() * var10 / var6;
         ...
         var1.drawRoundRect(
            var13,
            ((float)var16 - (var10 + var21)) / 2.0F + var20,
            this.labelWidthRatio * var8,
            ((float)var16 - (var10 + var21)) / 2.0F + var10 - var20,
            var5,
            var5,
            this.paint
         );
         var1.drawRoundRect(var13, var23 + var6, var8 * this.labelWidthRatioSecondary, var23 + var21 - var6, var19, var19, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var12 - (float)SizeUtilsKt.getDpToPx(1), var7 - this.config.getDividerPaddingRight(), var12, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

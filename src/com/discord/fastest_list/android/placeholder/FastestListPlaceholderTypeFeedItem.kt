...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var16 - (var11 + var19)) / 2.0F + var11;
         var1.drawRoundRect(
            var7,
            ((float)var16 - (var11 + var19)) / 2.0F + var20,
            this.labelWidthRatio * var8,
            ((float)var16 - (var11 + var19)) / 2.0F + var11 - var20,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var7, var23 + var12, var8 * this.labelWidthRatioSecondary, var23 + var19 - var12, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var9 - (float)SizeUtilsKt.getDpToPx(1), var13 - this.config.getDividerPaddingRight(), var9, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var11: Float = this.config.getLabelPaddingInnerRatio() * var21 / var6;
         ...
         var6 = var16;
         val var23: Float = (var16 - (var12 + var21)) / 2.0F + var12;
         var1.drawRoundRect(
            var10,
            ((float)var16 - (var12 + var21)) / 2.0F + var19,
            this.labelWidthRatio * var8,
            ((float)var16 - (var12 + var21)) / 2.0F + var12 - var19,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var10, var23 + var11, var8 * this.labelWidthRatioSecondary, var23 + var21 - var11, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var6 - (float)SizeUtilsKt.getDpToPx(1), var13 - this.config.getDividerPaddingRight(), var6, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

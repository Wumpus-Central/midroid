...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var9: Float = this.config.getLabelPaddingInnerRatio() * var20 / var6;
         ...
         var1.drawRoundRect(
            var11,
            ((float)var14 - (var13 + var20)) / 2.0F + var21,
            this.labelWidthRatio * var10,
            ((float)var14 - (var13 + var20)) / 2.0F + var13 - var21,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var9, var10 * this.labelWidthRatioSecondary, var23 + var20 - var9, var5, var5, this.paint);

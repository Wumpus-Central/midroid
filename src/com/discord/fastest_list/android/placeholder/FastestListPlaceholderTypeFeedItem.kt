...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var9: Float = this.config.getLabelPaddingInnerRatio() * var19 / var7;
         ...
         val var22: Float = (var14 - (var6 + var19)) / 2.0F + var6;
         var1.drawRoundRect(
            var10,
            ((float)var14 - (var6 + var19)) / 2.0F + var20,
            this.labelWidthRatio * var12,
            ((float)var14 - (var6 + var19)) / 2.0F + var6 - var20,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var10, var22 + var9, var12 * this.labelWidthRatioSecondary, var22 + var19 - var9, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var8 - (float)SizeUtilsKt.getDpToPx(1), var11 - this.config.getDividerPaddingRight(), var8, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

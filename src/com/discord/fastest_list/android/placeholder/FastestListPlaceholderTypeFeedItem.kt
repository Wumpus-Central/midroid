...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var21: Float = this.config.getLabelPaddingInnerRatio() * var9 / var6;
         ...
         val var23: Float = (var16 - (var9 + var20)) / 2.0F + var9;
         var1.drawRoundRect(
            var11,
            ((float)var16 - (var9 + var20)) / 2.0F + var21,
            this.labelWidthRatio * var6,
            ((float)var16 - (var9 + var20)) / 2.0F + var9 - var21,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var10, var6 * this.labelWidthRatioSecondary, var23 + var20 - var10, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var8 - (float)SizeUtilsKt.getDpToPx(1), var13 - this.config.getDividerPaddingRight(), var8, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

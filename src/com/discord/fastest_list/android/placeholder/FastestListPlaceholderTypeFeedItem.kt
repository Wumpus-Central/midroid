...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var10: Float = this.config.getLabelPaddingInnerRatio() * var21 / var6;
         val var11: Float = this.config.getPadding() + this.config.getShapeSize() + this.config.getLabelPadding();
         val var8: Float = var16;
         val var7: Float = var16 - this.config.getPadding() - this.config.getLabelPadding();
         var6 = var15;
         val var23: Float = (var15 - (var13 + var21)) / 2.0F + var13;
         var1.drawRoundRect(
            var11,
            ((float)var15 - (var13 + var21)) / 2.0F + var5,
            this.labelWidthRatio * var7,
            ((float)var15 - (var13 + var21)) / 2.0F + var13 - var5,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var10, var7 * this.labelWidthRatioSecondary, var23 + var21 - var10, var20, var20, this.paint);

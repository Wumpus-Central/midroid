...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var1.drawRoundRect(
            var11,
            ((float)var14 - (var12 + var21)) / 2.0F + var20,
            this.labelWidthRatio * var9,
            ((float)var14 - (var12 + var21)) / 2.0F + var12 - var20,
            var5,
            var5,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var10, var9 * this.labelWidthRatioSecondary, var23 + var21 - var10, var19, var19, this.paint);

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var5: Float = this.config.getLabelPaddingInnerRatio() * var11 / var6;
         ...
         val var9: Float = var16;
         val var23: Float = (var16 - (var11 + var20)) / 2.0F + var11;
         var1.drawRoundRect(
            var12,
            ((float)var16 - (var11 + var20)) / 2.0F + var5,
            this.labelWidthRatio * var7,
            ((float)var16 - (var11 + var20)) / 2.0F + var11 - var5,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var12, var23 + var10, var7 * this.labelWidthRatioSecondary, var23 + var20 - var10, var19, var19, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var9 - (float)SizeUtilsKt.getDpToPx(1), var6 - this.config.getDividerPaddingRight(), var9, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

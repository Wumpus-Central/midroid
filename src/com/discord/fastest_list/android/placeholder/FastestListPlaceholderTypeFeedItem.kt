...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var var6: Float = 2;
         val var20: Float = var8 / 2;
         val var21: Float = var19 / 2;
         val var5: Float = this.config.getLabelPaddingInnerRatio() * var8 / var6;
         ...
         val var7: Float = var15 - this.config.getPadding() - this.config.getLabelPadding();
         val var11: Float = var16;
         val var23: Float = (var16 - (var8 + var19)) / 2.0F + var8;
         var1.drawRoundRect(
            var13,
            ((float)var16 - (var8 + var19)) / 2.0F + var5,
            this.labelWidthRatio * var7,
            ((float)var16 - (var8 + var19)) / 2.0F + var8 - var5,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var13, var23 + var6, var7 * this.labelWidthRatioSecondary, var23 + var19 - var6, var21, var21, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var11 - (float)SizeUtilsKt.getDpToPx(1), var12 - this.config.getDividerPaddingRight(), var11, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var6 = var14;
         val var23: Float = (var14 - (var11 + var19)) / 2.0F + var11;
         var1.drawRoundRect(
            var10,
            ((float)var14 - (var11 + var19)) / 2.0F + var5,
            this.labelWidthRatio * var9,
            ((float)var14 - (var11 + var19)) / 2.0F + var11 - var5,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var10, var23 + var8, var9 * this.labelWidthRatioSecondary, var23 + var19 - var8, var21, var21, this.paint);

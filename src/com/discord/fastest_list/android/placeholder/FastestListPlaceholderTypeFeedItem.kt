...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public open fun draw(canvas: Canvas) {
         ...
         var1.drawRoundRect(
            var13,
            ((float)var14 - (var6 + var20)) / 2.0F + var19,
            this.labelWidthRatio * var8,
            ((float)var14 - (var6 + var20)) / 2.0F + var6 - var19,
            var5,
            var5,
            this.paint
         );
         var1.drawRoundRect(var13, var22 + var11, var8 * this.labelWidthRatioSecondary, var22 + var20 - var11, var21, var21, this.paint);

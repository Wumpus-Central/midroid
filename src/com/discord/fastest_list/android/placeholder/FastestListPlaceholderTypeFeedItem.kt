...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var14 - (var12 + var5)) / 2.0F + var12;
         var1.drawRoundRect(
            var13,
            ((float)var14 - (var12 + var5)) / 2.0F + var20,
            this.labelWidthRatio * var6,
            ((float)var14 - (var12 + var5)) / 2.0F + var12 - var20,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var13, var23 + var9, var6 * this.labelWidthRatioSecondary, var23 + var5 - var9, var21, var21, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var10 - (float)SizeUtilsKt.getDpToPx(1), var8 - this.config.getDividerPaddingRight(), var10, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

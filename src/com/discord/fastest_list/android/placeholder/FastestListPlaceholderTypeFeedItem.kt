...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var6 = var16;
         val var23: Float = (var16 - (var12 + var5)) / 2.0F + var12;
         var1.drawRoundRect(
            var13,
            ((float)var16 - (var12 + var5)) / 2.0F + var21,
            this.labelWidthRatio * var8,
            ((float)var16 - (var12 + var5)) / 2.0F + var12 - var21,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var13, var23 + var11, var8 * this.labelWidthRatioSecondary, var23 + var5 - var11, var19, var19, this.paint);

   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         if (var14 != 1) {
            ...
            val var4: Float = (var16 - this.config.getShapeSize()) / 2.0F;
         ...
         val var20: Float = this.config.getLabelPaddingInnerRatio() * var11 / var6;
         ...
         var6 = var15 - this.config.getPadding() - this.config.getLabelPadding();
         val var10: Float = var16;
         val var23: Float = (var16 - (var11 + var21)) / 2.0F + var11;
         var1.drawRoundRect(
            var8,
            ((float)var16 - (var11 + var21)) / 2.0F + var20,
            this.labelWidthRatio * var6,
            ((float)var16 - (var11 + var21)) / 2.0F + var11 - var20,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var8, var23 + var7, var6 * this.labelWidthRatioSecondary, var23 + var21 - var7, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var10 - (float)SizeUtilsKt.getDpToPx(1), var9 - this.config.getDividerPaddingRight(), var10, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

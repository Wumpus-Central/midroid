...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var1.drawRoundRect(
            var7,
            ((float)var15 - (var9 + var20)) / 2.0F + var5,
            this.labelWidthRatio * var10,
            ((float)var15 - (var9 + var20)) / 2.0F + var9 - var5,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var7, var23 + var13, var10 * this.labelWidthRatioSecondary, var23 + var20 - var13, var19, var19, this.paint);

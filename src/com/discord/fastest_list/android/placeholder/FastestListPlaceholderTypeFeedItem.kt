...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var15 - (var10 + var21)) / 2.0F + var10;
         var1.drawRoundRect(
            var12,
            ((float)var15 - (var10 + var21)) / 2.0F + var19,
            this.labelWidthRatio * var8,
            ((float)var15 - (var10 + var21)) / 2.0F + var10 - var19,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var12, var23 + var6, var8 * this.labelWidthRatioSecondary, var23 + var21 - var6, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var7 - (float)SizeUtilsKt.getDpToPx(1), var13 - this.config.getDividerPaddingRight(), var7, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

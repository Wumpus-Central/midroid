...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var13: Float = this.config.getLabelPaddingInnerRatio() * var21 / var6;
         ...
         val var23: Float = (var14 - (var10 + var21)) / 2.0F + var10;
         var1.drawRoundRect(
            var6,
            ((float)var14 - (var10 + var21)) / 2.0F + var20,
            this.labelWidthRatio * var7,
            ((float)var14 - (var10 + var21)) / 2.0F + var10 - var20,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var6, var23 + var13, var7 * this.labelWidthRatioSecondary, var23 + var21 - var13, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var9 - (float)SizeUtilsKt.getDpToPx(1), var12 - this.config.getDividerPaddingRight(), var9, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public open fun draw(canvas: Canvas) {
         ...
         val var20: Float = this.config.getLabelPaddingInnerRatio() * var13 / var6;
         val var11: Float = this.config.getLabelPaddingInnerRatio() * var19 / var6;
         ...
         val var23: Float = (var16 - (var13 + var19)) / 2.0F + var13;
         var1.drawRoundRect(
            var6,
            ((float)var16 - (var13 + var19)) / 2.0F + var20,
            this.labelWidthRatio * var12,
            ((float)var16 - (var13 + var19)) / 2.0F + var13 - var20,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var6, var23 + var11, var12 * this.labelWidthRatioSecondary, var23 + var19 - var11, var5, var5, this.paint);

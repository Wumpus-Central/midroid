...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var var6: Float = 2;
         val var21: Float = var10 / 2;
         val var5: Float = var20 / 2;
         val var19: Float = this.config.getLabelPaddingInnerRatio() * var10 / var6;
         val var7: Float = this.config.getLabelPaddingInnerRatio() * var20 / var6;
         ...
         val var23: Float = (var15 - (var10 + var20)) / 2.0F + var10;
         var1.drawRoundRect(
            var9,
            ((float)var15 - (var10 + var20)) / 2.0F + var19,
            this.labelWidthRatio * var12,
            ((float)var15 - (var10 + var20)) / 2.0F + var10 - var19,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var7, var12 * this.labelWidthRatioSecondary, var23 + var20 - var7, var5, var5, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var11 - (float)SizeUtilsKt.getDpToPx(1), var6 - this.config.getDividerPaddingRight(), var11, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

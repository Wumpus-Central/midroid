...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var19: Float = this.config.getLabelPaddingInnerRatio() * var8 / var6;
         ...
         var6 = var14;
         val var23: Float = (var14 - (var8 + var21)) / 2.0F + var8;
         var1.drawRoundRect(
            var13,
            ((float)var14 - (var8 + var21)) / 2.0F + var19,
            this.labelWidthRatio * var10,
            ((float)var14 - (var8 + var21)) / 2.0F + var8 - var19,
            var20,
            var20,
            this.paint
         );
         var1.drawRoundRect(var13, var23 + var9, var10 * this.labelWidthRatioSecondary, var23 + var21 - var9, var5, var5, this.paint);

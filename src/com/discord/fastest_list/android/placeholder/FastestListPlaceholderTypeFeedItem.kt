...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var11: Float = this.config.getLabelPaddingInnerRatio() * var5 / var6;
         val var9: Float = this.config.getPadding() + this.config.getShapeSize() + this.config.getLabelPadding();
         val var13: Float = var14;
         val var7: Float = var14 - this.config.getPadding() - this.config.getLabelPadding();
         val var8: Float = var15;
         val var23: Float = (var15 - (var12 + var5)) / 2.0F + var12;
         var1.drawRoundRect(
            var9,
            ((float)var15 - (var12 + var5)) / 2.0F + var21,
            this.labelWidthRatio * var7,
            ((float)var15 - (var12 + var5)) / 2.0F + var12 - var21,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var11, var7 * this.labelWidthRatioSecondary, var23 + var5 - var11, var20, var20, this.paint);

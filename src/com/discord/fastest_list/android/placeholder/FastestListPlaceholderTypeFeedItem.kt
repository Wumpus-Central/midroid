...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var7: Float = 2;
         val var19: Float = var6 / 2;
         val var5: Float = var21 / 2;
         val var20: Float = this.config.getLabelPaddingInnerRatio() * var6 / var7;
         val var8: Float = this.config.getLabelPaddingInnerRatio() * var21 / var7;
         ...
         var1.drawRoundRect(var9, var22 + var8, var13 * this.labelWidthRatioSecondary, var22 + var21 - var8, var5, var5, this.paint);

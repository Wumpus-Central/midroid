...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var16 - (var12 + var19)) / 2.0F + var12;
         var1.drawRoundRect(
            var11,
            ((float)var16 - (var12 + var19)) / 2.0F + var5,
            this.labelWidthRatio * var13,
            ((float)var16 - (var12 + var19)) / 2.0F + var12 - var5,
            var21,
            var21,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var6, var13 * this.labelWidthRatioSecondary, var23 + var19 - var6, var20, var20, this.paint);

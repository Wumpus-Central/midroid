...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var9: Float = this.config.getLabelPaddingInnerRatio() * var5 / var6;
         ...
         val var23: Float = (var15 - (var10 + var5)) / 2.0F + var10;
         var1.drawRoundRect(
            var11,
            ((float)var15 - (var10 + var5)) / 2.0F + var20,
            this.labelWidthRatio * var12,
            ((float)var15 - (var10 + var5)) / 2.0F + var10 - var20,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var11, var23 + var9, var12 * this.labelWidthRatioSecondary, var23 + var5 - var9, var21, var21, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var7 - (float)SizeUtilsKt.getDpToPx(1), var6 - this.config.getDividerPaddingRight(), var7, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         val var23: Float = (var14 - (var11 + var20)) / 2.0F + var11;
         var1.drawRoundRect(
            var9,
            ((float)var14 - (var11 + var20)) / 2.0F + var5,
            this.labelWidthRatio * var6,
            ((float)var14 - (var11 + var20)) / 2.0F + var11 - var5,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var10, var6 * this.labelWidthRatioSecondary, var23 + var20 - var10, var21, var21, this.paint);
         if (this.config.getDivider()) {
            this.paint.setColor(this.config.getDividerColor());
            var1.drawRect(
               this.config.getDividerPaddingLeft(), var8 - (float)SizeUtilsKt.getDpToPx(1), var7 - this.config.getDividerPaddingRight(), var8, this.paint
            );
            this.paint.setColor(this.config.getColor());
         }
      }

...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder() {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public open fun draw(canvas: Canvas) {
         ...
         var1.drawRoundRect(
            var9,
            ((float)var15 - (var11 + var20)) / 2.0F + var21,
            this.labelWidthRatio * var10,
            ((float)var15 - (var11 + var20)) / 2.0F + var11 - var21,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var8, var10 * this.labelWidthRatioSecondary, var23 + var20 - var8, var5, var5, this.paint);

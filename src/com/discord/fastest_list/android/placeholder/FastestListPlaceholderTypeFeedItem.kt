...
internal class FastestListPlaceholderTypeFeedItem(config: FeedItem) : FastestListPlaceholder {
   ...
   private class FeedItemDrawable(config: FeedItem, labelWidthRatio: Float, labelWidthRatioSecondary: Float) : CustomDrawDrawable {
      ...
      public override fun draw(canvas: Canvas) {
         ...
         var var6: Float = 2;
         val var19: Float = var8 / 2;
         val var21: Float = var5 / 2;
         val var20: Float = this.config.getLabelPaddingInnerRatio() * var8 / var6;
         val var10: Float = this.config.getLabelPaddingInnerRatio() * var5 / var6;
         ...
         val var23: Float = (var16 - (var8 + var5)) / 2.0F + var8;
         var1.drawRoundRect(
            var9,
            ((float)var16 - (var8 + var5)) / 2.0F + var20,
            this.labelWidthRatio * var6,
            ((float)var16 - (var8 + var5)) / 2.0F + var8 - var20,
            var19,
            var19,
            this.paint
         );
         var1.drawRoundRect(var9, var23 + var10, var6 * this.labelWidthRatioSecondary, var23 + var5 - var10, var21, var21, this.paint);

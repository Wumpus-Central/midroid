...
internal data class FastestListPlaceholderConfig(listFooter: FastestListPlaceholderType,
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         var1 = var1;
         if (!(this.listFooter == var1.listFooter)) {
            return false;
         } else if (!(this.listHeader == var1.listHeader)) {
            return false;
         } else if (!(this.sectionFooter == var1.sectionFooter)) {
            return false;
         } else if (!(this.sectionHeader == var1.sectionHeader)) {
            return false;
         } else if (!(this.sectionItem == var1.sectionItem)) {
            return false;
         } else if (!(this.sectionItemAtFront == var1.sectionItemAtFront)) {
            return false;
         } else if (!(this.sectionItemAtRear == var1.sectionItemAtRear)) {
            return false;
         } else {
            return this.sectionItemSingleton == var1.sectionItemSingleton;
         }
      }
   }
   ...
   public fun getForEntry(entry: Entry): FastestListPlaceholderType {
      if (var1 is FastestListSections.Entry.SectionItem) {
         ...
         if ((var1 as FastestListSections.Entry.SectionItem).getAtFront() && (var1 as FastestListSections.Entry.SectionItem).getAtRear()) {
            var var6: FastestListPlaceholderType = this.sectionItemSingleton;
            if (this.sectionItemSingleton is FastestListPlaceholderType.None) {
               var6 = this.sectionItem;
            }

            return var6;
         } else if (var3.getAtFront()) {
            var var5: FastestListPlaceholderType = this.sectionItemAtFront;
            if (this.sectionItemAtFront is FastestListPlaceholderType.None) {
               var5 = this.sectionItem;
            }

            return var5;
         } else if (var3.getAtRear()) {
            var var4: FastestListPlaceholderType = this.sectionItemAtRear;
   ...
   public override fun toString(): String {
      ...
      val var4: FastestListPlaceholderType = this.sectionItemAtFront;
      ...
      var2.append("FastestListPlaceholderConfig(listFooter=");
      var2.append(var5);
      var2.append(", listHeader=");
      var2.append(var1);
      var2.append(", sectionFooter=");
      var2.append(var6);
      var2.append(", sectionHeader=");
      var2.append(var8);
      var2.append(", sectionItem=");
      var2.append(var7);
      var2.append(", sectionItemAtFront=");
      var2.append(var4);
      var2.append(", sectionItemAtRear=");
      var2.append(var3);
      var2.append(", sectionItemSingleton=");
      var2.append(var9);
      var2.append(")");

...
internal class FastestListScrollOffset(layoutManager: FastestListLayoutManager, sections: FastestListSections) {
   ...
   private fun getContentHeight(): Int {
      return if (!this.layoutManager.getHorizontal()) this.sections.getItemCumulativeSize() else this.layoutManager.getHeight();
   }

   private fun getContentWidth(): Int {
      return if (this.layoutManager.getHorizontal()) this.sections.getItemCumulativeSize() else this.layoutManager.getWidth();
   }

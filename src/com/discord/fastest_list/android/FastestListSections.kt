   ...
   public sealed class Entry protected constructor() {
      ...
      public data class ListFooter(key: String, section: com.discord.fastest_list.android.FastestListSections.Section, size: Int) : FastestListSections.Entry.ListFooter(
         ...
         public override fun toString(): String {
            ...
            val var3: java.lang.String = FastestListSections.Section.toString-impl(this.getSection-sZRFyWU());
      ...
      public data class SectionFooter(key: String, section: com.discord.fastest_list.android.FastestListSections.Section, size: Int) : FastestListSections.Entry.SectionFooter(
         ...
         public override fun toString(): String {
            val var4: java.lang.String = this.getKey();
      ...
      public data class SectionItem(key: String,
         ...
         public override fun hashCode(): Int {
            val var5: Int = this.getKey().hashCode();
            val var4: Int = FastestListSections.Section.hashCode-impl(this.getSection-sZRFyWU());
            val var6: Int = FastestListSections.Item.hashCode-impl(this.item);
            val var7: Int = Integer.hashCode(this.getSize());
            var var2: Byte = 1;
            ...
            return ((((var5 * 31 + var4) * 31 + var6) * 31 + var7) * 31 + var1) * 31 + var2;
         }

         public override fun toString(): String {
            val var6: java.lang.String = this.getKey();

...
internal data class VerificationCodeReceivedEvent(code: String) : ReactEvent {
   ...
   @JvmStatic
   public fun `write$Self`(self: VerificationCodeReceivedEvent, output: CompositeEncoder, serialDesc: SerialDescriptor) {
      r.h(var0, "self");
      r.h(var1, "output");
      r.h(var2, "serialDesc");
      var1.z(var2, 0, var0.code);
   }
   ...
   public object `$serializer` : f0<VerificationCodeReceivedEvent> {
      ...
      public open fun serialize(encoder: Encoder, value: VerificationCodeReceivedEvent) {
         ...
         VerificationCodeReceivedEvent.write$Self(var2, var4, var3);
         var4.c(var3);
      }

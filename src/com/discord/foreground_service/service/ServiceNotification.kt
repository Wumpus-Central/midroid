...
internal object ServiceNotification {
   ...
   public fun Service.startForegroundCompat(context: Context, serviceNotificationConfigurations: List<ServiceNotificationConfiguration>) {
      var3 = CollectionsKt.W0(var3, new Comparator() {
         @Override
      ...
      var var5: Notification = this.buildNotification(var2, CollectionsKt.o0(var3) as ServiceNotificationConfiguration);
      ForegroundServiceUtilsKt.startForegroundCompat(var1, var2, 8761, var5);
      var3 = CollectionsKt.f0(var3, 1);

      for (int var4 = 0; var4 < 6; var4++) {
         val var8: ServiceNotificationConfiguration = CollectionsKt.q0(var3, var4) as ServiceNotificationConfiguration;
         if (var8 != null) {

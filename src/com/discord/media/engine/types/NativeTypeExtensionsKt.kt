...
internal fun Array<AudioInputDeviceDescription>.toListOfMaps(): List<Map<String, Any>> {
   ...
   for (int var1 = 0; var2 < var3; var1++) {
      var4.add(p8.q.l(new Pair[]{w.a("name", var0[var2].getName()), w.a("guid", var0[var2].getGuid()), w.a("index", var1)}));
      var2++;
   }
...
internal fun Array<AudioOutputDeviceDescription>.toListOfMaps(): List<Map<String, Any>> {
   ...
   for (int var1 = 0; var2 < var3; var1++) {
      var5.add(p8.q.l(new Pair[]{w.a("name", var0[var2].getName()), w.a("guid", var0[var2].getGuid()), w.a("index", var1)}));
      var2++;
   }
...
internal fun Array<VideoInputDeviceDescription>.toListOfMaps(): List<Map<String, Any>> {
   ...
   for (int var12 = 0; var17.hasNext(); var12++) {
      ...
      var16.add(p8.q.l(new Pair[]{w.a("name", var18.getName()), w.a("guid", var18.getGuid()), w.a("facing", var9), w.a("index", var12)}));
   }
...
internal fun AudioInputDeviceDescription.toMap(): Map<String, Any> {
   q.h(var0, "<this>");
   return p8.q.l(new Pair[]{w.a("name", var0.getName()), w.a("guid", var0.getGuid())});
}

internal fun ConnectionInfo.toMap(): Map<String, Any> {
   q.h(var0, "<this>");
   return p8.q.l(new Pair[]{w.a("protocol", var0.getProtocol()), w.a("address", var0.getLocalAddress()), w.a("port", var0.getLocalPort())});
}

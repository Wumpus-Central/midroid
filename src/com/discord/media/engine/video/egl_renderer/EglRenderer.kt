...
internal open class EglRenderer(name: String) : VideoSink {
   ...
   init {
      ...
      this.logStatisticsRunnable = new com.discord.media.engine.video.egl_renderer.c(this);
   ...
   private fun logE(string: String, e: Throwable) {
      ...
      var3.append("name: ");
      var3.append(var1);
      Logging.e(var4, var3.toString(), var2);
   }
   ...
   private fun renderFrameOnRenderThread() {
      ...
      // 08f: lload 7
      // 091: lload 5
      // 093: invokestatic kotlin/ranges/e.f (JJ)J
      ...
      // 1e0: return
      // 1e1: aload 11
      // 1e3: invokevirtual org/webrtc/VideoFrame.release ()V
      // 1e6: aload 12
      // 1e8: athrow
      // 1e9: aload 11
      // 1eb: invokevirtual org/webrtc/VideoFrame.release ()V
      // 1ee: return
      // 1ef: astore 11
      // 1f1: aload 13
      // 1f3: monitorexit
      ...
      // 1fc: athrow
      // 1fd: aload 0
      // 1fe: ldc_w "Dropping frame - No surface"
      // 201: invokespecial com/discord/media/engine/video/egl_renderer/EglRenderer.logD (Ljava/lang/String;)V
      // 204: aload 11
      // 206: invokevirtual org/webrtc/VideoFrame.release ()V
      // 209: return
      // 20a: astore 11
      // 20c: goto 213
      // 20f: aload 12
   ...
   public fun init() {
      ...
      synchronized (this.handlerLock) {
         ...
         val var8: HandlerWithExceptionCallback = new HandlerWithExceptionCallback(var11, new com.discord.media.engine.video.egl_renderer.f(this));
         this.renderThreadHandler = var8;
         val var12: Debug = Debug.INSTANCE;
         ThreadUtils.invokeAtFrontUninterruptibly(var8, new com.discord.media.engine.video.egl_renderer.g(this, var1));
   ...
   public override fun onFrame(frame: VideoFrame, mirror: Boolean) {
      ...
      // 93: aload 0
      // 94: aload 0
      // 95: getfield com/discord/media/engine/video/egl_renderer/EglRenderer.framesDropped I
      // 98: bipush 1
      // 99: iadd
      // 9a: putfield com/discord/media/engine/video/egl_renderer/EglRenderer.framesDropped I
      // 9d: aload 1
      // 9e: monitorexit
      // 9f: return
      // a0: astore 4

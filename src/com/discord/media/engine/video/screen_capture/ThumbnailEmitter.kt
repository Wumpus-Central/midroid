...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var2 / var3 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, P9.a.c(((float)this.width - var2 * ((float)this.height / var3)) / 2.0F), 0, P9.a.c(var10), this.height
            );
      } else {
         val var13: Float = var3 * (this.width / var2);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, P9.a.c(((float)this.height - var3 * ((float)this.width / var2)) / 2.0F), this.width, P9.a.c(var13)
            );
      }

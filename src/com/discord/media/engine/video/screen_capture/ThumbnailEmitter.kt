...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var4 / var5 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, N9.a.c(((float)this.width - var4 * ((float)this.height / var5)) / 2.0F), 0, N9.a.c(var10), this.height
            );
      } else {
         val var13: Float = var5 * (this.width / var4);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, N9.a.c(((float)this.height - var5 * ((float)this.width / var4)) / 2.0F), this.width, N9.a.c(var13)
            );
      }

...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var2 / var4 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, Wa.a.c(((float)this.width - var2 * ((float)this.height / var4)) / 2.0F), 0, Wa.a.c(var10), this.height
            );
      } else {
         val var11: Float = var4 * (this.width / var2);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, Wa.a.c(((float)this.height - var4 * ((float)this.width / var2)) / 2.0F), this.width, Wa.a.c(var11)
            );
      }

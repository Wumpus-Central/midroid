...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var5 / var3 < (float)this.width / this.height) {
         val var10: Float = var5 * (this.height / var3);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, zh.a.b(((float)this.width - var5 * ((float)this.height / var3)) / 2.0F), 0, zh.a.b(var10), this.height
            );
      } else {
         val var13: Float = var3 * (this.width / var5);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, zh.a.b(((float)this.height - var3 * ((float)this.width / var5)) / 2.0F), this.width, zh.a.b(var13)
            );
      }

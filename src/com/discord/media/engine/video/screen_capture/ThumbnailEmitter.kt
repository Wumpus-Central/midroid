...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var5 / var2 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, C8.a.c(((float)this.width - var5 * ((float)this.height / var2)) / 2.0F), 0, C8.a.c(var12), this.height
            );
      } else {
         val var11: Float = var2 * (this.width / var5);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, C8.a.c(((float)this.height - var2 * ((float)this.width / var5)) / 2.0F), this.width, C8.a.c(var11)
            );
      }

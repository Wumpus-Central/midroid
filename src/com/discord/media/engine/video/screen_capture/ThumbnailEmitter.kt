...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var4 / var2 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, sh.a.b(((float)this.width - var4 * ((float)this.height / var2)) / 2.0F), 0, sh.a.b(var12), this.height
            );
      } else {
         val var11: Float = var2 * (this.width / var4);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, sh.a.b(((float)this.height - var2 * ((float)this.width / var4)) / 2.0F), this.width, sh.a.b(var11)
            );
      }

...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var3 / var5 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, sh.a.b(((float)this.width - var3 * ((float)this.height / var5)) / 2.0F), 0, sh.a.b(var12), this.height
            );
      } else {
         val var11: Float = var5 * (this.width / var3);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, sh.a.b(((float)this.height - var5 * ((float)this.width / var3)) / 2.0F), this.width, sh.a.b(var11)
            );
      }

...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var2 / var4 < (float)this.width / this.height) {
         val var10: Float = var2 * (this.height / var4);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, zh.a.b(((float)this.width - var2 * ((float)this.height / var4)) / 2.0F), 0, zh.a.b(var10), this.height
            );
      } else {
         val var13: Float = var4 * (this.width / var2);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, zh.a.b(((float)this.height - var4 * ((float)this.width / var2)) / 2.0F), this.width, zh.a.b(var13)
            );
      }

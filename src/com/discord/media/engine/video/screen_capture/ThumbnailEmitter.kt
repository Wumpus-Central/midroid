...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var2 / var5 < (float)this.width / this.height) {
         val var12: Float = var2 * (this.height / var5);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, zh.a.b(((float)this.width - var2 * ((float)this.height / var5)) / 2.0F), 0, zh.a.b(var12), this.height
            );
      } else {
         val var11: Float = var5 * (this.width / var2);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, zh.a.b(((float)this.height - var5 * ((float)this.width / var2)) / 2.0F), this.width, zh.a.b(var11)
            );
      }

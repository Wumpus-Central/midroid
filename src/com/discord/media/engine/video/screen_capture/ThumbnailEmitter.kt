...
internal class ThumbnailEmitter(width: Int, height: Int, periodMs: Long, onNextThumbnail: (Bitmap) -> Unit) {
   ...
   private fun createThumbnail(frame: VideoFrame): Bitmap {
      ...
      if (var3 / var2 < (float)this.width / this.height) {
         ...
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, ci.a.b(((float)this.width - var3 * ((float)this.height / var2)) / 2.0F), 0, ci.a.b(var12), this.height
            );
      } else {
         val var11: Float = var2 * (this.width / var3);
         this.frameDrawer
            .drawFrame(
               var1, this.rectDrawer, renderMatrix, 0, ci.a.b(((float)this.height - var2 * ((float)this.width / var3)) / 2.0F), this.width, ci.a.b(var11)
            );
      }

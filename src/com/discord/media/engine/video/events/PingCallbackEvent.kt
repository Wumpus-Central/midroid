...
internal data class PingCallbackEvent(connectionId: Int, ping: Int, server: String, port: Int, seq: Int) : ReactEvent {
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{N.a, N.a, C0.a, N.a, N.a};
      }
      ...
      public open fun deserialize(decoder: Decoder): PingCallbackEvent {
         ...
         if (var10.y()) {
            ...
            var18 = var10.k(var9, 1);
            var11 = var10.t(var9, 2);
            var2 = var10.k(var9, 3);
            val var3: Int = var10.k(var9, 4);
            var5 = 31;
            var6 = var15;
            var15 = var18;
            var18 = var3;
         ...
         var10.b(var9);
         return new PingCallbackEvent(var5, var6, var15, var11, var2, var18, null);
      }

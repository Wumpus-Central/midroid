...
internal data class OnSizeEvent(width: Int, height: Int) : ReactEvent {
   ...
   public fun copy(width: Int = var0.width, height: Int = var0.height): OnSizeEvent {
      return new OnSizeEvent(var1, var2);
   }

   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         return true;
      } else if (var1 !is OnSizeEvent) {
         return false;
      } else {
         var1 = var1;
   ...
   public companion object {
      public fun serializer(): KSerializer<OnSizeEvent> {

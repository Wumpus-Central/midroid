...
internal data class PingTimeoutCallbackEvent(connectionId: Int, server: String, port: Int, seq: Int, timeout: Int) : ReactEvent {
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         return new KSerializer[]{N.a, C0.a, N.a, N.a, N.a};
      }
      ...
      public open fun deserialize(decoder: Decoder): PingTimeoutCallbackEvent {
                     ...
                     if (var8 != 1) {
                        if (var8 != 2) {
                           if (var8 != 3) {
                              ...
                              var14 = var10.k(var9, 4);
                              var12 |= 16;
                           } else {
                              var16 = var10.k(var9, 3);
                              var12 |= 8;
                           }
                        } else {
                           var3 = var10.k(var9, 2);
         ...
         var10.b(var9);
         return new PingTimeoutCallbackEvent(var7, var6, var11, var14, var16, var3, null);
      }

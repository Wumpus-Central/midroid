...
public object ImageQualityCalculator {
   ...
   private fun calculateSSIMFromGrayscale(original: FloatArray, compressed: FloatArray, width: Int, height: Int): Double {
      val var16: Int = Qa.c.c(0, var4 - 8, 4);
      var var7: Double;
      if (var16 >= 0) {
         var var11: Int = 0;
         var4 = 0;
         ...
         while (true) {
            val var13: Int = Qa.c.c(0, var3 - 8, 4);
            var var12: Int;
            var var15: Int;
            if (var13 >= 0) {
               var var14: Int = 0;
   ...
   private fun unpremultiplyPixels(pixels: IntArray): IntArray {
      ...
      for (int var2 = 0; var2 < var3; var2++) {
         ...
         if ((var1[var2] shr 24 and 255) != 0) {
            if (var4 != 255) {
               var8[var2] = kotlin.ranges.e.m((var5 and 255) * 255 / var4, 0, 255) or var4 shl 24 or kotlin.ranges.e.m(
                  (var5 shr 16 and 255) * 255 / var4, 0, 255
               ) shl 16 or kotlin.ranges.e.m((var5 shr 8 and 255) * 255 / var4, 0, 255) shl 8;
            } else {
               var8[var2] = var5;
            }
         } else {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  try {
                     var13 = new int[var8];
                     var15 = new int[var8];
                     this.$originalBitmap.getPixels(var13, 0, var7, 0, 0, var7, var6);
                     this.$compressedBitmap.getPixels(var15, 0, var7, 0, 0, var7, var6);
                  ...
                  try {
                     ...
                     var1 = new ImageQualityCalculator.ImageQualityMetrics(
                        ImageQualityCalculator.access$calculatePSNR(ImageQualityCalculator.INSTANCE, var1, var13, var7, var6),
                        ImageQualityCalculator.access$calculateSSIM(var27, var1, var13, var7, var6),
   ...
   public suspend fun calculateQualityMetrics(originalData: ByteArray, compressedData: ByteArray): com.discord.media.utils.ImageQualityCalculator.ImageQualityMetrics? {
      return mc.f.g(K.a(), new Function2<CoroutineScope, Continuation, Object>(var1, var2, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               if (var3 != null && var5 != null) {
                  try {
                     this.label = 1;
                     var3 = (Bitmap)var1.calculateQualityMetrics(var3, var5, this);
                  } catch (var6: Exception) {
                     return null;
                  }

...
public object ImageQualityCalculator {
   ...
   private fun calculateSSIMFromGrayscale(original: FloatArray, compressed: FloatArray, width: Int, height: Int): Double {
      val var15: Int = mm.c.c(0, var4 - 8, 4);
      var var7: Double;
      var var11: Int;
      if (var15 >= 0) {
         var4 = 0;
         ...
         while (true) {
            val var14: Int = mm.c.c(0, var3 - 8, 4);
            var7 = var5;
            var11 = var4;
            if (var14 >= 0) {
               var var13: Int = 0;
   ...
   private fun calculateWindowSSIM(original: FloatArray, compressed: FloatArray, width: Int, startX: Int, startY: Int, windowSize: Int, c1: Float, c2: Float): Double {
      ...
      return if ((var11 / (var6 * var6) * (var11 / (var6 * var6)) + var17 / (var6 * var6) * (var17 / (var6 * var6)) + var7)
               * ((var15 - var11 * (var11 / (var6 * var6))) / (var6 * var6) + (var13 - var17 * (var17 / (var6 * var6))) / (var6 * var6) + var8)
            > 0.0)
         (var11 / (var6 * var6) * 2.0 * (var17 / (var6 * var6)) + var7)
            * ((var9 - var11 * (var17 / (var6 * var6))) / (var6 * var6) * 2.0 + var8)
            / (
               (var11 / (var6 * var6) * (var11 / (var6 * var6)) + var17 / (var6 * var6) * (var17 / (var6 * var6)) + var7)
                  * ((var15 - var11 * (var11 / (var6 * var6))) / (var6 * var6) + (var13 - var17 * (var17 / (var6 * var6))) / (var6 * var6) + var8)
            )
         else
         0.0;
   ...
   private fun unpremultiplyPixels(pixels: IntArray): IntArray {
      ...
      for (int var2 = 0; var2 < var3; var2++) {
         ...
         if ((var1[var2] shr 24 and 255) != 0) {
            if (var4 != 255) {
               var8[var2] = kotlin.ranges.e.m((var6 and 255) * 255 / var4, 0, 255) or var4 shl 24 or kotlin.ranges.e.m(
                  (var6 shr 16 and 255) * 255 / var4, 0, 255
               ) shl 16 or kotlin.ranges.e.m((var6 shr 8 and 255) * 255 / var4, 0, 255) shl 8;
            } else {
               var8[var2] = var6;
            }
         } else {
   ...
   public suspend fun calculateQualityMetrics(originalData: ByteArray, compressedData: ByteArray): com.discord.media.utils.ImageQualityCalculator.ImageQualityMetrics? {
      return jp.f.g(k0.a(), new Function2<CoroutineScope, Continuation, Object>(var1, var2, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               try {
                  ...
                  var5 = ImageQualityCalculator.access$decodeByteArraySafely(var4, this.$compressedData);
               } catch (var7: Exception) {
                  return null;
               }
               ...
               if (var1 != null && var5 != null) {
                  try {
                     this.label = 1;
                     var1 = var4.calculateQualityMetrics(var1, var5, this);
                  } catch (var6: Exception) {
                     return null;
                  }

...
public object ImageQualityCalculator {
   ...
   private fun calculateWindowSSIM(original: FloatArray, compressed: FloatArray, width: Int, startX: Int, startY: Int, windowSize: Int, c1: Float, c2: Float): Double {
      ...
      var17 = var7;
      var9 = var8;
      var11 = (var37 * var37 + var36 * var36 + var17) * (var15 + var11 + var8);
      if ((var37 * var37 + var36 * var36 + var17) * (var15 + var11 + var8) > 0.0) {
         var9 = (var37 * 2.0 * var36 + var17) * (var13 * 2.0 + var9) / var11;
      } else {
         var9 = 0.0;
      }

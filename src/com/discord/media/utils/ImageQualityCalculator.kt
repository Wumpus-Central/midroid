...
public object ImageQualityCalculator {
   ...
   private fun calculateWindowSSIM(original: FloatArray, compressed: FloatArray, width: Int, startX: Int, startY: Int, windowSize: Int, c1: Float, c2: Float): Double {
      ...
      var17 = var7;
      var11 = var8;
      var13 = (var36 * var36 + var37 * var37 + var17) * (var15 + var13 + var8);
      if ((var36 * var36 + var37 * var37 + var17) * (var15 + var13 + var8) > 0.0) {
         var9 = (var36 * 2.0 * var37 + var17) * (var9 * 2.0 + var11) / var13;
      } else {
         var9 = 0.0;
      }

...
public class QualityAndResolutionConstraint(quality: Int, shouldResize: Boolean) : ka.a {
   ...
   public open fun satisfy(imageFile: File): File {
      if (this.shouldResize) {
         var1 = ja.c.k(var1, ja.c.f(var1, ja.c.e(var1, 612, 816)), null, this.quality, 4, null);
      } else {
         var1 = ja.c.k(var1, ja.c.i(var1), null, this.quality, 4, null);
      }

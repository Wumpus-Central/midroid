...
public class QualityAndResolutionConstraint(quality: Int, shouldResize: Boolean) : y8.a {
   ...
   public open fun satisfy(imageFile: File): File {
      ...
      if (this.shouldResize) {
         var1 = x8.c.k(var1, x8.c.f(var1, x8.c.e(var1, 612, 816)), null, this.quality, 4, null);
      } else {
         var1 = x8.c.k(var1, x8.c.i(var1), null, this.quality, 4, null);
      }

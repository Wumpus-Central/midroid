...
public class QualityAndResolutionConstraint(quality: Int, shouldResize: Boolean) : b9.a {
   ...
   public open fun satisfy(imageFile: File): File {
      ...
      if (this.shouldResize) {
         var1 = a9.c.k(var1, a9.c.f(var1, a9.c.e(var1, 612, 816)), null, this.quality, 4, null);
      } else {
         var1 = a9.c.k(var1, a9.c.i(var1), null, this.quality, 4, null);
      }

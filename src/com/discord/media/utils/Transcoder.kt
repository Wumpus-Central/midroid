...
internal object Transcoder {
   ...
   public suspend fun convertCompress(
      ...
      val var8: kotlinx.coroutines.e = new kotlinx.coroutines.e(I9.b.c(var7), 1);
      var8.C();
      ...
      var13.h(var1, var3.getInputUri(), var4, var9, var3.getAudioFormat(), new h8.a(var6, var13, var1, var8, var4) {
         ...
         public void onCancelled(java.lang.String var1, java.util.List<i8.a> var2) {
            r.h(var1, "id");
            this.$transformer.e();
         ...
         public void onCompleted(java.lang.String var1, java.util.List<i8.a> var2) {
            r.h(var1, "id");
            this.$transformer.e();
         ...
         public void onError(java.lang.String var1, java.lang.Throwable var2, java.util.List<i8.a> var3) {
            r.h(var1, "id");
            this.$transformer.e();
            Transcoder.access$getCancelCallbacks$p().remove(this.$requestId);
            val var4: kotlin.Result.a = Result.k;

...
internal object Transcoder {
   ...
   public suspend fun convertCompress(
      ...
      val var8: kotlinx.coroutines.e = new kotlinx.coroutines.e(A9.b.c(var7), 1);
      var8.C();
      ...
      q.g(var14, "build(...)");
      var13.h(var1, var3.getInputUri(), var4, var9, var3.getAudioFormat(), new c8.a(var6, var13, var1, var8, var4) {

...
internal object Transcoder {
   ...
   public suspend fun convertCompress(
      ...
      val var8: kotlinx.coroutines.e = new kotlinx.coroutines.e(X8.b.c(var7), 1);
      var8.C();
      ...
      q.g(var14, "build(...)");
      var13.h(var1, var3.getInputUri(), var4, var9, var3.getAudioFormat(), new M7.a(var6, var13, var1, var8, var4) {
         ...
         public void onCancelled(java.lang.String var1, java.util.List<N7.a> var2) {
            q.h(var1, "id");
            this.$transformer.e();
         ...
         public void onCompleted(java.lang.String var1, java.util.List<N7.a> var2) {
            q.h(var1, "id");
            this.$transformer.e();
         ...
         public void onError(java.lang.String var1, java.lang.Throwable var2, java.util.List<N7.a> var3) {
            q.h(var1, "id");
            this.$transformer.e();
            Transcoder.access$getCancelCallbacks$p().remove(this.$requestId);
            val var4: kotlin.Result.a = Result.k;

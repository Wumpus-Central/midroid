...
internal class DiscordVideoMediaSource(context: Context, inputUri: Uri) : V7.a {
   ...
   init {
      ...
      super(var1, var2);
      this.inputUri = var2;
      val var6: IntRange = kotlin.ranges.d.r(0, this.getTrackCount());
      val var144: ArrayList = new ArrayList(i.v(var6, 10));
      val var169: java.util.Iterator = var6.iterator();

      while (var169.hasNext()) {
         var144.add(this.getTrackFormat((var169 as n).a()));
      }
      ...
      if (this.srcVideoFormat != null) {
         ...
         var var152: java.lang.String = (java.lang.String)var171;
         if (var171 == null) {
            var152 = "unknown";
         }
         ...
         this.bitRate = Y7.h.a(this, this.srcTrackFormats.indexOf(var182));
         ...
         label1394: {
            label205: {
               ...
               try {
                  ...
                  var142 = var162.extractMetadata(24);
         ...
         var var166: Any = var141;
         if (Result.g(var141)) {
            var166 = 0;
         }

         this.rotationDegrees = (var166 as java.lang.Number).intValue();
      } else {
         this.width = 640;
         this.height = 480;
         this.frameRate = 30;

...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
   ...
   private suspend fun handleImage(inputUri: Uri, compressionQuality: Int, isLowQuality: Boolean): Uri {
      label62: {
         if (var4 is <unrepresentable>) {
            ...
            if ((var4.label and Integer.MIN_VALUE) != 0) {
               var8.label = var4.label + Integer.MIN_VALUE;
               var4 = var8;
               break label62;
            }
         }

         var4 = new d(this, var4) {
            Object L$0;
            Object L$1;
            int label;
            Object result;
      ...
      label57: {
         ...
         if (var4.label != 0) {
            if (var4.label == 1) {
               var1 = var4.L$1 as Uri;
               var15 = var4.L$0 as MediaResolver;
               s.b(var19);
               break label57;
            }
            ...
            if (var17) {
               ...
               var4.L$1 = var1;
               var4.label = 1;
               var19 = rg.a.b((rg.a)var19, var11, var1, null, var23, var4, 4, null);
               if (var19 === var9) {
                  return var9;
               }
            ...
            var4.label = 2;
            val var12: Any = copyToFile$default(this, var1, null, var4, 2, null);
            var19 = var12;
            if (var12 === var9) {
               return var9;
            }
   ...
   private suspend fun handleVideo(inputUri: Uri, compressionQuality: VideoCompressionQuality, skipVideoTranscode: Boolean): Uri {
      ...
      // 25e: astore 8
      // 260: goto 24a
      // 263: getstatic kh/r.k Lkh/r$a;
      // 266: astore 7
      // 268: aload 6
      // 26a: invokestatic kh/s.a (Ljava/lang/Throwable;)Ljava/lang/Object;
      // 26d: invokestatic kh/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 270: astore 6
      // 272: aload 6
      // 274: invokestatic kh/r.e (Ljava/lang/Object;)Ljava/lang/Throwable;
      // 277: astore 7
      // 279: aload 7
      // 27b: ifnonnull 284
      // 27e: aload 6

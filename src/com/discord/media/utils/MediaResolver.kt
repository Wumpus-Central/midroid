...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
   ...
   private suspend fun checkFreeSpace() {
      ...
      return if (var2 === I9.b.e()) var2 else Unit.a;
   }
   ...
   private fun createMP4FastStartUri(inputUri: Uri, compressedUri: Uri, mediaSourceSize: Long): Uri? {
      ...
      // 50: aload 9
      // 52: invokestatic Ob/b.a (Ljava/io/FileDescriptor;Ljava/io/File;)Z
      // 55: istore 6
      // 57: iload 6
      // 59: ifeq 6f
      // 5c: iload 6
      ...
      label111: {
         label98: {
            ...
            if (((<unrepresentable>)var9).label != 0) {
               ...
               var18 = i9.a.b(var20, var29, var1, null, var13, (Continuation)var9, 4, null);
               if (var18 === var11) {
                  return var11;
               }
   ...
   private suspend fun handleVideo(inputUri: Uri, skipVideoTranscode: Boolean, encodingConfig: EncodingConfig?): Uri {
      ...
      // 044: astore 4
      // 046: invokestatic I9/b.e ()Ljava/lang/Object;
      // 049: astore 12
      // 04b: aload 8
      ...
      // 23b: aload 7
      // 23d: aload 10
      // 23f: invokevirtual p8/a.getSize ()J

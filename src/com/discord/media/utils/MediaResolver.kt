...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
      ...
      label111: {
         label98: {
            ...
            if (((<unrepresentable>)var9).label != 0) {
               ...
               var19 = O7.a.b(var30, var21, var1, null, var13, (Continuation)var9, 4, null);
               if (var19 === var11) {
                  return var11;
               }
   ...
   private suspend fun handleVideo(inputUri: Uri, skipVideoTranscode: Boolean, encodingConfig: EncodingConfig?): Uri {
      ...
      // 0d7: goto 28c
      // 0da: aload 4
      // 0dc: invokestatic h8/s.b (Ljava/lang/Object;)V
      ...
      // 10d: aload 7
      // 10f: invokestatic h8/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 112: astore 7
      // 114: goto 128
      // 117: astore 7
      // 119: getstatic h8/r.k Lh8/r$a;
      // 11c: astore 10
      // 11e: aload 7
      // 120: invokestatic h8/s.a (Ljava/lang/Throwable;)Ljava/lang/Object;
      // 123: invokestatic h8/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 126: astore 7
      // 128: aload 7
      // 12a: invokestatic h8/r.e (Ljava/lang/Object;)Ljava/lang/Throwable;
      // 12d: astore 10
      // 12f: aload 10
      // 131: ifnull 176
      // 134: aload 10
      ...
      // 178: astore 10
      // 17a: aload 7
      // 17c: invokestatic h8/r.g (Ljava/lang/Object;)Z
      // 17f: ifeq 185
      // 182: aconst_null
      // 183: astore 10
      // 185: aload 10
      ...
      // 28a: aload 1
      // 28b: athrow
      // 28c: getstatic h8/r.k Lh8/r$a;
      // 28f: astore 7
      // 291: aload 3
      // 292: invokestatic h8/s.a (Ljava/lang/Throwable;)Ljava/lang/Object;
      // 295: invokestatic h8/r.b (Ljava/lang/Object;)Ljava/lang/Object;
      // 298: astore 3
      // 299: aload 3
      // 29a: invokestatic h8/r.e (Ljava/lang/Object;)Ljava/lang/Throwable;
      // 29d: astore 7
      // 29f: aload 7
      // 2a1: ifnonnull 2a9
      // 2a4: aload 3
      ...
      // 2be: astore 7
      // 2c0: aload 7
      // 2c2: ldc_w "Error compressing/converting video: "
      ...
      // 2cf: pop
      // 2d0: aload 4
      // 2d2: ldc_w "Media conversion error"
      // 2d5: aload 7
      // 2d7: invokevirtual java/lang/StringBuilder.toString ()Ljava/lang/String;
      // 2da: aload 6
      // 2dc: aload 1
      // 2dd: invokespecial com/discord/media/utils/MediaResolver.logMediaError (Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/net/Uri;)V
      // 2e0: aload 8
      // 2e2: aconst_null
      // 2e3: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$0 Ljava/lang/Object;
      // 2e6: aload 8
      // 2e8: aconst_null
      // 2e9: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$1 Ljava/lang/Object;
      // 2ec: aload 8
      // 2ee: aconst_null
      // 2ef: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$2 Ljava/lang/Object;
      // 2f2: aload 8
      // 2f4: aconst_null
      // 2f5: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$3 Ljava/lang/Object;
      // 2f8: aload 8
      // 2fa: aconst_null
      // 2fb: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$4 Ljava/lang/Object;
      // 2fe: aload 8
      // 300: bipush 2
      // 301: putfield com/discord/media/utils/MediaResolver$handleVideo$1.label I
      // 304: aload 4
      // 306: aload 6
      // 308: aconst_null
      // 309: aload 8
      // 30b: bipush 2
      // 30c: aconst_null
      // 30d: invokestatic com/discord/media/utils/MediaResolver.copyToFile$default (Lcom/discord/media/utils/MediaResolver;Landroid/net/Uri;Ljava/io/File;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
      // 310: astore 1
      // 311: aload 1
      // 312: astore 4
      // 314: aload 1
      ...
      // 31c: areturn
      // 31d: aload 4
      // 31f: checkcast android/net/Uri
      // 322: astore 1
      // 323: aload 1
      // 324: checkcast android/net/Uri
      // 327: areturn
      // 328: aload 7
      // 32a: athrow
      // 32b: aload 8
      // 32d: bipush 3
      // 32e: putfield com/discord/media/utils/MediaResolver$handleVideo$1.label I
      // 331: aload 0
      // 332: aload 1
      // 333: aconst_null
      // 334: aload 8
      // 336: bipush 2
      // 337: aconst_null
      // 338: invokestatic com/discord/media/utils/MediaResolver.copyToFile$default (Lcom/discord/media/utils/MediaResolver;Landroid/net/Uri;Ljava/io/File;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
      // 33b: astore 1
      // 33c: aload 1
      // 33d: astore 4
      // 33f: aload 1

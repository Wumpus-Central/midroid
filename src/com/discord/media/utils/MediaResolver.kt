...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
   ...
   private suspend fun checkFreeSpace() {
      ...
      return if (var2 === l9.b.e()) var2 else Unit.a;
   }
   ...
   private fun createMP4FastStartUri(inputUri: Uri, compressedUri: Uri, mediaSourceSize: Long): Uri? {
      ...
      // 50: aload 10
      // 52: invokestatic rb/b.a (Ljava/io/FileDescriptor;Ljava/io/File;)Z
      // 55: istore 6
      // 57: iload 6
      // 59: ifeq 6f
      // 5c: iload 6
      ...
      label111: {
         label98: {
            ...
            if (((<unrepresentable>)var9).label != 0) {
               ...
               var19 = L8.a.b(var21, var30, var1, null, var13, (Continuation)var9, 4, null);
               if (var19 === var11) {
                  return var11;
               }
   ...
   fun `handleImage$lambda$7`(var0: Int, var1: Boolean, var2: MediaResolver, var3: Uri, var4: Compression): Unit {
      ...
      M8.g.a(var4, CompressFormat.JPEG);
      M8.e.a(var4, ContentResolverUtils.createTempFile$default(ContentResolverUtils.INSTANCE, var2.getResolver(), var3, null, "jpeg", 2, null));
      return Unit.a;
   }
   ...
   private suspend fun handleVideo(inputUri: Uri, skipVideoTranscode: Boolean, encodingConfig: EncodingConfig?): Uri {
      ...
      // 044: astore 4
      // 046: invokestatic l9/b.e ()Ljava/lang/Object;
      // 049: astore 12
      // 04b: aload 8
      ...
      // 23f: aload 7
      // 241: aload 10
      // 243: invokevirtual V7/a.getSize ()J
      ...
      // 28d: aload 1
      // 28e: athrow
      // 28f: getstatic kotlin/Result.k Lkotlin/Result$a;
      // 292: astore 7
      // 294: aload 3
      ...
      // 2dd: aload 6
      // 2df: aload 1
      // 2e0: invokespecial com/discord/media/utils/MediaResolver.logMediaError (Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/net/Uri;)V
      // 2e3: aload 8
      // 2e5: aconst_null
      // 2e6: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$0 Ljava/lang/Object;
      // 2e9: aload 8
      // 2eb: aconst_null
      // 2ec: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$1 Ljava/lang/Object;
      // 2ef: aload 8
      // 2f1: aconst_null
      // 2f2: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$2 Ljava/lang/Object;
      // 2f5: aload 8
      // 2f7: aconst_null
      // 2f8: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$3 Ljava/lang/Object;
      // 2fb: aload 8
      // 2fd: aconst_null
      // 2fe: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$4 Ljava/lang/Object;
      // 301: aload 8
      // 303: bipush 2
      ...
      // 325: astore 1
      // 326: aload 1
      // 327: checkcast android/net/Uri
      // 32a: areturn
      // 32b: aload 7
      // 32d: athrow
      // 32e: aload 8
      // 330: bipush 3
      // 331: putfield com/discord/media/utils/MediaResolver$handleVideo$1.label I
      // 334: aload 0
      // 335: aload 1
      // 336: aconst_null
      // 337: aload 8
      // 339: bipush 2
      // 33a: aconst_null
      // 33b: invokestatic com/discord/media/utils/MediaResolver.copyToFile$default (Lcom/discord/media/utils/MediaResolver;Landroid/net/Uri;Ljava/io/File;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
      // 33e: astore 1
      // 33f: aload 1
      // 340: astore 4
      // 342: aload 1
   ...
   private fun logMediaError(tag: String, message: String, inputUri: Uri, outputUri: Uri) {
      ...
      CrashReporting.addBreadcrumb$default(
         CrashReporting.INSTANCE, var2, f9.q.l(new Pair[]{s.a("inputUri", var3.toString()), s.a("outputUri", var4.toString())}), null, 4, null
      );

...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
   ...
   private suspend fun checkFreeSpace() {
      ...
      return if (var2 === Ia.b.e()) var2 else Unit.a;
   }
   ...
   private fun createMP4FastStartUri(inputUri: Uri, compressedUri: Uri, mediaSourceSize: Long): Uri? {
      ...
      // 50: aload 9
      // 52: invokestatic Kc/b.a (Ljava/io/FileDescriptor;Ljava/io/File;)Z
      // 55: istore 6
      // 57: iload 6
      // 59: ifeq 6f
      // 5c: iload 6
      ...
      label111: {
         label98: {
            ...
            if (((<unrepresentable>)var9).label != 0) {
               ...
               var18 = ka.a.b(var29, var13, var1, null, var20, (Continuation)var9, 4, null);
               if (var18 === var11) {
                  return var11;
               }
            ...
            var21 = var18 as File;
            var14.onProgress.invoke(var10, kotlin.coroutines.jvm.internal.b.e(100));
            if (!var4) {
               break label111;
            }
   ...
   fun `handleImage$lambda$7`(var0: Int, var1: Boolean, var2: MediaResolver, var3: Uri, var4: Compression): Unit {
      ...
      la.g.a(var4, CompressFormat.JPEG);
      la.e.a(var4, ContentResolverUtils.createTempFile$default(ContentResolverUtils.INSTANCE, var2.getResolver(), var3, null, "jpeg", 2, null));
      return Unit.a;
   }
   ...
   private suspend fun handleVideo(inputUri: Uri, skipVideoTranscode: Boolean, encodingConfig: EncodingConfig?): Uri {
      ...
      // 044: astore 4
      // 046: invokestatic Ia/b.e ()Ljava/lang/Object;
      // 049: astore 12
      // 04b: aload 8
      ...
      // 237: aload 7
      // 239: aload 9
      // 23b: invokevirtual q9/a.getSize ()J
      ...
      // 285: aload 1
      // 286: athrow
      // 287: getstatic kotlin/Result.e Lkotlin/Result$a;
      // 28a: astore 7
      // 28c: aload 3
      ...
      // 2d5: aload 6
      // 2d7: aload 1
      // 2d8: invokespecial com/discord/media/utils/MediaResolver.logMediaError (Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/net/Uri;)V
      // 2db: aload 8
      // 2dd: aconst_null
      // 2de: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$0 Ljava/lang/Object;
      // 2e1: aload 8
      // 2e3: aconst_null
      // 2e4: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$1 Ljava/lang/Object;
      // 2e7: aload 8
      // 2e9: aconst_null
      // 2ea: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$2 Ljava/lang/Object;
      // 2ed: aload 8
      // 2ef: aconst_null
      // 2f0: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$3 Ljava/lang/Object;
      // 2f3: aload 8
      // 2f5: aconst_null
      // 2f6: putfield com/discord/media/utils/MediaResolver$handleVideo$1.L$4 Ljava/lang/Object;
      // 2f9: aload 8
      // 2fb: bipush 2
      // 2fc: putfield com/discord/media/utils/MediaResolver$handleVideo$1.label I
      // 2ff: aload 4
      // 301: aload 6
      // 303: aconst_null
      // 304: aload 8
      // 306: bipush 2
      // 307: aconst_null
      // 308: invokestatic com/discord/media/utils/MediaResolver.copyToFile$default (Lcom/discord/media/utils/MediaResolver;Landroid/net/Uri;Ljava/io/File;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
      // 30b: astore 1
      // 30c: aload 1
      // 30d: astore 4
      // 30f: aload 1
      ...
      // 326: aload 8
      // 328: bipush 3
      // 329: putfield com/discord/media/utils/MediaResolver$handleVideo$1.label I
      // 32c: aload 0
      // 32d: aload 1
      // 32e: aconst_null
      // 32f: aload 8
      // 331: bipush 2
      // 332: aconst_null
      // 333: invokestatic com/discord/media/utils/MediaResolver.copyToFile$default (Lcom/discord/media/utils/MediaResolver;Landroid/net/Uri;Ljava/io/File;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
      // 336: astore 1
      // 337: aload 1
      // 338: astore 4
      // 33a: aload 1
   ...
   private fun logMediaError(tag: String, message: String, inputUri: Uri, outputUri: Uri) {
      ...
      CrashReporting.addBreadcrumb$default(
         CrashReporting.INSTANCE, var2, O.m(new Pair[]{v.a("inputUri", var3.toString()), v.a("outputUri", var4.toString())}), null, null, 12, null
      );

...
public class MediaResolver(context: Context, onProgress: (Uri, Int) -> Unit) {
      ...
      label111: {
         label98: {
            ...
            if (((<unrepresentable>)var9).label != 0) {
               ...
               var19 = g9.a.b(var13, var30, var1, null, var21, (Continuation)var9, 4, null);
               if (var19 === var11) {
                  return var11;
               }
   ...
   private suspend fun handleVideo(inputUri: Uri, skipVideoTranscode: Boolean, encodingConfig: EncodingConfig?): Uri {
      ...
      // 23b: aload 7
      // 23d: aload 10
      // 23f: invokevirtual n8/a.getSize ()J
      ...
      // 28a: aload 1
      // 28b: athrow
      // 28c: getstatic kotlin/Result.k Lkotlin/Result$a;
      // 28f: astore 7
      // 291: aload 3

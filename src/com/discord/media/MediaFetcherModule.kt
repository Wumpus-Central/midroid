...
public class MediaFetcherModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule {
   ...
   public fun getPhotos(params: ReadableMap, promise: Promise) {
      ...
      try {
         ...
         var16 = i.N0(i.L0(var6.getMedia(var12, var7, var4, var5), new Comparator() {
            @Override
            public final int compare(T var1, T var2) {
               return F9.a.d((var2 as ContentResolverMedia).getDateAdded(), (var1 as ContentResolverMedia).getDateAdded());
            }
         }), var4);
         var3 = var16.size();

         ...
         new Function2<CoroutineScope, Continuation, Object>(this, var13, var9, var11, var12, var10, var17, var3, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               label49: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var26;
                        this.label = 1;
                        var7 = var36.resolveToUri$media_release((Uri)var7, var30, var4, var3x, var5, var8, this);
                     } catch (var12: java.lang.Throwable) {
                        var1 = Result.e;
                        var1 = Result.b(c.a(var12));
                        break label49;
               ...
               if (var29 != null) {
                  ...
                  val var35: CrashReporting = CrashReporting.INSTANCE;
                  ...
                  CrashReporting.addBreadcrumb$default(
                     ...
                     L.l(new Pair[]{var40, s.a("mimeType", java.lang.String.valueOf(var38.getMimeType(var34)))}),
                     null,
                     null,
                     12,
                     null
                  );
                  CrashReporting.captureException$default(var35, var29, false, 2, null);
                  var32.reject(var29);
               }

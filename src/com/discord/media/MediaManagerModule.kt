...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2<CoroutineScope, Continuation, Object>(this, var13, var8, var12, var11, var10, var17, var3, var1, null) {
               ...
               label49: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var25;
                        this.label = 1;
                        var28 = var37.resolveToUri$media_release((Uri)var28, var27, var3x, var4, var5, var8, this);
                     } catch (var12: java.lang.Throwable) {
                        var28 = Result.e;
                        var1 = Result.b(c.a(var12));
                        break label49;

...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule {
      ...
      f.d(this.scope, K.b(), null, new Function2(var1, var3, this, var4, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               r.e(var4);
               val var9: Flow = PublicFileDownloader.downloadFile$default(var5, var1, var6, var4, null, 8, null);
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2(this, var13, var7, var10, var11, var12, var17, var3, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               label47: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var6;
                        this.label = 1;
                        var1 = (kotlin.Result.a)var34.resolveToUri$media_release(var8, var30, var4, var5, var3x, var26, this);
                     } catch (var12: java.lang.Throwable) {
                        var1 = Result.k;
                        var1 = Result.b(c.a(var12));
                        break label47;
               ...
               if (var29 != null) {
                  ...
                  CrashReporting.addBreadcrumb$default(
                     ...
                     q.l(new Pair[]{var38, s.a("mimeType", java.lang.String.valueOf(var36.getMimeType(var31)))}),
                     null,
                     4,
                     null
                  );

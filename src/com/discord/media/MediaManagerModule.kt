...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
         ...
         new Function2<CoroutineScope, Continuation, Object>(this, var1, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (var727 != null) {
                  ...
                  val var691: java.lang.String = var727.getMessage();
      ...
      f.d(this.scope, K.b(), null, new Function2<CoroutineScope, Continuation, Object>(var1, var3, this, var4, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               val var9: Flow = PublicFileDownloader.downloadFile$default(var5, var1, var4, var6, null, 8, null);
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2<CoroutineScope, Continuation, Object>(this, var13, var8, var11, var10, var12, var17, var3, var1, null) {
               ...
               label49: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var26;
                        this.label = 1;
                        var7 = var37.resolveToUri$media_release((Uri)var7, var30, var3x, var4, var5, var8, this);
                     } catch (var12: java.lang.Throwable) {
                        var1 = Result.e;
                        var1 = Result.b(c.a(var12));
                        break label49;

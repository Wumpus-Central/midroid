      ...
      f.d(this.scope, K.b(), null, new Function2(var1, var3, this, var4, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               r.e(var1);
               val var8: Flow = PublicFileDownloader.downloadFile$default(var4, var6, var5, var1, null, 8, null);
               ...
               label49: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var26;
                        this.label = 1;
                        var6 = var37.resolveToUri$media_release((Uri)var6, var30, var4, var5, var3x, var8, this);
                     } catch (var12: java.lang.Throwable) {
                        var1 = Result.k;
                        var1 = Result.b(c.a(var12));
                        break label49;

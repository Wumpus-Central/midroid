...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
         ...
         new Function2<CoroutineScope, Continuation, Object>(this, var1, var2, var3, null) {
            ...
            public final Object invokeSuspend(Object var1) {
                                 ...
                                 label250: {
                                    ...
                                    label251: {
                                       ...
                                       try {
                                          ...
                                          this.L$4 = var730;
                                          this.label = 2;
                                          var733 = MediaManagerModule.access$getImageDimensions(var701, var662, this);
               ...
               if (var725 != null) {
                  ...
                  CrashReporting.captureException$default(var665, var725, false, 2, null);
                  val var666: java.lang.String = var725.getMessage();
      ...
      f.d(this.scope, K.b(), null, new Function2<CoroutineScope, Continuation, Object>(var1, var3, this, var4, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               val var8: Flow = PublicFileDownloader.downloadFile$default(var1, var6, var5, var4, null, 8, null);
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2<CoroutineScope, Continuation, Object>(this, var13, var7, var12, var10, var11, var17, var3, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               label47: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var6;
                        this.label = 1;
                        var1 = (kotlin.Result.a)var35.resolveToUri$media_release(var26, var30, var4, var5, var3x, var8, this);
                     } catch (var12: java.lang.Throwable) {
                        var1 = Result.e;
                        var1 = Result.b(c.a(var12));
                        break label47;
               ...
               if (var29 != null) {
                  ...
                  val var38: Pair = v.a("uri", var37);
                  val var34: MediaResolver = MediaManagerModule.access$getMediaResolver$p(var33);
                  CrashReporting.addBreadcrumb$default(
                     var36,
                     "Failed to resolve URI to file",
                     O.m(new Pair[]{var38, v.a("mimeType", java.lang.String.valueOf(var34.getMimeType(var32)))}),
                     null,
                     4,
                     null
                  );

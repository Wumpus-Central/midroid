...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule {
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2(this, var13, var8, var11, var10, var12, var17, var3, var1, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (var26 != null) {
                  ...
                  CrashReporting.addBreadcrumb$default(
                     ...
                     p8.q.l(new Pair[]{var40, w.a("mimeType", java.lang.String.valueOf(var38.getMimeType(var32)))}),
                     null,
                     4,
                     null
                  );
                  CrashReporting.captureException$default(var35, var26, false, 2, null);
                  var34.reject(var26);
               }

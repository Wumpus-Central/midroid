...
public class MediaManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
      ...
      f.d(this.scope, K.b(), null, new Function2<CoroutineScope, Continuation, Object>(var1, var3, this, var4, null) {
         ...
         public final Object invokeSuspend(Object var1) {
            ...
            if (this.label != 0) {
               ...
               var1 = this.$uri;
               val var9: Flow = PublicFileDownloader.downloadFile$default(var6, var4, var1, var5, null, 8, null);
   ...
   public fun resolveToMediaFilePath(uri: String, options: ReadableMap?, promise: Promise) {
      ...
      f.d(
         ...
         null,
         null,
         new Function2<CoroutineScope, Continuation, Object>(this, var13, var7, var12, var11, var10, var17, var3, var1, null) {
               ...
               label47: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        this.L$0 = var6;
                        this.label = 1;
                        var1 = (CoroutineScope)var34.resolveToUri$media_release(var25, var27, var5, var3x, var4, var8, this);
                     } catch (var12: java.lang.Throwable) {

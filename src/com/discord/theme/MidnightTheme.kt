...
internal class MidnightTheme(resources: Resources, theme: Theme) : DiscordThemeObject {
   ...
   init {
      ...
      this.backgroundMessageHighlight$delegate = j.b(new y2(var1, var2));
      this.backgroundMobilePrimary$delegate = j.b(new K2(var1, var2));
      this.backgroundMobileSecondary$delegate = j.b(new M2(var1, var2));
      this.backgroundModifierAccent$delegate = j.b(new N2(var1, var2));
      this.backgroundModifierSelected$delegate = j.b(new O2(var1, var2));
      this.backgroundPrimary$delegate = j.b(new P2(var1, var2));
      this.backgroundSecondary$delegate = j.b(new R2(var1, var2));
      this.backgroundSecondaryAlt$delegate = j.b(new j2(var1, var2));
      this.backgroundTertiary$delegate = j.b(new u2(var1, var2));
      this.bgModStrong$delegate = j.b(new F2(var1, var2));
      this.bgSurfaceOverlay$delegate = j.b(new Q2(var1, var2));
      this.borderStrong$delegate = j.b(new S2(var1, var2));
      this.borderSubtle$delegate = j.b(new T2(var1, var2));
      this.buttonSecondaryBackground$delegate = j.b(new U2(var1, var2));
      this.cardPrimaryBg$delegate = j.b(new V2(var1, var2));
      this.chatSwipeToReplyBackground$delegate = j.b(new W2(var1, var2));
      this.chatSwipeToReplyGradientBackground$delegate = j.b(new Z1(var1, var2));
      this.embedBackground$delegate = j.b(new b2(var1, var2));
      this.headerPrimary$delegate = j.b(new c2(var1, var2));
      this.headerSecondary$delegate = j.b(new d2(var1, var2));
      this.infoDangerForeground$delegate = j.b(new e2(var1, var2));
      this.interactiveActive$delegate = j.b(new f2(var1, var2));
      this.interactiveMuted$delegate = j.b(new g2(var1, var2));
      this.interactiveNormal$delegate = j.b(new h2(var1, var2));
      this.redesignButtonPrimaryBackground$delegate = j.b(new i2(var1, var2));
      this.redesignButtonPrimaryOverlayBackground$delegate = j.b(new k2(var1, var2));
      this.redesignButtonPrimaryOverlayPressedBackground$delegate = j.b(new l2(var1, var2));
      this.redesignButtonPrimaryOverlayText$delegate = j.b(new n2(var1, var2));
      this.redesignButtonTertiaryBackground$delegate = j.b(new o2(var1, var2));
      this.redesignButtonTertiaryText$delegate = j.b(new p2(var1, var2));
      this.spoilerHiddenBackground$delegate = j.b(new q2(var1, var2));
      this.spoilerRevealedBackground$delegate = j.b(new r2(var1, var2));
      this.statusDanger$delegate = j.b(new s2(var1, var2));
      this.statusDangerBackground$delegate = j.b(new t2(var1, var2));
      this.statusPositive$delegate = j.b(new v2(var1, var2));
      this.statusPositiveText$delegate = j.b(new w2(var1, var2));
      this.statusWarning$delegate = j.b(new x2(var1, var2));
      this.textBrand$delegate = j.b(new z2(var1, var2));
      this.textDanger$delegate = j.b(new A2(var1, var2));
      this.textLink$delegate = j.b(new B2(var1, var2));
      this.textLowContrast$delegate = j.b(new C2(var1, var2));
      this.textMuted$delegate = j.b(new D2(var1, var2));
      this.textNormal$delegate = j.b(new E2(var1, var2));
      this.textPositive$delegate = j.b(new G2(var1, var2));
      this.textPrimary$delegate = j.b(new H2(var1, var2));
      this.textSecondary$delegate = j.b(new I2(var1, var2));
      this.textWarning$delegate = j.b(new J2(var1, var2));
      this.white$delegate = j.b(new L2(var1, var2));
   }

...
internal class MidnightTheme(resources: Resources, theme: Theme) : DiscordThemeObject {
   ...
   init {
      ...
      this.inputBorder$delegate = l.b(new Function0(var1, var2) {
         ...
         public final Integer invoke() {
            return ColorUtilsKt.getColorCompat(this.$resources, R.color.input_border_midnight, this.$theme);
         }
      });
      this.inputErrorBackground$delegate = l.b(new Function0(var1, var2) {
         ...
         public final Integer invoke() {
            return ColorUtilsKt.getColorCompat(this.$resources, R.color.input_error_background_midnight, this.$theme);
         }
      });

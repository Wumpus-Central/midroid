...
public fun interpolateColors(colorA: Int, colorB: Int, t: Float, minT: Float = 0.0F, maxT: Float = 1.0F): Int {
   if (var2 <= var3) {
      ...
      return Color.argb(
         ...
         d.k((int)((float)var8 + (float)(Color.red(var1) - var8) * ((var2 - var3) / (var4 - var3))), 0, 255),
         d.k((int)((float)var7 + (float)(Color.green(var1) - var7) * ((var2 - var3) / (var4 - var3))), 0, 255),
...
public fun rgbaToArgb(rgbaString: String?): Int {
   ...
   if (var0 != null) {
      ...
      if (var5 != null) {
         val var4: b = var5.a();
         var1 = Color.argb(
            (int)(java.lang.Double.parseDouble(var4.a().b().get(4) as java.lang.String) * (double)255),
            Integer.parseInt(var4.a().b().get(1) as java.lang.String),
            Integer.parseInt(var4.a().b().get(2) as java.lang.String),
            Integer.parseInt(var4.a().b().get(3) as java.lang.String)
         );
      } else {
         var1 = -16777216;
      }

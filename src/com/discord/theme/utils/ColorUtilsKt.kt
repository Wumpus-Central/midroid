...
public fun interpolateColors(colorA: Int, colorB: Int, t: Float, minT: Float = 0.0F, maxT: Float = 1.0F): Int {
   if (var2 <= var3) {
      ...
      return Color.argb(
         ...
         kotlin.ranges.e.n((int)((float)var9 + (float)(Color.red(var1) - var9) * ((var2 - var3) / (var4 - var3))), 0, 255),
         kotlin.ranges.e.n((int)((float)var7 + (float)(Color.green(var1) - var7) * ((var2 - var3) / (var4 - var3))), 0, 255),

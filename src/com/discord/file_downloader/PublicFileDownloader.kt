...
public object PublicFileDownloader {
   ...
   private fun ProducerScope<DownloadState>.onFileDownloaded(downloadManager: DownloadManager, downloadId: Long, downloadFileName: String): Boolean {
      ...
      // 3d: aload 1
      // 3e: aload 5
      // 40: invokeinterface qk/s.m (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 45: pop
      // 46: goto 79
      // 49: astore 5
      // 4b: goto 8a
      ...
      // 70: aload 1
      // 71: aload 5
      // 73: invokeinterface qk/s.m (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 78: pop
      // 79: aload 1
      // 7a: aconst_null
      // 7b: bipush 1
      // 7c: aconst_null
      // 7d: invokestatic qk/s$a.a (Lqk/s;Ljava/lang/Throwable;ILjava/lang/Object;)Z
      // 80: istore 6
      // 82: aload 2
      // 83: aconst_null
      // 84: invokestatic rh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: iload 6
      // 89: ireturn
      // 8a: aload 5
      // 8c: athrow

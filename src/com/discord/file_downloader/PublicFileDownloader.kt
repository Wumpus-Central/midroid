...
public object PublicFileDownloader {
   ...
   private fun ProducerScope<DownloadState>.onFileDownloaded(downloadManager: DownloadManager, downloadId: Long, downloadFileName: String): Boolean {
      ...
      // 3d: aload 1
      // 3e: aload 5
      // 40: invokeinterface kb/t.g (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 45: pop
      // 46: goto 78
      // 49: astore 1
      // 4a: goto 89
      ...
      // 6f: aload 1
      // 70: aload 5
      // 72: invokeinterface kb/t.g (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 77: pop
      // 78: aload 1
      // 79: aconst_null
      // 7a: bipush 1
      // 7b: aconst_null
      // 7c: invokestatic kb/t$a.a (Lkb/t;Ljava/lang/Throwable;ILjava/lang/Object;)Z
      // 7f: istore 6
      // 81: aload 2
      // 82: aconst_null
                  ...
                  label80: {
                     ...
                     label86: {
                        label87: {
                           ...
                           try {
                              val var32: DownloadState.Failure = new DownloadState.Failure(
                                 new IllegalStateException("Download Manager returned an invalid download id")
                              );
                              this.L$0 = var1;
                              this.L$1 = var23;
                              this.label = 2;
                              var27 = var1.k(var32, this);
                        ...
                        try {
                           kotlin.coroutines.jvm.internal.b.a(kb.t.a.a(var20, null, 1, null));
                           break label80;
                     ...
                     kotlin.coroutines.jvm.internal.b.a(kb.t.a.a(var6, null, 1, null));
                     var1 = var7;
                     var20 = var6;
                  }

...
public object PublicFileDownloader {
   ...
   private fun ProducerScope<DownloadState>.onFileDownloaded(downloadManager: DownloadManager, downloadId: Long, downloadFileName: String): Boolean {
      ...
      // 70: aload 1
      // 71: aload 7
      // 73: invokeinterface vm/s.d (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 78: pop
      // 79: aload 1
      // 7a: aconst_null
      // 7b: bipush 1
      // 7c: aconst_null
      // 7d: invokestatic vm/s$a.a (Lvm/s;Ljava/lang/Throwable;ILjava/lang/Object;)Z
      // 80: istore 6
      // 82: aload 2
      // 83: aconst_null
      // 84: invokestatic wj/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: iload 6
      // 89: ireturn
      // 8a: aload 5
      // 8c: athrow

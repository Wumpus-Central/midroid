...
public object PublicFileDownloader {
   ...
   private fun ProducerScope<DownloadState>.onFileDownloaded(downloadManager: DownloadManager, downloadId: Long, downloadFileName: String): Boolean {
      ...
      // 3d: aload 1
      // 3e: aload 5
      // 40: invokeinterface iu/w.c (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 45: pop
      // 46: goto 79
      // 49: astore 5
      // 4b: goto 8a
      ...
      // 70: aload 1
      // 71: aload 7
      // 73: invokeinterface iu/w.c (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 78: pop
      // 79: aload 1
      // 7a: aconst_null
      // 7b: bipush 1
      // 7c: aconst_null
      // 7d: invokestatic iu/w$a.a (Liu/w;Ljava/lang/Throwable;ILjava/lang/Object;)Z
      // 80: istore 6
      // 82: aload 2
      // 83: aconst_null
      // 84: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: iload 6
      // 89: ireturn
      // 8a: aload 5
      // 8c: athrow
      ...
      // 8e: aload 2
      // 8f: aload 5
      // 91: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 94: aload 1
      // 95: athrow
   }
   ...
   public fun downloadFile(context: Context, url: String, fileName: String, description: String? = null): Flow<DownloadState> {
      return ju.g.d(
         new Function2<ProducerScope, Continuation<? super Unit>, Object>(var1, var2, var3, var4, null) {
            ...
            public final Object invoke(ProducerScope var1, Continuation<? super Unit> var2x) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               label82: {
                  label81: {
                     ...
                     label88: {
                           ...
                           if (var3x != 0L && var3x != 1L) {
                              try {
                                 PublicFileDownloader.access$getOnDownloadListeners$p()
                                    .put(kotlin.coroutines.jvm.internal.b.f(var23.element), new b(var23, var1, var33, this.$fileName));
                                 break label82;
                        ...
                        try {
                           kotlin.coroutines.jvm.internal.b.a(iu.w.a.a(var20, null, 1, null));
                           break label81;
                     ...
                     var6.c(new DownloadState.Failure(var1));
                     kotlin.coroutines.jvm.internal.b.a(iu.w.a.a(var6, null, 1, null));
                     var1 = var7;
                     var20 = var6;
                  }
               ...
               this.L$1 = null;
               this.label = 3;
               return if (s.a(var1, var24, this) === var9) var9 else Unit.a;
            }
         }
      );
   }

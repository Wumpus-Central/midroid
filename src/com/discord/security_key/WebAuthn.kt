...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
         ...
         if (var5 != null) {
            ...
            if (var2 != 116204) {
               if (var2 != 93029116) {
                  ...
                  var10.append(var6);
                  var10.append("`");
                  Log.i$default(var4, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
            ...
            switch (var4.hashCode()) {
               ...
               case 563476214:
                  if (var4.equals("authenticatorAttachment")) {
                     val var7: com.google.android.gms.fido.fido2.api.common.a = com.google.android.gms.fido.fido2.api.common.a.e(var1.nextString());
                     q.g(var7, "fromString(...)");
            ...
            switch (var6.hashCode()) {
               ...
               case -1313911455:
                  if (var6.equals("timeout")) {
                     ...
                     val var14: StringBuilder = new StringBuilder();
                     var14.append("parseCreationOptions: timeout: `");
                     var14.append(var3);
                     var14.append("`");
               ...
               case -709624112:
                  if (var6.equals("attestation")) {
                     val var8: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.e(var1.nextString());
                     q.g(var8, "fromString(...)");
                     val var13: Log = Log.INSTANCE;
                     ...
                     var15.append(var8);
                     var15.append("`");
                     Log.i$default(var13, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
                     q.e(var2.b(var8));
                     continue;
                  }
                  break;
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 9b: aload 1
      // 9c: aload 3
      // 9d: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a0: aload 2
      // a1: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ac: aload 1
      // ad: aconst_null
      // ae: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b1: aload 2
      ...
      // c2: aload 1
      // c3: aload 2
      // c4: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c7: aload 3
      // c8: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var3, "uvm")) {
            ...
            var4.append(var7);
            var4.append("`");
            Log.i$default(var5, "DCDSecurityKeyManager.WebAuthn", var4.toString(), null, 4, null);
            q.e(var2.d(var7));
         } else {
            val var8: Log = Log.INSTANCE;
            val var9: StringBuilder = new StringBuilder();
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var6.hashCode()) {
               ...
               case 3506169:
                  if (var6.equals("rpId")) {
                     ...
                     var19.append(var10);
                     var19.append("`");
                     Log.i$default(var16, "DCDSecurityKeyManager.WebAuthn", var19.toString(), null, 4, null);
                     q.e(var2.e(var10));
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var15.append(var18);
                     var15.append("`");
                     Log.i$default(var9, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
                     q.e(var18);
                     q.e(var2.d(this.decodeBase64(var18)));
                     continue;
                  }
                  break;
               case 2036710790:
         ...
         Log.w$default(var12, "DCDSecurityKeyManager.WebAuthn", var20.toString(), null, 4, null);
         var1.skipValue();
      }

...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var7.hashCode()) {
               ...
               case -709624112:
                  if (var7.equals("attestation")) {
                     ...
                     val var11: StringBuilder = new StringBuilder();
                     var11.append("parseCreationOptions: attestation preference: `");
                     var11.append(var15);
                     var11.append("`");
   ...
   private fun parseCredentialDescriptors(reader: JsonReader): List<n> {
      ...
      while (var1.hasNext()) {
         ...
         while (var1.hasNext()) {
            ...
            var12.append(var7);
            var12.append("`");
            Log.w$default(var14, "DCDSecurityKeyManager.WebAuthn", var12.toString(), null, 4, null);
            var1.skipValue();
         }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 82: aload 1
      // 83: aconst_null
      // 84: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: aload 2
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // c3: aload 1
      // c4: aload 3
      // c5: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 2
      // c9: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var3, "uvm")) {
            ...
            var4.append(var5);
            var4.append("`");
            Log.i$default(var7, "DCDSecurityKeyManager.WebAuthn", var4.toString(), null, 4, null);
            var2.d(var5);
         } else {
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var5.hashCode()) {
               ...
               case -1313911455:
                  if (var5.equals("timeout")) {
                     ...
                     var11.append(var3);
                     var11.append("`");
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var11.toString(), null, 4, null);
               ...
               case 3506169:
                  if (var5.equals("rpId")) {
                     ...
                     var10.append(var13);
                     var10.append("`");
                     Log.i$default(var17, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
                     var2.e(var13);
                     continue;
                  }
                  break;
         ...
         var18.append("parseRequestOptions: Found unrecognized option: `");
         var18.append(var5);
         var18.append("`, skipping");
         Log.w$default(var15, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
         var1.skipValue();
      }
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.B() is f) {
                  ...
                  val var13: java.lang.String = (var10 as f).v();

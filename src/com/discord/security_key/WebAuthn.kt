...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var4.hashCode()) {
               ...
               case 1098323695:
                  if (var4.equals("residentKey")) {
                     ...
                     var10.append(var14);
                     var10.append("`");
                     Log.w$default(var9, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
                     var3.d(var14);
                     continue;
                  }
                  break;
            ...
            switch (var7.hashCode()) {
               ...
               case -1313911455:
                  if (var7.equals("timeout")) {
                     ...
                     var9.append(var3);
                     var9.append("`");
                     Log.i$default(var12, "DCDSecurityKeyManager.WebAuthn", var9.toString(), null, 4, null);
               ...
               case -709624112:
                  if (var7.equals("attestation")) {
                     ...
                     var8.append(var11);
                     var8.append("`");
                     Log.i$default(var15, "DCDSecurityKeyManager.WebAuthn", var8.toString(), null, 4, null);
                     var2.b(var11);
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     var6.append(var5);
                     var6.append("`");
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var6.toString(), null, 4, null);
                     q.e(var5);
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 82: aload 1
      // 83: aconst_null
      // 84: invokestatic q8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: aload 2
      ...
      // 8c: aload 1
      // 8d: ldc_w "build(...)"
      // 90: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 93: aload 1
      // 94: areturn
      // 95: aload 3
      // 96: athrow
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic q8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic q8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // b7: aload 1
      // b8: ldc_w "build(...)"
      // bb: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // be: aload 1
      // bf: areturn
      // c0: aload 3
      // c1: athrow
      ...
      // c3: aload 1
      // c4: aload 3
      // c5: invokestatic q8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 2
      // c9: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var4, "uvm")) {
            ...
            var3.append("parseRegisterExtensions: ... uvm extension: `");
            var3.append(var8);
            var3.append("`");
            Log.i$default(var5, "DCDSecurityKeyManager.WebAuthn", var3.toString(), null, 4, null);
            var2.d(var8);
         } else {
            val var9: Log = Log.INSTANCE;
            val var7: StringBuilder = new StringBuilder();
            var7.append("parseRegisterExtensions: ... found unsupported extension: `");
            var7.append(var4);
            var7.append("`, skipping");
            Log.w$default(var9, "DCDSecurityKeyManager.WebAuthn", var7.toString(), null, 4, null);
            var1.skipValue();
         }
      }
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var7.hashCode()) {
               ...
               case -1313911455:
                  if (var7.equals("timeout")) {
                     ...
                     val var14: Log = Log.INSTANCE;
                     val var10: StringBuilder = new StringBuilder();
                     var10.append("parseRequestOptions: timeout: `");
                     var10.append(var3);
                     var10.append("`");
               ...
               case 3506169:
                  if (var7.equals("rpId")) {
                     ...
                     var13.append("parseRequestOptions: rpId: `");
                     var13.append(var9);
                     var13.append("`");
                     Log.i$default(var18, "DCDSecurityKeyManager.WebAuthn", var13.toString(), null, 4, null);
                     var2.e(var9);
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     var8.append(var12);
                     var8.append("`");
                     Log.i$default(var17, "DCDSecurityKeyManager.WebAuthn", var8.toString(), null, 4, null);
                     q.e(var12);
               ...
               case 2036710790:
                  if (var7.equals("userVerification")) {
                     ...
                     Log.w$default(var16, "DCDSecurityKeyManager.WebAuthn", var6.toString(), null, 4, null);
                     continue;
                  }
               default:
            }
         ...
         var15.append("parseRequestOptions: Found unrecognized option: `");
         var15.append(var7);
         var15.append("`, skipping");
         Log.w$default(var11, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
         var1.skipValue();
      }
               ...
               if (var7.E() is f) {
                  ...
                  if (var1 != 4001) {
                     if (var1 == 4002) {
                        ...
                        val var8: java.lang.String = var7.I();
                        q.g(var8, "toJson(...)");
                        var4.invoke(var8);
                     }
                  } else {
                     val var12: Function1 = this.resolve;
                     val var9: java.lang.String = var7.I();
                     q.g(var9, "toJson(...)");
                     var12.invoke(var9);
                  }
               }

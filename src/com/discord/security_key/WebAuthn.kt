...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
         ...
         if (var5 != null) {
            ...
            if (var2 != 116204) {
               if (var2 != 93029116) {
                  ...
                  var6.append(var5);
                  var6.append("`");
                  Log.i$default(var4, "DCDSecurityKeyManager.WebAuthn", var6.toString(), null, 4, null);
                  q.e(var3.b(new k(var5)));
                  continue;
               }
            ...
            switch (var4.hashCode()) {
               ...
               case 1098323695:
                  if (var4.equals("residentKey")) {
                     val var10: com.google.android.gms.fido.fido2.api.common.c = com.google.android.gms.fido.fido2.api.common.c.e(var1.nextString());
            ...
            switch (var6.hashCode()) {
               ...
               case -709624112:
                  if (var6.equals("attestation")) {
                     val var15: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.e(var1.nextString());
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var5.append(var7);
                     var5.append("`");
                     Log.i$default(var12, "DCDSecurityKeyManager.WebAuthn", var5.toString(), null, 4, null);
                     q.e(var7);
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // c3: aload 1
      // c4: aload 2
      // c5: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 3
      // c9: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var5, "uvm")) {
            ...
            var3.append(var9);
            var3.append("`");
            Log.i$default(var4, "DCDSecurityKeyManager.WebAuthn", var3.toString(), null, 4, null);
            q.e(var2.d(var9));
         } else {
            val var8: Log = Log.INSTANCE;
            val var7: StringBuilder = new StringBuilder();
            ...
            switch (var7.hashCode()) {
               ...
               case 3506169:
                  if (var7.equals("rpId")) {
                     ...
                     var10.append(var15);
                     var10.append("`");
                     Log.i$default(var20, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
                     q.e(var2.e(var15));
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     q.e(var9);
                     q.e(var2.d(this.decodeBase64(var9)));
                     continue;
                  }
                  break;
               case 2036710790:
                  if (var7.equals("userVerification")) {
                     ...
                     var18.append("parseRequestOptions: userVerification: `");
                     var18.append(var6);
                     var18.append("`, skipping");
                     Log.w$default(var5, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
                     continue;
                  }
               default:
            }

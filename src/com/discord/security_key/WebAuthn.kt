...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 82: aload 1
      // 83: aconst_null
      // 84: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: aload 2
      ...
      // 98: aload 1
      // 99: aload 2
      // 9a: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 3
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 3
      // c1: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 2
      // c5: athrow
   }
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.A() is Y6.f) {
                  ...
                  val var10: g = var7.A();
                  val var13: java.lang.String = (var10 as Y6.f).w();

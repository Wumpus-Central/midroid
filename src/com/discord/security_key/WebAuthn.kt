...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var4.hashCode()) {
               ...
               case 563476214:
                  if (var4.equals("authenticatorAttachment")) {
                     val var15: com.google.android.gms.fido.fido2.api.common.a = com.google.android.gms.fido.fido2.api.common.a.a(var1.nextString());
               ...
               case 1098323695:
                  if (var4.equals("residentKey")) {
                     val var9: com.google.android.gms.fido.fido2.api.common.c = com.google.android.gms.fido.fido2.api.common.c.a(var1.nextString());
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 82: aload 1
      // 83: aconst_null
      // 84: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: aload 2
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // c3: aload 1
      // c4: aload 3
      // c5: invokestatic Ha/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 2
      // c9: athrow
   }
   ...
   public fun authenticateSecurityKey(requestOptions: String, currentActivity: Activity?) {
      if (var2 == null) {
         ...
         val var3: X6.a = W6.a.a(var2);
         val var4: Task = var3.y(this.parsePublicKeyCredentialRequestOptions(var1));
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.g() is Y6.f) {
                  ...
                  val var10: g = var7.g();
                  val var13: java.lang.String = (var10 as Y6.f).d();
   ...
   public fun registerSecurityKey(creationOptions: String, currentActivity: Activity?) {
      if (var2 == null) {
         ...
         val var3: X6.a = W6.a.a(var2);
         val var4: Task = var3.x(this.parsePublicKeyCredentialCreationOptions(var1));

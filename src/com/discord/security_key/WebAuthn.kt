...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var5.hashCode()) {
               ...
               case 1402633315:
                  if (var5.equals("challenge")) {
                     ...
                     r.e(var5);
                     r.e(var2.e(this.decodeBase64(var5)));
                     continue;
                  }
                  break;
               case 1684840642:
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 9b: aload 1
      // 9c: aload 2
      // 9d: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a0: aload 3
      // a1: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 2
      // c1: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 3
      // c5: athrow
   }
            ...
            switch (var6.hashCode()) {
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     r.e(var6);
                     r.e(var2.d(this.decodeBase64(var6)));
                     continue;
                  }
                  break;
               case 2036710790:

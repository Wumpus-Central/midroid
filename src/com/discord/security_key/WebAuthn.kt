...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var4.hashCode()) {
               ...
               case 563476214:
                  if (var4.equals("authenticatorAttachment")) {
                     val var15: com.google.android.gms.fido.fido2.api.common.a = com.google.android.gms.fido.fido2.api.common.a.e(var1.nextString());
            ...
            switch (var7.hashCode()) {
               ...
               case -709624112:
                  if (var7.equals("attestation")) {
                     val var16: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.e(var1.nextString());
                     q.g(var16, "fromString(...)");
                     val var12: Log = Log.INSTANCE;
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 85: aload 1
      // 86: aconst_null
      // 87: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8a: aload 2
      ...
      // 9b: aload 1
      // 9c: aload 3
      // 9d: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a0: aload 2
      // a1: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 2
      // c1: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 3
      // c5: athrow
   }
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.y() is K5.f) {
                  ...
                  val var13: java.lang.String = (var10 as K5.f).v();
                  ...
                  if (var1 != 4001) {
                     if (var1 == 4002) {
                        ...
                        val var8: java.lang.String = var7.C();
                        q.g(var8, "toJson(...)");
                        var4.invoke(var8);
                     }
                  } else {
                     val var12: Function1 = this.resolve;
                     val var9: java.lang.String = var7.C();
                     q.g(var9, "toJson(...)");
                     var12.invoke(var9);
                  }
               }

...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
         ...
         if (var5 != null) {
            ...
            if (var2 != 116204) {
               if (var2 != 93029116) {
                  ...
                  var4.append(var5);
                  var4.append("`");
                  Log.i$default(var6, "DCDSecurityKeyManager.WebAuthn", var4.toString(), null, 4, null);
                  var3.b(new k(var5));
                  continue;
               }
   ...
   private fun parseCreationOptions(reader: JsonReader, builder: Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var6.hashCode()) {
               ...
               case -709624112:
                  if (var6.equals("attestation")) {
                     ...
                     var8.append(var12);
                     var8.append("`");
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var8.toString(), null, 4, null);
                     var2.b(var12);
                     continue;
                  }
                  break;
         ...
         var15.append("parseCreationOptions: Found unexpected key in creation options: `");
         var15.append(var6);
         var15.append("`, skipping");
         Log.w$default(var10, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 86: aload 1
      // 87: aconst_null
      // 88: invokestatic x8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      ...
      // 9c: aload 1
      // 9d: aload 3
      // 9e: invokestatic x8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: aload 2
      // a2: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ac: aload 1
      // ad: aconst_null
      // ae: invokestatic x8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b1: aload 2
      ...
      // c2: aload 1
      // c3: aload 3
      // c4: invokestatic x8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c7: aload 2
      // c8: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var4, "uvm")) {
            ...
            val var5: Log = Log.INSTANCE;
            val var8: StringBuilder = new StringBuilder();
            var8.append("parseRegisterExtensions: ... uvm extension: `");
            var8.append(var3);
            var8.append("`");
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var5.hashCode()) {
               ...
               case -1313911455:
                  if (var5.equals("timeout")) {
                     ...
                     var14.append(var3);
                     var14.append("`");
                     Log.i$default(var11, "DCDSecurityKeyManager.WebAuthn", var14.toString(), null, 4, null);
               ...
               case 3506169:
                  if (var5.equals("rpId")) {
                     ...
                     var10.append(var17);
                     var10.append("`");
                     Log.i$default(var13, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
                     var2.e(var17);
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var5.equals("challenge")) {
                     ...
                     var12.append("parseRequestOptions: challenge: `");
                     var12.append(var16);
                     var12.append("`");
         ...
         var15.append(var5);
         var15.append("`, skipping");
         Log.w$default(var18, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
         var1.skipValue();
      }
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.E() is f) {
                  ...
                  val var13: java.lang.String = (var10 as f).u();

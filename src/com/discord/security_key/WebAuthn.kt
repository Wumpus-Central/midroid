...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ac: aload 1
      // ad: aconst_null
      // ae: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b1: aload 2
      ...
      // c2: aload 1
      // c3: aload 3
      // c4: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c7: aload 2
      // c8: athrow
   }

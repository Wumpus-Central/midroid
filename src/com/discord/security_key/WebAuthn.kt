...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var4.hashCode()) {
               ...
               case 563476214:
                  if (var4.equals("authenticatorAttachment")) {
                     val var15: com.google.android.gms.fido.fido2.api.common.a = com.google.android.gms.fido.fido2.api.common.a.f(var1.nextString());
   ...
   private fun parseCreationOptions(reader: JsonReader, builder: Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var5.hashCode()) {
               ...
               case -709624112:
                  if (var5.equals("attestation")) {
                     val var15: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.f(var1.nextString());
                     q.g(var15, "fromString(...)");
                     val var9: Log = Log.INSTANCE;
                     val var12: StringBuilder = new StringBuilder();
               ...
               case 1402633315:
                  if (var5.equals("challenge")) {
                     ...
                     var7.append(var5);
                     var7.append("`");
                     Log.i$default(var6, "DCDSecurityKeyManager.WebAuthn", var7.toString(), null, 4, null);
                     q.e(var5);
         ...
         Log.w$default(var16, "DCDSecurityKeyManager.WebAuthn", var14.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 86: aload 1
      // 87: aconst_null
      // 88: invokestatic q9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      ...
      // 9c: aload 1
      // 9d: aload 3
      // 9e: invokestatic q9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: aload 2
      // a2: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var4, "uvm")) {
            ...
            var8.append(var5);
            var8.append("`");
            Log.i$default(var3, "DCDSecurityKeyManager.WebAuthn", var8.toString(), null, 4, null);
            q.e(var2.d(var5));
         } else {
            val var9: Log = Log.INSTANCE;
            val var7: StringBuilder = new StringBuilder();
            ...
            switch (var7.hashCode()) {
               ...
               case 3506169:
                  if (var7.equals("rpId")) {
                     ...
                     var20.append(var15);
                     var20.append("`");
                     Log.i$default(var10, "DCDSecurityKeyManager.WebAuthn", var20.toString(), null, 4, null);
                     q.e(var2.e(var15));
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     var19.append(var9);
                     var19.append("`");
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var19.toString(), null, 4, null);
                     q.e(var9);

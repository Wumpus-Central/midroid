...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parseCreationOptions(reader: JsonReader, builder: Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var5.hashCode()) {
               ...
               case -709624112:
                  if (var5.equals("attestation")) {
                     ...
                     var14.append("parseCreationOptions: attestation preference: `");
                     var14.append(var11);
                     var14.append("`");
         ...
         Log.w$default(var13, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 82: aload 1
      // 83: aconst_null
      // 84: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 87: aload 2
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 2
      // c1: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 3
      // c5: athrow
   }
               ...
               if (var7.z() is f) {
                  ...
                  if (var1 != 4001) {
                     if (var1 == 4002) {
                        ...
                        val var8: java.lang.String = var7.B();
                        q.g(var8, "toJson(...)");
                        var4.invoke(var8);
                     }
                  } else {
                     val var12: Function1 = this.resolve;
                     val var9: java.lang.String = var7.B();
                     q.g(var9, "toJson(...)");
                     var12.invoke(var9);
                  }
               }

...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
      ...
      while (var1.hasNext()) {
         ...
         if (var4 != null) {
            ...
            if (var2 != 116204) {
               ...
               val var9: s = new s(var1.nextBoolean());
            ...
            switch (var4.hashCode()) {
               ...
               case 1098323695:
                  if (var4.equals("residentKey")) {
                     val var10: com.google.android.gms.fido.fido2.api.common.c = com.google.android.gms.fido.fido2.api.common.c.a(var1.nextString());
            ...
            switch (var7.hashCode()) {
               ...
               case -709624112:
                  if (var7.equals("attestation")) {
                     val var12: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.a(var1.nextString());
                     val var16: Log = Log.INSTANCE;
                     val var8: StringBuilder = new StringBuilder();
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 86: aload 1
      // 87: aconst_null
      // 88: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      ...
      // 9c: aload 1
      // 9d: aload 3
      // 9e: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: aload 2
      // a2: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 3
      // c1: invokestatic Ta/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 2
      // c5: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (var5 == "uvm") {
            val var3: s = new s(var1.nextBoolean());
            val var9: Log = Log.INSTANCE;
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.h() is g7.f) {
                  ...
                  val var10: g = var7.h();
                  val var13: java.lang.String = (var10 as g7.f).d();
   ...
   public fun registerSecurityKey(creationOptions: String, currentActivity: Activity?) {
      if (var2 == null) {
         ...
         val var3: f7.a = e7.a.a(var2);
         val var4: Task = var3.y(this.parsePublicKeyCredentialCreationOptions(var1));

...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var6.hashCode()) {
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var5.append(var6);
                     var5.append("`");
                     Log.i$default(var7, "DCDSecurityKeyManager.WebAuthn", var5.toString(), null, 4, null);
                     r.e(var6);
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 90: aload 1
      // 91: ldc_w "build(...)"
      // 94: invokestatic kotlin/jvm/internal/r.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 97: aload 1
      // 98: areturn
      // 99: aload 2
      // 9a: athrow
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (r.c(var4, "uvm")) {
            ...
            var3.append(var5);
            var3.append("`");
            Log.i$default(var8, "DCDSecurityKeyManager.WebAuthn", var3.toString(), null, 4, null);
            r.e(var2.d(var5));
         } else {
            val var9: Log = Log.INSTANCE;
            val var7: StringBuilder = new StringBuilder();
            ...
            switch (var7.hashCode()) {
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var9.toString(), null, 4, null);
                     r.e(var7);
                     r.e(var2.d(this.decodeBase64(var7)));
                     continue;
                  }
                  break;
               case 2036710790:
                  if (var7.equals("userVerification")) {
                     ...
                     Log.w$default(var6, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
                     continue;
                  }
               default:
            }

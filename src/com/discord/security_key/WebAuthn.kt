...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parseAuthenticationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         var12.append(var5);
         var12.append("`");
         Log.w$default(var8, "DCDSecurityKeyManager.WebAuthn", var12.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parseCreationOptions(reader: JsonReader, builder: Builder) {
      ...
      while (var1.hasNext()) {
         ...
         val var13: StringBuilder = new StringBuilder();
         var13.append("parseCreationOptions: Found unexpected key in creation options: `");
         var13.append(var7);
         var13.append("`, skipping");
         Log.w$default(var10, "DCDSecurityKeyManager.WebAuthn", var13.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 86: aload 1
      // 87: aconst_null
      // 88: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      ...
      // 9c: aload 1
      // 9d: aload 2
      // 9e: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: aload 3
      // a2: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // c3: aload 1
      // c4: aload 2
      // c5: invokestatic u8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 3
      // c9: athrow
   }
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var6.hashCode()) {
               ...
               case 3506169:
                  if (var6.equals("rpId")) {
                     ...
                     var14.append("parseRequestOptions: rpId: `");
                     var14.append(var9);
                     var14.append("`");
                     Log.i$default(var17, "DCDSecurityKeyManager.WebAuthn", var14.toString(), null, 4, null);
                     var2.e(var9);
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var16.append("parseRequestOptions: challenge: `");
                     var16.append(var8);
                     var16.append("`");
                     Log.i$default(var13, "DCDSecurityKeyManager.WebAuthn", var16.toString(), null, 4, null);
                     q.e(var8);
               ...
               case 2036710790:
                  if (var6.equals("userVerification")) {
                     ...
                     Log.w$default(var12, "DCDSecurityKeyManager.WebAuthn", var5.toString(), null, 4, null);
                     continue;
                  }
               default:
            }
         ...
         Log.w$default(var18, "DCDSecurityKeyManager.WebAuthn", var11.toString(), null, 4, null);
         var1.skipValue();
      }

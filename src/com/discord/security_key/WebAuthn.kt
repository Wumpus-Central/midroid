...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var6.hashCode()) {
               ...
               case -709624112:
                  if (var6.equals("attestation")) {
                     val var13: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.b(var1.nextString());
                     r.g(var13, "fromString(...)");
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     r.e(var7);
                     r.e(var2.e(this.decodeBase64(var7)));
                     continue;
                  }
                  break;
               case 1684840642:
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 8c: aload 1
      // 8d: ldc_w "build(...)"
      // 90: invokestatic kotlin/jvm/internal/r.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 93: aload 1
      // 94: areturn
      // 95: aload 2
      // 96: athrow
      ...
      // 98: aload 1
      // 99: aload 2
      // 9a: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 3
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // 50: aload 5
      // 52: ldc_w "publicKey"
      // 55: invokestatic kotlin/jvm/internal/r.c (Ljava/lang/Object;Ljava/lang/Object;)Z
      // 58: ifeq 68
      // 5b: aload 0
      // 5c: aload 1
      // 5d: aload 2
      ...
      // ad: aload 1
      // ae: aconst_null
      // af: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b2: aload 2
      ...
      // b7: aload 1
      // b8: ldc_w "build(...)"
      // bb: invokestatic kotlin/jvm/internal/r.g (Ljava/lang/Object;Ljava/lang/String;)V
      // be: aload 1
      // bf: areturn
      // c0: aload 2
      // c1: athrow
      ...
      // c3: aload 1
      // c4: aload 2
      // c5: invokestatic M9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c8: aload 3
      // c9: athrow
   }
            ...
            switch (var6.hashCode()) {
               ...
               case 3506169:
                  if (var6.equals("rpId")) {
                     ...
                     var10.append(var6);
                     var10.append("`");
                     Log.i$default(var19, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
                     r.e(var2.e(var6));
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var18.append(var9);
                     var18.append("`");
                     Log.i$default(var15, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
                     r.e(var9);
         ...
         if (var2 != -1) {
            ...
            if (var6 == null) {
               ...
               if (var7.B() is Z5.f) {
                  ...
                  val var13: java.lang.String = (var10 as Z5.f).v();

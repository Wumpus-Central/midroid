...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
         ...
         if (var4 != null) {
            ...
            if (var2 != 116204) {
               if (var2 != 93029116) {
                  ...
                  var5.append("parseAuthenticationExtensions: ... appid extension: `");
                  var5.append(var6);
                  var5.append("`");
                  Log.i$default(var8, "DCDSecurityKeyManager.WebAuthn", var5.toString(), null, 4, null);
                  q.e(var3.b(new k(var6)));
                  continue;
               }
            ...
            switch (var4.hashCode()) {
               ...
               case 563476214:
                  if (var4.equals("authenticatorAttachment")) {
                     val var11: com.google.android.gms.fido.fido2.api.common.a = com.google.android.gms.fido.fido2.api.common.a.e(var1.nextString());
               ...
               case 1098323695:
                  if (var4.equals("residentKey")) {
                     val var9: com.google.android.gms.fido.fido2.api.common.c = com.google.android.gms.fido.fido2.api.common.c.e(var1.nextString());
                     q.g(var9, "fromString(...)");
            ...
            switch (var5.hashCode()) {
               ...
               case -709624112:
                  if (var5.equals("attestation")) {
                     val var12: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.e(var1.nextString());
               ...
               case 1402633315:
                  if (var5.equals("challenge")) {
                     ...
                     q.e(var5);
                     q.e(var2.e(this.decodeBase64(var5)));
                     continue;
                  }
                  break;
               case 1684840642:
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 98: aload 1
      // 99: aload 3
      // 9a: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 9d: aload 2
      // 9e: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // a9: aload 1
      // aa: aconst_null
      // ab: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      ...
      // bf: aload 1
      // c0: aload 3
      // c1: invokestatic d9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c4: aload 2
      // c5: athrow
   }
   ...
   private fun parseRegistrationExtensions(reader: JsonReader): AuthenticationExtensions {
      ...
      while (var1.hasNext()) {
         ...
         if (q.c(var3, "uvm")) {
            ...
            var7.append(var4);
            var7.append("`");
            Log.i$default(var5, "DCDSecurityKeyManager.WebAuthn", var7.toString(), null, 4, null);
            q.e(var2.d(var4));
         } else {
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var5.hashCode()) {
               ...
               case 3506169:
                  if (var5.equals("rpId")) {
                     ...
                     var15.append(var5);
                     var15.append("`");
                     Log.i$default(var19, "DCDSecurityKeyManager.WebAuthn", var15.toString(), null, 4, null);
                     q.e(var2.e(var5));
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var5.equals("challenge")) {
                     ...
                     var18.append(var5);
                     var18.append("`");
                     Log.i$default(var14, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
                     q.e(var5);
                     q.e(var2.d(this.decodeBase64(var5)));
                     continue;
                  }
                  break;
               case 2036710790:
         ...
         var20.append("parseRequestOptions: Found unrecognized option: `");
         var20.append(var5);
         var20.append("`, skipping");
         Log.w$default(var17, "DCDSecurityKeyManager.WebAuthn", var20.toString(), null, 4, null);
         var1.skipValue();
      }
               ...
               if (var7.w() is L5.f) {
                  ...
                  if (var1 != 4001) {
                     if (var1 == 4002) {
                        ...
                        val var8: java.lang.String = var7.D();
                        q.g(var8, "toJson(...)");
                        var4.invoke(var8);
                     }
                  } else {
                     val var12: Function1 = this.resolve;
                     val var9: java.lang.String = var7.D();
                     q.g(var9, "toJson(...)");
                     var12.invoke(var9);
                  }
               }

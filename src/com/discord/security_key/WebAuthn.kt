...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 85: aload 1
      // 86: aconst_null
      // 87: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8a: aload 2
      ...
      // 9b: aload 1
      // 9c: aload 3
      // 9d: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a0: aload 2
      // a1: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // ac: aload 1
      // ad: aconst_null
      // ae: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // b1: aload 2
      ...
      // c2: aload 1
      // c3: aload 2
      // c4: invokestatic Ma/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // c7: aload 3
      // c8: athrow
   }

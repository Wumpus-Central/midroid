...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
   ...
   private fun parseCreationOptions(reader: JsonReader, builder: Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var6.hashCode()) {
               ...
               case -709624112:
                  if (var6.equals("attestation")) {
                     val var14: com.google.android.gms.fido.fido2.api.common.b = com.google.android.gms.fido.fido2.api.common.b.b(var1.nextString());
                     q.g(var14, "fromString(...)");
                     val var12: Log = Log.INSTANCE;
                     val var8: StringBuilder = new StringBuilder();
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     val var7: Log = Log.INSTANCE;
                     val var11: StringBuilder = new StringBuilder();
                     var11.append("parseCreationOptions: challenge: `");
                     var11.append(var5);
                     var11.append("`");
                     Log.i$default(var7, "DCDSecurityKeyManager.WebAuthn", var11.toString(), null, 4, null);
                     q.e(var5);
         ...
         Log.w$default(var15, "DCDSecurityKeyManager.WebAuthn", var10.toString(), null, 4, null);
         var1.skipValue();
      }
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 86: aload 1
      // 87: aconst_null
      // 88: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8b: aload 2
      ...
      // 9c: aload 1
      // 9d: aload 3
      // 9e: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a1: aload 2
      // a2: athrow
   }
   ...
   private fun parseRequestOptions(reader: JsonReader, builder: com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRequestOptions.Builder) {
      ...
      while (var1.hasNext()) {
            ...
            switch (var6.hashCode()) {
               ...
               case -1313911455:
                  if (var6.equals("timeout")) {
                     ...
                     var15.append("parseRequestOptions: timeout: `");
                     var15.append(var3);
                     var15.append("`");
               ...
               case 3506169:
                  if (var6.equals("rpId")) {
                     ...
                     val var9: Log = Log.INSTANCE;
                     val var17: StringBuilder = new StringBuilder();
                     var17.append("parseRequestOptions: rpId: `");
                     var17.append(var6);
                     var17.append("`");
                     Log.i$default(var9, "DCDSecurityKeyManager.WebAuthn", var17.toString(), null, 4, null);
                     var2.e(var6);
                     continue;
                  }
                  break;
               ...
               case 2036710790:
                  if (var6.equals("userVerification")) {
                     ...
                     val var7: Log = Log.INSTANCE;
                     val var12: StringBuilder = new StringBuilder();
                     var12.append("parseRequestOptions: userVerification: `");
                     var12.append(var5);
         ...
         Log.w$default(var11, "DCDSecurityKeyManager.WebAuthn", var18.toString(), null, 4, null);
         var1.skipValue();
      }

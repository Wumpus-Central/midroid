...
public class WebAuthn(resolve: (String) -> Unit, reject: (String) -> Unit) {
            ...
            switch (var6.hashCode()) {
               ...
               case 1402633315:
                  if (var6.equals("challenge")) {
                     ...
                     var11.append("challenge: `");
                     var11.append(var5);
                     var11.append("`");
                     Log.i$default(var7, "DCDSecurityKeyManager.WebAuthn parseCreationOptions", var11.toString(), null, 4, null);
                     q.e(var5);
   ...
   private fun parsePublicKeyCredentialCreationOptions(creationOptions: String): PublicKeyCredentialCreationOptions {
      ...
      // 87: aload 1
      // 88: aconst_null
      // 89: invokestatic nh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 8c: aload 2
      ...
      // 9d: aload 1
      // 9e: aload 2
      // 9f: invokestatic nh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // a2: aload 3
      // a3: athrow
   }
   ...
   private fun parsePublicKeyCredentialRequestOptions(requestOptions: String): PublicKeyCredentialRequestOptions {
      ...
      // 93: aload 1
      // 94: aconst_null
      // 95: invokestatic nh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 98: aload 2
      ...
      // a9: aload 1
      // aa: aload 3
      // ab: invokestatic nh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // ae: aload 2
      // af: athrow
   }
            ...
            switch (var7.hashCode()) {
               ...
               case 3506169:
                  if (var7.equals("rpId")) {
                     ...
                     var9.append(var7);
                     var9.append("`");
                     Log.i$default(var13, "DCDSecurityKeyManager.WebAuthn parseRequestOptions", var9.toString(), null, 4, null);
                     var2.e(var7);
                     continue;
                  }
                  break;
               ...
               case 1402633315:
                  if (var7.equals("challenge")) {
                     ...
                     var17.append(var12);
                     var17.append("`");
                     Log.i$default(var8, "DCDSecurityKeyManager.WebAuthn parseRequestOptions", var17.toString(), null, 4, null);
                     q.e(var12);

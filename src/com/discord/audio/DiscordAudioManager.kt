      ...
      return new AudioDeviceCallback(this) {
         ...
         public void onAudioDevicesAdded(AudioDeviceInfo[] var1) {
            if (var1 != null && var1.length != 0) {
               ...
               DiscordAudioManager.access$setAudioDevices$p(var7, kotlin.collections.i.z0(var5, var4));
         ...
         public void onAudioDevicesRemoved(AudioDeviceInfo[] var1) {
            if (var1 != null && var1.length != 0) {
               ...
               DiscordAudioManager.access$setAudioDevices$p(var7, kotlin.collections.i.v0(var6, kotlin.collections.i.V0(var5)));

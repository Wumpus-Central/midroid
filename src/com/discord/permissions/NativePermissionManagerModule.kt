...
public class NativePermissionManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun requestWithDeduplication(key: String, promise: Promise, makeRequest: (String, Promise) -> Unit) {
      ...
      // c5: pop
      // c6: aload 1
      // c7: ldc_w "PERMISSION_REQUEST_ERROR"
      // ca: aload 3
      // cb: invokevirtual java/lang/StringBuilder.toString ()Ljava/lang/String;
      // ce: aload 2
      // cf: invokeinterface com/facebook/react/bridge/Promise.reject (Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V 4
      // d4: goto 94
      // d7: aload 2
      // d8: athrow
      // d9: aload 4

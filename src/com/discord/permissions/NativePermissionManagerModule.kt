...
public class NativePermissionManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun requestWithDeduplication(key: String, promise: Promise, makeRequest: (String, Promise) -> Unit) {
      ...
      // 88: ifnull d8
      // 8b: aload 1
      // 8c: checkcast java/lang/Iterable
      // 8f: invokeinterface java/lang/Iterable.iterator ()Ljava/util/Iterator; 1
      // 94: astore 1
      // 95: aload 1
      // 96: invokeinterface java/util/Iterator.hasNext ()Z 1
      // 9b: ifeq d8
      // 9e: aload 1
      ...
      // a7: astore 6
      // a9: aload 2
      // aa: invokevirtual java/lang/Throwable.getMessage ()Ljava/lang/String;
      // ad: astore 5
      ...
      // cf: aload 2
      // d0: invokeinterface com/facebook/react/bridge/Promise.reject (Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V 4
      // d5: goto 95
      // d8: aload 2
      // d9: athrow
      // da: aload 4

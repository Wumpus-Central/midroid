...
public class NativePermissionManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun createMultiPromiseResolver(permissionKey: String): Promise {
      return new Promise(this, var1) {
         ...
         private final void executeOnAllPending(Function1<? super Promise, Unit> param1) {
            ...
            // 2a: return
            // 2b: aload 3
            // 2c: checkcast java/lang/Iterable
            // 2f: invokeinterface java/lang/Iterable.iterator ()Ljava/util/Iterator; 1
            // 34: astore 7
            // 36: aload 7
            // 38: invokeinterface java/util/Iterator.hasNext ()Z 1
            // 3d: ifeq 8f
            // 40: aload 7
            // 42: invokeinterface java/util/Iterator.next ()Ljava/lang/Object; 1
            // 47: checkcast com/facebook/react/bridge/Promise
            // 4a: astore 4
            // 4c: aload 1
            // 4d: aload 4
            // 4f: invokeinterface kotlin/jvm/functions/Function1.invoke (Ljava/lang/Object;)Ljava/lang/Object; 2
            // 54: pop
            // 55: goto 36
            // 58: astore 1
            // 59: goto 96
            // 5c: astore 3
            // 5d: aload 3
            // 5e: invokevirtual java/lang/Throwable.getMessage ()Ljava/lang/String;
            // 61: astore 5
            ...
            // 6d: aload 6
            // 6f: ldc "Failed to resolve promise: "
            ...
            // 7c: pop
            // 7d: aload 4
            // 7f: ldc "PROMISE_RESOLUTION_ERROR"
            // 81: aload 6
            // 83: invokevirtual java/lang/StringBuilder.toString ()Ljava/lang/String;
            // 86: aload 3
            // 87: invokeinterface com/facebook/react/bridge/Promise.reject (Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V 4
            // 8c: goto 36
         ...
         public void reject(java.lang.String var1, java.lang.String var2, WritableMap var3) {
            this.executeOnAllPending(new com.discord.permissions.h(var1, var2, var3));
         }
         ...
         public void reject(java.lang.String var1, java.lang.String var2, java.lang.Throwable var3, WritableMap var4) {
            this.executeOnAllPending(new com.discord.permissions.j(var1, var2, var3, var4));
         }
         ...
         public void reject(java.lang.String var1, java.lang.Throwable var2, WritableMap var3) {
            this.executeOnAllPending(new s(var1, var2, var3));
         }
         ...
         public void reject(java.lang.Throwable var1, WritableMap var2) {
            this.executeOnAllPending(new com.discord.permissions.i(var1, var2));
         }
   ...
   fun `requestForegroundServicePermissionScreenShareWithMic$lambda$4`(var0: NativePermissionManagerModule, var1: Promise, var2: Promise): Unit {
      ...
      if (androidx.core.content.a.a(var0.getReactApplicationContext(), "android.permission.RECORD_AUDIO") != 0) {
         var4.add("android.permission.RECORD_AUDIO");
      }

      if (androidx.core.content.a.a(var0.getReactApplicationContext(), "android.permission.FOREGROUND_SERVICE_MICROPHONE") != 0) {
         var4.add("android.permission.FOREGROUND_SERVICE_MICROPHONE");
      }

      if (androidx.core.content.a.a(var0.getReactApplicationContext(), "android.permission.FOREGROUND_SERVICE_MEDIA_PROJECTION") != 0) {
   ...
   fun `requestForegroundServicePermissionVoiceCall$lambda$3`(var0: NativePermissionManagerModule, var1: Promise, var2: Promise): Unit {
      var0.requestMicrophoneAuthorization(NativePermissionPromise.INSTANCE.generate(new b(var0, var1), new com.discord.permissions.c(var1)));
      return Unit.a;
   }

   @JvmStatic
   fun `requestForegroundServicePermissionVoiceCall$lambda$3$lambda$1`(var0: NativePermissionManagerModule, var1: Promise): Unit {
      var0.requireAppInForeground(var1, new com.discord.permissions.g(var0, var1));
      return Unit.a;
   }
   ...
   private fun requestMultiplePermissionsWithDeduplication(permissions: List<String>, promise: Promise) {
      this.requestWithDeduplication(CollectionsKt.x0(CollectionsKt.U0(var1), ",", null, null, 0, null, null, 62, null), var2, new a(this, var1));
   }
   ...
   private fun requestPermissionWithDeduplication(permission: String, promise: Promise) {
      this.requestWithDeduplication(var1, var2, new com.discord.permissions.d(this));
   }
   ...
   private fun requestWithDeduplication(key: String, promise: Promise, makeRequest: (String, Promise) -> Unit) {
      ...
      // 39: aload 2
      // 3a: aastore
      // 3b: invokestatic kotlin/collections/CollectionsKt.r ([Ljava/lang/Object;)Ljava/util/List;
      ...
      // 68: aload 1
      // 69: aload 6
      // 6b: invokeinterface kotlin/jvm/functions/Function2.invoke (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object; 3
      // 70: pop
      // 71: getstatic kotlin/Unit.a Lkotlin/Unit;
      // 74: astore 1
      // 75: aload 4
      // 77: monitorexit
      // 78: return
      // 79: astore 2
      // 7a: aload 0
      // 7b: getfield com/discord/permissions/NativePermissionManagerModule.pendingPermissionRequests Ljava/util/Map;
      // 7e: aload 1
      // 7f: invokeinterface java/util/Map.remove (Ljava/lang/Object;)Ljava/lang/Object; 2
      // 84: checkcast java/util/List
      // 87: astore 1
      // 88: aload 1
      // 89: ifnull dc
      // 8c: aload 1
      // 8d: checkcast java/lang/Iterable
      // 90: invokeinterface java/lang/Iterable.iterator ()Ljava/util/Iterator; 1
      // 95: astore 1
      // 96: aload 1
      // 97: invokeinterface java/util/Iterator.hasNext ()Z 1
      // 9c: ifeq dc
      // 9f: aload 1
      // a0: invokeinterface java/util/Iterator.next ()Ljava/lang/Object; 1
      // a5: checkcast com/facebook/react/bridge/Promise
      // a8: astore 6
      // aa: aload 2
      // ab: invokevirtual java/lang/Throwable.getMessage ()Ljava/lang/String;
      // ae: astore 3
      ...
      // b9: aload 5
      // bb: ldc_w "Failed to request permission: "
      ...
      // c8: pop
      // c9: aload 6
      // cb: ldc_w "PERMISSION_REQUEST_ERROR"
      // ce: aload 5
      // d0: invokevirtual java/lang/StringBuilder.toString ()Ljava/lang/String;
      // d3: aload 2
      // d4: invokeinterface com/facebook/react/bridge/Promise.reject (Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V 4
      // d9: goto 96
      // dc: aload 2
      // dd: athrow
      // de: aload 4
   ...
   public fun requestForegroundServicePermissionScreenShareWithMic(promise: Promise) {
      if (VERSION.SDK_INT >= 34) {
         this.requireAppInForeground(var1, new com.discord.permissions.e(this, var1));
      } else {
   ...
   public fun requestForegroundServicePermissionVoiceCall(promise: Promise) {
      if (VERSION.SDK_INT >= 34) {
         this.requireAppInForeground(var1, new com.discord.permissions.f(this, var1));
      } else {
         this.requestForegroundServicePermissionPreU(var1);
      }
   }

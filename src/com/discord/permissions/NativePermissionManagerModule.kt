...
public class NativePermissionManagerModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun requestWithDeduplication(key: String, promise: Promise, makeRequest: (String, Promise) -> Unit) {
      ...
      // af: astore 3
      // b0: aload 3
      // b1: invokespecial java/lang/StringBuilder.<init> ()V
      // b4: aload 3
      // b5: ldc_w "Failed to request permission: "
      ...
      // c2: pop
      // c3: aload 6
      // c5: ldc_w "PERMISSION_REQUEST_ERROR"
      // c8: aload 3
      // c9: invokevirtual java/lang/StringBuilder.toString ()Ljava/lang/String;
      // cc: aload 2
      // cd: invokeinterface com/facebook/react/bridge/Promise.reject (Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V 4
      // d2: goto 92
      // d5: aload 2
      // d6: athrow
      // d7: aload 4

...
public class CompressionModule(reactContext: ReactApplicationContext) : NativeCompressionModuleSpec(var1) {
   ...
   protected override fun getTypedExportedConstants(): MutableMap<String, Any> {
      return s0.n(new Pair[]{v.a("supportsZstd", java.lang.Boolean.TRUE)});
   }
   ...
   private class ZlibContentHandler(inflater: Inflater) : WebSocketModule.ContentHandler {
      ...
      public override fun onMessage(text: String, params: WritableMap) {
      ...
      public override fun onMessage(byteString: ByteString, params: WritableMap) {
         ...
         if (var6.getDurationMillis() > 100L) {
            ...
            var7.append(var9);
            Log.i$default(var4, var3, var7.toString(), null, 4, null);
         }

         var2.putString("type", "text");
         var2.putString("data", var5);
         var2.putInt("raw_length", var1.H());
         DeviceResourceUsageRecorder.Companion.setSocketBytesReceived(DeviceResourceUsageRecorder.Companion.getSocketBytesReceived() + (long)var1.H());
      }

      private class ZLibByteStream(bytes: ByteString, inflater: Inflater) : ByteArrayOutputStream(var1.H() * 2) {
         init {
   ...
   private class ZstdContentHandler(inflater: com.discord.compression.CompressionModule.ZstdInflater) : WebSocketModule.ContentHandler {
   ...
   private class ZstdInflater : ZstdBufferDecompressingStream(ByteBuffer.allocate(0)) {
      ...
      public fun decompress(byteString: ByteString): String {
         this.nextBuffer = ByteBuffer.wrap(var1.M());
         val var6: java.util.List = CollectionsKt.k1(CollectionsKt.l());
         var var2: Int = Math.max(var1.H() * 2, 1024);
      ...
      protected override fun refill(currentBuffer: ByteBuffer): ByteBuffer {

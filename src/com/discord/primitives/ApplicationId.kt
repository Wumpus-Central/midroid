...
public inline class ApplicationId : SnowflakePrimitive {
   ...
   public open operator fun equals(other: Any?): Boolean {
      if (var2 !is ApplicationId) {
         return false;
      } else {
         return var0 == (var2 as ApplicationId).unbox-impl();
      }
   }
   ...
   public object `$serializer` : f0<ApplicationId> {
      ...
      public open fun deserialize(decoder: Decoder): ApplicationId {
         r.h(var1, "decoder");
         return ApplicationId.constructor-impl(var1.q(this.getDescriptor()).l());
      }
   ...
   public companion object {
      public fun serializer(): KSerializer<ApplicationId> {
         return ApplicationId.$serializer.INSTANCE;
      }
   }

   // $VF: Class flags could not be determined
   internal class Creator : android.os.Parcelable.Creator<ApplicationId> {
      fun `createFromParcel-UV2lyTI`(var1: Parcel): Long {
         r.h(var1, "parcel");
         return ApplicationId.constructor-impl(var1.readLong());
      }

      fun newArray(var1: Int): Array<ApplicationId> {

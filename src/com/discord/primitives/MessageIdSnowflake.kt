...
public inline class MessageIdSnowflake : SnowflakePrimitive {
   ...
   public open operator fun equals(other: Any?): Boolean {
      if (var2 !is MessageIdSnowflake) {
         return false;
      } else {
         return var0 == (var2 as MessageIdSnowflake).unbox-impl();
      }
   }
   ...
   public companion object {
      public fun serializer(): KSerializer<MessageIdSnowflake> {
         return MessageIdSnowflake.$serializer.INSTANCE;
      }
   }

   // $VF: Class flags could not be determined
   internal class Creator : android.os.Parcelable.Creator<MessageIdSnowflake> {
      fun `createFromParcel-D_BKnMo`(var1: Parcel): Long {
         return MessageIdSnowflake.constructor-impl(var1.readLong());
      }

      fun newArray(var1: Int): Array<MessageIdSnowflake> {
         return new MessageIdSnowflake[var1];
      }
   }
}

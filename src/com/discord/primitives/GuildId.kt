...
public inline class GuildId : SnowflakePrimitive {
   ...
   public open operator fun equals(other: Any?): Boolean {
      if (var2 !is GuildId) {
         ...
         return var0 == (var2 as GuildId).unbox-impl();
      }
   }
   ...
   public object `$serializer` : f0<GuildId> {
   ...
   public companion object {
      public fun serializer(): KSerializer<GuildId> {
         return GuildId.$serializer.INSTANCE;
      }
   }

   // $VF: Class flags could not be determined
   internal class Creator : android.os.Parcelable.Creator<GuildId> {
      fun `createFromParcel-hCFrBxw`(var1: Parcel): Long {
         r.h(var1, "parcel");
         return GuildId.constructor-impl(var1.readLong());
      }

      fun newArray(var1: Int): Array<GuildId> {
         return new GuildId[var1];
      }
   }
}

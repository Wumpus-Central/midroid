...
public final class ViewOverlayMenuBinding implements ViewBinding {
   ...
   public static ViewOverlayMenuBinding bind(View var0) {
      ...
      if (var5 != null) {
         ...
         CardView var9 = (CardView)a.a(var0, var1);
         if (var9 != null) {
            var1 = R.id.menu_top;
            CardView var12 = (CardView)a.a(var0, var1);
            if (var12 != null) {
                           ...
                           if (var4 != null) {
                              ...
                              if (var7 != null) {
                                 ...
                                 if (var6 != null) {
                                    ...
                                    if (var3 != null) {
                                       return new ViewOverlayMenuBinding(var0, var5, var9, var12, var11, var8, var10, var2, var4, var7, var6, var3);
                                    }
                                 }
                              }
                           }

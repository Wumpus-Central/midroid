...
public data class MobileVoiceOverlayDataUser(userId: UserId, avatar: String?, speaking: Boolean, discriminator: Int) : MobileVoiceOverlayDataUser(
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): MobileVoiceOverlayDataUser {
         ...
         val var11: UserId;
         if (var10.y()) {
            var11 = var10.m(var9, 0, UserId.$serializer.INSTANCE, null) as UserId;
            val var7: java.lang.String = var10.v(var9, 1, b2.a, null) as java.lang.String;
            var3 = var10.s(var9, 2);
            ...
            while (var15) {
               ...
               if (var6 != -1) {
                  if (var6 != 0) {
                     ...
                     var16 = var10.m(var9, 0, UserId.$serializer.INSTANCE, var16) as UserId;
                     var13 |= 1;
                  }
               } else {
                  var15 = false;
         ...
         var10.b(var9);
         return new MobileVoiceOverlayDataUser(var4, var11, var8, (boolean)var3, var5, null, null);
      }

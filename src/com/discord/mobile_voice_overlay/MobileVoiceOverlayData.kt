...
public data class MobileVoiceOverlayData(users: List<MobileVoiceOverlayDataUser>,
   ...
   public object `$serializer` : g0 {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         val var5: Array<KSerializer> = MobileVoiceOverlayData.access$get$childSerializers$cp();
         return new KSerializer[]{
            var5[0], n0.a, en.a.u(GuildId.$serializer.INSTANCE), ChannelId.$serializer.INSTANCE, b2.a, b2.a, h.a, h.a, var5[8], h.a, var5[10]
         };
      }
      ...
      public open fun deserialize(decoder: Decoder): MobileVoiceOverlayData {
         ...
         if (var9) {
            var13 = var19.y(var18, 0, var16[0], null) as java.util.List;
            var6 = var19.i(var18, 1);
            var11 = var19.n(var18, 2, GuildId.$serializer.INSTANCE, null) as GuildId;
            var12 = var19.y(var18, 3, ChannelId.$serializer.INSTANCE, null) as ChannelId;
            var15 = var19.m(var18, 4);
            val var20: java.lang.String = var19.m(var18, 5);
            var4 = var19.C(var18, 6);
            val var23: Byte = var19.C(var18, 7);
            var10 = var19.y(var18, 8, var16[8], null) as ConnectionQuality;
            var9 = var19.C(var18, 9);
            val var31: java.util.List = var19.y(var18, 10, var16[10], null) as java.util.List;
            var5 = 2047;
            var14 = var20;
            var3 = var23;
            var21 = var31;
            ...
            while (var7) {
               ...
               switch (var8) {
                  case -1:
                     ...
                     continue;
                  case 0:
                     var13 = var19.y(var18, 0, var16[0], var13) as java.util.List;
                     var2 |= 1;
                     var6 = 7;
                     continue;
                  case 1:
                     var3 = var19.i(var18, 1);
                     var2 |= 2;
                     break;
                  case 2:
                     var11 = var19.n(var18, 2, GuildId.$serializer.INSTANCE, var11) as GuildId;
                     var2 |= 4;
                     break;
                  case 3:
                     var12 = var19.y(var18, 3, ChannelId.$serializer.INSTANCE, var12) as ChannelId;
                     var2 |= 8;
                     break;
                  case 4:
                     var10 = var19.m(var18, 4);
                     var2 |= 16;
                     continue;
                  case 5:
                  ...
                  case 6:
                     ...
                     continue;
                  case 7:
                     var25 = var19.C(var18, var6);
                     var2 |= 128;
                     continue;
                  case 8:
                     var15 = var19.y(var18, 8, var16[8], var15) as ConnectionQuality;
                     var2 |= 256;
                     continue;
                  case 9:
                     var9 = var19.C(var18, 9);
                     ...
                     continue;
                  case 10:
                     var14 = var19.y(var18, 10, var16[10], var14) as java.util.List;
                     var2 |= 1024;
                     continue;
                  default:
                     throw new n(var8);

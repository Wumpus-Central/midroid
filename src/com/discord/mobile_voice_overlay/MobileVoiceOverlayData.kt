...
public data class MobileVoiceOverlayData(users: List<MobileVoiceOverlayDataUser>,
   ...
   public object `$serializer` : g0 {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         val var2: Array<KSerializer> = MobileVoiceOverlayData.access$get$childSerializers$cp();
         return new KSerializer[]{
            var2[0], n0.a, en.a.u(GuildId.$serializer.INSTANCE), ChannelId.$serializer.INSTANCE, b2.a, b2.a, h.a, h.a, var2[8], h.a, var2[10]
         };
      }
      ...
      public open fun deserialize(decoder: Decoder): MobileVoiceOverlayData {
         ...
         var var19: Any;
         if (var9) {
            var13 = var17.y(var16, 0, var18[0], null) as java.util.List;
            var5 = var17.i(var16, 1);
            var11 = var17.n(var16, 2, GuildId.$serializer.INSTANCE, null) as GuildId;
            var12 = var17.y(var16, 3, ChannelId.$serializer.INSTANCE, null) as ChannelId;
            var10 = var17.m(var16, 4);
            var19 = var17.m(var16, 5);
            var3 = var17.C(var16, 6);
            val var20: Byte = var17.C(var16, 7);
            var15 = var17.y(var16, 8, var18[8], null) as ConnectionQuality;
            var9 = var17.C(var16, 9);
            var14 = var17.y(var16, 10, var18[10], null) as java.util.List;
            var4 = 2047;
            var6 = var20;
         } else {
            ...
            while (var7) {
               ...
               switch (var8) {
                  case -1:
                     ...
                     continue;
                  case 0:
                     var13 = var17.y(var16, 0, var18[0], var13) as java.util.List;
                     var2 |= 1;
                     var6 = 7;
                     continue;
                  case 1:
                     ...
                     break;
                  case 2:
                     var11 = var17.n(var16, 2, GuildId.$serializer.INSTANCE, var11) as GuildId;
                     var2 |= 4;
                     break;
                  case 3:
                     var12 = var17.y(var16, 3, ChannelId.$serializer.INSTANCE, var12) as ChannelId;
                     var2 |= 8;
                     break;
                  case 4:
                     var10 = var17.m(var16, 4);
                  ...
                  case 5:
                     ...
                     continue;
                  case 6:
                     var22 = var17.C(var16, 6);
                     var2 |= 64;
                     continue;
                  case 7:
                     var23 = var17.C(var16, var6);
                     var2 |= 128;
                     continue;
                  case 8:
                     var15 = var17.y(var16, 8, var18[8], var15) as ConnectionQuality;
                     var2 |= 256;
                     continue;
                  case 9:
                     var9 = var17.C(var16, 9);
                     ...
                     continue;
                  case 10:
                     var14 = var17.y(var16, 10, var18[10], var14) as java.util.List;
                     var2 |= 1024;
                     continue;
                  default:
                     throw new n(var8);

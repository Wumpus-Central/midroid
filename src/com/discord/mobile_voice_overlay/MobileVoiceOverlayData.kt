...
public data class MobileVoiceOverlayData(users: List<MobileVoiceOverlayDataUser>,
   ...
   fun MobileVoiceOverlayData(
      ...
      kotlin.jvm.internal.q.h(var1, "users");
      kotlin.jvm.internal.q.h(var6, "channelName");
      kotlin.jvm.internal.q.h(var7, "guildName");
      kotlin.jvm.internal.q.h(var10, "connectionQuality");
      kotlin.jvm.internal.q.h(var12, "channelSelectorResults");
      super();
      this.users = var1;
   ...
   public override operator fun equals(other: Any?): Boolean {
      if (this === var1) {
         ...
         var1 = var1;
         if (!kotlin.jvm.internal.q.c(this.users, var1.users)) {
            return false;
            ...
            return kotlin.jvm.internal.q.c(this.channelSelectorResults, var1.channelSelectorResults);
         }
      }
   }

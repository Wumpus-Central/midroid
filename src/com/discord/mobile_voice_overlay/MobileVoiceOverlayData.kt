...
public data class MobileVoiceOverlayData(users: List<MobileVoiceOverlayDataUser>,
   ...
   fun MobileVoiceOverlayData(
      ...
      if (2047 != (var1 and 2047)) {
         p0.b(var1, 2047, MobileVoiceOverlayData.$serializer.INSTANCE.getDescriptor());
      }
   ...
   public object `$serializer` : G {
      ...
      public open fun childSerializers(): Array<KSerializer<*>> {
         ...
         return new KSerializer[]{
            var4[0], N.a, da.a.u(GuildId.$serializer.INSTANCE), ChannelId.$serializer.INSTANCE, C0.a, C0.a, h.a, h.a, var4[8], h.a, var4[10]
         };
      }

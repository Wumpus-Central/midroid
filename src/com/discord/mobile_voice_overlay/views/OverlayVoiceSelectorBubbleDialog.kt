...
public class OverlayVoiceSelectorBubbleDialog : OverlayDialog {
   ...
   private fun bindAssets() {
      ...
      if (var1 != null) {
         ...
         kotlin.jvm.internal.q.g(this.binding.close, "close");
   ...
   private fun bindData(): Unit? {
      ...
      if (this.data != null) {
         ...
         kotlin.jvm.internal.q.g(this.binding.emptyResults, "emptyResults");
         var var1: Byte;
         if (var3) {
            var1 = 0;
         } else {
         ...
         kotlin.jvm.internal.q.g(this.binding.resultsRv, "resultsRv");
         var1 = 8;
         if (!var3) {
            var1 = 0;
         }
   ...
   private fun onViewBound() {
      ...
      kotlin.jvm.internal.q.g(this.binding.overlayChannelSearch, "overlayChannelSearch");
      ...
      kotlin.jvm.internal.q.g(this.binding.channelSelect, "channelSelect");
      DiscordFontUtilsKt.setDiscordFont(var3, DiscordFont.PrimarySemibold);
      val var2: TextView = this.binding.emptyResults;
      kotlin.jvm.internal.q.e(this.binding.emptyResults);
      ...
      kotlin.jvm.internal.q.g(this.binding.menuContainer, "menuContainer");
      ...
      kotlin.jvm.internal.q.e(this.binding.overlayChannelSearch);
   ...
   public override fun getClosingAnimator(): Animator {
      ...
      kotlin.jvm.internal.q.g(var1, "apply(...)");
      return var1;
   }

...
public class OverlayMenuBubbleDialog : OverlayDialog {
   ...
   fun `setData$lambda$21`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      ...
      var2.startHeadlessTask(var3, "GenerateInvite", v1.d.a(new Pair[]{fm.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
   ...
   fun `setData$lambda$24`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      ...
      var5.startHeadlessTask(var4, "SelectChannel", v1.d.a(new Pair[]{fm.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
      return Unit.a;
   }
   ...
   fun `setData$lambda$26`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      val var2: MobileVoiceOverlay.Companion = MobileVoiceOverlay.Companion;
      val var3: Context = var0.getContext();
      var2.startHeadlessTask(var3, "Disconnect", v1.d.a(new Pair[]{fm.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
      return Unit.a;
   }
   ...
   public override fun setData(data: MobileVoiceOverlayData) {
      ...
      if (var3.size() < 2) {
         ...
         var3 = CollectionsKt.K0(var3, kotlin.ranges.e.v(1, var3.size()));
      }

...
public class OverlayMenuBubbleDialog : OverlayDialog {
   ...
   fun `setData$lambda$21`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      ...
      var3.startHeadlessTask(var2, "GenerateInvite", v0.d.a(new Pair[]{Ja.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
   ...
   fun `setData$lambda$24`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      ...
      var5.startHeadlessTask(var4, "SelectChannel", v0.d.a(new Pair[]{Ja.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
      return Unit.a;
   }
   ...
   fun `setData$lambda$26`(var0: OverlayMenuBubbleDialog, var1: MobileVoiceOverlayData): Unit {
      ...
      var2.startHeadlessTask(var3, "Disconnect", v0.d.a(new Pair[]{Ja.v.a("channelId", java.lang.String.valueOf(var1.getChannelId-o4g7jtM()))}));
      return Unit.a;
   }

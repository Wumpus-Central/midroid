...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver {
   ...
   private fun getProjection(): Array<String> {
      ...
      return c.r(c.r(new java.lang.String[]{"_display_name", "date_added", "_id"}, var2), var3) as Array<java.lang.String>;
   }
   ...
   private fun getScreenshotData(uri: Uri): com.discord.bug_reporter.ScreenshotContentObserver.ScreenshotData? {
      ...
      // 06b: aload 7
      // 06d: aconst_null
      // 06e: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 071: aconst_null
      // 072: areturn
      // 073: astore 1
      // 074: goto 111
      ...
      // 0b0: bipush 2
      // 0b1: aconst_null
      // 0b2: invokestatic kotlin/text/h.Y0 (Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
      // 0b5: astore 6
      // 0b7: goto 08f
      // 0ba: aload 7
      // 0bc: aload 7
      ...
      // 0de: aload 8
      // 0e0: ldc "getString(...)"
      // 0e2: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 0e5: aload 6
      // 0e7: invokestatic kotlin/jvm/internal/q.e (Ljava/lang/Object;)V
      ...
      // 109: aload 7
      // 10b: aconst_null
      // 10c: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 10f: aload 1
      // 110: areturn
      // 111: aload 1
      // 112: athrow
      ...
      // 115: aload 7
      // 117: aload 1
      // 118: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 11b: aload 6
      // 11d: athrow
      // 11e: aload 7
      // 120: aconst_null
      // 121: invokestatic s8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 124: aconst_null
      // 125: areturn
   }

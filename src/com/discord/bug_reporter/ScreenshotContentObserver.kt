...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver {
   ...
   private fun getScreenshotData(uri: Uri): com.discord.bug_reporter.ScreenshotContentObserver.ScreenshotData? {
      ...
      // 06b: aload 7
      // 06d: aconst_null
      // 06e: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 071: aconst_null
      // 072: areturn
      // 073: astore 6
      // 075: goto 112
      ...
      // 10a: aload 7
      // 10c: aconst_null
      // 10d: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 110: aload 1
      // 111: areturn
      // 112: aload 6
      // 114: athrow
      ...
      // 116: aload 7
      // 118: aload 6
      // 11a: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 11d: aload 1
      // 11e: athrow
      // 11f: aload 7
      // 121: aconst_null
      // 122: invokestatic c9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 125: aconst_null
      // 126: areturn
   }

...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver {
   ...
   private fun getProjection(): Array<String> {
      ...
      return c.t(c.t(new java.lang.String[]{"_display_name", "date_added", "_id"}, var2), var3) as Array<java.lang.String>;
   }
   ...
   private fun getScreenshotData(uri: Uri): com.discord.bug_reporter.ScreenshotContentObserver.ScreenshotData? {
      ...
      // 06b: aload 7
      // 06d: aconst_null
      // 06e: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 071: aconst_null
      // 072: areturn
      // 073: astore 6
      // 075: goto 112
      ...
      // 0a5: aload 6
      // 0a7: ldc "getString(...)"
      // 0a9: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 0ac: aload 6
      // 0ae: bipush 47
      // 0b0: aconst_null
      // 0b1: bipush 2
      // 0b2: aconst_null
      // 0b3: invokestatic kotlin/text/h.Y0 (Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
      // 0b6: astore 6
      // 0b8: goto 090
      // 0bb: aload 7
      // 0bd: aload 7
      ...
      // 0df: aload 8
      // 0e1: ldc "getString(...)"
      // 0e3: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 0e6: aload 6
      // 0e8: invokestatic kotlin/jvm/internal/q.e (Ljava/lang/Object;)V
      ...
      // 10a: aload 7
      // 10c: aconst_null
      // 10d: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 110: aload 1
      // 111: areturn
      // 112: aload 6
      // 114: athrow
      ...
      // 116: aload 7
      // 118: aload 6
      // 11a: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 11d: aload 1
      // 11e: athrow
      // 11f: aload 7
      // 121: aconst_null
      // 122: invokestatic A8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 125: aconst_null
      // 126: areturn
   }
   ...
   private fun process(uri: Uri) {
      ...
      if (var3 != null) {
         if (this.lastProcessedPath == null || !h.w(this.lastProcessedPath, var3.getPath(), false, 2, null)) {
   ...
   public companion object {
      ...
      private fun String.isScreenshotPath(): Boolean {
         ...
         return h.O(var1, "screenshots/", false, 2, null);
      }
   }

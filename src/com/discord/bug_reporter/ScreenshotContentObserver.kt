...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver {
   ...
   private fun getScreenshotData(uri: Uri): com.discord.bug_reporter.ScreenshotContentObserver.ScreenshotData? {
      ...
      // 109: aload 7
      // 10b: aconst_null
      // 10c: invokestatic F9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 10f: aload 1
      // 110: areturn
      // 111: aload 1
      // 112: athrow
      ...
      // 115: aload 7
      // 117: aload 1
      // 118: invokestatic F9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 11b: aload 6
      // 11d: athrow
      // 11e: aload 7
      // 120: aconst_null
      // 121: invokestatic F9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 124: aconst_null
      // 125: areturn
   }

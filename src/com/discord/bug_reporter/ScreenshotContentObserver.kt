...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver {
   ...
   private fun getScreenshotData(uri: Uri): com.discord.bug_reporter.ScreenshotContentObserver.ScreenshotData? {
      ...
      // 073: aload 6
      // 075: aconst_null
      // 076: invokestatic vh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 079: aconst_null
      // 07a: areturn
      // 07b: iload 2
      // 07c: bipush 29
      ...
      // 10b: aload 6
      // 10d: aconst_null
      // 10e: invokestatic vh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 111: aload 1
      // 112: areturn
      // 113: aload 1
      // 114: athrow
      ...
      // 117: aload 6
      // 119: aload 1
      // 11a: invokestatic vh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 11d: aload 5
      // 11f: athrow
      // 120: aload 6
      // 122: aconst_null
      // 123: invokestatic vh/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 126: aconst_null
      // 127: areturn
   }

...
internal class ScreenshotContentObserver(contentResolver: ContentResolver, onScreenshot: () -> Unit) : ContentObserver(null) {
   ...
   private fun process(uri: Uri) {
      ...
      if (var3 != null
         && (this.lastProcessedPath == null || !StringsKt.A(this.lastProcessedPath, var3.getPath(), false, 2, null))
         && ScreenshotContentObserver.Companion.access$isScreenshotPath(Companion, var3.getPath())

...
internal class BillingManager(isProdBuild: Boolean,
         ...
         this.backoff.fail(new Function1(this, null) {
            ...
            public final Object invokeSuspend(Object var1) {
               ...
               if (this.label == 0) {
                  ...
                  var1.k(BillingManager.access$getBillingClientStateListener$p(this.this$0));
   ...
   private fun verifyPurchase(purchase: Purchase) {
      if (var1.g() == 1 && !var1.k() && this.allowedPackageNames.contains(var1.e())) {
         ...
         for (java.lang.String var3 : var2) {
            ...
            kotlin.jvm.internal.q.g(var7, "getPackageName(...)");
            kotlin.jvm.internal.q.e(var3);
            var4.invoke(var6, var7, var3);
         }
      }
   }
   ...
   public fun open(context: ReactApplicationContext) {
      ...
      if (!var7.e()) {
         ...
         try {
            var8.k(this.billingClientStateListener);

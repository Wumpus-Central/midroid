...
public class NotificationClient {
   ...
   private fun appendNotificationToCacheFile(context: Context, notificationData: NotificationData) {
      ...
      // 030: astore 1
      // 031: aload 1
      // 032: invokespecial yb/p.<init> ()V
      // 035: aload 1
      // 036: ldc "push_action_type"
      // 038: aload 2
      // 039: invokevirtual com/discord/notifications/api/NotificationData.getType ()Ljava/lang/String;
      // 03c: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 03f: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 042: pop
      // 043: aload 1
      // 044: ldc "os_enabled"
      // 046: iload 3
      // 047: invokestatic java/lang/Boolean.valueOf (Z)Ljava/lang/Boolean;
      // 04a: invokestatic yb/g.b (Ljava/lang/Boolean;)Lkotlinx/serialization/json/JsonPrimitive;
      // 04d: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 050: pop
      // 051: aload 2
      ...
      // 05d: ldc "timestamp"
      // 05f: aload 7
      // 061: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 064: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 067: pop
      // 068: goto 074
      // 06b: astore 1
      // 06c: goto 263
      ...
      // 082: aload 7
      // 084: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 087: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 08a: pop
      // 08b: aload 2
      ...
      // 099: aload 7
      // 09b: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 09e: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0a1: pop
      // 0a2: aload 2
      ...
      // 0ae: ldc "join_id"
      // 0b0: aload 7
      // 0b2: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0b5: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0b8: pop
      // 0b9: aload 2
      ...
      // 0cf: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0d2: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0d5: pop
      // 0d6: aload 2
      ...
      // 0ed: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0f0: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0f3: pop
      // 0f4: aload 2
      ...
      // 10e: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 111: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 114: pop
      // 115: aload 2
      ...
      // 12c: invokestatic yb/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 12f: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 132: pop
      // 133: aload 2
      ...
      // 14a: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 14d: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 150: pop
      // 151: aload 2
      ...
      // 168: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 16b: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 16e: pop
      // 16f: aload 2
      ...
      // 186: invokestatic yb/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 189: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 18c: pop
      // 18d: aload 2
      ...
      // 1a4: invokestatic yb/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1a7: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1aa: pop
      // 1ab: aload 2
      ...
      // 1ba: aload 7
      // 1bc: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1bf: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1c2: pop
      // 1c3: aload 2
      ...
      // 1cd: ldc_w "app_state"
      // 1d0: aload 2
      // 1d1: invokestatic yb/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1d4: invokevirtual yb/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1d7: pop
      // 1d8: aload 1
      // 1d9: invokevirtual yb/p.a ()Lkotlinx/serialization/json/JsonObject;
      // 1dc: astore 2
      ...
      // 1fa: astore 6
      // 1fc: aload 6
      // 1fe: invokeinterface ub/f.a ()LAb/b; 1
      // 203: pop
      // 204: aload 6
      ...
      // 20c: aload 2
      // 20d: invokeinterface ub/n.c (Lub/i;Ljava/lang/Object;)Ljava/lang/String; 3
      // 212: getstatic ib/a.b Ljava/nio/charset/Charset;
      ...
      // 22f: aload 1
      // 230: aconst_null
      // 231: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 234: goto 260
      // 237: astore 6
      // 239: aload 6
      // 23b: athrow
      ...
      // 23d: aload 1
      // 23e: aload 6
      // 240: invokestatic N9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 243: aload 2
      // 244: athrow
      ...
      // 253: invokestatic kotlin/jvm/internal/r.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 256: aload 1
      // 257: aload 2
   ...
   private fun showNotification(context: Context, notificationData: NotificationData, notificationDataMap: Map<String, String>, makeOrUpdateShortcut: Boolean) {
      ...
      if (this.cache.isAuthed(var1)) {
         ...
         } else if (r.c(var2.getType(), "CALL_RING_END")) {
            this.renderer.handleCallRingEnd(var1, var2.getAckChannelIds());
         } else if (r.c(var2.getType(), "CALL_ACK")) {
               ...
               if (var72 != null) {
                  ...
                  if (var76 != null && var78 != null) {
                     ...
                     try {
                        ...
                        Json.d.a();
                        DiscordMobileApi.putMessage(var65, var50, var10, var77, var81.c(KvMessageEntry.Companion.serializer(), var72));
                     } catch (var19: Exception) {
                        val var48: Log = Log.INSTANCE;
                        val var67: java.lang.String = NotificationClient.class.getSimpleName();
                        r.g(var67, "getSimpleName(...)");

...
public class NotificationClient {
   ...
   private fun appendNotificationToCacheFile(context: Context, notificationData: NotificationData) {
      ...
      // 02f: astore 1
      // 030: aload 1
      // 031: invokespecial ob/p.<init> ()V
      // 034: aload 1
      // 035: ldc "push_action_type"
      // 037: aload 2
      // 038: invokevirtual com/discord/notifications/api/NotificationData.getType ()Ljava/lang/String;
      // 03b: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 03e: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 041: pop
      // 042: aload 1
      // 043: ldc "os_enabled"
      // 045: iload 5
      // 047: invokestatic java/lang/Boolean.valueOf (Z)Ljava/lang/Boolean;
      // 04a: invokestatic ob/g.b (Ljava/lang/Boolean;)Lkotlinx/serialization/json/JsonPrimitive;
      // 04d: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 050: pop
      // 051: aload 2
      ...
      // 05d: ldc "timestamp"
      // 05f: aload 7
      // 061: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 064: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 067: pop
      // 068: goto 074
      // 06b: astore 1
      // 06c: goto 263
      ...
      // 082: aload 7
      // 084: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 087: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 08a: pop
      // 08b: aload 2
      ...
      // 099: aload 7
      // 09b: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 09e: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0a1: pop
      // 0a2: aload 2
      ...
      // 0ae: ldc "join_id"
      // 0b0: aload 7
      // 0b2: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0b5: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0b8: pop
      // 0b9: aload 2
      ...
      // 0cf: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0d2: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0d5: pop
      // 0d6: aload 2
      ...
      // 0ed: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0f0: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0f3: pop
      // 0f4: aload 2
      ...
      // 10e: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 111: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 114: pop
      // 115: aload 2
      ...
      // 12c: invokestatic ob/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 12f: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 132: pop
      // 133: aload 2
      ...
      // 14a: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 14d: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 150: pop
      // 151: aload 2
      ...
      // 168: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 16b: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 16e: pop
      // 16f: aload 2
      ...
      // 186: invokestatic ob/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 189: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 18c: pop
      // 18d: aload 2
      ...
      // 1a4: invokestatic ob/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1a7: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1aa: pop
      // 1ab: aload 2
      ...
      // 1ba: aload 7
      // 1bc: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1bf: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1c2: pop
      // 1c3: aload 2
      ...
      // 1cd: ldc_w "app_state"
      // 1d0: aload 2
      // 1d1: invokestatic ob/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1d4: invokevirtual ob/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1d7: pop
      // 1d8: aload 1
      // 1d9: invokevirtual ob/p.a ()Lkotlinx/serialization/json/JsonObject;
      // 1dc: astore 2
      ...
      // 1fa: astore 6
      // 1fc: aload 6
      // 1fe: invokeinterface kb/e.a ()Lqb/b; 1
      // 203: pop
      // 204: aload 6
      ...
      // 20c: aload 2
      // 20d: invokeinterface kb/m.c (Lkb/h;Ljava/lang/Object;)Ljava/lang/String; 3
      // 212: getstatic Ya/a.b Ljava/nio/charset/Charset;
      // 215: invokevirtual java/lang/String.getBytes (Ljava/nio/charset/Charset;)[B
      // 218: astore 2
      // 219: aload 2
      // 21a: ldc_w "getBytes(...)"
      // 21d: invokestatic kotlin/jvm/internal/q.g (Ljava/lang/Object;Ljava/lang/String;)V
      // 220: aload 1
      // 221: aload 2
      ...
      // 22f: aload 1
      // 230: aconst_null
      // 231: invokestatic D9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 234: goto 260
      // 237: astore 6
      // 239: aload 6
      // 23b: athrow
      ...
      // 23d: aload 1
      // 23e: aload 6
      // 240: invokestatic D9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 243: aload 2
      // 244: athrow
         ...
         if (kotlin.jvm.internal.q.c(var2.getType(), "CHANNEL_ACK")) {
            ...
            if (this.shouldDisplayNotification.invoke() as java.lang.Boolean || kotlin.jvm.internal.q.c(var2.getType(), "CALL_RING")) {
               ...
               if (var8 != null) {
                  ...
                  try {
                     var15.logPushNotification(var1, var8, new PushNotificationMeta(var5, var7 xor true, var13, var14, var75, var16, var10));

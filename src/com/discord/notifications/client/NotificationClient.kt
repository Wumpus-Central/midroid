...
public class NotificationClient {
   ...
   private fun appendNotificationToCacheFile(context: Context, notificationData: NotificationData) {
      ...
      // 1f9: astore 6
      // 1fb: aload 6
      // 1fd: invokeinterface mb/e.a ()Lsb/b; 1
      // 202: pop
      // 203: aload 6
      ...
      // 20b: aload 2
      // 20c: invokeinterface mb/m.c (Lmb/h;Ljava/lang/Object;)Ljava/lang/String; 3
      // 211: getstatic ab/a.b Ljava/nio/charset/Charset;
      ...
      // 22e: aload 1
      // 22f: aconst_null
      // 230: invokestatic F9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 233: goto 261
      // 236: astore 6
      // 238: aload 6
      // 23a: athrow
      ...
      // 23c: aload 1
      // 23d: aload 6
      // 23f: invokestatic F9/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 242: aload 2
      // 243: athrow

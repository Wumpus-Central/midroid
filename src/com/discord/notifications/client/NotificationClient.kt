...
public class NotificationClient {
   ...
   private fun showNotification(context: Context, notificationData: NotificationData, notificationDataMap: Map<String, String>, makeOrUpdateShortcut: Boolean) {
      ...
      var var12: Pair = v.a("type", var2.getType());
      ...
      CrashReporting.addBreadcrumb$default(
         var11, "Kotlin NotificationClient received Notification.", s0.m(new Pair[]{var12, var9, v.a("messageId", var8)}), null, null, 12, null
      );

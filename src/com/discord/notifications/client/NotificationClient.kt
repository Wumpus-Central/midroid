...
public class NotificationClient {
   ...
   private fun appendNotificationToCacheFile(context: Context, notificationData: NotificationData) {
      ...
      // 23c: aload 1
      // 23d: aload 2
      // 23e: invokestatic tt/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 241: aload 6
      // 243: athrow
      ...
      if (this.cache.isAuthed(var1)) {
         ...
         if (this.shouldDisplayNotification.invoke() as java.lang.Boolean || var2.getType() == "CALL_RING") {
            ...
            try {
               ...
               var34.e(var50, "Unable to display notification", var32);
               return;
            }
            ...
            label134: {
               if (var70 != null) {
                  try {
                     ...
                     var35.e(var51, "Unable to display notification", var31);
                     return;
                  }
               ...
               try {
                  ...
                  var36.e(var52, "Unable to display notification", var30);
                  return;
               }
            }
            ...
            if (var8 != null) {
               ...
               try {
                  ...
                  var37.e(var53, "Unable to display notification", var29);
                  return;
               }
               ...
               if (var74 != null) {
                  try {
                     ...
                     var38.e(var54, "Unable to display notification", var28);
                     return;
                  }
               } else {
                  var75 = null;
               ...
               try {
                  ...
                  var39.e(var55, "Unable to display notification", var27);
                  return;
               }
               ...
               if (var17 != null) {
                  try {
                     ...
                     var40.e(var56, "Unable to display notification", var26);
                     return;
                  }
               }
               ...
               try {
                  ...
                  var41.e(var57, "Unable to display notification", var25);
                  return;
               }
            }
            ...
            if (var5) {
               try {
                  ...
                  var42.e(var58, "Unable to display notification", var24);
                  return;
               }
            } else {
               try {
                  ...
                  var43.e(var59, "Unable to display notification", var23);
                  return;
               }
            }
            ...
            try {
               ...
               var44.e(var60, "Unable to display notification", var33);
               return;
            }

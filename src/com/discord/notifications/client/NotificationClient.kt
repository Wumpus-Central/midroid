...
public class NotificationClient {
   ...
   private fun appendNotificationToCacheFile(context: Context, notificationData: NotificationData) {
      ...
      // 026: astore 1
      // 027: aload 1
      // 028: invokespecial ja/p.<init> ()V
      // 02b: aload 1
      // 02c: ldc "push_action_type"
      // 02e: aload 2
      // 02f: invokevirtual com/discord/notifications/api/NotificationData.getType ()Ljava/lang/String;
      // 032: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 035: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 038: pop
      // 039: aload 2
      ...
      // 045: ldc "timestamp"
      // 047: aload 6
      // 049: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 04c: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 04f: pop
      // 050: goto 05c
      // 053: astore 1
      // 054: goto 248
      ...
      // 06a: aload 6
      // 06c: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 06f: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 072: pop
      // 073: aload 2
      ...
      // 081: aload 6
      // 083: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 086: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 089: pop
      // 08a: aload 2
      ...
      // 096: ldc "join_id"
      // 098: aload 6
      // 09a: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 09d: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0a0: pop
      // 0a1: aload 2
      ...
      // 0b7: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0ba: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0bd: pop
      // 0be: aload 2
      ...
      // 0d4: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0d7: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0da: pop
      // 0db: aload 2
      ...
      // 0f4: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 0f7: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 0fa: pop
      // 0fb: aload 2
      ...
      // 112: invokestatic ja/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 115: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 118: pop
      // 119: aload 2
      ...
      // 130: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 133: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 136: pop
      // 137: aload 2
      ...
      // 14e: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 151: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 154: pop
      // 155: aload 2
      ...
      // 16c: invokestatic ja/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 16f: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 172: pop
      // 173: aload 2
      ...
      // 18a: invokestatic ja/g.c (Ljava/lang/Number;)Lkotlinx/serialization/json/JsonPrimitive;
      // 18d: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 190: pop
      // 191: aload 2
      ...
      // 1a0: aload 6
      // 1a2: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1a5: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1a8: pop
      // 1a9: aload 2
      ...
      // 1b3: ldc_w "app_state"
      // 1b6: aload 2
      // 1b7: invokestatic ja/g.d (Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
      // 1ba: invokevirtual ja/p.b (Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonElement;
      // 1bd: pop
      // 1be: aload 1
      // 1bf: invokevirtual ja/p.a ()Lkotlinx/serialization/json/JsonObject;
      // 1c2: astore 2
      ...
      // 1e0: astore 5
      // 1e2: aload 5
      // 1e4: invokeinterface fa/e.a ()Lla/b; 1
      // 1e9: pop
      // 1ea: aload 5
      ...
      // 1f2: aload 2
      // 1f3: invokeinterface fa/m.c (Lfa/h;Ljava/lang/Object;)Ljava/lang/String; 3
      // 1f8: getstatic T9/a.b Ljava/nio/charset/Charset;
      ...
      // 215: aload 1
      // 216: aconst_null
      // 217: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 21a: goto 245
      // 21d: astore 2
      // 21e: aload 2
      // 21f: athrow
      ...
      // 222: aload 1
      // 223: aload 2
      // 224: invokestatic y8/c.a (Ljava/io/Closeable;Ljava/lang/Throwable;)V
      // 227: aload 5
      // 229: athrow
   ...
   public fun onDirectReplySuccess(context: Context, data: String) {
      ...
      this.showNotification(var1, var5, q.l(new Pair[]{var3, var4, w.a("message_id", var2)}), false);
   }

   public fun onNotificationReceived(context: Context, data: Map<String, String>) {
      kotlin.jvm.internal.q.h(var1, "context");
      kotlin.jvm.internal.q.h(var2, "data");
      val var5: ma.a.a = ma.a.b;

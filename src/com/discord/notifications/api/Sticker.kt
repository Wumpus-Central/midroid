...
public data class Sticker(id: StickerId = ...,
   ...
   public override fun hashCode(): Int {
      ...
      return (((((((var4 * 31 + var5) * 31 + var1) * 31 + var2) * 31 + var8) * 31 + var6) * 31 + var7) * 31 + var9) * 31 + var3;
   }
   ...
   public override fun toString(): String {
      ...
      var3.append(var9);
      var3.append(", formatType=");
      var3.append(var6);
      var3.append(", tags=");
      var3.append(var4);
      var3.append(", type=");
      var3.append(var7);
      var3.append(", available=");
      var3.append(var10);
      var3.append(")");
   ...
   public object `$serializer` : g0 {
      ...
      public open fun deserialize(decoder: Decoder): Sticker {
         ...
         val var18: Any;
         if (var7) {
            var12 = var20.y(var19, 0, StickerId.$serializer.INSTANCE, null) as StickerId;
   ...
   internal class Creator : android.os.Parcelable.Creator<Sticker> {
      fun createFromParcel(var1: Parcel): Sticker {
         ...
         return new Sticker(var3, var6, var5, var10, var7, var11, var8, var9, var12, null);
      }

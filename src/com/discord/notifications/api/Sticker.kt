...
public data class Sticker(id: StickerId = ...,
   ...
   public override fun hashCode(): Int {
      ...
      return (((((((var4 * 31 + var5) * 31 + var1) * 31 + var2) * 31 + var7) * 31 + var6) * 31 + var8) * 31 + var9) * 31 + var3;
   }
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): Sticker {
         ...
         if (var7) {
            var16 = var20.m(var19, 0, StickerId.$serializer.INSTANCE, null) as StickerId;

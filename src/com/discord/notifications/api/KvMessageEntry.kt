...
public data class KvMessageEntry(members: List<JsonObject> = ..., users: List<JsonObject> = ..., message: JsonObject, id: MessageId, channelId: ChannelId) : KvMessageEntry(
   ...
   fun {
      val var0: q = q.a;
      $childSerializers = new KSerializer[]{new da.f(q.a), new da.f(var0), null, null, null};
   }
   ...
   public object `$serializer` : G {
      ...
      public open fun deserialize(decoder: Decoder): KvMessageEntry {
         ...
         if (var11.y()) {
            ...
            var5 = var11.m(var10, 1, var9[1], null) as java.util.List;
         ...
         var11.b(var10);
         return new KvMessageEntry(var2, var8, var5, var9, var7, var15, null, null);
      }

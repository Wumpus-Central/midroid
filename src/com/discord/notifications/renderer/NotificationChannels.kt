...
internal object NotificationChannels {
   ...
   public fun init(context: Context, localizedCategoryNames: Map<String, String>, localizedGroupNames: Map<String, String>) {
      ...
      val var13: Array<NotificationChannels.Category> = NotificationChannels.Category.values();
      val var9: ArrayList = new ArrayList();
      val var5: Int = var13.length;

      for (int var4 = 0; var4 < var5; var4++) {
         val var18: NotificationChannelCompat = INSTANCE.migrateOrCreateNotificationChannel(var1, var13[var4], var6, var2, new Function2(var13[var4], var1) {
      ...
      try {
         ...
         CrashReporting.addBreadcrumb$default(var14, "Failed to create notification group or channel", var15, null, 4, null);

...
public fun NotificationData.getAuthor(): JsonObject {
   ...
   val var5: qb.p = new qb.p();
   if (var3 != null) {
      qb.f.c(var5, "avatar", var3);
   }

   qb.f.c(var5, "id", UserId.toString-impl(var1));
   qb.f.c(var5, "username", var6);
   qb.f.c(var5, "globalName", var0.getUserGlobalName());
   qb.f.a(var5, "incomplete", java.lang.Boolean.TRUE);
   return var5.a();
}
   ...
   if (var3 != null && var2 != null && var0.getType() == "MESSAGE_CREATE") {
      ...
      if (var1 != null && var4 != null) {
         ...
         while (var14.hasNext()) {
            ...
            var6.put("incomplete", qb.g.b(java.lang.Boolean.TRUE));
...
public fun NotificationData.toNotificationMessage(author: JsonObject): JsonObject {
   ...
   qb.f.b(var10, "type", var12);
   qb.f.c(var10, "id", MessageId.toString-impl(var8));
   qb.f.c(var10, "channel_id", ChannelId.toString-impl(var4));
   qb.f.c(var10, "timestamp", var13);
   var10.b("author", var1);
   if (var11 != null) {
      qb.f.c(var10, "guild_id", GuildId.toString-impl(var11.unbox-impl()));
   }

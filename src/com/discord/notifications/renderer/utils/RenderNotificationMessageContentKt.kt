...
public fun renderNotificationMessageContent(content: String): String {
   ...
   var var14: java.lang.String = var4.h(var3.h(var0, new z()), new A());
   ...
   while (true) {
      ...
      val var12: Int = var6.c().q();
      val var2: Int = var6.c().w();
      var13 = StringsKt.v0(var13, var12, var2 + 1, var10).toString();
      var14 = StringsKt.v0(var14, var6.c().q(), var6.c().w() + 1, var10).toString();
   }
}

...
public class NotificationActions : BroadcastReceiver {
   public open fun onReceive(context: Context, intent: Intent) {
      ...
      if (IntentUtilsKt.hasExtra(var2, h0.b(MarkAsReadAction.class))) {
         var6 = (d.b(var2, "action_intent_arg_key", MarkAsReadAction.class) as Parcelable) as NotificationAction;
      } else {
         var6 = null;
      }
      ...
      if (var6 as MarkAsReadAction == null) {
         if (IntentUtilsKt.hasExtra(var2, h0.b(MuteAction.class))) {
            var7 = (d.b(var2, "action_intent_arg_key", MuteAction.class) as Parcelable) as NotificationAction;
         } else {
            var7 = null;
         }
         ...
         if (var7 as MuteAction == null) {
            if (IntentUtilsKt.hasExtra(var2, h0.b(DismissCallAction.class))) {
               var7 = (d.b(var2, "action_intent_arg_key", DismissCallAction.class) as Parcelable) as NotificationAction;
            } else {
               var7 = null;
            }
            ...
            if (var7 as DismissCallAction == null) {
               if (IntentUtilsKt.hasExtra(var2, h0.b(DirectReplyAction.class))) {
                  var7 = (d.b(var2, "action_intent_arg_key", DirectReplyAction.class) as Parcelable) as NotificationAction;
               } else {
                  var7 = null;
               }
               ...
               if (var7 as DirectReplyAction == null) {
                  if (IntentUtilsKt.hasExtra(var2, h0.b(DeleteAction.class))) {
                     var7 = (d.b(var2, "action_intent_arg_key", DeleteAction.class) as Parcelable) as NotificationAction;
                  } else {
                     var7 = null;
                  }
                  ...
                  if (var7 as DeleteAction == null) {
                     ...
                     if (IntentUtilsKt.hasExtra(var2, h0.b(GenericAction.class))) {
                        var7 = (d.b(var2, "action_intent_arg_key", GenericAction.class) as Parcelable) as NotificationAction;
                     }
                  }
               }
            }

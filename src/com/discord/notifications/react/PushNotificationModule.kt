...
public class PushNotificationModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   init {
      ...
      this.reactEvents = new ReactEvents(
         v.a("register", RegisterEvent::class), v.a("notification", NotificationEvent::class), v.a("localNotification", LocalNotificationEvent::class)
      );
   ...
   fun `_init_$lambda$0`(var0: PushNotificationModule): Boolean {
      return var0.reactContext.getLifecycleState() != LifecycleState.RESUMED;
   }
   ...
   public fun markNotificationAsDirectReply(channelId: String) {
      val var5: java.lang.Long = StringsKt.s(var1);
      if (var5 != null) {
   ...
   public fun presentLocalNotification(details: ReadableMap) {
      ...
      val var7: LinkedHashMap = new LinkedHashMap(s0.e(var2.size()));
      ...
      if (var2 != -690213213) {
         if (var2 != -145165322) {
            if (var2 == 595233003 && var1.equals("notification")) {
               NotificationClient.Companion.getInstance().setNotificationListener(new y8.c(this));
               return;
            }
         } else if (var1.equals("localNotification")) {
            NotificationClient.Companion.getInstance().setLocalNotificationListener(new y8.d(this));
            return;
         }

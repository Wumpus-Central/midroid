...
public object IconUrlUtils {
   public fun getApplicationIcon(applicationId: ApplicationId?, imageId: String?, size: Int = ...): String {
      ...
      var4.append("/");
      var4.append(var2);
      return var6.withSize(var4.toString(), false, var3, null);
   }
   ...
   public fun getForChannel(context: Context, id: ChannelId?, icon: String?, isGroupDM: Boolean, size: Int? = ...): String {
      ...
      if (var2 == null) {
         ...
         try {
            ...
            var13.append("/");
            var13.append(var3);
            var11 = r.b(var17.withSize(var13.toString(), false, var5, var3));
      ...
      if (var2 != null) {
         ...
         if (var3 != null) {
            ...
            try {
               ...
               var14.append("/");
               var14.append(var3);
               var12 = r.b(MediaProxy.INSTANCE.withSize(var14.toString(), var5, var6, var3));
            } catch (var8: java.lang.Throwable) {
               val var11: a = r.k;
               var12 = r.b(s.a(var8));
               break label43;

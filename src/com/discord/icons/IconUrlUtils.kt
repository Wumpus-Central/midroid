...
public object IconUrlUtils {
   ...
   public fun getForChannel(context: Context, id: ChannelId?, icon: String?, isGroupDM: Boolean, size: Int? = ...): String {
      ...
      if (var2 == null) {
         ...
         try {
            val var13: a = r.k;
            val var14: MediaProxy = MediaProxy.INSTANCE;
            ...
            var18.append(".");
            var18.append(var7);
            var12 = r.b(MediaProxy.withSize$default(var14, var18.toString(), var5, null, 4, null));
      ...
      if (var2 != null) {
         ...
         if (var3 != null) {
            ...
            try {
               ...
               var19.append(".");
               var19.append(var8);
               var13 = r.b(MediaProxy.withSize$default(MediaProxy.INSTANCE, var19.toString(), var6, null, 4, null));
            } catch (var9: java.lang.Throwable) {
               val var12: a = r.k;
               var13 = r.b(s.a(var9));
               break label43;

...
public object IconUrlUtils {
   public fun getApplicationIcon(applicationId: ApplicationId?, imageId: String?, size: Int = ...): String {
      ...
      var4.append(".");
      var4.append(var6);
      return MediaProxy.withSize$default(var5, var4.toString(), var3, null, 4, null);
   }
   ...
   public fun getCustomEmojiUrl(emojiId: Long, animate: Boolean, size: Int? = null): String {
      ...
      var5.append(".");
      var5.append(var7);
      return MediaProxy.withSize$default(var8, var5.toString(), var4, null, 4, null);
   }
   ...
   public fun getForChannel(context: Context, id: ChannelId?, icon: String?, isGroupDM: Boolean, size: Int? = ...): String {
      ...
      if (var2 == null) {
         ...
         try {
            ...
            var8.append(".");
            var8.append(var7);
            var11 = r.b(MediaProxy.withSize$default(var13, var8.toString(), var5, null, 4, null));

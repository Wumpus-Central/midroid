   ...
   private final val serviceConnection: <unrepresentable> =
      new ServiceConnection(this) {
         ...
         public void onServiceConnected(ComponentName var1, IBinder var2) {
            ...
            try {
               var38 = var5.N("97t47j218f", "dummy", "com.discord", var37);
            ...
            if (var38 == null) {
               ...
               try {
                  ...
                  val var3: Boolean = var5.b0(1221, var38, var42);
      ...
      public data class Success(authCode: String, serverUrl: String) : SamsungConnectActivity.Result() {
         ...
         public override operator fun equals(other: Any?): Boolean {
            if (this === var1) {
               ...
               var1 = var1;
               if (!(this.authCode == var1.authCode)) {
                  return false;
               } else {
                  return this.serverUrl == var1.serverUrl;
               }
            }
         }

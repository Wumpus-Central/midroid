               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var8: Function2 = new Function2(var5, var24, var9, var6, var4, null) {
                           final java.lang.String $authCode;
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var10 != null) {
                                       ...
                                       var3.append(var2x);
                                       var3.append("\"}");
                                       val var16: java.util.Map = R8.q.l(new Pair[]{var4, s.a("code", var3.toString())});

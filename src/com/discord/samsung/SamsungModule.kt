   ...
   private fun handleAuthResult(result: Result) {
      if (var1 is SamsungConnectActivity.Result.Success) {
         ...
         if ((var1 as SamsungConnectActivity.Result.Failure).isRetryAllowed() && (var1 as SamsungConnectActivity.Result.Failure).getAttemptCount() < 2) {
            ...
            var5.startActivityForResult(var9.getIntent(var4, var6.getAttemptCount()), 101);
         } else {
               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var9: Function2 = new Function2<CoroutineScope, Continuation, Object>(var5, var6, var8, var25, var4, null) {
                           final java.lang.String $authCode;
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var10 != null) {
                                       ...
                                       var4.append(var2x);
                                       var4.append("\"}");
                                       val var16: java.util.Map = L.l(new Pair[]{var3, s.a("code", var4.toString())});

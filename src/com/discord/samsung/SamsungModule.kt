...
public class SamsungModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun handleAuthResult(result: Result) {
      if (var1 is SamsungConnectActivity.Result.Success) {
         ...
         if ((var1 as SamsungConnectActivity.Result.Failure).isRetryAllowed() && (var1 as SamsungConnectActivity.Result.Failure).getAttemptCount() < 2) {
            ...
            var4.startActivityForResult(var6.getIntent(var5, var7.getAttemptCount()), 101);
         } else {
               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var31: CoroutineDispatcher = m0.b();
                        val var9: Function2 = new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var24, var6, var8, var4, var5, null) {
                           final java.lang.String $authCode;
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var10 != null) {
                                       ...
                                       var12.append(var4);
                                       var12.append("\"}");
                                       val var16: java.util.Map = s0.m(new Pair[]{var3, v.a("code", var12.toString())});
                        ...
                        this.label = 1;
                        if (gu.g.g(var31, var9, this) === var3x) {
                           return var3x;
                        }
   ...
   public fun getAccountUrlAndAuthCode(promise: Promise) {
      ...
      label16:
      try {
         val var8: a = kotlin.Result.e;
         val var3: ReactApplicationContext = this.getReactApplicationContext();
         val var2: SamsungConnectActivity.Companion = SamsungConnectActivity.Companion;
         val var9: Activity = this.reactContext.getCurrentActivity();
         var7 = kotlin.Result.b(var3.startActivityForResult(SamsungConnectActivity.Companion.getIntent$default(var2, var9, 0, 2, null), 101, Bundle.EMPTY));
      } catch (var4: java.lang.Throwable) {
         val var6: a = kotlin.Result.e;
         var7 = kotlin.Result.b(kotlin.c.a(var4));
         break label16;
      }
   ...
   public fun showConnectionDisclaimer(promise: Promise) {
      ...
      try {
         ...
         var5 = kotlin.Result.b(kotlin.c.a(var3));
         break label16;
      }

...
public class SamsungModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun handleSamsungCallback(response: Response): Uri? {
      ...
      val var4: java.lang.String = Response.T(var1, "Location", null, 2, null);
      val var8: Uri;
      if (var4 != null) {
         var8 = Uri.parse(var4);
      } else {
               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var31: Function2 = new Function2<CoroutineScope, Continuation, Object>(var24, var6, var9, var5, var4, null) {
                           final java.lang.String $authCode;

...
public class SamsungModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule {
   ...
   private fun getAccountUrlFromAuthServerUrl(authServerUrl: String): String {
      val var3: java.lang.String = h.f1(var1, 2);
   ...
   private fun handleAuthResult(result: Result) {
      if (var1 is SamsungConnectActivity.Result.Success) {
         ...
         if ((var1 as SamsungConnectActivity.Result.Failure).isRetryAllowed() && (var1 as SamsungConnectActivity.Result.Failure).getAttemptCount() < 2) {
            ...
            q.e(var5);
            var4.startActivityForResult(var9.getIntent(var5, var6.getAttemptCount()), 101);
         } else {
   ...
   private fun handleSamsungCallback(response: Response): Uri? {
      ...
      val var4: java.lang.String = Response.Y(var1, "Location", null, 2, null);
      val var8: Uri;
      if (var4 != null) {
         var8 = Uri.parse(var4);
      } else {
      ...
      if (var8 != null) {
         ...
         var2 = false;
         if (var6 != null) {
            var2 = h.O(var6, "error", false, 2, null);
         }
      }

      if (var2 || !var1.w1() && !var1.t0()) {
         label29: {
            if (var8 != null) {
   ...
   public fun checkIfOAuthRequest(clientId: String, promise: Promise) {
      ...
      label14: {
         ...
         if (q.c(var1, "591317049637339146") && VERSION.SDK_INT >= 28) {
            var3 = true;
            if (h.v(Build.MANUFACTURER, "samsung", true)) {
               break label14;
            }
         }
            ...
            public final Object invokeSuspend(Object var1) {
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     val var25: java.lang.String = this.$location;
                     ...
                     try {
                        val var7: a = r.k;
                        val var9: OkHttpClient = new Builder().k(false).c();
                        val var8: CoroutineDispatcher = K.b();
                        val var31: Function2 = new Function2(var25, var4, var9, var6, var5, null) {
                           final java.lang.String $authCode;
                           ...
                           public final Object invokeSuspend(Object var1) {
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var1 != null) {
                                       val var12: Pair = w.a("state", this.$state);
                                       val var3: java.lang.String = this.$authCode;
                                       val var4: StringBuilder = new StringBuilder();
                                       var4.append("{\"code\":\"");
                                       var4.append(var3);
                                       var4.append("\"}");
                                       val var16: java.util.Map = i8.q.l(new Pair[]{var12, w.a("code", var4.toString())});
               ...
               val var28: java.lang.Throwable = r.e(var1);
               if (var28 != null) {
   ...
   public fun getAccountUrlAndAuthCode(promise: Promise) {
      ...
      try {
         ...
         q.e(var2);
         var7 = r.b(var3.startActivityForResult(SamsungConnectActivity.Companion.getIntent$default(var9, var2, 0, 2, null), 101, Bundle.EMPTY));
   ...
   public fun showConnectionDisclaimer(promise: Promise) {
      ...
      try {
         val var7: a = r.k;
         var6 = r.b(this.getReactApplicationContext().startActivityForResult(disclaimerIntent, 100, Bundle.EMPTY));
      ...
      val var8: java.lang.Throwable = r.e(var6);
      if (var8 != null) {

   ...
   private fun handleAuthResult(result: Result) {
      if (var1 is SamsungConnectActivity.Result.Success) {
         ...
         if ((var1 as SamsungConnectActivity.Result.Failure).isRetryAllowed() && (var1 as SamsungConnectActivity.Result.Failure).getAttemptCount() < 2) {
            ...
            var6.startActivityForResult(var4.getIntent(var8, var5.getAttemptCount()), 101);
         } else {
               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var8: CoroutineDispatcher = m0.b();
                        val var9: Function2 = new Function2<CoroutineScope, Continuation<? super Unit>, Object>(var24, var6, var31, var4, var5, null) {
                           final java.lang.String $authCode;
                        ...
                        this.label = 1;
                        if (gu.g.g(var8, var9, this) === var3x) {
                           return var3x;
                        }

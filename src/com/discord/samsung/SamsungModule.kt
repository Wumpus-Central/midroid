...
public class SamsungModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(var1) {
   ...
   private fun handleSamsungCallback(response: Response): Uri? {
      ...
      if (var2 || !var1.isSuccessful() && !var1.e0()) {
         label29: {
            if (var8 != null) {
               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var8: Function2 = new Function2<CoroutineScope, Continuation, Object>(var4, var5, var9, var6, var25, null) {
                           final java.lang.String $authCode;
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var10 != null) {
                                       ...
                                       var12.append(var3);
                                       var12.append("\"}");
                                       val var16: java.util.Map = L.l(new Pair[]{var4, s.a("code", var12.toString())});
   ...
   public fun getAccountUrlAndAuthCode(promise: Promise) {
      ...
      try {
         ...
         var6 = kotlin.Result.b(var8.startActivityForResult(SamsungConnectActivity.Companion.getIntent$default(var3, var10, 0, 2, null), 101, Bundle.EMPTY));

               ...
               label43: {
                  ...
                  if (this.label != 0) {
                     ...
                     try {
                        ...
                        val var8: Function2 = new Function2(var24, var4, var9, var5, var6, null) {
                           final java.lang.String $authCode;
                              ...
                              if (this.label != 0) {
                                 ...
                                 if (var9 != null) {
                                    ...
                                    if (var1 != null) {
                                       ...
                                       var3.append(var12);
                                       var3.append("\"}");
                                       val var16: java.util.Map = s9.q.l(new Pair[]{var4, s.a("code", var3.toString())});
